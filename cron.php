...
file_put_contents(ROOT_DIRECTORY.'/user_privileges/cron.php', '<?php return '.App\Utils::varExport(array_merge(Settings_ConfReport_Module_Model::getPhpIniConf(), ['last_iteration_start' => time()])).';');
