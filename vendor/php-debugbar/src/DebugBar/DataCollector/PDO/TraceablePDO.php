...
class TraceablePDO extends PDO
{
   ...
   */
    ...
    {
		return array_reduce(self::$executedStatements, function ($v, $s) { return $v + $s->getDuration(); });
    }
    ...
    {
        return array_reduce(self::$executedStatements, function ($v, $s) { return $v + $s->getMemoryUsage(); });
    }
    ...
    {
        return array_reduce(self::$executedStatements, function ($v, $s) { $m = $s->getEndMemory(); return $m > $v ? $m : $v; });
    }
    ...
    {
        return array_filter(self::$executedStatements, function ($s) { return !$s->isSuccess(); });
    }
