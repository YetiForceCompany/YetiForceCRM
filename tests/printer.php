...
class YtResultPrinter extends PHPUnit\TextUI\DefaultResultPrinter
{
	...
	{
		echo PHP_EOL . 'error_reporting: ' . error_reporting() . ' | ' . \App\Utils::varExport(\App\ErrorHandler::error2string(error_reporting()), true) . PHP_EOL;
		...
		echo 'php_ini_scanned_files:' . php_ini_scanned_files() ?: '-' . PHP_EOL;
