...
class TextParser extends \Tests\Base
{
	...
	public function testStaticMethods()
	{
		...
		$this->assertSame((\App\Config::main('listview_max_textlength') + 3), \strlen((\App\TextParser::htmlTruncate(\Tests\Base\C_RecordActions::createLoremIpsumHtml(), \App\Config::main('listview_max_textlength')))), 'Clean instance: html should be truncated in expected format (default length)');
