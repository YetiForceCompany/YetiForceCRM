...
class TextParser extends \Tests\Base
{
	...
	/**
	 * Testing clean instance basic translate function.
	 */
	...
	/**
	 * Testing record model instance basic translate function.
	 */
	...
	/**
	 * Testing clean instance basic source record related functions.
	 */
	public function testCISrcRecord()
	{
		$this->assertSame('+autogenerated test lead for \App\TextParser tests+', static::$testInstanceClean->setContent('+$(sourceRecord : description)$+')->setSourceRecord(static::$testRecordId)->parse()->getContent(), 'Translations should be equal');
	}

	/**
	 * Testing record model instance basic source record related functions.
	 */
	public function testRMISrcRecord()
	{
		$this->assertSame('+autogenerated test lead for \App\TextParser tests+', static::$testInstanceRecord->setContent('+$(sourceRecord : description)$+')->setSourceRecord(static::$testRecordId)->parse()->getContent(), 'Translations should be equal');
	}
}
