...
class TextParser extends \Tests\Base
{
	...
	public function testRecord()
	{
		...
		$this->assertNotFalse(\strpos(self::$parserRecord->setContent($text)->parse()->getContent(), 'TestLead sp. z o.o.'), 'Test record changes list values should contain "TestLead sp. z o.o."');
		$this->assertNotFalse(\strpos(self::$parserRecord->setContent($text)->parse()->getContent(), 'autogenerated test lead for \App\TextParser tests'), 'Test record changes list values should contain "autogenerated test lead for \App\TextParser tests"');
