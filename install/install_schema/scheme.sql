...
/*Table structure for table `vtiger_osspaymentsin` */

CREATE TABLE `vtiger_osspaymentsin` (
  `osspaymentsinid` int(11) NOT NULL DEFAULT '0',
  ...
  `osspaymentsin_status` varchar(128) DEFAULT NULL,
  `relatedid` int(19) DEFAULT NULL,
  `salesid` int(19) DEFAULT NULL,
  `parentid` int(19) DEFAULT NULL,
  PRIMARY KEY (`osspaymentsinid`),
  CONSTRAINT `fk_1_vtiger_osspaymentsin` FOREIGN KEY (`osspaymentsinid`) REFERENCES `vtiger_crmentity` (`crmid`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `vtiger_osspaymentsin_status` */

CREATE TABLE `vtiger_osspaymentsin_status` (
  `osspaymentsin_statusid` int(11) NOT NULL AUTO_INCREMENT,
  `osspaymentsin_status` varchar(200) NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(11) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT '0',
  PRIMARY KEY (`osspaymentsin_statusid`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

/*Table structure for table `vtiger_osspaymentsin_status_seq` */

CREATE TABLE `vtiger_osspaymentsin_status_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `vtiger_osspaymentsincf` */

CREATE TABLE `vtiger_osspaymentsincf` (
  `osspaymentsinid` int(11) NOT NULL,
  PRIMARY KEY (`osspaymentsinid`),
  CONSTRAINT `fk_1_vtiger_osspaymentsincf` FOREIGN KEY (`osspaymentsinid`) REFERENCES `vtiger_osspaymentsin` (`osspaymentsinid`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `vtiger_osspaymentsout` */

CREATE TABLE `vtiger_osspaymentsout` (
  `osspaymentsoutid` int(11) NOT NULL DEFAULT '0',
  `paymentsvalue` decimal(25,3) DEFAULT NULL,
  `paymentsno` varchar(32) DEFAULT NULL,
  `paymentsname` varchar(128) DEFAULT NULL,
  ...
  `paymentscurrency` varchar(32) DEFAULT NULL,
  `bank_account` varchar(128) DEFAULT NULL,
  `osspaymentsout_status` varchar(128) DEFAULT NULL,
  `relatedid` int(19) DEFAULT NULL,
  `salesid` int(19) DEFAULT NULL,
  `parentid` int(19) DEFAULT NULL,
  PRIMARY KEY (`osspaymentsoutid`),
  CONSTRAINT `fk_1_vtiger_osspaymentsout` FOREIGN KEY (`osspaymentsoutid`) REFERENCES `vtiger_crmentity` (`crmid`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `vtiger_osspaymentsout_status` */

CREATE TABLE `vtiger_osspaymentsout_status` (
  `osspaymentsout_statusid` int(11) NOT NULL AUTO_INCREMENT,
  `osspaymentsout_status` varchar(200) NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(11) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT '0',
  PRIMARY KEY (`osspaymentsout_statusid`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

/*Table structure for table `vtiger_osspaymentsout_status_seq` */

CREATE TABLE `vtiger_osspaymentsout_status_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `vtiger_osspaymentsoutcf` */

CREATE TABLE `vtiger_osspaymentsoutcf` (
  `osspaymentsoutid` int(11) NOT NULL,
  PRIMARY KEY (`osspaymentsoutid`),
  CONSTRAINT `fk_1_vtiger_osspaymentsoutcf` FOREIGN KEY (`osspaymentsoutid`) REFERENCES `vtiger_osspaymentsout` (`osspaymentsoutid`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
