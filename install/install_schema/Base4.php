		...
		$this->data = [
			...
			'vtiger_settings_field' => [
				...
				'values' => [
						...
						[100, 5, 'LBL_WEBSERVICE_APPS', 'fa fa-globe', NULL, 'index.php?module=WebserviceApps&view=Index&parent=Settings', 11, 0, 0, NULL],
						...
						[106, 5, 'LBL_WEBSERVICE_USERS', 'fa fa-cogs', 'LBL_WEBSERVICE_USERS_DESCRIPTION', 'index.php?module=WebserviceUsers&view=List&parent=Settings', 11, 0, 0, NULL],
				]
			],
			'vtiger_squoteenquiries_status' => [
