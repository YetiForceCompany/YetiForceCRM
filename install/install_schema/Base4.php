...
class Base4 extends \App\Db\Importers\Base
{
	...
	public function data()
	{
		$this->data = [
			...
			'vtiger_recurringtype' => [
				'columns' => ['recurringtype', 'sortorderid', 'presence'],
				'values' => [
					['Daily', 1, 1],
					['Weekly', 2, 1],
					['Monthly', 3, 1],
			...
			'vtiger_rel_mod' => [
				'columns' => ['rel_mod', 'presence', 'picklist_valueid', 'sortorderid'],
				'values' => [
					['Accounts', 1, 393, 1],
					['Contacts', 1, 394, 2],
					['Leads', 1, 395, 3],
			...
			'vtiger_reminder_interval' => [
				'columns' => ['reminder_interval', 'sortorderid', 'presence'],
				'values' => [
					['1 Minute', 1, 1],
					['5 Minutes', 2, 1],
					['15 Minutes', 3, 1],
			...
			'vtiger_reportfolder' => [
				'columns' => ['foldername', 'description', 'state'],
				'values' => [
					['LBL_MAIN', '', 'SAVED'],
				]
			],
			'vtiger_reservations_status' => [
				'columns' => ['reservations_status', 'sortorderid', 'presence'],
				'values' => [
					['PLL_ACCEPTED', 1, 1],
					['PLL_TO_APPROVAL', 2, 1],
				]
			...
			'vtiger_role' => [
				'columns' => ['roleid', 'rolename', 'parentrole', 'depth', 'allowassignedrecordsto', 'changeowner', 'searchunpriv', 'clendarallorecords', 'listrelatedrecord', 'previewrelatedrecord', 'editrelatedrecord', 'permissionsrelatedfield', 'globalsearchadv', 'assignedmultiowner'],
				'values' => [
					['H1', 'Organization', 'H1', 0, 1, 1, NULL, 1, 0, 0, 0, '0', 1, 0],
					['H10', 'Sales Department', 'H1::H2::H10', 2, 1, 1, NULL, 3, 0, 0, 0, '0', 1, 1],
					['H14', 'Logistics Department', 'H1::H2::H14', 2, 1, 1, NULL, 3, 0, 0, 0, '0', 1, 1],
					['H18', 'Project Management Department', 'H1::H2::H18', 2, 1, 1, NULL, 3, 0, 0, 0, '0', 1, 1],
					['H2', 'Board of Management', 'H1::H2', 1, 1, 1, NULL, 3, 0, 0, 0, '0', 1, 1],
					['H22', 'Help Desk Department', 'H1::H2::H22', 2, 1, 1, NULL, 3, 0, 0, 0, '0', 1, 1],
					['H26', 'Human Resources Department', 'H1::H2::H26', 2, 1, 1, NULL, 3, 0, 0, 0, '0', 1, 1],
					['H3', 'Secretary\'s Office', 'H1::H2::H3', 2, 1, 1, NULL, 3, 0, 0, 0, '0', 1, 1],
					['H30', 'Financial Department', 'H1::H2::H30', 2, 1, 1, NULL, 3, 0, 0, 0, '0', 1, 1],
					['H34', 'Production Department', 'H1::H2::H34', 2, 1, 1, NULL, 3, 0, 0, 0, '0', 1, 1],
					['H6', 'Marketing Department', 'H1::H2::H6', 2, 1, 1, NULL, 3, 0, 0, 0, '0', 1, 1],
				]
			],
			'vtiger_role2picklist' => [
			...
			'vtiger_rowheight' => [
				'columns' => ['rowheight', 'sortorderid', 'presence'],
				'values' => [
					['wide', 1, 1],
					['medium', 2, 1],
					['narrow', 3, 1],
			...
			'vtiger_salutationtype' => [
				'columns' => ['salutationtype', 'presence', 'picklist_valueid', 'sortorderid'],
				'values' => [
					['Mr.', 1, 161, 1],
					['Ms.', 1, 162, 2],
					['Mrs.', 1, 163, 3],
			...
			'vtiger_scalculations_status' => [
				'columns' => ['scalculations_status', 'sortorderid', 'presence'],
				'values' => [
					['PLL_DRAFT', 1, 1],
					['PLL_IN_REALIZATION', 2, 1],
					['PLL_FOR_VERIFICATION', 3, 1],
					['PLL_CANCELLED', 4, 0],
					['PLL_COMPLETED', 5, 0],
				]
			],
			...
			'vtiger_service_usageunit' => [
				'columns' => ['service_usageunit', 'presence', 'picklist_valueid', 'sortorderid'],
				'values' => [
					['Hours', 1, 226, 1],
					['Days', 1, 227, 2],
					['Incidents', 1, 228, 3],
			...
			'vtiger_settings_blocks' => [
				'columns' => ['blockid', 'label', 'sequence', 'icon', 'type', 'linkto'],
				'values' => [
					[1, 'LBL_USER_MANAGEMENT', 2, 'adminIcon-permissions', 0, NULL],
			...
			'vtiger_settings_field' => [
				'columns' => ['fieldid', 'blockid', 'name', 'iconpath', 'description', 'linkto', 'sequence', 'active', 'pinned'],
				'values' => [
					[1, 1, 'LBL_USERS', 'adminIcon-user', 'LBL_USER_DESCRIPTION', 'index.php?module=Users&parent=Settings&view=List', 1, 0, 1],
					[2, 1, 'LBL_ROLES', 'adminIcon-roles', 'LBL_ROLE_DESCRIPTION', 'index.php?module=Roles&parent=Settings&view=Index', 2, 0, 0],
					[3, 1, 'LBL_PROFILES', 'adminIcon-profiles', 'LBL_PROFILE_DESCRIPTION', 'index.php?module=Profiles&parent=Settings&view=List', 3, 0, 0],
					[4, 1, 'USERGROUPLIST', 'adminIcon-groups', 'LBL_GROUP_DESCRIPTION', 'index.php?module=Groups&parent=Settings&view=List', 4, 0, 0],
					[5, 1, 'LBL_SHARING_ACCESS', 'adminIcon-module-access', 'LBL_SHARING_ACCESS_DESCRIPTION', 'index.php?module=SharingAccess&parent=Settings&view=Index', 5, 0, 0],
					[6, 1, 'LBL_FIELDS_ACCESS', 'adminIcon-special-access', 'LBL_SHARING_FIELDS_DESCRIPTION', 'index.php?module=FieldAccess&parent=Settings&view=Index', 6, 0, 0],
					[7, 14, 'LBL_LOGIN_HISTORY_DETAILS', 'adminIcon-users-login', 'LBL_LOGIN_HISTORY_DESCRIPTION', 'index.php?module=LoginHistory&parent=Settings&view=List', 3, 0, 0],
					[8, 2, 'VTLIB_LBL_MODULE_MANAGER', 'adminIcon-modules-installation', 'VTLIB_LBL_MODULE_MANAGER_DESCRIPTION', 'index.php?module=ModuleManager&parent=Settings&view=List', 1, 0, 1],
					[9, 2, 'LBL_PICKLIST_EDITOR', 'adminIcon-fields-picklists', 'LBL_PICKLIST_DESCRIPTION', 'index.php?parent=Settings&module=Picklist&view=Index', 9, 0, 1],
					[10, 2, 'LBL_PICKLIST_DEPENDENCY_SETUP', 'adminIcon-fields-picklists-relations', 'LBL_PICKLIST_DEPENDENCY_DESCRIPTION', 'index.php?parent=Settings&module=PickListDependency&view=List', 10, 0, 0],
					[11, 1, 'LBL_ADVANCED_PERMISSION', 'glyphicon glyphicon-ice-lolly', NULL, 'index.php?module=AdvancedPermission&parent=Settings&view=List', 10, 0, 0],
					[12, 3, 'NOTIFICATIONSCHEDULERS', '', 'LBL_NOTIF_SCHED_DESCRIPTION', 'index.php?module=Settings&view=listnotificationschedulers&parenttab=Settings', 4, 0, 0],
					[13, 4, 'INVENTORYNOTIFICATION', '', 'LBL_INV_NOTIF_DESCRIPTION', 'index.php?module=Settings&view=listinventorynotifications&parenttab=Settings', 1, 0, 0],
					[14, 3, 'LBL_COMPANY_DETAILS', 'adminIcon-company-detlis', 'LBL_COMPANY_DESCRIPTION', 'index.php?parent=Settings&module=Vtiger&view=CompanyDetails', 2, 0, 0],
					[15, 8, 'LBL_MAIL_SERVER_SETTINGS', 'adminIcon-mail-configuration', 'LBL_MAIL_SERVER_DESCRIPTION', 'index.php?parent=Settings&module=Vtiger&view=OutgoingServerDetail', 5, 0, 0],
					[16, 4, 'LBL_CURRENCY_SETTINGS', 'adminIcon-currencies', 'LBL_CURRENCY_DESCRIPTION', 'index.php?parent=Settings&module=Currency&view=List', 4, 0, 0],
					[17, 4, 'LBL_SWITCH_USERS', 'adminIcon-users', 'LBL_SWITCH_USERS_DESCRIPTION', 'index.php?module=Users&view=SwitchUsers&parent=Settings', 11, 0, 0],
					[18, 4, 'LBL_SYSTEM_INFO', 'adminIcon-server-configuration', 'LBL_SYSTEM_DESCRIPTION', 'index.php?module=Settings&submodule=Server&view=ProxyConfig', 6, 1, 0],
					[20, 4, 'LBL_DEFAULT_MODULE_VIEW', 'adminIcon-standard-modules', 'LBL_DEFAULT_MODULE_VIEW_DESC', 'index.php?module=Settings&action=DefModuleView&parenttab=Settings', 2, 0, 0],
					[21, 4, 'LBL_TERMS_AND_CONDITIONS', 'adminIcon-terms-and-conditions', 'LBL_INV_TANDC_DESCRIPTION', 'index.php?parent=Settings&module=Vtiger&view=TermsAndConditionsEdit', 3, 0, 0],
					[22, 2, 'LBL_CUSTOMIZE_RECORD_NUMBERING', 'adminIcon-recording-control', 'LBL_CUSTOMIZE_MODENT_NUMBER_DESCRIPTION', 'index.php?module=Vtiger&parent=Settings&view=CustomRecordNumbering', 6, 0, 0],
					[24, 15, 'LBL_LIST_WORKFLOWS', 'adminIcon-triggers', 'LBL_LIST_WORKFLOWS_DESCRIPTION', 'index.php?module=Workflows&parent=Settings&view=List', 1, 0, 1],
					[25, 4, 'LBL_CONFIG_EDITOR', 'adminIcon-system-tools', 'LBL_CONFIG_EDITOR_DESCRIPTION', 'index.php?module=Vtiger&parent=Settings&view=ConfigEditorDetail', 7, 0, 0],
					[26, 15, 'Scheduler', 'adminIcon-cron', 'LBL_SCHEDULER_DESCRIPTION', 'index.php?module=CronTasks&parent=Settings&view=List', 3, 0, 0],
					[27, 15, 'LBL_WORKFLOW_LIST', 'adminIcon-workflow', 'LBL_AVAILABLE_WORKLIST_LIST', 'index.php?module=com_vtiger_workflow&action=workflowlist', 1, 0, 0],
					[28, 4, 'ModTracker', 'adminIcon-modules-track-chanegs', 'LBL_MODTRACKER_DESCRIPTION', 'index.php?module=ModTracker&action=BasicSettings&parenttab=Settings&formodule=ModTracker', 9, 0, 0],
					[29, 5, 'LBL_PBXMANAGER', 'adminIcon-pbx-manager', 'LBL_PBXMANAGER_DESCRIPTION', 'index.php?module=PBXManager&parent=Settings&view=Index', 22, 0, 0],
					[30, 5, 'LBL_CUSTOMER_PORTAL', 'adminIcon-customer-portal', 'PORTAL_EXTENSION_DESCRIPTION', 'index.php?module=CustomerPortal&action=index&parenttab=Settings', 3, 0, 0],
					[31, 5, 'Webforms', 'adminIcon-online-forms', 'LBL_WEBFORMS_DESCRIPTION', 'index.php?module=Webforms&action=index&parenttab=Settings', 4, 0, 0],
					[33, 2, 'LBL_EDIT_FIELDS', 'adminIcon-modules-fields', 'LBL_LAYOUT_EDITOR_DESCRIPTION', 'index.php?module=LayoutEditor&parent=Settings&view=Index', 2, 0, 0],
					[35, 4, 'LBL_PDF', 'adminIcon-modules-pdf-templates', 'LBL_PDF_DESCRIPTION', 'index.php?module=PDF&parent=Settings&view=List', 10, 0, 0],
					[38, 7, 'LBL_PASSWORD_CONF', 'adminIcon-passwords-configuration', 'LBL_PASSWORD_DESCRIPTION', 'index.php?module=Password&parent=Settings&view=Index', 1, 0, 0],
					[40, 2, 'LBL_MENU_BUILDER', 'adminIcon-menu-configuration', 'LBL_MENU_BUILDER_DESCRIPTION', 'index.php?module=Menu&view=Index&parent=Settings', 14, 0, 1],
					[41, 2, 'LBL_ARRANGE_RELATED_TABS', 'adminIcon-modules-relations', 'LBL_ARRANGE_RELATED_TABS', 'index.php?module=LayoutEditor&parent=Settings&view=Index&mode=showRelatedListLayout', 4, 0, 1],
					[44, 8, 'Mail Scanner', 'adminIcon-mail-scanner', 'LBL_MAIL_SCANNER_DESCRIPTION', 'index.php?module=OSSMailScanner&parent=Settings&view=Index', 3, 0, 0],
					[45, 14, 'Mail Logs', 'adminIcon-mail-download-history', 'LBL_MAIL_LOGS_DESCRIPTION', 'index.php?module=OSSMailScanner&parent=Settings&view=logs', 4, 0, 0],
					[46, 8, 'Mail View', 'adminIcon-oss_mailview', 'LBL_MAIL_VIEW_DESCRIPTION', 'index.php?module=OSSMailView&parent=Settings&view=index', 21, 0, 0],
					[47, 15, 'Document Control', 'adminIcon-workflow', 'LBL_DOCUMENT_CONTROL_DESCRIPTION', 'index.php?module=OSSDocumentControl&parent=Settings&view=Index', 4, 0, 0],
					[48, 15, 'Project Templates', 'adminIcon-document-templates', 'LBL_PROJECT_TEMPLATES_DESCRIPTION', 'index.php?module=OSSProjectTemplates&parent=Settings&view=Index', 5, 0, 0],
					[49, 9, 'License', 'adminIcon-license', 'LBL_LICENSE_DESCRIPTION', 'index.php?module=Vtiger&parent=Settings&view=License', 4, 0, 0],
					[51, 7, 'OSSPassword Configuration', 'adminIcon-passwords-encryption', 'LBL_OSSPASSWORD_CONFIGURATION_DESCRIPTION', 'index.php?module=OSSPasswords&view=ConfigurePass&parent=Settings', 3, 0, 0],
					[52, 15, 'LBL_DATAACCESS', 'adminIcon-recording-control', 'LBL_DATAACCESS_DESCRIPTION', 'index.php?module=DataAccess&parent=Settings&view=Index', 2, 0, 0],
					[53, 4, 'LangManagement', 'adminIcon-languages-and-translations', 'LBL_LANGMANAGEMENT_DESCRIPTION', 'index.php?module=LangManagement&parent=Settings&view=Index', 1, 0, 0],
					[54, 1, 'GlobalPermission', 'adminIcon-special-access', 'LBL_GLOBALPERMISSION_DESCRIPTION', 'index.php?module=GlobalPermission&parent=Settings&view=Index', 7, 0, 0],
					[56, 13, 'Search Setup', 'adminIcon-search-configuration', 'LBL_SEARCH_SETUP_DESCRIPTION', 'index.php?module=Search&parent=Settings&view=Index', 1, 0, 0],
					[57, 13, 'CustomView', 'adminIcon-filters-configuration', 'LBL_CUSTOMVIEW_DESCRIPTION', 'index.php?module=CustomView&parent=Settings&view=Index', 2, 0, 0],
					[58, 2, 'Widgets', 'adminIcon-modules-widgets', 'LBL_WIDGETS_DESCRIPTION', 'index.php?module=Widgets&parent=Settings&view=Index', 3, 0, 1],
					[59, 9, 'Credits', 'adminIcon-contributors', 'LBL_CREDITS_DESCRIPTION', 'index.php?module=Vtiger&view=Credits&parent=Settings', 3, 0, 0],
					[60, 2, 'LBL_QUICK_CREATE_EDITOR', 'adminIcon-fields-quick-create', 'LBL_QUICK_CREATE_EDITOR_DESCRIPTION', 'index.php?module=QuickCreateEditor&parent=Settings&view=Index', 8, 0, 0],
					[61, 5, 'LBL_API_ADDRESS', 'adminIcon-address', 'LBL_API_ADDRESS_DESCRIPTION', 'index.php?module=ApiAddress&parent=Settings&view=Configuration', 5, 0, 0],
					[62, 7, 'LBL_BRUTEFORCE', 'adminIcon-brute-force', 'LBL_BRUTEFORCE_DESCRIPTION', 'index.php?module=BruteForce&parent=Settings&view=Index', 2, 0, 0],
					[63, 14, 'LBL_UPDATES_HISTORY', 'adminIcon-server-updates', 'LBL_UPDATES_HISTORY_DESCRIPTION', 'index.php?parent=Settings&module=Updates&view=Index', 2, 0, 0],
					[65, 14, 'LBL_CONFREPORT', 'adminIcon-server-configuration', 'LBL_CONFREPORT_DESCRIPTION', 'index.php?parent=Settings&module=ConfReport&view=Index', 1, 0, 0],
					[66, 12, 'LBL_ACTIVITY_TYPES', 'adminIcon-calendar-types', 'LBL_ACTIVITY_TYPES_DESCRIPTION', 'index.php?parent=Settings&module=Calendar&view=ActivityTypes', 1, 0, 0],
					[67, 2, 'LBL_WIDGETS_MANAGEMENT', 'adminIcon-widgets-configuration', 'LBL_WIDGETS_MANAGEMENT_DESCRIPTION', 'index.php?module=WidgetsManagement&parent=Settings&view=Configuration', 15, 0, 0],
					[69, 5, 'LBL_MOBILE_KEYS', 'adminIcon-mobile-applications', 'LBL_MOBILE_KEYS_DESCRIPTION', 'index.php?parent=Settings&module=MobileApps&view=MobileKeys', 6, 0, 0],
					[70, 2, 'LBL_TREES_MANAGER', 'adminIcon-field-folders', 'LBL_TREES_MANAGER_DESCRIPTION', 'index.php?module=TreesManager&parent=Settings&view=List', 11, 0, 0],
					[71, 2, 'LBL_MODTRACKER_SETTINGS', 'adminIcon-modules-track-chanegs', 'LBL_MODTRACKER_SETTINGS_DESCRIPTION', 'index.php?module=ModTracker&parent=Settings&view=List', 5, 0, 0],
					[72, 2, 'LBL_HIDEBLOCKS', 'adminIcon-filed-hide-bloks', 'LBL_HIDEBLOCKS_DESCRIPTION', 'index.php?module=HideBlocks&parent=Settings&view=List', 12, 0, 0],
					[73, 12, 'LBL_PUBLIC_HOLIDAY', 'adminIcon-calendar-holidys', 'LBL_PUBLIC_HOLIDAY_DESCRIPTION', 'index.php?module=PublicHoliday&view=Configuration&parent=Settings', 3, 0, 0],
					[74, 12, 'LBL_CALENDAR_CONFIG', 'adminIcon-calendar-configuration', 'LBL_CALENDAR_CONFIG_DESCRIPTION', 'index.php?parent=Settings&module=Calendar&view=UserColors', 2, 0, 0],
					[75, 6, 'LBL_SALES_PROCESSES', 'adminIcon-sales', 'LBL_SALES_PROCESSES_DESCRIPTION', 'index.php?module=SalesProcesses&view=Index&parent=Settings', 2, 0, 0],
					[77, 5, 'LBL_DAV_KEYS', 'adminIcon-dav-applications', 'LBL_DAV_KEYS_DESCRIPTION', 'index.php?parent=Settings&module=Dav&view=Keys', 7, 0, 0],
					[78, 8, 'LBL_AUTOLOGIN', 'adminIcon-mail-auto-login', 'LBL_AUTOLOGIN_DESCRIPTION', 'index.php?parent=Settings&module=Mail&view=Autologin', 4, 0, 0],
					[79, 8, 'LBL_MAIL_GENERAL_CONFIGURATION', 'adminIcon-mail-smtp-server', 'LBL_MAIL_GENERAL_CONFIGURATION_DESCRIPTION', 'index.php?parent=Settings&module=Mail&view=Config', 1, 0, 0],
					[80, 6, 'LBL_SUPPORT_PROCESSES', 'adminIcon-support ', 'LBL_SUPPORT_PROCESSES_DESCRIPTION', 'index.php?module=SupportProcesses&view=Index&parent=Settings', 6, 0, 0],
					[81, 12, 'LBL_COLORS', 'adminIcon-colors', 'LBL_COLORS_DESCRIPTION', 'index.php?module=Users&parent=Settings&view=Colors', 4, 0, 0],
					[82, 6, 'LBL_REALIZATION_PROCESSES', 'adminIcon-realization', 'LBL_REALIZATION_PROCESSES_DESCRIPTION', 'index.php?module=RealizationProcesses&view=Index&parent=Settings', 3, 0, 0],
					[83, 6, 'LBL_MARKETING_PROCESSES', 'adminIcon-marketing', 'LBL_MARKETING_PROCESSES_DESCRIPTION', 'index.php?module=MarketingProcesses&view=Index&parent=Settings', 1, 0, 0],
					[84, 6, 'LBL_FINANCIAL_PROCESSES', 'adminIcon-finances', 'LBL_FINANCIAL_PROCESSES_DESCRIPTION', 'index.php?module=FinancialProcesses&view=Index&parent=Settings', 5, 0, 0],
					[85, 5, 'LBL_AUTHORIZATION', 'adminIcon-automation', 'LBL_AUTHORIZATION_DESCRIPTION', 'index.php?module=Users&view=Auth&parent=Settings', 1, 0, 0],
					[86, 6, 'LBL_TIMECONTROL_PROCESSES', 'adminIcon-logistics', 'LBL_TIMECONTROL_PROCESSES_DESCRIPTION', 'index.php?module=TimeControlProcesses&parent=Settings&view=Index', 7, 0, 0],
					[87, 2, 'LBL_CUSTOM_FIELD_MAPPING', 'adminIcon-filed-mapping', 'LBL_CUSTOM_FIELD_MAPPING_DESCRIPTION', 'index.php?parent=Settings&module=Leads&view=MappingDetail', 13, 0, 0],
					[88, 5, 'LBL_CURRENCY_UPDATE', 'adminIcon-currencies', 'LBL_CURRENCY_UPDATE_DESCRIPTION', 'index.php?module=CurrencyUpdate&view=Index&parent=Settings', 2, 0, 0],
					[89, 11, 'LBL_CREDITLIMITS', 'adminIcon-credit-limit-base_2', 'LBL_CREDITLIMITS_DESCRIPTION', 'index.php?module=Inventory&parent=Settings&view=CreditLimits', 5, 0, 0],
					[90, 11, 'LBL_TAXES', 'adminIcon-taxes-rates', 'LBL_TAXES_DESCRIPTION', 'index.php?module=Inventory&parent=Settings&view=Taxes', 1, 0, 0],
					[91, 11, 'LBL_DISCOUNTS', 'adminIcon-discount-base', 'LBL_DISCOUNTS_DESCRIPTION', 'index.php?module=Inventory&parent=Settings&view=Discounts', 3, 0, 0],
					[92, 11, 'LBL_TAXCONFIGURATION', 'adminIcon-taxes-caonfiguration', 'LBL_TAXCONFIGURATION_DESCRIPTION', 'index.php?module=Inventory&parent=Settings&view=TaxConfiguration', 4, 0, 0],
					[93, 11, 'LBL_DISCOUNTCONFIGURATION', 'adminIcon-discount-configuration', 'LBL_DISCOUNTCONFIGURATION_DESCRIPTION', 'index.php?module=Inventory&parent=Settings&view=DiscountConfiguration', 2, 0, 0],
					[94, 8, 'Mail', 'adminIcon-mail-download-history', 'LBL_OSSMAIL_DESCRIPTION', 'index.php?module=OSSMail&parent=Settings&view=index', 2, 0, 0],
					[95, 2, 'LBL_MAPPEDFIELDS', 'adminIcon-mapped-fields', 'LBL_MAPPEDFIELDS_DESCRIPTION', 'index.php?module=MappedFields&parent=Settings&view=List', 16, 0, 0],
					[96, 1, 'LBL_LOCKS', 'adminIcon-locks', 'LBL_LOCKS_DESCRIPTION', 'index.php?module=Users&view=Locks&parent=Settings', 8, 0, 0],
					[98, 4, 'LBL_NOTIFICATIONS_CONFIGURATION', 'adminIcon-NotificationConfiguration', 'LBL_TYPE_NOTIFICATIONS_DESCRIPTION', 'index.php?module=Notifications&view=Configuration&parent=Settings', 13, 0, 0],
					[99, 5, 'LBL_POS', NULL, NULL, 'index.php?module=POS&view=Index&parent=Settings', 10, 0, 0],
					[100, 5, 'LBL_WEBSERVICE_APPS', NULL, NULL, 'index.php?module=WebserviceApps&view=Index&parent=Settings', 11, 0, 0],
			...
			'vtiger_squoteenquiries_status' => [
				'columns' => ['squoteenquiries_status', 'sortorderid', 'presence'],
				'values' => [
					['PLL_DRAFT', 1, 1],
					['PLL_IN_REALIZATION', 2, 1],
					['PLL_FOR_VERIFICATION', 3, 1],
			...
			'vtiger_squotes_status' => [
				'columns' => ['squotes_status', 'sortorderid', 'presence'],
				'values' => [
					['PLL_DRAFT', 1, 1],
					['PLL_IN_REALIZATION', 2, 1],
					['PLL_FOR_VERIFICATION', 3, 1],
					['PLL_AWAITING_DECISION', 4, 1],
					['PLL_NEGOTIATIONS', 5, 1],
					['PLL_CANCELLED', 6, 0],
					['PLL_ACCEPTED', 7, 0],
				]
			],
			'vtiger_srecurringorders_status' => [
				'columns' => ['srecurringorders_status', 'sortorderid', 'presence'],
				'values' => [
					['PLL_DRAFT', 1, 1],
					['PLL_REQUIRES_TO_BE_COMPLEMENTED', 2, 1],
					['PLL_REQUIRES_CONSULTATION', 3, 1],
					['PLL_WAITING_FOR_SHIPPING', 4, 1],
					['PLL_WAITING_FOR_SIGNATURE', 5, 1],
					['PLL_WAITING_FOR_REALIZATION', 6, 1],
					['PLL_AUTOMATIC_GENERATION', 7, 0],
					['PLL_UNREALIZED', 8, 0],
					['PLL_REALIZED', 9, 0],
				]
			],
			'vtiger_srequirementscards_status' => [
				'columns' => ['srequirementscards_status', 'sortorderid', 'presence'],
				'values' => [
					['PLL_DRAFT', 1, 1],
					['PLL_IN_REALIZATION', 2, 1],
					['PLL_FOR_VERIFICATION', 3, 1],
			...
			'vtiger_ssalesprocesses_source' => [
				'columns' => ['ssalesprocesses_source', 'sortorderid', 'presence'],
				'values' => [
					['PLL_WEBSITE', 1, 1],
					['PLL_PHONE', 2, 1],
					['PLL_MAIL_CAMPAIGN', 3, 1],
					['PLL_CONFERENCE', 4, 1],
					['PLL_RECOMMENDATION', 5, 1],
					['PLL_MEETING', 6, 1],
					['PLL_ADVERTISING', 7, 1],
					['PLL_COMMUNITY', 8, 1],
					['PLL_OTHER', 9, 1],
			...
			'vtiger_ssalesprocesses_status' => [
				'columns' => ['ssalesprocesses_status', 'sortorderid', 'presence'],
				'values' => [
					['PLL_DRAFT', 1, 1],
					['PLL_FOR_REALIZATION', 2, 1],
					['PLL_QUOTE_ENQUIRY', 3, 1],
					['PLL_REQUIREMENTS_CARD', 4, 1],
					['PLL_CALCULATION', 5, 1],
					['PLL_QUOTE', 6, 1],
					['PLL_NEGOTIATIONS', 7, 1],
					['PLL_AWAITING_DECISION', 8, 1],
					['PLL_AWAITING_SIGNATURES', 9, 1],
					['PLL_ORDER', 10, 1],
					['PLL_REALIZATION', 11, 1],
					['PLL_AWAITING_PAYMENT', 12, 1],
					['PLL_INVOICING', 13, 1],
					['PLL_SALE_COMPLETED', 14, 0],
					['PLL_SALE_FAILED', 15, 0],
					['PLL_SALE_CANCELLED', 16, 0],
				]
			],
			'vtiger_ssalesprocesses_type' => [
				'columns' => ['ssalesprocesses_type', 'sortorderid', 'presence'],
				'values' => [
					['PLL_NEW_SALES', 1, 1],
					['PLL_RENEWAL', 2, 1],
					['PLL_AFTERSALES', 3, 1],
			...
			'vtiger_ssingleorders_status' => [
				'columns' => ['ssingleorders_status', 'sortorderid', 'presence'],
				'values' => [
					['PLL_DRAFT', 1, 1],
					['PLL_IN_REALIZATION', 2, 1],
					['PLL_FOR_VERIFICATION', 3, 1],
					['PLL_AWAITING_SIGNATURES', 4, 1],
					['PLL_CANCELLED', 5, 0],
					['PLL_ACCEPTED', 6, 0],
				]
			],
			'vtiger_ssservicesstatus' => [
				'columns' => ['ssservicesstatus', 'presence', 'picklist_valueid', 'sortorderid'],
				'values' => [
					['PLL_DRAFT', 1, 416, 1],
					['PLL_WAITING_FOR_VERIFICATION', 1, 417, 2],
					['PLL_WAITING_FOR_ACCEPTANCE', 1, 418, 3],
					['PLL_ACCEPTED', 0, 689, 4],
					['PLL_CANCELLED', 0, 690, 5],
				]
			],
			'vtiger_ssservicesstatus_seq' => [
				'columns' => ['id'],
			...
			'vtiger_start_hour' => [
				'columns' => ['start_hour', 'presence', 'picklist_valueid', 'sortorderid'],
				'values' => [
					['00:00', 1, 297, 1],
					['01:00', 1, 298, 2],
					['02:00', 1, 299, 3],
			...
			'vtiger_state' => [
				'columns' => ['state', 'sortorderid', 'presence'],
				'values' => [
					['PLL_OPAQUE', 1, 1],
					['PLL_TRANSPARENT', 2, 1],
				]
			...
			'vtiger_status' => [
				'columns' => ['status', 'presence', 'picklist_valueid'],
				'values' => [
					['Active', 0, 1],
					['Inactive', 1, 1],
				]
			...
			'vtiger_storage_status' => [
				'columns' => ['storage_status', 'sortorderid', 'presence'],
				'values' => [
					['PLL_ACTIVE', 1, 1],
					['PLL_INACTIVE', 2, 1],
				]
			...
			'vtiger_storage_type' => [
				'columns' => ['storage_type', 'sortorderid', 'presence'],
				'values' => [
					['PLL_INTERNAL', 1, 1],
					['PLL_EXTERNAL', 2, 1],
				]
			...
			'vtiger_subindustry' => [
				'columns' => ['subindustry', 'sortorderid', 'presence'],
				'values' => [
					['Ministry', 1, 1],
					['Chancellery', 2, 1],
					['Voivodeship Office', 3, 1],
					['Marshal Office', 4, 1],
					['Poviat', 5, 1],
					['City/Township/District', 6, 1],
					['Social Welfare Centre', 7, 1],
					['Water and Sewerage Company', 8, 1],
					['Voivodeship Job Centre', 9, 1],
					['Poviat Job Centre', 10, 1],
					['Court of justice', 11, 1],
					['Attorney General\'s Office', 12, 1],
					['Other', 44, 1],
					['Deweloperzy', 14, 1],
					['Real Estate', 15, 1],
					['Primary Schools', 16, 1],
					['High Schools', 17, 1],
					['Banking', 18, 1],
					['Capital Market', 19, 1],
					...
					['Fuel', 30, 1],
					['Wood and paper', 31, 1],
					['Electromechanical', 32, 1],
					['Pharmaceutical', 33, 1],
					['Building Materials', 34, 1],
					['Metal', 35, 1],
					['Light', 36, 1],
					['Food industry', 37, 1],
					['Recycling', 38, 1],
			...
			'vtiger_subunit' => [
				'columns' => ['subunit', 'sortorderid', 'presence'],
				'values' => [
					['50g', 1, 1],
					['100g', 2, 1],
					['300g', 3, 1],
			...
			'vtiger_tab' => [
				...
				'values' => [
					...
					[49, 'OSSMailTemplates', 0, -1, 'OSSMailTemplates', NULL, NULL, 0, 0, 1, '1.04', 'Tools', NULL, 0, 0],
					...
					[55, 'OSSDocumentControl', 0, -1, 'OSSDocumentControl', NULL, NULL, 0, 0, 0, '0.9.19', '', NULL, 0, 0],
					[56, 'OSSProjectTemplates', 0, -1, 'OSSProjectTemplates', NULL, NULL, 0, 0, 0, '0.9.17', '', NULL, 0, 0],
			...
			'vtiger_tab_info' => [
				...
				'values' => [
					...
					[55, 'vtiger_min_version', '6.0.0'],
					[56, 'vtiger_min_version', '6.0.0'],
			...
			'vtiger_taskpriority' => [
				'columns' => ['taskpriority', 'presence', 'picklist_valueid', 'sortorderid'],
				'values' => [
					['High', 1, 170, 0],
					['Medium', 1, 171, 1],
					['Low', 1, 172, 2],
			...
			'vtiger_taxclass' => [
				'columns' => ['taxclass', 'sortorderid', 'presence'],
				'values' => [
					['SalesTax', 0, 1],
					['Vat', 1, 1],
				]
			...
			'vtiger_ticketpriorities' => [
				'columns' => ['ticketpriorities', 'presence', 'picklist_valueid', 'sortorderid', 'color'],
				'values' => [
					['Low', 1, 182, 0, '	#E6FAD8'],
					['Normal', 1, 183, 1, '	#E6FAD8'],
					['High', 1, 184, 2, '	#E6FAD8'],
					['Urgent', 1, 185, 3, '	#E6FAD8'],
				]
			],
			'vtiger_ticketpriorities_seq' => [
				'columns' => ['id'],
			...
			'vtiger_ticketseverities' => [
				'columns' => ['ticketseverities', 'presence', 'picklist_valueid', 'sortorderid'],
				'values' => [
					['Minor', 1, 186, 0],
					['Major', 1, 187, 1],
					['Feature', 1, 188, 2],
			...
			'vtiger_ticketstatus' => [
				'columns' => ['ticketstatus', 'presence', 'picklist_valueid', 'sortorderid', 'color'],
				'values' => [
					['Open', 0, 190, 1, '#E6FAD8'],
					['In Progress', 0, 191, 5, '#E6FAD8'],
					['Wait For Response', 0, 192, 3, '#E6FAD8'],
					['Closed', 0, 193, 8, '#E6FAD8'],
					['Answered', 0, 387, 2, '#E6FAD8'],
					['Rejected', 0, 557, 9, '#E6FAD8'],
					['PLL_SUBMITTED_COMMENTS', 1, 694, 4, '#E6FAD8'],
					['PLL_FOR_APPROVAL', 1, 695, 6, '#E6FAD8'],
					['PLL_TO_CLOSE', 1, 696, 7, '#E6FAD8'],
				]
			],
			'vtiger_ticketstatus_seq' => [
				'columns' => ['id'],
			...
			'vtiger_time_zone' => [
				'columns' => ['time_zone', 'sortorderid', 'presence'],
				'values' => [
					['Pacific/Midway', 0, 1],
					['Pacific/Samoa', 1, 1],
					['Pacific/Honolulu', 2, 1],
					['America/Anchorage', 3, 1],
					['America/Los_Angeles', 4, 1],
					['America/Tijuana', 5, 1],
					['America/Denver', 6, 1],
					['America/Chihuahua', 7, 1],
					['America/Mazatlan', 8, 1],
					['America/Phoenix', 9, 1],
					['America/Regina', 10, 1],
					['America/Tegucigalpa', 11, 1],
					['America/Chicago', 12, 1],
					['America/Mexico_City', 13, 1],
					['America/Monterrey', 14, 1],
					['America/New_York', 15, 1],
					['America/Bogota', 16, 1],
					['America/Lima', 17, 1],
					['America/Rio_Branco', 18, 1],
					['America/Indiana/Indianapolis', 19, 1],
					['America/Caracas', 20, 1],
					['America/Halifax', 21, 1],
					['America/Manaus', 22, 1],
					['America/Santiago', 23, 1],
					['America/La_Paz', 24, 1],
					['America/Cuiaba', 25, 1],
					['America/Asuncion', 26, 1],
					['America/St_Johns', 27, 1],
					['America/Argentina/Buenos_Aires', 28, 1],
					['America/Sao_Paulo', 29, 1],
					['America/Godthab', 30, 1],
					['America/Montevideo', 31, 1],
					['Atlantic/South_Georgia', 32, 1],
					['Atlantic/Azores', 33, 1],
					['Atlantic/Cape_Verde', 34, 1],
					['Europe/London', 35, 1],
					['UTC', 36, 1],
					['Africa/Monrovia', 37, 1],
					['Africa/Casablanca', 38, 1],
					['Europe/Belgrade', 39, 1],
					['Europe/Sarajevo', 40, 1],
					['Europe/Brussels', 41, 1],
					['Africa/Algiers', 42, 1],
					['Europe/Amsterdam', 43, 1],
					['Europe/Minsk', 44, 1],
					['Africa/Cairo', 45, 1],
					['Europe/Helsinki', 46, 1],
					['Europe/Athens', 47, 1],
					['Europe/Istanbul', 48, 1],
					['Asia/Jerusalem', 49, 1],
					['Asia/Amman', 50, 1],
					['Asia/Beirut', 51, 1],
					['Africa/Windhoek', 52, 1],
					['Africa/Harare', 53, 1],
					['Asia/Kuwait', 54, 1],
					['Asia/Baghdad', 55, 1],
					['Africa/Nairobi', 56, 1],
					...
					['Asia/Dhaka', 68, 1],
					['Asia/Almaty', 69, 1],
					['Asia/Yekaterinburg', 70, 1],
					['Asia/Rangoon', 71, 1],
					['Asia/Novosibirsk', 72, 1],
					['Asia/Bangkok', 73, 1],
					['Asia/Brunei', 74, 1],
					['Asia/Krasnoyarsk', 75, 1],
					['Asia/Ulaanbaatar', 76, 1],
					['Asia/Kuala_Lumpur', 77, 1],
					['Asia/Taipei', 78, 1],
					['Australia/Perth', 79, 1],
					['Asia/Irkutsk', 80, 1],
					['Asia/Seoul', 81, 1],
					['Asia/Tokyo', 82, 1],
					['Australia/Darwin', 83, 1],
					['Australia/Adelaide', 84, 1],
					['Australia/Canberra', 85, 1],
					['Australia/Brisbane', 86, 1],
					['Australia/Hobart', 87, 1],
					['Asia/Vladivostok', 88, 1],
					['Pacific/Guam', 89, 1],
					['Asia/Yakutsk', 90, 1],
					['Pacific/Fiji', 92, 1],
					['Asia/Kamchatka', 93, 1],
					['Pacific/Auckland', 94, 1],
					['Asia/Magadan', 95, 1],
					['Pacific/Tongatapu', 96, 1],
					['Etc/GMT-11', 91, 1],
				]
			],
			'vtiger_time_zone_seq' => [
			...
			'vtiger_timecontrol_type' => [
				'columns' => ['timecontrol_type', 'sortorderid', 'presence', 'color'],
				'values' => [
					['PLL_WORKING_TIME', 1, 1, '#EDC240'],
					['PLL_BREAK_TIME', 2, 1, '#AFD8F8'],
					['PLL_HOLIDAY', 3, 1, '#CB4B4B'],
				]
			],
			'vtiger_timecontrol_type_seq' => [
				'columns' => ['id'],
			...
			'vtiger_tracking_unit' => [
				'columns' => ['tracking_unit', 'presence', 'picklist_valueid', 'sortorderid'],
				'values' => [
					['Hours', 1, 211, 2],
					['Days', 1, 212, 3],
					['Incidents', 1, 213, 4],
			...
			'vtiger_usageunit' => [
				'columns' => ['usageunit', 'presence', 'picklist_valueid', 'sortorderid'],
				'values' => [
					['pcs', 1, 194, 0],
					['pack', 1, 195, 1],
					['kg', 1, 196, 2],
			...
			'vtiger_verification' => [
				'columns' => ['verification', 'presence', 'picklist_valueid', 'sortorderid'],
				'values' => [
					['Address details', 1, 440, 1],
					['Contact details', 1, 444, 2],
					['Registration details', 1, 445, 3],
				]
			],
			'vtiger_verification_seq' => [
				'columns' => ['id'],
			...
			'vtiger_version' => [
				'columns' => ['old_version', 'current_version'],
				'values' => [
					['2.2.0', '2.2.0'],
				]
			],
			...
			'vtiger_visibility' => [
				'columns' => ['visibility', 'sortorderid', 'presence'],
				'values' => [
					['Private', 0, 1],
					['Public', 1, 1],
				]
			...
			'vtiger_widgets' => [
				'columns' => ['tabid', 'type', 'label', 'wcol', 'sequence', 'nomargin', 'data'],
				'values' => [
					[6, 'Summary', NULL, 1, 0, NULL, '[]'],
					[6, 'Comments', 'ModComments', 2, 5, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[6, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[6, 'Activities', 'Calendar', 2, 3, NULL, '{"limit":"5"}'],
					[6, 'RelatedModule', 'Contacts', 2, 2, NULL, '{"limit":"5","relatedmodule":"4","columns":"3","action":"1","filter":"-"}'],
					[7, 'Summary', NULL, 1, 1, NULL, '[]'],
					[7, 'Comments', 'ModComments', 1, 2, 1, '{"relatedmodule":"ModComments","limit":"5"}'],
					[7, 'Updates', 'LBL_UPDATES', 2, 6, NULL, '[]'],
					[7, 'Activities', 'Calendar', 2, 4, NULL, '{"limit":"5"}'],
					[7, 'EmailList', 'Emails', 2, 5, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[6, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[4, 'Summary', NULL, 1, 1, NULL, '[]'],
					[4, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[4, 'Updates', 'LBL_UPDATES', 1, 3, NULL, '[]'],
					[4, 'Activities', 'Calendar', 2, 4, NULL, '{"limit":"5"}'],
					[4, 'EmailList', 'Emails', 2, 5, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[43, 'Summary', NULL, 1, 1, NULL, '[]'],
					[43, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[43, 'Updates', 'LBL_UPDATES', 1, 3, NULL, '[]'],
					[43, 'EmailList', 'Emails', 1, 5, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[43, 'RelatedModule', 'ProjectTask', 2, 6, NULL, '{"limit":"5","relatedmodule":"42","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[43, 'RelatedModule', 'ProjectMilestone', 2, 7, NULL, '{"limit":"5","relatedmodule":"41","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[13, 'Summary', NULL, 1, 1, NULL, '[]'],
					[13, 'Comments', 'ModComments', 1, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[13, 'Updates', 'LBL_UPDATES', 1, 3, NULL, '[]'],
					[13, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[13, 'Activities', 'Calendar', 2, 5, NULL, '{"limit":"5"}'],
					[13, 'RelatedModule', 'Documents', 2, 6, NULL, '{"limit":"5","relatedmodule":"8","columns":"3","action":"1","filter":"-"}'],
					[51, 'Summary', NULL, 1, 1, NULL, '[]'],
					[51, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[51, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"5","relatedmodule":"8","columns":"3","filter":"-"}'],
					[7, 'RelatedModule', 'Contacts', 2, 3, NULL, '{"limit":"5","relatedmodule":"4","columns":"3","action":"1","filter":"-"}'],
					[13, 'WYSIWYG', 'WYSIWYG', 1, 7, NULL, '{"field_name":"description"}'],
					[54, 'PreviewMail', NULL, 1, 1, NULL, '{"relatedmodule":"Emails"}'],
					[42, 'Summary', NULL, 1, 0, NULL, '[]'],
					[42, 'Comments', 'ModComments', 2, 1, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[84, 'Summary', NULL, 1, 0, NULL, '[]'],
					[84, 'Comments', '', 2, 1, NULL, '{"relatedmodule":"ModComments","limit":"10"}'],
					[85, 'Summary', NULL, 1, 0, NULL, '[]'],
					[85, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[85, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[85, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[85, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[87, 'Summary', NULL, 1, 0, NULL, '[]'],
					[87, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[87, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[87, 'Comments', 'ModComments', 2, 5, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[87, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[88, 'Summary', NULL, 1, 0, NULL, '[]'],
					[88, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[88, 'Comments', 'ModComments', 2, 5, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[88, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[88, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[89, 'Summary', NULL, 1, 0, NULL, '[]'],
					[89, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[89, 'Comments', 'ModComments', 2, 5, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[89, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[89, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[90, 'Summary', NULL, 1, 0, NULL, '[]'],
					[90, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[90, 'Comments', 'ModComments', 2, 5, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[90, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[90, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[86, 'Summary', NULL, 1, 0, NULL, '[]'],
					[86, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[86, 'Comments', 'ModComments', 2, 6, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[86, 'RelatedModule', 'Documents', 2, 4, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"-","checkbox":"-"}'],
					[86, 'EmailList', 'Emails', 2, 5, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[92, 'Summary', NULL, 1, 0, NULL, '[]'],
					[92, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[92, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[92, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[92, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[93, 'Summary', NULL, 1, 0, NULL, '[]'],
					[93, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[93, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[93, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[93, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[18, 'Summary', NULL, 1, 0, NULL, '[]'],
					[18, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[18, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[18, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[18, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[86, 'RelatedModule', 'Contacts', 1, 2, NULL, '{"limit":"5","relatedmodule":"4","columns":"1","action":"1","actionSelect":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[92, 'RelatedModule', 'Contacts', 1, 5, NULL, '{"limit":"5","relatedmodule":"4","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[93, 'RelatedModule', 'Contacts', 1, 5, NULL, '{"limit":"5","relatedmodule":"4","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[6, 'RelatedModule', '', 1, 6, NULL, '{"relatedmodule":"86","limit":"10","columns":"3","action":"1","switchHeader":"0","filter":"-","checkbox":"-"}'],
					[100, 'Summary', NULL, 1, 0, NULL, '[]'],
					[100, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[100, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[100, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[101, 'Summary', NULL, 1, 0, NULL, '[]'],
					[101, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[101, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[101, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[98, 'Summary', NULL, 1, 0, NULL, '[]'],
					[98, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[98, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[98, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[102, 'Comments', '', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[102, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[102, 'Summary', NULL, 1, 0, NULL, '[]'],
					[102, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"-","checkbox":"-"}'],
					[103, 'Summary', NULL, 1, 0, NULL, '[]'],
					[103, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[103, 'Comments', '', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[103, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[97, 'Summary', NULL, 1, 0, NULL, '[]'],
					[97, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[97, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[97, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[94, 'Summary', NULL, 1, 0, NULL, '[]'],
					[94, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[94, 'Comments', 'ModComments', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[94, 'RelatedModule', 'Documents', 2, 3, NULL, '{"limit":"","relatedmodule":"8","columns":"3","action":"1","filter":"-","checkbox_selected":"","checkbox":"-"}'],
					[104, 'Comments', '', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[104, 'Summary', NULL, 1, 0, NULL, '[]'],
					[104, 'RelatedModule', 'Documents', 2, 3, NULL, '{"relatedmodule":"8","limit":"","columns":"3","action":"1","switchHeader":"-","filter":"-","checkbox":"-"}'],
					[104, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[105, 'Comments', '', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[105, 'Summary', NULL, 1, 0, NULL, '[]'],
					[105, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[105, 'RelatedModule', '', 2, 3, NULL, '{"relatedmodule":"8","limit":"","columns":"1","switchHeader":"-","filter":"-","checkbox":"-"}'],
					[106, 'Summary', NULL, 1, 0, NULL, '[]'],
					[106, 'Comments', '', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[106, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[106, 'RelatedModule', 'Documents', 2, 3, NULL, '{"relatedmodule":"8","limit":"","columns":"3","action":"1","switchHeader":"-","filter":"-","checkbox":"-"}'],
					[96, 'Comments', '', 2, 2, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[96, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[96, 'RelatedModule', '', 2, 3, NULL, '{"relatedmodule":"8","limit":"5","columns":"1","action":"1","switchHeader":"-","filter":"-","checkbox":"-"}'],
					[96, 'Summary', NULL, 1, 0, NULL, '[]'],
					[86, 'Activities', 'Calendar', 2, 3, NULL, '{"limit":"5"}'],
					[88, 'Activities', 'Calendar', 2, 2, NULL, '{"limit":"5"}'],
					[85, 'Activities', 'Calendar', 1, 6, NULL, '{"limit":"5"}'],
					[89, 'Activities', 'Calendar', 2, 2, NULL, '{"limit":"5"}'],
					[91, 'Activities', 'Calendar', 2, 2, NULL, '{"limit":"5"}'],
					[87, 'Activities', 'Calendar', 2, 2, NULL, '{"limit":"5"}'],
					[90, 'Activities', 'Calendar', 2, 2, NULL, '{"limit":"5"}'],
					[91, 'Summary', NULL, 1, 0, NULL, '[]'],
					[91, 'Updates', 'LBL_UPDATES', 1, 1, NULL, '[]'],
					[91, 'RelatedModule', 'Documents', 2, 3, NULL, '{"relatedmodule":"8","limit":"","columns":"3","action":"1","switchHeader":"-","filter":"-","checkbox":"-"}'],
					[91, 'EmailList', 'Emails', 2, 4, NULL, '{"relatedmodule":"Emails","limit":"5"}'],
					[91, 'Comments', 'ModComments', 2, 5, NULL, '{"relatedmodule":"ModComments","limit":"5"}'],
					[26, 'Summary', NULL, 1, 0, 0, '[]'],
					[26, 'Comments', 'ModComments', 2, 3, 0, '{"relatedmodule":"ModComments","limit":"5"}'],
					[26, 'RelatedModule', 'Documents', 2, 2, 0, '{"relatedmodule":"8","limit":"5","columns":"3","action":"1","switchHeader":"-","filter":"-","checkbox":"-"}'],
					[26, 'Updates', 'LBL_UPDATES', 1, 1, 0, '[]'],
				]
			],
			'vtiger_ws_entity' => [
				'columns' => ['name', 'handler_path', 'handler_class', 'ismodule'],
				'values' => [
					['Campaigns', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Vendors', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Faq', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['PriceBooks', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Calendar', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Leads', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Accounts', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Contacts', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Products', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Documents', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Emails', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['HelpDesk', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Events', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Users', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Groups', 'include/Webservices/VtigerActorOperation.php', 'VtigerActorOperation', 0],
					['Currency', 'include/Webservices/VtigerActorOperation.php', 'VtigerActorOperation', 0],
					['DocumentFolders', 'include/Webservices/VtigerActorOperation.php', 'VtigerActorOperation', 0],
					['CompanyDetails', 'include/Webservices/VtigerCompanyDetails.php', 'VtigerCompanyDetails', 0],
					['PBXManager', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['ServiceContracts', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Services', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Assets', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['ModComments', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['ProjectMilestone', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['ProjectTask', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Project', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['SMSNotifier', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['LineItem', 'include/Webservices/LineItem/VtigerLineItemOperation.php', 'VtigerLineItemOperation', 0],
					['Tax', 'include/Webservices/LineItem/VtigerTaxOperation.php', 'VtigerTaxOperation', 0],
					['ProductTaxes', 'include/Webservices/LineItem/VtigerProductTaxesOperation.php', 'VtigerProductTaxesOperation', 0],
					['OSSMailTemplates', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['OSSTimeControl', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['OSSMailView', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['OSSOutsourcedServices', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['OSSSoldServices', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['OutsourcedProducts', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['OSSPasswords', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['OSSEmployees', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['CallHistory', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Ideas', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['HolidaysEntitlement', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['PaymentsIn', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['PaymentsOut', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['LettersIn', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['LettersOut', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Announcements', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Reservations', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['SQuoteEnquiries', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['SSalesProcesses', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['SRequirementsCards', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['SCalculations', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['SQuotes', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['SSingleOrders', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['SRecurringOrders', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Partners', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Competition', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['FBookkeeping', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['FInvoice', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['KnowledgeBase', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['IStorages', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['IGRN', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['FInvoiceProforma', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['IGDN', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['IIDN', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['IGIN', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['IPreOrder', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['ISTDN', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['ISTN', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['ISTRN', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['FCorectingInvoice', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['IGRNC', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['IGDNC', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
					['Notification', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1],
				]
			],
			'vtiger_ws_entity_fieldtype' => [
				'columns' => ['table_name', 'field_name', 'fieldtype'],
				'values' => [
					['vtiger_attachmentsfolder', 'createdby', 'reference'],
					['vtiger_organizationdetails', 'logoname', 'file'],
					['vtiger_organizationdetails', 'phone', 'phone'],
					['vtiger_organizationdetails', 'fax', 'phone'],
					['vtiger_organizationdetails', 'website', 'url'],
					['vtiger_inventoryproductrel', 'productid', 'reference'],
					['vtiger_inventoryproductrel', 'id', 'reference'],
					['vtiger_inventoryproductrel', 'incrementondel', 'autogenerated'],
					['vtiger_producttaxrel', 'productid', 'reference'],
					['vtiger_producttaxrel', 'taxid', 'reference'],
				]
			],
			'vtiger_ws_entity_fieldtype_seq' => [
				'columns' => ['id'],
			...
			'vtiger_ws_fieldinfo' => [
				'columns' => ['id', 'property_name', 'property_value'],
				'values' => [
					['vtiger_organizationdetails.organization_id', 'upload.path', '1'],
				]
			],
			'vtiger_ws_fieldtype' => [
				'columns' => ['uitype', 'fieldtype'],
				'values' => [
					['15', 'picklist'],
					['16', 'picklist'],
					['19', 'text'],
			...
			'vtiger_ws_operation' => [
				'columns' => ['name', 'handler_path', 'handler_method', 'type', 'prelogin'],
				'values' => [
					['login', 'include/Webservices/Login.php', 'vtws_login', 'POST', 1],
					['retrieve', 'include/Webservices/Retrieve.php', 'vtws_retrieve', 'GET', 0],
					['create', 'include/Webservices/Create.php', 'vtws_create', 'POST', 0],
					['update', 'include/Webservices/Update.php', 'vtws_update', 'POST', 0],
					['delete', 'include/Webservices/Delete.php', 'vtws_delete', 'POST', 0],
					['sync', 'include/Webservices/GetUpdates.php', 'vtws_sync', 'GET', 0],
					['query', 'include/Webservices/Query.php', 'vtws_query', 'GET', 0],
					['logout', 'include/Webservices/Logout.php', 'vtws_logout', 'POST', 0],
					['listtypes', 'include/Webservices/ModuleTypes.php', 'vtws_listtypes', 'GET', 0],
					['getchallenge', 'include/Webservices/AuthToken.php', 'vtws_getchallenge', 'GET', 1],
					['describe', 'include/Webservices/DescribeObject.php', 'vtws_describe', 'GET', 0],
					['extendsession', 'include/Webservices/ExtendSession.php', 'vtws_extendSession', 'POST', 1],
					['convertlead', 'include/Webservices/ConvertLead.php', 'vtws_convertlead', 'POST', 0],
					['revise', 'include/Webservices/Revise.php', 'vtws_revise', 'POST', 0],
					['changePassword', 'include/Webservices/ChangePassword.php', 'vtws_changePassword', 'POST', 0],
					['deleteUser', 'include/Webservices/DeleteUser.php', 'vtws_deleteUser', 'POST', 0],
					['wsapp_register', 'modules/WSAPP/api/ws/Register.php', 'wsapp_register', 'POST', 0],
					['wsapp_deregister', 'modules/WSAPP/api/ws/DeRegister.php', 'wsapp_deregister', 'POST', 0],
					['wsapp_get', 'modules/WSAPP/api/ws/Get.php', 'wsapp_get', 'POST', 0],
					['wsapp_put', 'modules/WSAPP/api/ws/Put.php', 'wsapp_put', 'POST', 0],
					['wsapp_map', 'modules/WSAPP/api/ws/Map.php', 'wsapp_map', 'POST', 0],
					['retrieve_inventory', 'include/Webservices/LineItem/RetrieveInventory.php', 'vtws_retrieve_inventory', 'GET', 0],
				]
			],
			'vtiger_ws_operation_parameters' => [
				'columns' => ['name', 'type', 'sequence'],
				'values' => [
					['accessKey', 'String', 2],
					['username', 'String', 1],
					['id', 'String', 1],
					...
					['modifiedTime', 'DateTime', 1],
					['query', 'String', 1],
					['sessionName', 'String', 1],
					['fieldTypeList', 'encoded', 1],
					['username', 'String', 1],
					['elementType', 'String', 1],
					['accountName', 'String', 3],
					['assignedTo', 'String', 2],
					['avoidPotential', 'Boolean', 4],
					['leadId', 'String', 1],
					['potential', 'Encoded', 5],
					['element', 'Encoded', 1],
					['confirmPassword', 'String', 4],
					['id', 'String', 1],
					['newPassword', 'String', 3],
					['oldPassword', 'String', 2],
					['id', 'String', 1],
					['newOwnerId', 'String', 2],
					['alertid', 'string', 1],
					['module', 'string', 1],
			...
			'vtiger_wsapp' => [
				'columns' => ['name', 'appkey', 'type'],
				'values' => [
					['vtigerCRM', '53c651eaafa17', 'user'],
				]
			],
			'vtiger_wsapp_handlerdetails' => [
			...
			'w_yf_pos_actions' => [
				'columns' => ['label', 'name'],
				'values' => [
					['LBL_SYNCHRONIZE_PRODUCTS', 'GetProducts'],
					['LBL_SYNCHRONIZE_ORDERS', 'SetSSingleOrders'],
					['LBL_SYNCHRONIZE_PRODUCTS_IMAGES', 'GetImage'],
					['LBL_SYNCHRONIZE_STORAGES', 'GetIStorages'],
					['LBL_CANCEL_ORDERS', 'CancelSSingleOrders'],
					['LBL_SYNCHRONIZE_TREES', 'GetTree'],
				]
			],
			'yetiforce_auth' => [
			...
			'yetiforce_menu' => [
				'columns' => ['role', 'parentid', 'type', 'sequence', 'module', 'label', 'newwindow', 'dataurl', 'showicon', 'icon', 'sizeicon', 'hotkey', 'filters'],
				'values' => [
					[0, 0, 2, 0, NULL, 'MEN_VIRTUAL_DESK', 0, NULL, 0, 'userIcon-VirtualDesk', NULL, NULL, NULL],
					[0, 44, 0, 0, 3, 'Home page', 0, NULL, 0, 'userIcon-Home', NULL, '', NULL],
					[0, 44, 0, 1, 9, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 0, 2, 1, NULL, 'MEN_COMPANIES_CONTACTS', 0, NULL, 0, 'userIcon-CompaniesAndContact', NULL, NULL, NULL],
					[0, 47, 0, 0, 7, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 47, 0, 5, 4, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 47, 0, 3, 18, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 47, 0, 1, 6, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 0, 2, 2, NULL, 'MEN_MARKETING', 0, NULL, 0, 'userIcon-Campaigns', NULL, NULL, NULL],
					[0, 52, 0, 0, 26, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 118, 0, 7, 19, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 0, 2, 5, NULL, 'MEN_SUPPORT', 0, NULL, 0, 'userIcon-Support', NULL, NULL, NULL],
					[0, 63, 0, 0, 13, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 63, 0, 1, 34, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 63, 0, 2, 15, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 0, 2, 4, NULL, 'MEN_PROJECTS', 0, NULL, 0, 'userIcon-Project', NULL, NULL, NULL],
					[0, 67, 0, 0, 43, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 67, 0, 1, 41, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 67, 0, 2, 42, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 0, 2, 6, NULL, 'MEN_ACCOUNTING', 0, NULL, 0, 'userIcon-Bookkeeping', NULL, NULL, NULL],
					[0, 71, 0, 5, 79, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 71, 0, 4, 80, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 0, 2, 8, NULL, 'MEN_HUMAN_RESOURCES', 0, NULL, 0, 'userIcon-HumanResources', NULL, NULL, NULL],
					[0, 76, 0, 0, 61, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 76, 0, 1, 51, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 76, 0, 2, 78, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 0, 2, 9, NULL, 'MEN_SECRETARY', 0, NULL, 0, 'userIcon-Secretary', NULL, NULL, NULL],
					[0, 80, 0, 0, 81, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 80, 0, 1, 82, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 80, 0, 2, 84, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 0, 2, 10, NULL, 'MEN_DATABESES', 0, NULL, 0, 'userIcon-Database', NULL, NULL, NULL],
					[0, 84, 2, 0, NULL, 'MEN_PRODUCTBASE', 0, NULL, 0, NULL, NULL, NULL, NULL],
					[0, 84, 0, 1, 14, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 2, 59, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 3, 37, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 3, 4, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL],
					[0, 84, 2, 5, NULL, 'MEN_SERVICESBASE', 0, NULL, 0, NULL, NULL, NULL, NULL],
					[0, 84, 0, 6, 35, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 7, 57, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 8, 58, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 3, 9, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL],
					[0, 84, 2, 10, NULL, 'MEN_LISTS', 0, NULL, 0, NULL, NULL, NULL, NULL],
					[0, 84, 0, 11, 54, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 12, 45, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 13, 33, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 14, 49, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 15, 8, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 17, 74, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 3, 18, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL],
					[0, 84, 0, 23, 83, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 16, 60, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 44, 0, 3, 75, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 44, 0, 2, 48, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 22, 25, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 19, 24, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 20, 27, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 3, 21, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL],
					[0, 0, 2, 3, NULL, 'MEN_SALES', 0, NULL, 0, 'userIcon-Sales', NULL, NULL, NULL],
					[0, 118, 0, 0, 86, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 118, 0, 1, 85, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 118, 0, 2, 87, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 118, 0, 3, 88, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 118, 0, 4, 89, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 118, 0, 5, 90, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 118, 0, 6, 91, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 47, 0, 2, 92, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 47, 0, 4, 93, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 71, 0, 0, 94, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 71, 0, 1, 95, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 63, 0, 3, 96, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 0, 2, 7, NULL, 'MEN_LOGISTICS', 0, NULL, 0, 'userIcon-VendorsAccounts', NULL, NULL, NULL],
					[0, 131, 0, 10, 97, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 131, 0, 1, 98, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 71, 0, 2, 99, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 131, 0, 4, 100, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 131, 0, 5, 101, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 131, 0, 6, 102, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 131, 0, 7, 103, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 131, 0, 9, 104, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 131, 0, 0, 105, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 131, 0, 8, 106, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 71, 0, 3, 107, NULL, 0, NULL, 0, '', NULL, '', NULL],
					[0, 131, 0, 2, 108, 'IGRNC', 0, NULL, 0, '', NULL, '', NULL],
					[0, 131, 0, 3, 109, 'IGDNC', 0, NULL, 0, '', NULL, '', NULL],
					[0, 84, 0, 24, 44, '', 0, NULL, 0, '', NULL, '', NULL],
				]
			],
			'yetiforce_proc_marketing' => [
				'columns' => ['type', 'param', 'value'],
				'values' => [
					...
					['lead', 'groups', ''],
					['lead', 'status', ''],
					['lead', 'convert_status', 'LBL_LEAD_ACQUIRED'],
