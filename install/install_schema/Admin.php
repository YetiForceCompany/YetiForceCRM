	...
	public function data()
	{
		$this->data = [
			...
			'a_#__pdf' => [
				...
				'values' => [
					[1, 'SCalculations', '', '<table border="0" style="margin:0 auto;" width="100%"><tr><td height="25" width="5%">Â </td>
			<td height="25" width="65%">Â </td>
			<td height="25" width="25%">Â </td>
			<td height="25" width="5%">Â </td>
		</tr></table><table border="0" style="margin:0 auto;" width="100%"><tr><td height="150" width="5%">Â </td>
			...
			<td height="150" width="5%">Â </td>
		</tr></table><table border="0" style="margin:0 auto;" width="100%"><tr><td height="150" width="5%">Â </td>
			<td height="150" width="60%">
			<p style="text-transform:uppercase;">Termin pĹ‚atnoĹ›ci: 2015-02-12<br>
			Data wykonania: $(general : CurrentDate)$<br>
			Forma pĹ‚atnoĹ›ci: PRZELEW<br><br>
...
<table border="0" style="margin:0 auto;" width="100%"><tr><td height="150" width="5%">Â </td>
			...
			$(record : attention)$</td>
			<td width="45%">$(general : CurrentDate)$</td>
			<td height="150" width="5%">Â </td>
		</tr></table>
Â 

<table border="0" style="margin:0 auto;" width="100%"><tr><td height="150" width="5%">Â </td>
			<td style="font-size:13px;border:1px solid #ddd;" width="45%">WystawiĹ‚:<br><br>
...
<table border="0" cellpadding="10" cellspacing="0" style="margin:0 auto;" width="100%"><tbody><tr><td align="center" bgcolor="#13181A">
		...
		</tr></tbody></table>', 1, 'Kalkulacje', '*', '', '', '', 1, '', '', 'A4', 0, 0, 0, 0, 0, 0, 0, 'PLL_PORTRAIT', 'pl_pl', 'kalkulacje', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[2, 'SQuotes', '', '<table border="0" style="margin:0 auto;" width="100%"><tr><td height="25" width="5%">Â </td>
			<td height="25" width="65%">Â </td>
			<td height="25" width="25%">Â </td>
			<td height="25" width="5%">Â </td>
		</tr></table><table border="0" style="margin:0 auto;" width="100%"><tr><td height="150" width="5%">Â </td>
...
<table border="0" style="margin:0 auto;" width="100%"><tr><td height="150" width="5%">Â </td>
			...
			<td height="150" width="5%">Â </td>
		</tr></table>', '<div style="text-align:center;">Â </div>

<table border="0" cellpadding="10" cellspacing="0" style="margin:0 auto;" width="100%"><tbody><tr><td align="center" bgcolor="#13181A">
			<p style="color:#fff;font-size:10px;">WE CREATED AN INNOACTIVE CRM SYSTEM THAT IS OPEN AND ADAPTS PERFECTLY TO YOUR BUSINESS.<br />
			FIND OUT ABOUT ITS CAPABILITIES BY DOWNLOADING IT OR TESTING. CHANGE YOUR SYSTEM TO YETIFORCE!</p>
			</td>
		</tr></tbody></table>', 1, 'Oferty', '*', '', '', '', 1, '', '', 'A4', 0, 0, 0, 0, 0, 0, 0, 'PLL_PORTRAIT', 'pl_pl', 'oferty', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[3, 'SSingleOrders', '', '<table border="0" style="margin:0 auto;" width="100%"><tr><td height="25" width="5%">Â </td>
			<td height="25" width="65%">Â </td>
			<td height="25" width="25%">Â </td>
			<td height="25" width="5%">Â </td>
		</tr></table><table border="0" style="margin:0 auto;" width="100%"><tr><td height="150" width="5%">Â </td>
...
<table border="0" cellpadding="10" cellspacing="0" style="margin:0 auto;" width="100%"><tbody><tr><td align="center" bgcolor="#13181A">
		...
		</tr></tbody></table>', 1, 'Zapytanie jednorazowe', '*', '', '', '', 1, '', '', 'A4', 0, 0, 0, 0, 0, 0, 0, 'PLL_PORTRAIT', 'pl_pl', 'zapytanie_jednorazowe', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, 'null', 0, '', 0, 0, '', 'Users:1', NULL],
					[4, 'IStorages', '', '<table style="width:100%;border-collapse:collapse;font-size:10px;"><tr><td style="padding:5px;font-size:20px;text-align:center;"><b>ARKUSZ KONTROLNY STANĂ“W MAGAZYNOWYCH</b></td>
...
<table style="width:100%;border-collapse:collapse;font-size:10px;"><tr><td style="padding:5px;">$(organization : name)$<br>
			...
			<div style="text-align:right;"><b>$(translate : IStorages|FL_NUMBER)$</b> $(record : number)$<br><b>$(translate : IStorages|FL_SUBJECT)$</b> $(record : subject)$<br><strong>Data wygenerowania</strong>Â $(general : CurrentTime)$</div>
			<br>
			Â </td>
		</tr></table></div>
<br>
$(custom : ProductsControlTable|IStorages)$', '<div style="text-align:center;"><span style="font-size:8px;">{nb} /Â {PAGENO}</span></div>
', 1, 'Arkusz kontrolny stanĂłw magazynowych', '*', '', '', '', 1, '', '', 'A4', 1, 0, 0, 0, 0, 0, 0, 'PLL_PORTRAIT', 'pl_pl', 'arkusz_kont_stanow_magazynowych', 'PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[5, 'IStorages', '', '<table style="width:100%;border-collapse:collapse;font-size:10px;"><tr><td style="padding:5px;font-size:20px;text-align:center;"><b>RAPORT STANĂ“W MAGAZYNOWYCH</b></td>
		</tr></table><hr><div style="width:100%;">
<table style="width:100%;border-collapse:collapse;font-size:10px;"><tr><td style="padding:5px;">$(organization : name)$<br>
			$(organization : street)$<br>
			$(organization : code)$ $(organization : city)$<br><strong>$(translate : Vat ID)$ $(organization : vatid)$<br><strong>$(translate : Registration number 2)$:</strong>$(organization : id1)$</strong></td>
...
<br>
$(custom : ProductsTable|IStorages)$', '<div style="text-align:center;"><span style="font-size:8px;">{nb} /Â {PAGENO}</span></div>
', 1, 'Raport stanĂłw magazynowych', '*', '', '', '', 1, '', '', 'A4', 1, 0, 0, 0, 0, 0, 0, 'PLL_PORTRAIT', 'pl_pl', 'raport_stanow_magazynowych', 'PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[6, 'IStorages', '', '<table style="width:100%;border-collapse:collapse;font-size:10px;"><tr><td style="padding:5px;font-size:20px;text-align:center;"><b>RAPORT WARTOĹšCIOWY STANĂ“W MAGAZYNOWYCH</b></td>
		</tr></table><hr><div style="width:100%;">
<table style="width:100%;border-collapse:collapse;font-size:10px;"><tr><td style="padding:5px;">$(organization : name)$<br>
			$(organization : street)$<br>
			$(organization : code)$ $(organization : city)$<br><strong>$(translate : Vat ID)$ $(organization : vatid)$<br><strong>$(translate : Registration number 2)$:</strong>$(organization : id1)$</strong></td>
...
<br>
$(custom : ProductsValueTable|IStorages)$', '<div style="text-align:center;"><span style="font-size:8px;">{nb} /Â {PAGENO}</span></div>
', 1, 'Raport wartoĹ›ciowy stanĂłw magazynowych', '*', '', '', '', 1, '', '', 'A4', 1, 0, 0, 0, 0, 0, 0, 'PLL_PORTRAIT', 'pl_pl', 'raport_wart_stanow_magazynowych', 'PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[7, 'IIDN', '<table style="width:100%;"><tbody><tr><td style="width:50%;"><span style="font-size:16px;"><strong>PrzyjÄ™cie wewnÄ™trzne</strong></span></td>
...
#ShowDescription#<br>
Â 
<table style="width:100%;"><tr><td style="width:50%;"><span style="font-size:10px;"><b>PRZYGOTOWAĹ<br><br><br><br>
			............................................. </b></span></td>
			<td style="width:50%;text-align:right;"><span style="font-size:10px;"><b>ZAAKCEPTOWAĹ<br><br><br><br>
			............................................. </b></span></td>
		</tr></table>', '<div style="text-align:center;"><span style="font-size:8px;"><span style="line-height:20.8px;">{PAGENO} /Â </span>{nb}</span>Â </div>
', 1, 'PrzyjÄ™cie wewnÄ™trzne', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'pl_pl', 'przyjecie_wewnetrzne', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[8, 'IGRN', '<table style="width:100%;"><tbody><tr><td style="width:50%;"><span style="font-size:16px;"><strong>PrzyjÄ™cie z zewnÄ…trz</strong></span></td>
...
', 1, 'PrzyjÄ™cie zewnÄ™trzne', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'pl_pl', 'przyjecie_zewnetrzne', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[9, 'IGIN', '<table style="width:100%;"><tbody><tr><td style="width:50%;"><span style="font-size:16px;"><strong>RozchĂłd wewnÄ™trzny</strong></span></td>
...
', 1, 'RozchĂłd wewnÄ™trzny', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'pl_pl', 'rozchod_wewnetrzny', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[10, 'IGDN', '<table style="width:100%;"><tbody><tr><td style="width:50%;"><span style="font-size:16px;"><strong>Wydanie na zewnÄ…trz</strong></span></td>
...
', 1, 'Wydanie na zewnÄ…trz', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'pl_pl', 'wydanie_na_zewnatrz', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[11, 'ISTRN', '<table style="width:100%;"><tbody><tr><td style="width:50%;"><span style="font-size:16px;"><strong>PrzyjÄ™cie magazynowe</strong></span></td>
			<td style="width:50%;text-align:right;"><span style="font-size:10px;"><strong>$(translate : ISTRN|FL_ACCEPTANCE_DATE)$:</strong> $(record : acceptance_date)$</span><br /><span style="font-size:10px;"><strong>$(translate : ISTRN|Assigned To)$:</strong> $(record : assigned_user_id)$</span><br /><span style="font-size:10px;"><strong>Numer dokumentu:</strong>Â $(record : number)$</span></td>
...
', 1, 'PrzyjÄ™cie magazynowe', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'pl_pl', 'przyjecie_magazynowe', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
...
', 1, 'Rezerwacja magazynowa', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'pl_pl', 'rezerwacja_magazynowa', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
...
#ShowDescription#<br>
Â 
<table style="width:100%;"><tr><td style="width:50%;">PRZYGOTOWAĹ<br><br><br><br>
			.............................................</td>
			<td style="width:50%;text-align:right;">ZAAKCEPTOWAĹ<br><br><br><br>
			.............................................</td>
		</tr></table>', '<div style="text-align:center;"><span style="font-size:8px;"><span style="line-height:20.8px;">{PAGENO} /Â </span>{nb}</span>Â </div>
', 1, 'Wydanie magazynowe', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'pl_pl', 'wydanie_magazynowe', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
		...
		</tr></tbody></table><hr />', '<br><br><table style="width:100%;"><tr><td style="width:50%;font-size:10px;"><b>COMPANY</b><br>
			$(organization : name)$<br>
			$(organization : street)$<br>
			$(organization : code)$ $(organization : city)$<br>
			$(translate : Vat ID)$ $(organization : vatid)$<br><b>$(translate : Registration number 2)$ : </b>$(organization : id1)$</td>
...
', 1, 'Internal Delivery Notes', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'en_us', 'internal_delivery_notes', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
		...
		</tr></tbody></table><hr />', '<br><br><table style="width:100%;"><tr><td style="width:50%;font-size:10px;"><b>VENDOR</b><br>
			$(reletedRecord : vendorid|vendorname|Vendors)$<br>
...
', 1, 'Goods Received Note', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'en_us', 'goods_received_note', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
...
', 1, 'Goods Issued Note', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'en_us', 'goods_issued_note', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
		...
		</tr></tbody></table><hr />', '<br><br><table style="width:100%;"><tr><td style="width:50%;font-size:10px;"><strong>RECIPIENT</strong><br>
			$(reletedRecord : accountid|accountname|Accounts)$<br>
			$(reletedRecord : accountid|addresslevel8a|Accounts)$ $(reletedRecord : accountid|buildingnumbera|Accounts)$ $(reletedRecord : accountid|localnumbera|Accounts)$<br>
...
', 1, 'Goods Dispatched Note', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'en_us', 'goods_dispatched_note', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
			...
			<td style="width:50%;text-align:right;"><span style="font-size:10px;"><strong>$(translate : ISTRN|FL_ACCEPTANCE_DATE)$:</strong> $(record : acceptance_date)$</span><br /><span style="font-size:10px;"><strong>$(translate : ISTRN|Assigned To)$:</strong> $(record : assigned_user_id)$</span><br /><span style="font-size:10px;"><strong>Document number:</strong>Â $(record : number)$</span></td>
		</tr></tbody></table><hr />', '<br><br><table style="width:100%;"><tr><td style="width:50%;font-size:10px;"><strong>VENDOR</strong><br>
			$(reletedRecord : vendorid|vendorname|Vendors)$<br>
			$(reletedRecord : vendorid|addresslevel8a|Vendors)$ $(reletedRecord : vendorid|buildingnumbera|Vendors)$ $(localnumbera : vendorid|vendorname|Vendors)$<br>
			$(reletedRecord : vendorid|addresslevel7a|Vendors)$<span style="font-size:10px;">, $(reletedRecord : vendorid|addresslevel5a|Vendors)$<br><strong>$(translate : Vendors|Vat ID)$:</strong> $(reletedRecord : vendorid|vat_id|Vendors)$<br><strong>$(translate : Vendors|Registration number 2)$: </strong>$(reletedRecord : vendorid|registration_number_2|Vendors)$</span></td>
			<td style="width:50%;font-size:10px;text-align:right;"><b>STORAGE</b><br>
...
', 1, 'Storage Transfer Received Notes', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'en_us', 'storage_transfer_received_notes', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
...
', 1, 'Pre-order', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'en_us', 'pre_order', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
...
', 1, 'Storage Transfer Dispatched Notes', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'en_us', 'storage_transfer_dispatched_notes', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[21, 'IStorages', '', '<table style="width:100%;border-collapse:collapse;font-size:10px;"><tr><td style="padding:5px;font-size:20px;text-align:center;"><b>RAPORT CAĹKOWITY STANĂ“W MAGAZYNOWYCH</b></td>
		</tr></table><hr><div style="width:50%;float:left;">
<table style="width:100%;border-collapse:collapse;font-size:10px;"><tr><td style="padding:5px;">$(organization : name)$<br>
			$(organization : street)$<br>
			$(organization : city)$,Â $(organization : code)$<br><strong>$(translate : Vat ID)$ :</strong>Â $(organization : vatid)$<br><strong>$(translate : Registration number 2)$:</strong>Â $(organization : id1)$<br><b>$(translate : IStorages|FL_NUMBER)$</b> $(record : number)$<br><b>$(translate : IStorages|FL_SUBJECT)$</b> $(record : subject)$<br><strong>Data wygenerowania</strong>Â $(general : CurrentDate)$</td>
		</tr></table></div>
$(custom : ProductsTableHierarchy|IStorages)$', '<div style="text-align:center;"><span style="font-size:8px;">{nb} /Â {PAGENO}</span></div>
', 1, 'Raport caĹ‚kowity stanĂłw magazynowych', '*', '', '', '', 1, '', '', 'A4', 1, 0, 0, 0, 0, 0, 0, 'PLL_PORTRAIT', 'pl_pl', 'raport_stanow_magazynowych', 'PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[22, 'IGRNC', '<table style="width:100%;"><tbody><tr><td style="width:50%;"><span style="font-size:16px;"><strong>Korekta przyjÄ™cia z zewnÄ…trz</strong></span></td>
			<td style="width:50%;text-align:right;"><span style="font-size:10px;"><strong>$(translate : IGRNC|FL_ACCEPTANCE_DATE)$:</strong> $(record : acceptance_date)$</span><br /><span style="font-size:10px;"><strong>$(translate : IGRNC|Assigned To)$:</strong> $(record : assigned_user_id)$</span><br /><span style="font-size:10px;"><strong>Numer dokumentu:</strong> $(record : number)$<br /><strong>Data wystawienia:</strong>Â $(general : CurrentDate)$</span></td>
		</tr></tbody></table><hr />', '<br><br><table style="width:100%;"><tr><td style="width:50%;font-size:10px;"><strong>DOSTAWCA</strong><br>
			$(reletedRecord : vendorid|vendorname|Vendors)$<br>
			$(reletedRecord : vendorid|addresslevel8a|Vendors)$ $(reletedRecord : vendorid|buildingnumbera|Vendors)$ $(localnumbera : vendorid|vendorname|Vendors)$<br>
			$(reletedRecord : vendorid|addresslevel7a|Vendors)$ $(reletedRecord : vendorid|addresslevel5a|Vendors)$<br><strong>$(translate : Vendors|Vat ID)$:</strong> $(reletedRecord : vendorid|vat_id|Vendors)$<br><strong>$(translate : Vendors|Registration number 2)$: </strong>$(reletedRecord : vendorid|registration_number_2|Vendors)$</td>
			...
			$(reletedRecord : storageid|addresslevel7a|IStorages)$ $(reletedRecord : storageid|addresslevel5a|IStorages)$<br><br>
			Â </td>
		</tr></table><hr><strong><span style="font-size:16px;">ByĹ‚o</span></strong><br><br>
$(custom : ProductsTableRelatedModule)$
<hr><strong><span style="font-size:16px;">Winno byÄ‡</span></strong><br><br>
$(custom : ProductsTableNew)$<br>
Â 
<table style="width:100%;"><tr><td style="width:50%;"><span style="font-size:10px;">PRZYGOTOWAĹ<br><br><br><br>
			.............................................</span></td>
			<td style="width:50%;text-align:right;"><span style="font-size:10px;">ZAAKCEPTOWAĹ<br><br><br><br>
			.............................................</span></td>
		</tr></table>', '<div style="text-align:center;"><span style="font-size:8px;"><span style="line-height:20.8px;">{PAGENO} /Â </span>{nb}</span>Â </div>
', 1, 'Korekta przyjÄ™cia zewnÄ™trznego', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'pl_pl', 'korekta_przyjecia_zewnetrznego', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[23, 'IGDNC', '<table style="width:100%;"><tbody><tr><td style="width:50%;"><span style="font-size:16px;"><strong>Korekta wydania na zewnÄ…trz</strong></span></td>
			<td style="width:50%;text-align:right;"><span style="font-size:10px;"><strong>$(translate : IGDNC|FL_ACCEPTANCE_DATE)$:</strong> $(record : acceptance_date)$</span><br /><span style="font-size:10px;"><strong>$(translate : IGDNC|Assigned To)$:</strong> $(record : assigned_user_id)$</span><br /><span style="font-size:10px;"><strong>Numer dokumentu:</strong> $(record : number)$<br /><strong>Data wystawienia:</strong>Â $(general : CurrentDate)$</span></td>
		</tr></tbody></table><hr />', '<br><br><table style="width:100%;"><tr><td style="width:50%;font-size:10px;"><strong>ODBIORCA</strong><br>
			$(reletedRecord : accountid|accountname|Accounts)$<br>
			$(reletedRecord : accountid|addresslevel8a|Accounts)$ $(reletedRecord : accountid|buildingnumbera|Accounts)$ $(reletedRecord : accountid|localnumbera|Accounts)$<br>
			$(organization : code)$, $(reletedRecord : accountid|addresslevel5a|Accounts)$<br><strong>$(translate : Accounts|Vat ID)$: </strong>$(reletedRecord : accountid|vat_id|Accounts)$<br><strong>$(reletedRecord : accountid|registration_number_2|Accounts)$: </strong>$(reletedRecord : accountid|registration_number_2|Accounts)$</td>
...
', 1, 'Korekta wydania na zewnÄ…trz', '*', '', '', '', 1, '', '', 'A4', 0, 35, 15, 15, 15, 15, 15, 'PLL_PORTRAIT', 'pl_pl', 'korekta_wydania_na_zewnatrz', 'PLL_LISTVIEW,PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
					[24, 'IStorages', '', '<table style="width:100%;border-collapse:collapse;font-size:10px;"><tr><td style="padding:5px;font-size:20px;text-align:center;"><b>HIERARCHIA MAGAZYNĂ“W</b></td>
		</tr></table><hr><div style="width:100%;">
<table style="width:100%;border-collapse:collapse;font-size:10px;"><tr><td style="padding:5px;">
			$(organization : name)$<br>
			$(organization : code)$ $(organization : city)$<br><strong>$(translate : Vat ID)$:</strong>Â $(organization : vatid)$<br><strong>$(translate : Registration number 2)$:</strong>Â $(organization : id1)$</td>
			<td style="padding:5px;text-align:right;">
			<div><b>$(translate : IStorages|FL_NUMBER)$</b>$(record : number)$<br><b>$(translate : IStorages|FL_SUBJECT)$</b> $(record : subject)$<br><strong>Data wygenerowania</strong>Â $(general : CurrentDate)$</div>
			<br>
			Â </td>
		</tr></table></div>
<br>
$(custom : ProductsTableHierarchy|IStorages)$', '<div style="text-align:center;"><span style="font-size:8px;">{nb} /Â {PAGENO}</span></div>
', 1, 'Hierarchia magazynĂłw', '*', '', '', '', 1, '', '', 'A4', 1, 0, 0, 0, 0, 0, 0, 'PLL_PORTRAIT', 'pl_pl', 'hierarchia_magazynow', 'PLL_DETAILVIEW', 1, '[]', 0, '', 0, 0, '', 'Users:1', NULL],
				]
			],
			'a_#__taxes_config' => [
				'columns' => ['param', 'value'],
