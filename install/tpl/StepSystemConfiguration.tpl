				...
				<form class="" name="step{$STEP_NUMBER}" method="post" action="Install.php">
					...
					<div class="row">
						<div class="col-lg-6 table-responsive">
							...
							<table class="config-table input-table">
								<caption
									class="sr-only">{\App\Language::translate('LBL_MORE_INFORMATION', 'Install')}</caption>
								<thead>
									<tr>
										<th colspan="2">
											<span class="fas fa-tools mr-2"></span>
											{\App\Language::translate('LBL_MORE_INFORMATION','Install')}
										</th>
									</tr>
								</thead>
								<tbody>
							...
							<div class="table-responsive">
								<table class="config-table input-table">
									...
									<thead>
										<tr>
											<th colspan="2">
												<span class="fas fa-user-tie mr-2"></span>
												{\App\Language::translate('LBL_ADMIN_INFORMATION', 'Install')}
											</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td class="position-relative">
												<input id="admin-email" type="text"
													...
													value="{$ADMIN_EMAIL}" name="admin_email">
											</td>
										</tr>
										<tr>
											<td>
