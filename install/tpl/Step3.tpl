				...
				<div class="row">
					<div class="col-lg-6 table-responsive">
						<table class="config-table input-table">
							...
							<tr>
								<td><label for="db-hostname">{\App\Language::translate('LBL_HOST_NAME', 'Install')}<span
							...
							<tr>
								<td><label for="db-port">{\App\Language::translate('LBL_HOST_PORT', 'Install')}<span
												class="no">*</span></label></td>
								<td><input id="db-port" type="text" class="form-control" value="3306" name="db_port">
								</td>
							</tr>
							<tr>
								<td><label for="db-username">{\App\Language::translate('LBL_USERNAME', 'Install')}<span
												class="no">*</span></label></td>
							...
							<tr>
								...
								<td><input id="db-password" type="password" class="form-control" value="{$DB_PASSWORD}"
										   name="db_password"></td>
							</tr>
							<tr>
					...
					<div class="col-lg-6">
						<table class="config-table input-table">
							...
							<tbody>
							<tr>
								<td><label for="currency-name">{\App\Language::translate('LBL_CURRENCIES','Install')}
						...
						<div class="table-responsive">
							<table class="config-table input-table">
								...
								<tr>
									<td><label for="password">{\App\Language::translate('LBL_PASSWORD', 'Install')}<span
													class="no">*</span></label>
									</td>
								...
								<tr>
									<td><label for="last-name">{\App\Language::translate('Last Name', 'Install')} <span
													class="no">*</span></label>
									</td>
									<td><input id="last-name" type="text" class="form-control" value="{$ADMIN_LASTNAME}"
											   name="lastname">
									</td>
								</tr>
								<tr>
									<td><label for="admin-email">{\App\Language::translate('LBL_EMAIL','Install')} <span
													class="no">*</span></label></td>
									<td class="position-relative">
								...
								<tr>
									<td><label for="date-format">{\App\Language::translate('LBL_DATE_FORMAT','Install')}
											<span
													class="no">*</span></label>
									</td>
									<td>
