...
{strip}
	<div class="main-container">
		<div class="inner-container">
			<h2 class="h4">{\Install\Language::translate('LBL_LICENSE', 'Install')}</h2>
					...
					<div class="col-12">
						<div class="button-container">
							<input name="back" type="button" class="btn btn-sm btn-danger"
								   value="{\Install\Language::translate('LBL_DISAGREE', 'Install')}">
							<input id="agree" type="submit" class="btn btn-sm btn-primary"
								   value="{\Install\Language::translate('LBL_I_AGREE', 'Install')}">
						</div>
					</div>
				</div>
			</form>
