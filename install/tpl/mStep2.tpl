				...
				<div>
					<div class="inner-container">
						...
						<div>
							...
							{\App\Language::translate('LBL_HAVE_BACKUP_DATABASE', 'Install')}</a>
						</div>
						<br>
						<div>
							<input type="checkbox" id="checkBox2" name="checkBox2" required>
							<div class="chkbox"></div>
							{\App\Language::translate('LBL_HAVE_BACKUP_FILES', 'Install')}</a>
						</div>
						<br>
						<div>
							...
							<div class="col-md-9 paddingLRZero">
								<div class="col-md-5 paddingLRZero">
									<select name="system" class="form-control" id="old_version" required>
										<option value=""
												selected="">{\App\Language::translate('LBL_SELECT', 'Install')}</option>
							...
							<div class="col-md-9 paddingLRZero">
								<div class="col-md-5 paddingLRZero">
									<input type="text" value="" name="source_directory" id="source_directory"
										   ...
										   placeholder="{\App\Language::translate('LBL_EXAMPLE_DIRECTORY', 'Install')}: {$EXAMPLE_DIRECTORY}">
								</div>
							</div>
						</div>
						<br>
				...
				<div>
					<div class="button-container">
						<input id="agree" type="submit" class="btn btn-md btn-primary"
							   value="{\App\Language::translate('LBL_START_MIGRATION', 'Install')}">
					</div>
				</div>
			</form>
		</div>
