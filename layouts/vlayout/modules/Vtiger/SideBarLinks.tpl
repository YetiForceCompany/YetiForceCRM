...
<div class="quickLinksDiv">
	...
	<h3 class="">{if file_exists( vimage_path($IMAGE) )}<img style="position: relative;top: 4px;margin-right: 4px;" src="{vimage_path($IMAGE)}" alt="{vtranslate($MODULE, $MODULE)}" class="summaryImg" />{/if}{vtranslate($MODULE, $MODULE)}</h3>
	<hr />
