		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="actions modal-footer">
					...
					<button class="btn btn-default pull-right" id="advanceSearchButton" {if $SOURCE_MODULE eq 'Home'} disabled="" {/if}  type="submit"><strong>{vtranslate('LBL_SEARCH', $MODULE)}</strong></button>
