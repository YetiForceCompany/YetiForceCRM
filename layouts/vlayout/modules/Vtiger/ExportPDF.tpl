...
{strip}
	...
	<div class="modal-footer">
		<div class="btn-group">
			<button id="generate_pdf" href="#" target="_blank" data-url="index.php?module={$MODULE_NAME}&action=PDF&mode=generate{$EXPORT_VARS}&template=" type="button" class="btn btn-success">
				{vtranslate('LBL_GENERATE', $MODULE_NAME)}
			</button>
			...
			<ul class="dropdown-menu">
				<li>
					<a href="#" id="single_pdf" data-url="index.php?module={$MODULE_NAME}&action=PDF&mode=generate{$EXPORT_VARS}&single_pdf=1&template=">
						{vtranslate('LBL_GENERATE_SINGLE', $MODULE_NAME)}
					</a>
				</li>
				<li>
					<a href="#" id="email_pdf" data-url="index.php?module={$MODULE_NAME}&action=PDF&mode=generate{$EXPORT_VARS}&email_pdf=1&template=">
