				...
				<div class="modal-body">
					<div class="modal-Fields">
						<div class="form-horizontal">
							...
							<div class="form-group marginLeftZero marginRightZero">
								<div class="col-md-3 text-right"><label class="control-label">{vtranslate('No left margin', $QUALIFIED_MODULE)}:</label></div>
							...
							<div class="form-group marginLeftZero marginRightZero">
								<div class="col-md-3 text-right"><label class="control-label">{vtranslate('Limit entries', $QUALIFIED_MODULE)}:</label></div>
								<div class="col-md-7">
