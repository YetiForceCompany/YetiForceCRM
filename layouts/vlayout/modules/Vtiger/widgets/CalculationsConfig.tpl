					...
					<div class="modal-Fields">
						<div class="form-horizontal">
							<div class="form-group marginLeftZero marginRightZero">
								<div class="pull-left"><strong>{vtranslate('Type widget', $QUALIFIED_MODULE)}</strong>:</div>
								<div class="col-md-7">
									{vtranslate($TYPE, $QUALIFIED_MODULE)}
								</div>
							</div>
							<div class="form-group marginLeftZero marginRightZero">
								<div class="pull-left"><label class="control-label">{vtranslate('Label', $QUALIFIED_MODULE)}:</label></div>
								<div class="col-md-7"><input name="label" class="form-control" type="text" value="{$WIDGETINFO['label']}" /></div>
							</div>
							<div class="form-group marginLeftZero marginRightZero">
								<div class="pull-left"><label class="control-label">{vtranslate('No left margin', $QUALIFIED_MODULE)}:</label></div>
								<div class="col-md-7">
							...
							<div class="form-group marginLeftZero marginRightZero">
								<div class="pull-left"><label class="control-label">{vtranslate('Limit entries', $QUALIFIED_MODULE)}:</label></div>
								<div class="col-md-7">
