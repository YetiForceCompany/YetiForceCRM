	...
	<div>
		<div class="row-fluid">
			{if $RELATED_MODULE == 'Products' }
				<div class="span3"><strong>{vtranslate('Product Category', $RELATED_MODULE)}</strong></div>
				<div class="span3"><strong>{vtranslate('Product Name', $RELATED_MODULE)}</strong></div>
				<div class="span3"><strong>{vtranslate('Handler', $RELATED_MODULE)}</strong></div>
				<div class="span3"><strong>{vtranslate('Share with users', $RELATED_MODULE)}</strong></div>
			{/if}
			{if $RELATED_MODULE == 'Services' }
				<div class="span3"><strong>{vtranslate('Service Category', $RELATED_MODULE)}</strong></div>
				<div class="span3"><strong>{vtranslate('Service Name', $RELATED_MODULE)}</strong></div>
