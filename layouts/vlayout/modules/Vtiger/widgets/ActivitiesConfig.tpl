			...
			<form class="form-modalAddWidget">  
				...
				<div class="modal-body">
					<div class="modal-Fields">
						<div class="row">
							<div class="col-md-3 text-right marginLeftZero"><strong>{vtranslate('Type widget', $QUALIFIED_MODULE)}</strong>:</div>
							<div class="col-md-7">
								{vtranslate($TYPE, $QUALIFIED_MODULE)}
							</div>
							<div class="col-md-3 text-right marginLeftZero"><label class="">{vtranslate('Label', $QUALIFIED_MODULE)}:</label></div>
							<div class="col-md-7"><input name="label" class="form-control" type="text" value="{$WIDGETINFO['label']}" /></div>
							<div class="col-md-3 text-right marginLeftZero"><label class="">{vtranslate('No left margin', $QUALIFIED_MODULE)}:</label></div>
							<div class="col-md-7">
							...
							<div class="col-md-3 text-right marginLeftZero"><label class="">{vtranslate('Limit entries', $QUALIFIED_MODULE)}:</label></div>
							<div class="col-md-7">
