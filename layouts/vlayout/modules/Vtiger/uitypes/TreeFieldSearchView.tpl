...
{strip}
    ...
    <div class="row">
        <select class="select2noactive listSearchContributor col-md-9" title="{vtranslate($FIELD_MODEL->get('label'))}" multiple name="{$FIELD_MODEL->get('name')}" style="width:150px;" data-fieldinfo='{$FIELD_INFO|escape}'>
