...
{strip}
	...
	<select class="select2noactive listSearchContributor col-md-10 {$ASSIGNED_USER_ID}" title="{vtranslate('LBL_ASSIGNED_TO')}" title="{vtranslate($FIELD_MODEL->get('label'))}"  name="{$ASSIGNED_USER_ID}" multiple style="width:150px;"data-fieldinfo='{$FIELD_INFO|escape}'>
