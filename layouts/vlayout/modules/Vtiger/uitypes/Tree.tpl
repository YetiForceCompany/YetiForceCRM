...
<div class="row input-group">
	...
	{/if}
	<input id="{$FIELD_NAME}_display" name="{$FIELD_MODEL->getFieldName()}_display" type="text" class="{if (($smarty.request.view eq 'Edit') or ($smarty.request.module eq 'Webforms'))} col-md-7 {else} col-md-8 {/if}	marginLeftZero treeAutoComplete" {if !empty($displayId)}readonly="true"{/if}
