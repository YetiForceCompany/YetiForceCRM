...
{strip}
    ...
    <div class="row">
        <select class="select2noactive listSearchContributor col-md-9 form-control" name="{$FIELD_MODEL->get('name')}" title="{vtranslate($FIELD_MODEL->get('label'))}" multiple style="width:150px;" data-fieldinfo='{$FIELD_INFO|escape}'>
