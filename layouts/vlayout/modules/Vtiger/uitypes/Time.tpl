...
<div class="input-append time">
    <input id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->get('name')}" type="text" data-format="{$TIME_FORMAT}" class="timepicker-default input-small" value="{$FIELD_VALUE}" title="{vtranslate($FIELD_MODEL->get('label'), $MODULE)}" name="{$FIELD_MODEL->getFieldName()}"
