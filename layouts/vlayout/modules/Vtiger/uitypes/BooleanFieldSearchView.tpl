...
{strip}
    ...
    <div class="row-fluid">
    <select class="select2 listSearchContributor" name="{$FIELD_MODEL->get('name')}" style="width:90px;" data-fieldinfo='{$FIELD_INFO|escape}' {if $FIELD_MODEL->get('displaytype') == 10}readonly="readonly"{/if}>
