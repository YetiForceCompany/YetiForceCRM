...
<div class="row">
<input type="text" data-format="{$TIME_FORMAT}" class="col-md-9 timepicker-default listSearchContributor" title="{vtranslate($FIELD_MODEL->get('label'))}" value="{$FIELD_VALUE}" name="{$FIELD_MODEL->getFieldName()}" data-fieldinfo='{$FIELD_INFO}' />
</div>
{/strip}