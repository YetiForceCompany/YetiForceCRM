...
<div class="row conditionRow marginBottom10px">
	<span class="col-md-4">
		<select class="{if empty($NOCHOSEN)}chzn-select{/if} row" name="columnname" title="{vtranslate('LBL_CHOOSE_FIELD')}">
	...
	<span class="col-md-3">
		<select class="{if empty($NOCHOSEN)}chzn-select{/if} row" name="comparator" title="{vtranslate('LBL_COMAPARATOR_TYPE')}">
	...
	<span class="col-md-4 fieldUiHolder">
		<input name="{if $SELECTED_FIELD_MODEL}{$SELECTED_FIELD_MODEL->get('name')}{/if}" title="{vtranslate('LBL_COMPARISON_VALUE')}" data-value="value" class="row" type="text" value="{$CONDITION_INFO['value']|escape}" />
	</span>
	<span class="hide">
