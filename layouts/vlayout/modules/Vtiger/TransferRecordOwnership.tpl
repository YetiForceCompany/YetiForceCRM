				...
				<div class="modal-body tabbable">
					<div class="form-group">
						...
						<div class="col-sm-6 controls"> 
							<select class="select2-container form-control columnsSelect" id="related_modules" title="{vtranslate('LBL_SELECT_RELATED_MODULES',$MODULE)}" data-validation-engine="validate[required]" data-placeholder="{vtranslate('LBL_SELECT_RELATED_MODULES',$MODULE)}" multiple="" name="related_modules[]">
