...
{strip}
	...
	<textarea name="{$FIELD->getColumnName()}{$ROW_NO}" title="{vtranslate("LBL_ROW_COMMENT",$MODULE)}" id="editView_comment{$ROW_NO}" data-fieldinfo="{Zend_Json::encode(['mandatory' => false])|escape}"
