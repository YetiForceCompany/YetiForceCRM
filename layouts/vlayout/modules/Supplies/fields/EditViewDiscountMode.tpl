...
{strip}
	<select class="select2 discountMode" title="{vtranslate('LBL_TAX_MODE', $SUPMODULE)}" name="{$FIELD->getColumnName()}{$ROW_NO}" {if $FIELD->get('displaytype') == 10}readonly="readonly"{/if}>
