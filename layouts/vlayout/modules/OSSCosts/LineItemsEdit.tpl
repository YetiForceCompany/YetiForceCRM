    ...
    <table class="table table-bordered blockContainer lineItemTable" id="lineItemTab">
        <tr>
            ...
            <td colspan="2" class="chznDropDown">
                ...
                <select class="chzn-select" id="currency_id" title="{vtranslate('LBL_CURRENCY', $MODULE)}" name="currency_id">
            ...
            <td colspan="3" class="chznDropDown">
                <div class="">
                    ...
                    <select class="chzn-select lineItemTax" id="taxtype" title="{vtranslate('LBL_TAX_MODE', $MODULE)}" name="taxtype" >
        ...
        {foreach key=row_no item=data from=$RELATED_PRODUCTS}
            <tr id="row{$row_no}" class="lineItemRow" {if $data["entityType$row_no"] eq 'Products'}data-quantity-in-stock={$data["qtyInStock$row_no"]}{/if}>
                {include file="LineItemsContent.tpl"|@vtemplate_path:'OSSCosts' row_no=$row_no data=$data}
            </tr>
        {/foreach}
        {if count($RELATED_PRODUCTS) eq 0}
            <tr id="row1" class="lineItemRow">
                {include file="LineItemsContent.tpl"|@vtemplate_path:'OSSCosts' row_no=1 data=[]}
            </tr>
        {/if}
