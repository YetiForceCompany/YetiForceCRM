...
<div class="container" style="margin-top:20px">
	<form method="POST" action="index.php?module=OSSPaymentsIn&view=step1" name="ical_import"  enctype="multipart/form-data">
		<div class="row-fluid" >
			<div class="span12">
...
function OSSPaymentsIn() {
             ...
             this.preSave = function() {
                ...
                jQuery(':submit').on('click', function() {
                    ...
                    if(file == ""){
  							var msg = '{/literal}{vtranslate("LBL_ERROR_FILE", 'OSSPaymentsIn')}{literal}';
					...
					//	console.log(id);
						if(type[id-1]!='txt' && type[id-1]!='sta'){
							var msg = '{/literal}{vtranslate("LBL_ERROR_TYPE", 'OSSPaymentsIn')}{literal}';
								Vtiger_Helper_Js.showPnotify(msg);
							return false;
						}
