	...
	<div class="contentsDiv" >
		...
		*}
		<div class="pull-right" >
						...
						<a href="index.php?module=OSSPaymentsIn&view=List" id="go" class="btn addButton hide">{vtranslate('Go to Payments', $MODULENAME)}</a>&nbsp
                        <a href="index.php?module=OSSPaymentsIn&view=PaymentsImport#" class="btn">{vtranslate('Back', $MODULENAME)}</a>
        </div>
    </div>
</div>
{/strip}
