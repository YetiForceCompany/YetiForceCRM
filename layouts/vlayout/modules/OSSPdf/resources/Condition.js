...
function OSSCondition() {
	this.addCondiion = function() {
		...
		jQuery('button.add_condition').on('click', function() {
			...
			requestParams = {};
			requestParams.data = {module: 'OSSPdf', view: 'Condition', base_module: baseModule, num: numCondition}
	...
	this.submitEventRegister = function() {
		var thisInstance = this;
		jQuery('form[name="EditView"]').on('submit', function() {
            ...
            this.validateCondition = function(type) {
                ...
                jQuery('#' + type +  ' .conditionRow').each(function() {
                    ...
                    if (fieldType == 'email') {
                        ...
                        var doubleInstance = new Vtiger_Integer_Validator_Js();
