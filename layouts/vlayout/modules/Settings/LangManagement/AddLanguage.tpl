...
<div id="AddNewLangMondal" class="modal fade" tabindex="1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="row">
				<div class="col-md-3 marginLeftZero"><label class="">{vtranslate('LBL_Lang_label', $QUALIFIED_MODULE)}:</label></div>
				<div class="col-md-7"><input name="label" class="form-control" type="text" /></div>
				<div class="col-md-3 marginLeftZero"><label class="">{vtranslate('LBL_Lang_name', $QUALIFIED_MODULE)}:</label></div>
				<div class="col-md-7"><input name="name" class="form-control" type="text" /></div>
				<div class="col-md-3 marginLeftZero"><label class="">{vtranslate('LBL_Lang_prefix', $QUALIFIED_MODULE)}:</label></div>
