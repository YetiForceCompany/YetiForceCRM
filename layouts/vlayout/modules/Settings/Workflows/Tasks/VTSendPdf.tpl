	...
	<div class="well" id="VtVTEmailTemplateTaskContainer">
		<div class="row">
			...
			<div class="row padding-bottom1per">
				<select class="chzn-select col-md-4" name="pdf_tpl" data-validation-engine="validate[required]">
					<option value=""></option>
		...
		<div class="row">
			...
			<div class="row padding-bottom1per">
				<select class="chzn-select col-md-4" name="email_tpl"  data-validation-engine="validate[required]">
					<option value=""></option>
		...
		<div class="row padding-bottom1per">
			...
			<select class="chzn-select col-md-4" name="email_fld" data-placeholder="{vtranslate('LBL_SELECT_FIELD',$QUALIFIED_MODULE)}" data-validation-engine="validate[required]">
				<option value=""></option>
