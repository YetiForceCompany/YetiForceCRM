...
<div class="well" id="VtVTEmailTemplateTaskContainer">
	<div class="row">
		...
		<div class="row padding-bottom1per">
			...
			<select class="chzn-select col-md-4" name="email" data-placeholder="{vtranslate('LBL_SELECT_FIELD',$QUALIFIED_MODULE)}" data-validation-engine='validate[required]'>
		...
		<div class="row padding-bottom1per">
			...
			<input class="col-md-4 marginLeftZero" data-validation-engine="validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="copy_email" value="{$TASK_OBJECT->copy_email}">
