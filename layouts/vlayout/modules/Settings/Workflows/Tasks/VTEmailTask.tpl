		...
		<div class="">
			<div class="row padding-bottom1per">
				<span class="col-md-7 row">
					<span class="col-md-2 control-label">{vtranslate('LBL_FROM', $QUALIFIED_MODULE)}</span>
					<div class="col-md-9">
						<input data-validation-engine='validate[]' name="fromEmail" class="fields form-control" type="text" value="{$TASK_OBJECT->fromEmail}" />
					</div>
				</span>
				<span class="col-md-5">
					<select id="fromEmailOption" class="chzn-select" data-placeholder={vtranslate('LBL_SELECT_OPTIONS',$QUALIFIED_MODULE)}>
						<option></option>
			...
			<div class="row padding-bottom1per">
				<span class="col-md-7 row">
					<span class="col-md-2 control-label">{vtranslate('LBL_TO',$QUALIFIED_MODULE)}<span class="redColor">*</span></span>
					<div class="col-md-9">
			...
			<div class="row padding-bottom1per {if empty($TASK_OBJECT->emailcc)}hide {/if}" id="ccContainer">
				...
				<span class="col-md-5">
					<select class="task-fields form-control" data-placeholder='{vtranslate('LBL_SELECT_OPTIONS',$QUALIFIED_MODULE)}' >
						<option></option>
						{$EMAIL_FIELD_OPTION}
					</select>
				</span>
			...
			<div class="row padding-bottom1per">
				<span class="col-md-7 row">
					<span class="col-md-2 control-label">{vtranslate('LBL_SUBJECT',$QUALIFIED_MODULE)}<span class="redColor">*</span></span>
					<div class="col-md-9">
			...
			<div class="row padding-bottom1per">
				<span class="col-md-7 row">
					<span class="col-md-2 paddingRightZero control-label">{vtranslate('LBL_ADD_FIELD',$QUALIFIED_MODULE)}</span>
					<div class="col-md-9">
