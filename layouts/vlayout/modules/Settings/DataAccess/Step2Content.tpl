					...
					{if $TPL_ID}
						...
						{foreach from=$REQUIRED_CONDITIONS key=cnd_key item=cnd_item name=field_select}
							<div class="row conditionRow marginBottom10px" id="cnd_num_{$smarty.foreach.field_select.index}">
								<div class="col-md-4">
									<select data-num="{$smarty.foreach.field_select.index}" class="chzn-select form-control row comparator-select field-name-select" data-placeholder="{vtranslate('LBL_SELECT_FIELD',$QUALIFIED_MODULE)}">
								...
								<div class="col-md-3">
									<select data-num="{$smarty.foreach.field_select.index}" class="chzn-select form-control row" name="comparator">
