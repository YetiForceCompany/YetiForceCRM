				...
				<div class="modal-body">
					<div class="">
						...
						<div class="form-group">
							...
							<div class="col-md-6 controls">
								<input class="form-control" type="text" name="value" class="input-medium" placeholder="{vtranslate('LBL_ENTER_VALUE', $QUALIFIED_MODULE)}" value="{$RECORD_MODEL->getValue()}" data-validation-engine='validate[required, funcCall[Vtiger_Percentage_Validator_Js.invokeValidation]]' />
