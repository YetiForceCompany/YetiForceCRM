...
Vtiger_AdvanceFilter_Js('PDF_AdvanceFilter_Js', {}, {
...
Vtiger_Date_Field_Js('PDF_Date_Field_Js', {}, {
	/**
...
Vtiger_Date_Field_Js('PDF_Datetime_Field_Js', {}, {
	/**
	 * Function to get the user date format
	 */
	getDateFormat: function () {
...
Vtiger_Currency_Field_Js('PDF_Currency_Field_Js', {}, {
	getUi: function () {
...
Vtiger_Time_Field_Js('PDF_Time_Field_Js', {}, {
	/**
	 * Function to get the ui
	 * @return - input text field
	 */
...
Vtiger_Owner_Field_Js('PDF_Owner_Field_Js', {}, {
	getUi: function () {
...
Vtiger_Picklist_Field_Js('PDF_Picklist_Field_Js', {}, {
});
