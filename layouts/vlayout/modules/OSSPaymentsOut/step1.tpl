	...
	<div class="contentsDiv" >
		...
		*}
		<div class="pull-right" style="margin-top:20px">
						...
						<a href="index.php?module=OSSPaymentsOut&view=List" id="go" class="btn addButton hide">{vtranslate('Go to Payments', $MODULENAME)}</a>&nbsp
                        <a href="index.php?module=OSSPaymentsOut&view=PaymentsImport#" class="btn">{vtranslate('Back', $MODULENAME)}</a>
        </div>
    </div>
</div>
{/strip}
