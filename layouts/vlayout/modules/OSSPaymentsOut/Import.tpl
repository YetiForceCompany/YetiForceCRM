...
<div class="container" style="margin-top:20px">
	<form method="POST" action="index.php?module=OSSPaymentsOut&view=step1" name="ical_import"  enctype="multipart/form-data">
		<div class="row-fluid" >
			<div class="span12">
...
function OSSPaymentsOut() {
             ...
             this.preSave = function() {
                ...
                jQuery(':submit').on('click', function() {
                    ...
                    if(file == ""){
  							var msg = '{/literal}{vtranslate("LBL_ERROR_FILE", 'OSSPaymentsOut')}{literal}';
					...
					//	console.log(id);
						if(type[id-1]!='txt'){
							var msg = '{/literal}{vtranslate("LBL_ERROR_TYPE", 'OSSPaymentsOut')}{literal}';
								Vtiger_Helper_Js.showPnotify(msg);
							return false;
						}
