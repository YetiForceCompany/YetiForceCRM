		...
		<form class="form-horizontal recordEditView" id="report_step1" method="post" action="index.php">
			...
			<div class="well contentsBackground">
				...
				<div class="row-fluid padding1per">
					...
					<span class="span7 row-fluid">
						<select class="span6 chzn-select" title="{vtranslate('PRIMARY_MODULE',$MODULE)}" id="primary_module" name="primary_module">
							<optgroup>
				...
				<div class="row-fluid padding1per">
					...
					<span class="span7 row-fluid">
						...
						<select class="span6 select2-container" id="secondary_module" multiple name="secondary_modules[]" title="{vtranslate('LBL_SELECT_RELATED_MODULES',$MODULE)}" data-placeholder="{vtranslate('LBL_SELECT_RELATED_MODULES',$MODULE)}">
				...
				<div class="row-fluid padding1per">
					...
					<span class="span7"><textarea class="span6" type="text" title="{vtranslate('LBL_DESCRIPTION',$MODULE)}" name="description" >{$REPORT_MODEL->get('description')}</textarea></span>
				</div>
				<div class="row-fluid padding1per">
					<div class="row span">
				...
				<div id="scheduleBox" class='well contentsBackground {if $SCHEDULEDREPORTS->get('scheduleid') eq ''} hide {/if}'>
					...
					<div class='row-fluid {if $scheduleid neq 2} hide {/if}' id='scheduledWeekDay' style='padding:5px 0px;'>
                        ...
                        <div class='row-fluid {if $scheduleid neq 3} hide {/if}' id='scheduleMonthByDates' style="padding:5px 0px;">
                            ...
                            <div class='span4'>
                                ...
                                <select style="width: 281px !important;" multiple class="chosen-select span6" title="{vtranslate('LBL_ON_THESE_DAYS', $MODULE)}" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name='schdayofthemonth' id='schdayofthemonth' >
                    ...
                    <div class='row-fluid' id='scheduledTime' style='padding:5px 0px 10px 0px;'>
                        ...
                        <div class='span4' id='schtime'>
                            <div class="input-append time">
                                ...
                                <span class="add-on cursorPointer"><span class="icon-time"></span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='row-fluid' id='recipientsList' style='padding:5px 0px 10px 0px;'>
                        ...
                        <div class='span4'>
                            ...
                            <select multiple data-placeholder="{vtranslate('LBL_SELECT_OPTION')}" title="{vtranslate('LBL_SELECT_RECIEPIENTS', $MODULE)}" class="chosen-select span6" id='recipients' name='recipients' data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" style="width: 281px !important;">
                    ...
                    <div class='row-fluid' id='specificemailsids' style='padding:5px 0px 10px 0px;'>
                        ...
                        <div class='span4'>
                            ...
                            <input id="specificemails" style="width: 281px !important;" class="span6" title="{vtranslate('LBL_SPECIFIC_EMAIL_ADDRESS', $MODULE)}" type="text" value="{$specificemailids}" name="specificemails" data-validation-engine="validate[funcCall[Vtiger_MultiEmails_Validator_Js.invokeValidation]]"></input>
                        </div>
                    </div>
