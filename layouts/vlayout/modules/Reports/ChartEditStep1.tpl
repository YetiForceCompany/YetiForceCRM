		...
		<form class="form-horizontal recordEditView" id="report_step1" method="post" action="index.php">
			...
			<div class="well contentsBackground">
				...
				<div class="row padding1per">
					...
					<span class="col-md-7 row">
						<select class="col-md-6 chzn-select" id="primary_module" name="primary_module" {if $RECORD_ID and $REPORT_MODEL->getPrimaryModule() and $IS_DUPLICATE neq true} disabled="disabled"{/if}>
							<optgroup>
				...
				<div class="row padding1per">
					...
					<span class="col-md-7 row">
						...
						<select class="col-md-6 select2-container" id="secondary_module" multiple name="secondary_modules[]"
