	...
	<form class="form-horizontal recordEditView" id="report_step2" method="post" action="index.php">
		...
		<div class="well padding1per contentsBackground">
			<div class="row block padding1per">
				<div class="row padding1per"><strong>{vtranslate('LBL_SELECT_COLUMNS',$MODULE)}({vtranslate('LBL_MAX',$MODULE)} 25)</strong></div>
				<div class="row padding1per">
					<select data-placeholder="{vtranslate('LBL_ADD_MORE_COLUMNS',$MODULE)}" id="reportsColumnsList" class="select2-container col-md-11 columns" multiple="">
