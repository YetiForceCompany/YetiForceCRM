...
{strip}
	<!-- tpl-MailAccount-Edit-Field-MailFolders -->
	...
	<div class="js-tree-container" data-js="container">
		<input name="{$FIELD_MODEL->getFieldName()}" type="hidden" value="{$FIELD_VALUE}" class="sourceField"
			...
			data-treetemplate="{if $RECORD}{$RECORD->getId()}{/if}" data-module-name="{$FIELD_MODEL->getModuleName()}" data-view="MailFoldersModal">
