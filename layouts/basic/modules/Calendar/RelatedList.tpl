	...
	<div class="relatedContainer">
		...
		{if $RELATED_VIEW === 'ListPreview'}
			<div class="relatedContents">
				<div id="recordsListPreview" class="recordsListPreview">
					...
					<div class="listPreview col-md-9" id="listPreview">
						<iframe class="listPreviewframe border1px" id="listPreviewframe" frameborder="0"></iframe>
					</div>
