...
{strip}
	<div id="activityStateModal" class="modalEditStatus" tabindex="-1">
		{assign var=ID value=$RECORD->getId()}
		<div>
				<div>
					<div class="pull-left">
						<h4 class="modal-title">{\App\Language::translate('LBL_SET_RECORD_STATUS', $MODULE_NAME)}</h4>
					</div>
					<div class="pull-right">
						...
						{if $RECORD->isEditable()}
							<a href="#" data-url="{$RECORD->getEditViewUrl()}" data-id="{$ID}" class="editRecord btn btn-default"><span class="glyphicon glyphicon-pencil summaryViewEdit" title="{\App\Language::translate('LBL_EDIT',$MODULE_NAME)}"></span></a>
							{/if}
