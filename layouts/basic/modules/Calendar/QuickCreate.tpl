				...
				<form class="form-horizontal recordEditView" id="quickCreate" name="QuickCreate" method="post" action="index.php">
					<div class="modal-header">
						...
						<div class="quickCreateActions float-right pullRight">
							...
							<button class="cancelLink btn btn-warning" type="reset" data-dismiss="modal"	type="button" title="{\App\Language::translate('LBL_CLOSE')}"><span class="fas fa-times"></span></button>
						</div>
