{if !empty($FILTER_DATA)}
	<div class="js-filter__container">
		<div class="form-row d-flex align-items-center m-0">
			<h6 class="boxFilterTitle mt-2 mr-2 ">{\App\Language::translate('LBL_SELECT_USER_CALENDAR',$MODULE_NAME)}</h6>
			<input type="checkbox" class="alignMiddle js-select-all" title="{\App\Language::translate('LBL_SELECT_ALL', $MODULE_NAME)}"
				autocomplete="off">
		</div>
