...
-->*}
{strip}
<div id="massEditContainer contentsBackground" class='modelContainer modal fade'>
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close " data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 id="massEditHeader" class="modal-title">{vtranslate('LBL_CHANGE_OWNER', $MODULE)}</h3>
			</div>
			<form class="form-horizontal calendarMassEdit" id="massEdit" name="MassEdit" method="post" action="index.php">
				...
				<input type="hidden" id="massEditFieldsNameList" data-value='{Vtiger_Util_Helper::toSafeHTML(\App\Json::encode($massEditFields))}' />
