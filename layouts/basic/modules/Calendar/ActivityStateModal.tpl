			...
			<div class="modal-content">
					...
					<div class="col-7 px-0">
						<div class="float-right">
							...
							{if $RECORD->isEditable()}
								<a href="{$RECORD->getEditViewUrl()}" class="btn btn-light btn-sm"><span class="fas fa-edit js-detail-quick-edit" data-js="click" title="{\App\Language::translate('LBL_EDIT',$MODULE_NAME)}"></span></a>
								{/if}
								{if $RECORD->isViewable()}
								<a href="{$RECORD->getDetailViewUrl()}" class="btn btn-light btn-sm"><span title="{\App\Language::translate('LBL_SHOW_COMPLETE_DETAILS', $MODULE_NAME)}" class="fas fa-th-list js-detail-quick-edit"></span></a>
								{/if}
				...
				<div class="modal-body">
					...
					<div class="form-horizontal modalSummaryValues">
						...
						<div class="">
							<div class="form-group row">
								<label class="col-4 col-form-label col-form-label-sm">{\App\Language::translate('Start Date & Time',$MODULE_NAME)}:</label>
								<div class="col-8">
							...
							<div class="form-group row">
								<label class="col-4 col-form-label col-form-label-sm">{\App\Language::translate('Due Date',$MODULE_NAME)}:</label>
								<div class="col-8">
							...
							{if $RECORD->get('activitystatus') neq '' }
								<div class="form-group row">
									<label class="col-4 col-form-label col-form-label-sm">{\App\Language::translate('Status',$MODULE_NAME)}: </label>
									<div class="col-8">
							...
							<hr />
							<div class="form-group row">
								<label class="col-4 col-form-label col-form-label-sm">{\App\Language::translate('Description',$MODULE_NAME)}: </label>
								<div class="col-8">
							...
							{if $RECORD->get('shownerid')}
								<div class="form-group row">
									<label class="col-4 col-form-label col-form-label-sm">{\App\Language::translate('Share with users',$MODULE_NAME)}: </label>
