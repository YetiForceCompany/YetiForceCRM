		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="">
						{include file=\App\Layout::getTemplatePath('ButtonLinks.tpl', $MODULE_NAME) LINKS=$LINKS BUTTON_VIEW='detailViewBasic' BREAKPOINT='md' CLASS='c-btn-link--responsive' MODULE=$MODULE_NAME}
