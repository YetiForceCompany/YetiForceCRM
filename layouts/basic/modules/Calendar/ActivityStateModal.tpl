				...
				<div class="modal-body">
					...
					<div class="form-horizontal modalSummaryValues">
						<div class="form-group row">
							<label class="col-sm-4 col-form-label col-form-label-sm">{\App\Language::translate('Subject',$MODULE_NAME)}:</label>
						...
						<div class="">
							<div class="form-group row">
								<label class="col-sm-4 col-form-label col-form-label-sm">{\App\Language::translate('Start Date & Time',$MODULE_NAME)}:</label>
								<div class="col-sm-8">
							...
							<div class="form-group row">
								<label class="col-sm-4 col-form-label col-form-label-sm">{\App\Language::translate('Due Date',$MODULE_NAME)}:</label>
								<div class="col-sm-8">
							...
							{if $RECORD->get('activitystatus') neq '' }
								<div class="form-group row">
									<label class="col-sm-4 col-form-label col-form-label-sm">{\App\Language::translate('Status',$MODULE_NAME)}: </label>
									<div class="col-sm-8">
							...
							{if $RECORD->get('linkextend') neq '' }
								<div class="form-group row">
									<label class="col-sm-4 col-form-label col-form-label-sm">{\App\Language::translate('FL_RELATION_EXTEND',$MODULE_NAME)}: </label>
							...
							{if $RECORD->get('process') neq '' }
								<div class="form-group row">
									<label class="col-sm-4 col-form-label col-form-label-sm">{\App\Language::translate('Process',$MODULE_NAME)}: </label>
									<div class="col-sm-8 textOverflowEllipsis">
							...
							<hr />
							<div class="form-group row">
								<label class="col-sm-4 col-form-label col-form-label-sm">{\App\Language::translate('Description',$MODULE_NAME)}: </label>
								<div class="col-sm-8">
							...
							<hr />
							<div class="form-group row">
								<label class="col-sm-4 col-form-label col-form-label-sm">{\App\Language::translate('Created By',$MODULE_NAME)}: </label>
								<div class="col-sm-8 textOverflowEllipsis">
									{$RECORD->getDisplayValue('created_user_id',false,false,true)}
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-4 col-form-label col-form-label-sm">{\App\Language::translate('Assigned To',$MODULE_NAME)}: </label>
							...
							{if $RECORD->get('shownerid')}
								<div class="form-group row">
									<label class="col-sm-4 col-form-label col-form-label-sm">{\App\Language::translate('Share with users',$MODULE_NAME)}: </label>
