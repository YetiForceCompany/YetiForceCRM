...
{strip}
	<div class="d-flex flex-wrap flex-md-nowrap px-3 w-100">
		<div class="u-min-w-md-70 w-100">
			...
			<div class="pl-1">
				<div class="d-flex flex-nowrap align-items-center" data-ellipsis="true" data-content="{$RECORD->getName()}" data-toggle="popover" data-js="tooltip">
				...
				{if $LINK}
					<div class="js-popover-tooltip--ellipsis d-flex flex-nowrap align-items-center" data-ellipsis="true" data-content="{$RECORD->getDisplayValue('link')}" data-toggle="popover" data-js="tooltip">
