...
{strip}
	<div class="d-flex flex-wrap flex-md-nowrap px-3 w-100">
		<div class="u-min-w-md-70 w-100">
			...
			<div class="pl-1">
				<div class="js-popover-tooltip--ellipsis d-flex flex-nowrap align-items-center" data-content="{\App\Purifier::encodeHtml($RECORD->getName())}" data-toggle="popover" data-js="popover | mouseenter">
				...
				{if $LINK}
					<div class="js-popover-tooltip--ellipsis d-flex flex-nowrap align-items-center" data-content="{\App\Purifier::encodeHtml($RECORD->getDisplayValue('link'))}" data-toggle="popover" data-js="popover | mouseenter">
				...
				{if $PROCESS}
					<div class="js-popover-tooltip--ellipsis d-flex flex-nowrap align-items-center" data-content="{\App\Purifier::encodeHtml($RECORD->getDisplayValue('process'))}" data-toggle="popover" data-js="popover | mouseenter">
