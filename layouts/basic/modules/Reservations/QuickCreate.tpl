...
{strip}
	...
	<div class="tpl-QuickCreate  modelContainer modal quickCreateContainer fade c-modal--custom-animation" tabindex="-1" role="dialog">
						...
						<div>
							<h5 class="modal-title">
								...
								<p class="textTransform">
									<strong>{\App\Language::translate($SINGLE_MODULE, $MODULE)}</strong></p>
							</h5>
						</div>
						<div>
							...
							<button class="btn btn-outline-secondary goToFullFormReservation" id="goToFullForm"
