{strip}
	...
	<div class="container-fluid container-fluid-main">
		<div class="o-base-container js-base-container c-menu--animation {if $LEFTPANELHIDE} leftPanelOpen{/if} {if AppConfig::module('Users','IS_VISIBLE_USER_INFO_FOOTER')}userInfoFooter{/if}"
