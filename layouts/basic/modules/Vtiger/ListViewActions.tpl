			...
			<div class="dropdown dropdownEntityState">
				...
				<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownEntityState">
					<nav class="nav" role="tablist">
						<a class="dropdown-item nav-link{if $VIEW_MODEL->get('entityState') == 'Active'} active{/if}" data-toggle="tab" data-value="Active" href="#" {if $COLOR['Active']}style="border-left: 7px solid {$COLOR['Active']};"{/if}><span class="fas fa-undo-alt"></span>&nbsp;&nbsp;{\App\Language::translate('LBL_ENTITY_STATE_ACTIVE')}</a>
