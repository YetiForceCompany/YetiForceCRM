    ...
    ********************************************************************************/
    ...
    {strip}	
		<div id="tagRecordInput">
			<div class=" col-lg-2 col-md-3 col-sm-4 col-xs-12 paddingLRZero pull-left-sm pull-right-md pull-right-lg">
			...
			<div id="tagsList" class="pushDown col-xs-12 col-md-9 col-lg-10 paddingLRZero">
				{foreach from=$TAGS[1] item=TAG_ID key=TAG_NAME}
					<div class="btn-info btn-xs pull-right-lg pull-right-md pull-left-sm tag" data-tagname="{$TAG_NAME}" data-tagid="{$TAG_ID}">
