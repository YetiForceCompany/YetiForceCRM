...
{strip}
	...
	<div class="navbar-form navbar-right">
		<div class="dropdown quickActions">
			<a class="dropdown-toggle" data-toggle="dropdown" href="#"><img id="menubar_quickCreate" src="{getImagePath('plus.png')}" class="alignMiddle" alt="{\App\Language::translate('LBL_QUICK_CREATE',$MODULE)}" title="{\App\Language::translate('LBL_QUICK_CREATE',$MODULE)}" /></a>
