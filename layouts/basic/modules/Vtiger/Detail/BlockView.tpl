						...
						<div class="form-row border-bottom u-border-bottom-0-sm">
							...
							<div class="col-sm">
								<div class="form-row border-right h-100 align-items-start">
									<div class="flCT_{$MODULE}_{$FIELD_MODEL->getFieldName()} fieldLabel u-border-bottom-label-md u-border-right-0-md c-panel__label {if $FIELD_MODEL->getUIType() eq '20' or $FIELD_MODEL->getUIType() eq '300'}  col-lg-3  {else} col-lg-6 {/if} {$WIDTHTYPE} text-right" id="{$MODULE_NAME}_detailView_fieldLabel_{$FIELD_MODEL->getName()}">
