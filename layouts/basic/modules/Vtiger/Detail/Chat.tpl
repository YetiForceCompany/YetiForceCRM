...
{strip}
	<div class="tpl-Base-Detail-Chat js-chat-detail" data-js="container"
		 data-chat-room-id="{$RECORD_MODEL->getId()}">
		...
		<div class="{if !$CHAT->isCharRoomExists()}hide{/if} js-container-items">
			<div class="js-chat-items js-chat-room-{$RECORD_MODEL->getId()}" data-js="html">
