...
{assign var=FIELD_VALUE value=$FIELD_MODEL->getUITypeModel()->getDisplayValueEncoded($FIELD_MODEL->get('fieldvalue'), $RECORD->getId(),$FIELD_INFO_RAW['limit'])}
{assign var=FIELD_INFO value=\App\Purifier::encodeHtml(\App\Json::encode($FIELD_INFO_RAW))}
