									...
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-sm btn-outline-primary {if $ACTION_STATUS} active{/if}">
											<input type="radio" name="action"
												...
												{if $ACTION_STATUS}checked{/if}> {\App\Language::translate('LBL_YES', $QUALIFIED_MODULE)}
										</label>
										<label class="btn btn-sm btn-outline-primary {if !$ACTION_STATUS} active{/if}">
											<input type="radio" name="action"
												id="option2" autocomplete="off" value="0"
												{if !$ACTION_STATUS}checked{/if}> {\App\Language::translate('LBL_NO', $QUALIFIED_MODULE)}
										</label>
									</div>
								</div>
							</div>
									...
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-sm btn-outline-primary {if $ACTION_SELECT_STATUS} active{/if}">
											<input type="radio" name="actionSelect"
												id="option1" autocomplete="off" value="1"
												{if $ACTION_SELECT_STATUS}checked{/if}> {\App\Language::translate('LBL_YES', $QUALIFIED_MODULE)}
										</label>
										<label class="btn btn-sm btn-outline-primary {if !$ACTION_SELECT_STATUS} active{/if}">
											<input type="radio" name="actionSelect"
												id="option2" autocomplete="off" value="0"
												{if !$ACTION_SELECT_STATUS}checked{/if}> {\App\Language::translate('LBL_NO', $QUALIFIED_MODULE)}
										</label>
									</div>
								</div>
							</div>
									...
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-sm btn-outline-primary {if $NO_RESULT_TEXT} active{/if}">
											<input type="radio" name="no_result_text"
												id="option1" autocomplete="off" value="1"
												{if $NO_RESULT_TEXT}checked{/if}> {\App\Language::translate('LBL_YES', $QUALIFIED_MODULE)}
										</label>
										<label class="btn btn-sm btn-outline-primary {if !$NO_RESULT_TEXT} active{/if}">
											<input type="radio" name="no_result_text"
												id="option2" autocomplete="off" value="0"
												{if !$NO_RESULT_TEXT}checked{/if}> {\App\Language::translate('LBL_NO', $QUALIFIED_MODULE)}
										</label>
									</div>
								</div>
							</div>
