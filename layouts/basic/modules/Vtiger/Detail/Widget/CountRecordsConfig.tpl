				...
				<form class="form-modalAddWidget form-horizontal validateForm">
					...
					<div class="modal-body">
						<div class="form-container-sm">
							...
							<div class="form-group form-group-sm">
								<label class="col-md-4 col-form-label">{\App\Language::translate('Related module', $QUALIFIED_MODULE)}<a href="#" class="js-help-info" title="" data-placement="top" data-content="{\App\Language::translate('Related module info', $QUALIFIED_MODULE)}" data-original-title="{\App\Language::translate('Related module', $QUALIFIED_MODULE)}"><i class="fas fa-info-circle"></i></a>:</label>
