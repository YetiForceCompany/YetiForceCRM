...
<!-- tpl-Base-Detail-Widget-HistoryRelation -->
	...
	<div class="c-detail-widget js-detail-widget" data-js="container">
		<div class="widgetContainer_{$key} widgetContentBlock" data-url="{$WIDGET['url']}" data-name="{$WIDGET['label']}" data-type="{$WIDGET['type']}">
			<div class="c-detail-widget__header js-detail-widget-header collapsed pb-1" data-js="container|value">
				<div class="d-flex w-100 align-items-center py-1 justify-content-between">
					...
					<h5 class="mb-0 mb-0 mr-auto mr-sm-1 modCT_{$WIDGET['label']}">{\App\Language::translate($WIDGET['label'],$MODULE_NAME)}</h5>
			...
			<div class="c-detail-widget__content widgetContent js-detail-widget-content collapse multi-collapse pt-1" id="{$WIDGET_UID}-collapse" data-storage-key="{$WIDGET['id']}"  aria-labelledby="{$WIDGET_UID}" data-js="container|value">
			</div>
		</div>
	</div>
<!-- /tpl-Base-Detail-Widget-HistoryRelation -->
