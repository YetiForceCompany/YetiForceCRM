	...
	<div class="row marginBottom10px">
		<div class="col-md-12 btn-toolbar"">
			<div class="pull-right btn-group">
				<input class="switchBtn switchBtnReload recentActivitiesSwitch" type="checkbox" {if $TYPE eq 'changes'}checked=""{/if} data-size="small" data-label-width="5" data-on-text="{\App\Language::translate('LBL_UPDATES', $MODULE_BASE_NAME)}" data-off-text="{\App\Language::translate('LBL_REVIEW_HISTORY', $MODULE_BASE_NAME)}" data-urlparams="whereCondition" data-on-val="changes" data-off-val="review">
			</div>
