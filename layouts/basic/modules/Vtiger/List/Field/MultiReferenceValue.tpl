...
{strip}
	...
	<div class="tpl-List-Field-MultiReferenceValue picklistSearchField">
		<select class="select2noactive select2 listSearchContributor" name="{$FIELD_MODEL->getName()}" title="{\App\Language::translate($FIELD_MODEL->getFieldLabel(), $MODULE)}" multiple data-fieldinfo="{$FIELD_INFO|escape}">
