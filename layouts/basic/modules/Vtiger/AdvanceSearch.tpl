		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="actions modal-footer">
					...
					<button class="btn btn-info pull-right" id="advanceSearchButton" {if $SOURCE_MODULE eq 'Home'} disabled="" {/if}  type="submit"><span class="fa fa-search margin-right5px"></span><strong>{\App\Language::translate('LBL_SEARCH', $MODULE)}</strong></button>
