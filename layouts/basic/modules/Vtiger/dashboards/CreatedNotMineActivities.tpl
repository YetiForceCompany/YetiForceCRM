...
<div class="dashboardWidgetHeader">
	...
	<div class="row" >
		<div class="col-md-12 widget_header">
			...
			<div class="pull-left">
				<input class="switchBtn switchBtnReload" type="checkbox" checked="" data-size="small" data-label-width="5" data-on-text="{vtranslate('Upcoming Activities',$MODULE_NAME)}" data-off-text="{vtranslate('Overdue Activities',$MODULE_NAME)}" data-on-val="upcoming" data-off-val="overdue" data-urlparams="activitesType">
			</div>
		</div>
	</div>
</div>
