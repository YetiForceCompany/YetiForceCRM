				...
				<div class="row">
					{foreach item=FIELD from=$MINILIST_WIDGET_MODEL->getHeaders() name="minilistWidgetModelRowHeaders"}
						...
						<div class="col-sm-{$SPANSIZE_ARRAY[$ITERATION]} textOverflowEllipsis">
							{if $LAST_RECORD}
								<a href="{$RECORD->getDetailViewUrl()}" class="pull-right"><span title="{\App\Language::translate('LBL_SHOW_COMPLETE_DETAILS',$MODULE_NAME)}" class="fa fa-th-list alignMiddle"></span></a>
								{/if}
