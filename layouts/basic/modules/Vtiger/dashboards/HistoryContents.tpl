						...
						<div class="row">
							...
							<div class="col-md-11">
								<p class="pull-right muted" style="padding-right:5px;">
									<small>{\App\Fields\DateTime::getViewDateFormat("$TIME")}</small>
								</p>
				...
				{else if $MODELNAME == 'ModComments_Record_Model'}
					...
					<div class="row">
						...
						<div class="col-md-11">
							...
							<p class="pull-right muted" style="padding-right:5px;"><small title="{Vtiger_Util_Helper::formatDateTimeIntoDayString("$COMMENT_TIME")}">{\App\Fields\DateTime::getViewDateFormat("$COMMENT_TIME")}</small></p>
							<div>
