...
{strip}
	...
	<div class="dashboardWidgetContent">
		{include file="dashboards/MiniListContents.tpl"|@\App\Layout::getTemplatePath:$MODULE_NAME}
	</div>
	<div class="dashboardWidgetFooter">
		{include file="dashboards/MiniListFooter.tpl"|@\App\Layout::getTemplatePath:$MODULE_NAME}
	</div>
{/strip}
