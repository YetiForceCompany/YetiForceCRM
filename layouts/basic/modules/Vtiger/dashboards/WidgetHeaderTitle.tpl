...
<div class="js-popover-tooltip" data-ellipsis="true" data-content="{if !isset($TITLE)}{App\Purifier::encodeHtml(App\Language::translate($WIDGET->getTitle(), $MODULE_NAME))}{else}{$TITLE}{/if}" data-toggle="popover" data-js="tooltip">
  <h5 class="h6 d-block p-1 m-0 js-popover-tooltip js-widget__header__title" data-ellipsis="true" data-content="{if !isset($TITLE)}{App\Purifier::encodeHtml(App\Language::translate($WIDGET->getTitle(), $MODULE_NAME))}{else}{$TITLE}{/if}" data-toggle="popover" data-js="tooltip | text">
