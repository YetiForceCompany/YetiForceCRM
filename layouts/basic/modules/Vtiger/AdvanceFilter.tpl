		...
		<div class="contents">
			<div class="conditionList">
			 {foreach item=CONDITION_INFO from=$ALL_CONDITION_CRITERIA['columns']}
				{include file='AdvanceFilterCondition.tpl'|@\App\Layout::getTemplatePath:$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE CONDITION_INFO=$CONDITION_INFO MODULE=$MODULE}
			{/foreach}
			</div>
			<div class="hide basic">
				{include file='AdvanceFilterCondition.tpl'|@\App\Layout::getTemplatePath:$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE CONDITION_INFO=[] MODULE=$MODULE NOCHOSEN=true}
			</div>
	...
	<div class="anyConditionContainer conditionGroup contentsBackground well">
		...
		<div class="contents">
			...
			{foreach item=CONDITION_INFO from=$ANY_CONDITION_CRITERIA['columns']}
				{include file='AdvanceFilterCondition.tpl'|@\App\Layout::getTemplatePath:$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE CONDITION_INFO=$CONDITION_INFO MODULE=$MODULE CONDITION="or"}
			{/foreach}
			</div>
			<div class="hide basic">
				{include file='AdvanceFilterCondition.tpl'|@\App\Layout::getTemplatePath:$QUALIFIED_MODULE RECORD_STRUCTURE=$RECORD_STRUCTURE MODULE=$MODULE CONDITION_INFO=[] CONDITION="or" NOCHOSEN=true}
			</div>
			<div class="addCondition">
				<button type="button" class="btn btn-default pushDown"><strong>{\App\Language::translate('LBL_ADD_CONDITION',$MODULE)}</strong></button>
			</div>
