{strip}
	...
	<div class="detailViewBlockLinks">
		{foreach item=BLOCK_MODEL from=$VIEW_MODEL->getBlocks($TYPE_VIEW)}
			...
			<div class="js-toggle-panel c-panel detailViewBlockLink" data-js="click" data-url="{$BLOCK_MODEL->getUrl()}" data-reference="{$BLOCK_MODEL->getRelatedModuleName()}" data-count="{intval(App\Config::relation('SHOW_RECORDS_COUNT'))}">
