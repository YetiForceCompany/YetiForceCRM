	...
	<div class="listViewEntriesDiv u-overflow-scroll-non-desktop">
		...
		<div class="row m-0 mt-1 js-tiles-container h-100">
			{foreach item=LISTVIEW_ENTRY from=$LISTVIEW_ENTRIES name=listview}
				...
				<div class="col-md-{$TILE_COLUMN_SIZE} p-1 border-0 c-tile-container js-tile-container" data-recordUrl='{$LISTVIEW_ENTRY->getDetailViewUrl()}'>
					<div class="card js-tile-card justify-content-center">
						<div class="w-100 h-100 tile-body border border-light bg-light">
							...
							<div class="card-body js-card-body justify-content-center h-100">
								{foreach item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS name=listHeaderForeach}
									...
									{if $smarty.foreach.listHeaderForeach.first}
										<h5 class="card-title text-center c-tile-value {if in_array($FIELD_DATA_TYPE,['multiImage', 'image'])} tile-image {/if}"><span class=" listViewEntryValue noWrap text-muted" data-field-type="{$FIELD_DATA_TYPE}">
