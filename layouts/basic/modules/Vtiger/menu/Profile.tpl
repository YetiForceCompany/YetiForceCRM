{strip}
	...
	{if AppConfig::security('CHANGE_LOGIN_PASSWORD')}
		...
		<li class="menuLabel {if !$HASCHILDS}hasParentMenu{/if}" data-id="{$MENU['id']}" role="presentation" 
			...
			{/if}
			<ul class="slimScrollSubMenu nav subMenu {if $EXPAND}expand{/if}" role="menu"
