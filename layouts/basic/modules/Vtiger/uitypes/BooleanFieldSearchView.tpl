...
{strip}
    ...
    <select name="{$FIELD_MODEL->get('name')}" class="select2noactive select2 listSearchContributor" title="{\App\Language::translate($FIELD_MODEL->get('label'), $MODULE)}" data-fieldinfo='{$FIELD_INFO|escape}' {if $FIELD_MODEL->isEditableReadOnly()}readonly="readonly"{/if}>
