...
{strip}
	...
	<select name="{$FIELD_MODEL->get('name')}" class="select2noactive listSearchContributor form-control" title="{\App\Language::translate($FIELD_MODEL->get('label'), $MODULE)}" multiple data-fieldinfo='{$FIELD_INFO|escape}'>
