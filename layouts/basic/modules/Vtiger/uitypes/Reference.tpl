...
{strip}
	...
	<div class="input-group referenceGroup">
		...
		<span class="input-group-btn cursorPointer">
			<button class="btn btn-default clearReferenceSelection" type="button" {if $FIELD_MODEL->isEditableReadOnly()}disabled{/if}>
			...
			<button class="btn btn-default relatedPopup" type="button" {if $FIELD_MODEL->isEditableReadOnly()}disabled{/if}>
