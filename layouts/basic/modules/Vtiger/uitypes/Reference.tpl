...
{strip}
	...
	<div class="input-group referenceGroup">
		...
		<span class="input-group-btn cursorPointer">
			...
			{if (($VIEW eq 'Edit') or ($MODULE_NAME eq 'Webforms')) && $REFERENCE_MODULE_MODEL && $REFERENCE_MODULE_MODEL->isQuickCreateSupported() && Users_Privileges_Model::isPermitted($REFERENCE_LIST[0], 'CreateView')}
