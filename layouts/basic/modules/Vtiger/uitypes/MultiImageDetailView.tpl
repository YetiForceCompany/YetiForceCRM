...
{strip}
	...
	<div class="border rounded px-2 pt-2 clearfix c-multi-image js-multi-image">
		<div name="{$FIELD_MODEL->getFieldName()}"
			 id="{$MODULE_NAME}_detailView_fieldName_{$FIELD_MODEL->getFieldName()}"
			 data-value="{$FIELD_VALUE}"
			 data-fieldinfo='{$FIELD_INFO}'
			 class="js-multi-image__values"
			 data-js="value"></div>
		<div class="d-inline js-multi-image__result" data-js="container"
			 data-name="{$FIELD_MODEL->getFieldName()}"></div>
		<div class="js-multi-image__progress progress d-none my-2"
