...
{strip}
	...
	<div class="d-flex align-items-center js-multi-field">
		...
		<button type="button" class="btn btn-outline-success border mr-2 mb-2 h-100 js-add-item" data-js="click">
			<span class="fas fa-plus" title="{\App\Language::translate('LBL_ADD', $MODULE_NAME)}"></span>
		</button>
		<div class="form-inline w-100">
			{foreach item=VALUE from=$FIELD_VALUE}
				<div class="form-group mr-1 mb-2 js-multi-field-row w-100" data-js="container">
