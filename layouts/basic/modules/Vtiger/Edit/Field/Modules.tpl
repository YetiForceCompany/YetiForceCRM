...
{strip}
	...
	<div class="tpl-Edit-Field-Modules">
		<select class="select2 form-control" name="{$FIELD_MODEL->getFieldName()}"
				...
				data-selected-value='{$FIELD_VALUE}' {if $FIELD_MODEL->isEditableReadOnly()}readonly="readonly"{/if}{if $FIELD_MODEL->isEmptyPicklistOptionAllowed()}
			data-select="allowClear, true"{/if}>
