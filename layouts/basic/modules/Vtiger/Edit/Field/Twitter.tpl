...
{strip}
	<div class="tpl-Edit-Field-Twitter input-group">
		...
		<input name="{$FIELD_MODEL->getFieldName()}" value="{$FIELD_MODEL->getEditViewDisplayValue($FIELD_MODEL->get('fieldvalue'))}" id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->getName()}" class="form-control"
