...
{strip}
	...
	<div class="fileUploadContainer">
		<input type="text" class="form-control{if $FIELD_MODEL->isNameField()} nameField{/if} {if !$IS_EXTERNAL_LOCATION_TYPE}d-none{/if} js-type-text"
		...
		<input type="file" class="{if $FIELD_MODEL->isNameField()}nameField{/if} {if $IS_EXTERNAL_LOCATION_TYPE}d-none{/if} js-type-file"
