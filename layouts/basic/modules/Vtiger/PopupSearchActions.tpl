...
{strip}
	...
	{if $SWITCH && !empty($LISTVIEW_ENTRIES)}
		<div class="col-md-4 form-group float-left">
			...
			<div class="btn-group">
				&nbsp;<a href="#" class="popoverTooltip pull-right-xs pull-right-sm float-right" title="" data-placement="auto bottom" data-content="{\App\Language::translate('LBL_POPUP_NARROW_DOWN_RECORDS_LIST',$MODULE)}" data-original-title="{\App\Language::translate('LBL_POPUP_SWITCH_BUTTON',$MODULE)}"><span class="fas fa-info-circle"></span></a>
			</div>
		</div>
	{/if}
{/strip}
