...
{strip}
	...
	{if $SWITCH && !empty($LISTVIEW_ENTRIES)}
		<div class="col-md-4 form-group pull-left">
			...
			<div class="btn-group">
				&nbsp;<a href="#" class="popoverTooltip pull-right-xs pull-right-sm pull-right" title="" data-placement="auto bottom" data-content="{\App\Language::translate('LBL_POPUP_NARROW_DOWN_RECORDS_LIST',$MODULE)}" data-original-title="{\App\Language::translate('LBL_POPUP_SWITCH_BUTTON',$MODULE)}"><span class="glyphicon glyphicon-info-sign"></span></a>
			</div>
		</div>
	{/if}
{/strip}
