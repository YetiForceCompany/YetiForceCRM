...
{strip}
	...
	<div class="modal-body js-modal-body" data-js="container">
		...
		<div class="js-printed-by d-none d-print-block">
			{\App\Language::translate('LBL_PRINTED_BY', 'Other.RecordCollector')} {$USER_MODEL->getName()} {\App\Language::translate('LBL_IN_DAY', 'Other.RecordCollector')} {App\Fields\DateTime::formatToDisplay('now')}
		</div>
	</div>
	<!-- /tpl-Base-Modals-RecordCollector -->
{/strip}
