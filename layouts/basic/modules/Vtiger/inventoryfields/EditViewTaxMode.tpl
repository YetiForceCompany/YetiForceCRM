...
{strip}
	...
	<select class="select2 taxMode" title="{\App\Language::translate('LBL_TAX_MODE', $MODULE)}" name="inventory[{$ROW_NO}][{$FIELD->getColumnName()}]" {if $FIELD->get('displaytype') == 10}readonly="readonly"{/if}>
