...
{strip}
	<select class="select2 taxMode" title="{\App\Language::translate('LBL_DISCOUNT_MODE', $MODULE)}" name="{$FIELD->getColumnName()}" {if $FIELD->get('displaytype') == 10}readonly="readonly"{/if}>
