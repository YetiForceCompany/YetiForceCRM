...
{strip}
	...
	{if $REFERENCE_MODULE}
		<div class="rowName">
			...
			<div class="invUitype_{$MODULE_NAME}_{$FIELD_NAME} input-group input-group-sm u-min-w-300pxr">
				...
				<input name="{$FIELD_NAME}" type="hidden" value="{$VALUE|escape}"
				...
				<div class="input-group-append">
					...
					{if $REFERENCE_MODULE_MODEL->isQuickCreateSupported() && !$FIELD->isReadOnly()}
						<button class="btn btn-light u-cursor-pointer createReferenceRecord js-popover-tooltip" type="button"
							data-js="popover" data-content="{\App\Language::translate('LBL_CREATE', $MODULE_NAME)}">
