...
{strip}
	<select class="select2 discountMode" title="{\App\Language::translate('LBL_DISCOUNT_MODE', $MODULE)}" name="{$FIELD->getColumnName()}{$ROW_NO}" {if $FIELD->get('displaytype') == 10}readonly="readonly"{/if}>
