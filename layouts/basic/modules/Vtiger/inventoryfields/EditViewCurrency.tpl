...
<input name="currencyparam" type="hidden" value="{\App\Purifier::encodeHtml(\App\Json::encode($CURRENCY_PARAMS))}"
	   class="currencyparam"/>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				{else}
					...
					<div>{\App\Language::translate('Currency Name', $MODULE)}: <strong class="currencyName"></strong>
					</div>
