	...
	<div class="listViewPageDiv">
		<div class="listViewTopMenuDiv noprint mb-2">
			<div class="listViewActionsDiv row">
				...
				<div class="col-lg-7 col-md-12 col-sm-12 d-flex flex-wrap flex-md-nowrap flex-lg-nowrap justify-content-center justify-content-md-end justify-content-lg-end">
