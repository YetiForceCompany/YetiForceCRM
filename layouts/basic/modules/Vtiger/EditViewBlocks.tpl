	...
	<div class='verticalScroll'>
		<div class='editViewContainer'>
			<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
				...
				{if $BLOCKS_HIDE}
					<div class="js-toggle-panel card row  mx-1 mb-3" data-js="click" data-label="{$BLOCK_LABEL}">
						<div class="blockHeader u-cursor-pointer card-header">
							...
							{/if}
							<span class="u-cursor-pointer js-block-toggle fas fa-angle-right m-1 {if !($IS_HIDDEN)}d-none{/if}" data-js="click" data-mode="hide" data-id={$BLOCK_LIST[$BLOCK_LABEL]->get('id')}></span>
							<span class="u-cursor-pointer js-block-toggle fas fa-angle-down m-1 {if ($IS_HIDDEN)}d-none{/if}" data-js="click" data-mode="show" data-id={$BLOCK_LIST[$BLOCK_LABEL]->get('id')}></span>
							&nbsp;{\App\Language::translate($BLOCK_LABEL, $QUALIFIED_MODULE_NAME)}
						</div>
