					...
					<div class="contentHeader">
						...
						<span class="pull-right">
							{foreach item=LINK from=$EDITVIEW_LINKS['EDIT_VIEW_HEADER']}
								{include file='ButtonLink.tpl'|@\App\Layout::getTemplatePath:$MODULE BUTTON_VIEW='editViewHeader'}
								&nbsp;&nbsp;
							{/foreach}
						</span>
								...
								<div class="{if $FIELD_MODEL->get('uitype') neq "300"}col-md-6{/if} fieldRow">
									<div class="col-md-3 fieldLabel paddingLeft5px {$WIDTHTYPE}">
										...
										<label class="muted">
											...
											{/if}
											{\App\Language::translate($FIELD_MODEL->get('label'), $QUALIFIED_MODULE_NAME)}
										</label>
									</div>
