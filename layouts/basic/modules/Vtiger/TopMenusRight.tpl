{strip}
		...
		<ul class="settingIcons nav navbar-nav navbar-right">
			<li class="dropdown">
				<a data-toggle="dropdown" class="dropdown-toggle" href="#">
					<img src="{getImagePath('theme_brush.png')}" alt="theme roller" title="Theme Roller" />
				</a>
	...
	{if isset($CHAT_ENTRIES)}
		<ul class="headerLinksContainer headerLinksChat nav navbar-nav navbar-right">
			<li>
				<a class="ChatIcon" href="#" title="{\App\Language::translate('LBL_CHAT', $MODULE)}"><img src="{getImagePath('chat.png')}" alt="chat_icon"/></a>
			</li>
		</ul>
	{/if}
