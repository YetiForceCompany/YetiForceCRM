...
{strip}
	<div class="addReletedRecordBtn">
		{if $RELATED_MODULE eq 'Products' && Users_Privileges_Model::isPermitted('Assets')}
			<button class="btn btn-default showModal" type="button" data-url="index.php?module=Products&view=TreeCategoryModal&src_module={$SOURCE_MODULE}&src_record={$RECORDID}">
		...
		{if $RELATED_MODULE eq 'OutsourcedProducts' && Users_Privileges_Model::isPermitted('Assets')}
			<button class="btn btn-default showModal" type="button" data-module="OutsourcedProducts" data-url="index.php?module=OutsourcedProducts&view=TreeCategoryModal&src_module={$SOURCE_MODULE}&src_record={$RECORDID}">
				<span class="glyphicon glyphicon-zoom-in" title="{vtranslate('LBL_SELECT',$MODULE_NAME)}"></span>
			</button>
		{/if}
		{if $RELATED_MODULE eq 'Assets' && Users_Privileges_Model::isPermitted('Assets', 'CreateView')}
			<button class="btn btn-default" type="button" onclick="Vtiger_Header_Js.getInstance().quickCreateModule('Assets')">
		...
		{if $RELATED_MODULE eq 'Services' && Users_Privileges_Model::isPermitted('Assets')}
			<button class="btn btn-default showModal" type="button" data-url="index.php?module=Services&view=TreeCategoryModal&src_module={$SOURCE_MODULE}&src_record={$RECORDID}">
				<span class="glyphicon glyphicon-zoom-in" title="{vtranslate('LBL_SELECT',$MODULE_NAME)}"></span>
			</button>
		{/if}
		{if $RELATED_MODULE eq 'OSSOutsourcedServices' && Users_Privileges_Model::isPermitted('Assets')}
			<button class="btn btn-default showModal" type="button" data-module="OSSOutsourcedServices" data-url="index.php?module=OSSOutsourcedServices&view=TreeCategoryModal&src_module={$SOURCE_MODULE}&src_record={$RECORDID}">
				<span class="glyphicon glyphicon-zoom-in" title="{vtranslate('LBL_SELECT',$MODULE_NAME)}"></span>
			</button>
		{/if}
		{if $RELATED_MODULE eq 'OSSSoldServices' && Users_Privileges_Model::isPermitted('OSSSoldServices', 'CreateView')}
			<button class="btn btn-default" type="button" onclick="Vtiger_Header_Js.getInstance().quickCreateModule('OSSSoldServices')">
				<span class="glyphicon glyphicon-plus-sign" title="{vtranslate('LBL_ADD',$MODULE_NAME)}"></span>
			</button>
		{/if}
	</div>
