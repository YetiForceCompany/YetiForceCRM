						...
						<div class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-md-7">
									...
									<a href="#" class="HelpInfoPopover" title="" data-placement="top" data-content="{\App\Language::translate('Limit entries info', $QUALIFIED_MODULE)}" data-original-title="{\App\Language::translate('Limit entries', $QUALIFIED_MODULE)}"><i class="fa fa-info-circle"></i></a>
								</div>
							</div>
						</div>
					</div>
