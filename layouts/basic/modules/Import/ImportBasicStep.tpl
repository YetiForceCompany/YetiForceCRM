	...
	<div class='widget_header row '>
		...
		<div class="col-xs-12 searchUIBasic paddingLRZero" style='margin:0 !important'>
			...
			<div class="importContents col-xs-12">
					{include file='Import_Step1.tpl'|@\App\Layout::getTemplatePath:'Import'}
			</div>
			<div class="importContents col-xs-12">
				{include file='Import_Step2.tpl'|@\App\Layout::getTemplatePath:'Import'}
			</div>
            {if $DUPLICATE_HANDLING_NOT_SUPPORTED neq 'true'}
				<div class="importContents col-xs-12">
					{include file='Import_Step3.tpl'|@\App\Layout::getTemplatePath:'Import'}
				</div>
            {/if}
			<div class="col-xs-12 paddingBottom10">
				{include file='Import_Basic_Buttons.tpl'|@\App\Layout::getTemplatePath:'Import'}
			</div>
        </div>
    </form>
</div>
