...
{strip}
	...
	<button class="cancel btn btn-primary btn-sm mr-2 mb-sm-3 mb-md-0 js-show-modal" name="next" data-url="index.php?module={$MODULE}&forModule={$FOR_MODULE}&view=List&start=1&foruser={$OWNER_ID}">
