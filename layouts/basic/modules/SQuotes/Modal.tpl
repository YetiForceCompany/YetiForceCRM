...
{strip}
	...
	{assign var=OPENQUOTES value=Users_Privileges_Model::isPermitted($MODULE_NAME, 'OpenRecord', $ID)}
	{assign var=CLOSEQUOTES value=Users_Privileges_Model::isPermitted($MODULE_NAME, 'CloseRecord', $ID)}
