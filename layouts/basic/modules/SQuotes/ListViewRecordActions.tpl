...
-->*}
{strip}
	{assign var=OPENQUOTES value=Users_Privileges_Model::isPermitted($MODULE_NAME, 'OpenRecord', $RECORD_ID)}
	<div class="actions pull-right">
		<span class="actionImages">
			{if ($IS_MODULE_EDITABLE && $LISTVIEW_ENTRY->isEditable()) || $OPENQUOTES}
