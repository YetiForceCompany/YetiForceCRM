...
{strip}
	<div class="tpl-Settings-AutomaticAssignment-Tab row padding20">
		...
		{elseif $FIELD_NAME eq 'assign' || $FIELD_NAME eq 'roleid'}
			...
			<form id="formValue" class="col-sm-12 p-0">
				<div class="form-group">
					...
					<div class="col-12">
						&nbsp;<input name="{$FIELD_NAME}" id="defaultUser" class="switchBtn saveValue noField"
									 type="checkbox" {if $RECORD_MODEL->get($FIELD_NAME)}checked{/if} data-size="small"
									 data-label-width="5"
									 data-on-text="{\App\Language::translate('LBL_YES', $QUALIFIED_MODULE)}"
									 data-off-text="{\App\Language::translate('LBL_NO', $QUALIFIED_MODULE)}" value="1">
					</div>
				</div>
