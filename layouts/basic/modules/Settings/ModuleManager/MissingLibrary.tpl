{strip}
	...
	<div class="alert alert-danger" role="alert">
		...
		<div>
			<a href="index.php?module=ModuleManager&parent=Settings&action=Basic&mode=downloadLibrary" class="btn btn-primary">{vtranslate('BTN_DOWNLOAD_ALL', $QUALIFIED_MODULE)}</a>
		</div>
	</div>
{/strip}
