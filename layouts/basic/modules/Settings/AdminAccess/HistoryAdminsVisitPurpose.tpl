...
<!-- tpl-Settings-AdminAccess-HistoryAdminsVisitPurpose -->
	<form class="js-filter-form" data-js="container">
		<table id="dataTableHistoryAdminsVisitPurpose" class="table table-sm table-striped display text-center mt-2 js-data-table" data-url="index.php?module=AdminAccess&parent=Settings&action=GetData&mode=historyVisitPurpose">
			<thead>
				<tr>
