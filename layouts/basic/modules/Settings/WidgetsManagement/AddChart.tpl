			...
			<div class="modal-content">
				...
				<form class="form-horizontal validateForm sendByAjax" >
					...
					<div class="form-group margin0px padding1per">
						...
						<div class="col-sm-8 controls">
							<select class="select2 widgetFilter width90 form-control" title="{\App\Language::translate('LBL_SELECT_USER')}" name="reportId" style="margin-bottom:0;" data-validation-engine="validate[required]">
