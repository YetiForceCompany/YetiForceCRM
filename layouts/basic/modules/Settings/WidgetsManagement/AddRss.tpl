					...
					<div class="formContainer">
						<div class="form-group margin0px padding1per">
							...
							<div class="col-sm-8 controls">
								<input type="text" name="widgetTitle" class="form-control" data-validation-engine="validate[required]" />
							</div>
						</div>
						<div class="form-group margin0px padding1per">
							...
							<div class="col-sm-8 controls">	
								<div class="input-group">
									<input type="text" name="channelRss[]" class="form-control" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" data-validator='[ { "name":"Url" } ]'  />
						...
						<div class="form-group margin0px padding1per newChannel hide">
							...
							<div class="col-sm-8 controls">	
								<div class="input-group">
									<input type="text" disabled="disabled" name="channelRss[]" class="form-control" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" data-validator='[ { "name":"Url" } ]' />
									<span class="input-group-btn">
										<button class="removeChannel btn btn-default" type="button"><span class="glyphicon glyphicon-remove"></span></button>
									</span>
								</div>
