		...
		<form>
			<div class="form-group row">
				...
				<div class="col-sm-6 controls">
					<select class="authorized form-control validateForm mb-0 js-authorized select2" name="authorized" data-validation-engine="validate[required]">
				...
				<div class="col-sm-12 mt-3">
					<div class="row ml-5">
						...
						{foreach item=WIDGET_MODEL from=$WIDGETS_AUTHORIZATION name=fieldlist}
							<div class="col-sm-1"><input name="widgetLinkId" type="checkbox" value="{$WIDGET_MODEL->get('id')}"></div>
							<div class="col-sm-5">
