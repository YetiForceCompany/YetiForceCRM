					...
					<div class="card-body">
						<div class="form-group row">
							<div class="col-12 col-md-3">
								...
								<input type="text" name="name" class="form-control" value="{if !empty($RECORD->getName())}{\App\Purifier::encodeHtml($RECORD->getName())}{/if}" data-validation-engine="validate[required,maxSize[255]]">
							</div>
							<div class="col-12 col-md-3">
