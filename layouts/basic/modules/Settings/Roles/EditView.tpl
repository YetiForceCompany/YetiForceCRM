			...
			<div class="row mb-2">
				<div class="col-md-4">
					<label class="">
						...
						<strong>{\App\Language::translate('LBL_NAME', $QUALIFIED_MODULE)}:
						</strong>
					</label>
				</div>
				<div class=" col-md-7 ">
					<input type="text" class="fieldValue form-control" name="rolename" id="profilename" value="{\App\Purifier::encodeHtml($RECORD_MODEL->getName())}" data-validation-engine="validate[required]" />
				</div>
			</div>
			<div class="row mb-2">
