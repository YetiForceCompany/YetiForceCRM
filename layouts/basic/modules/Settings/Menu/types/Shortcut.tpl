...
<div class="form-group">
	<label class="col-md-4 control-label">{\App\Language::translate('LBL_URL', $QUALIFIED_MODULE)}:</label>
	<div class="col-md-7">
...
{include file='fields/Newwindow.tpl'|@\App\Layout::getTemplatePath:$QUALIFIED_MODULE}
