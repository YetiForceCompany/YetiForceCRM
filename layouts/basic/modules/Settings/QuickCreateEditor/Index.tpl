			...
			<div class="tab-content layoutContent paddingNoTop20 themeTableColor overflowVisible">
				<div class="tab-pane active" id="detailViewLayout">
					...
					<div class="moduleBlocks">
						<input value="{$DISPLAY_BLOCKS}" type="hidden" id="displayBlocksInQuickCreate"/>
						{if !$DISPLAY_BLOCKS}
							<div class="editFieldsTable block marginBottom10px border1px blockSortable" >
								<div class="row layoutBlockHeader no-margin">
									<div class="blockLabel col-md-5 marginLeftZero">
										{\App\Language::translate($SELECTED_MODULE_NAME, $SELECTED_MODULE_NAME)}
									</div>
								</div>
								<div class="blockFieldsList row no-margin" >
