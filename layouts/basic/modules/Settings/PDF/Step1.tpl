		...
		<form name="EditPdfTemplate" action="index.php" method="post" id="pdf_step1" class="form-horizontal">
			...
			<div class="row">
				<div class="col-xs-12 col-xl-6 col-xxl-4 mb-2">
					<div class="card">
						<div class="card-header">
							{\App\Language::translate('LBL_ENTER_BASIC_DETAILS',$QUALIFIED_MODULE)}
						</div>
						<div class="card-body">
				...
				<div class="col-xs-12 col-xl-6 col-xxl-4 mb-2 order-1 order-xl-2 order-xxl-1">
					<div class="card">
						<div class="card-header">
							{\App\Language::translate('LBL_DOCUMENT_SETTINGS_DETAILS',$QUALIFIED_MODULE)}
						</div>
						<div class="card-body">
							<div class="form-group row">
								<label class="col-sm-3 col-form-label">
							...
							<div class="form-group row margin_inputs {if $MARGIN_CHECKED eq 'true'}d-none{/if}">
								<label class="col-sm-3 col-form-label">{\App\Language::translate('LBL_MARGIN', $QUALIFIED_MODULE)}</label>
								<div class="col-sm-9">
				...
				<div class="col-xs-12 col-xl-6 col-xxl-4 mb-2  order-2 order-xl-1 order-xxl-2">
					<div class="card">
						<div class="card-header">
							{\App\Language::translate('LBL_PERMISSIONS_DETAILS',$QUALIFIED_MODULE)}
						</div>
						<div class="card-body">
							<div class="form-group row">
