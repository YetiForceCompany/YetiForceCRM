			...
			<div class="padding1per stepBorder">
				...
				<div class="form-group">
					...
					<div class="col-sm-6 row d-flex justify-content-center">
						<div class="col-sm-2 margin_inputs {if $MARGIN_CHECKED eq 'true'}d-none{/if}">
				...
				<div class="form-group margin_inputs {if $MARGIN_CHECKED eq 'true'}d-none{/if}">
					<div class="col-sm-6 row d-flex justify-content-center">
						<div class="col3">
							<label class="col-12 col-form-label">{\App\Language::translate('LBL_HEADER_HEIGHT', $QUALIFIED_MODULE)}</label>
						...
						<div class="col-3">
							<label class="col-12 col-form-label">{\App\Language::translate('LBL_FOOTER_HEIGHT', $QUALIFIED_MODULE)}</label>
