						...
						<tr data-module-name="{$MODULE_MODEL->get('name')}">
							...
							<td class="triggerCustomSharingAccess">
								<div class="row">
									...
									<div class="col-md-6">
										<button type="button" class="btn btn-xs btn-light vtButton arrowDown row" data-handlerfor="fields" data-togglehandler="{$TABID}-rules"><img src="{\App\Layout::getImagePath('Arrow-down.png')}" alt=""></img></button>
										<button type="button" class="btn btn-xs btn-light vtButton arrowUp row hide" data-handlerfor="fields" data-togglehandler="{$TABID}-rules"><img src="{\App\Layout::getImagePath('Arrow-up.png')}" alt=""></img></button>
									</div>
								</div>
							</td>
						</tr>
