						...
						{foreach key=FIELD_NAME item=FIELD_DATA from=$PROVIDER->getCustomFields()}
							<tr>
								...
								<td class="py-2 position-relative w-50 border-bottom">
									<div {if isset($FIELD_DATA['info'])}class="js-popover-tooltip" data-trigger="click" data-toggle="popover" data-placement="top" data-trigger="focus" data-content="{App\Language::translate($FIELD_DATA['info'], $QUALIFIED_MODULE)}"{/if}>
