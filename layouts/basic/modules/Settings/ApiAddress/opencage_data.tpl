...
{else}
	...
	<div class="col-2 ml-4 px-0">
		<a class="btn btn-primary" role="button" href="https://developer.opencagedata.com/" target="_blank" rel="noreferrer">{\App\Language::translate('OpenCage Geocoder', $MODULENAME)}</a>
		<button type="button" class="btn btn-success save" id="save">{\App\Language::translate('LBL_SAVE', $MODULENAME)}</button>
	</div>
{/if}