		...
		<div class="modal-content">
			...
			<div class="modal-header{if isset($MODAL_VIEW->headerClass)} {$MODAL_VIEW->headerClass}{/if}">
				...
				<span class="ml-5 u-fs-19px">
					...
					<span class="js-popover-tooltip ml-4" data-class="u-min-w-470px" data-placement="top" data-content="{\App\Purifier::encodeHtml(\App\Language::translate($VERIFY_SPF['desc'], $QUALIFIED_MODULE))}" data-js="popover">
					...
					<span class="js-popover-tooltip ml-4" data-class="u-min-w-470px" data-placement="top" data-content="{\App\Purifier::encodeHtml(\App\Language::translate($VERIFY_DKIM['desc'], $QUALIFIED_MODULE))}<hr />{\App\Purifier::encodeHtml($VERIFY_DKIM['logs'])}" data-js="popover">
					...
					<span class="js-popover-tooltip ml-4" data-class="u-min-w-470px" data-placement="top" data-content="{\App\Purifier::encodeHtml(\App\Language::translate($VERIFY_DMARC['desc'], $QUALIFIED_MODULE))}<hr />{\App\Purifier::encodeHtml($VERIFY_DMARC['logs'])}" data-js="popover">
