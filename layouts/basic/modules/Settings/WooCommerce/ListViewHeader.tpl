...
{strip}
	<!-- tpl-Settings-WooCommerce-ListViewHeader -->
	<div>
		<div class="o-breadcrumb widget_header row">
			...
			<div class="col-md-3 mt-1">
				<a href="index.php?parent=Settings&module=Log&view=LogsViewer&type=woocommerce" class="btn btn-info float-right">
					<span class="yfi yfi-system-monitoring mr-2"></span>{\App\Language::translate('LBL_LOGS_VIEWER', 'Settings:Log')}
				</a>
				<a href="https://yetiforce.com/en/knowledge-base/documentation/administrator-documentation/category/WooCommerce" target="_blank" class="btn btn-outline-info js-popover-tooltip float-right mr-3" data-content="{App\Language::translate('BTM_GOTO_YETIFORCE_DOCUMENTATION')}" rel="noreferrer noopener" data-js="popover">
		...
		{else}
			...
			{/if}
			{if !Settings_WooCommerce_Module_Model::isActive()}
				<div class="alert alert-danger">
					<form action='index.php' method="POST" enctype="multipart/form-data">
						<input type="hidden" name="module" value="WooCommerce" />
