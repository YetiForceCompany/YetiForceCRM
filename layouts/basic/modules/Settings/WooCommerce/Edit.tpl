...
{strip}
	...
	<div class="editViewContainer">
		<div class="alert alert-warning">
			<span class="mdi mdi-information-outline mr-2 u-fs-xlg float-left"></span>
			{\App\Language::translate('LBL_WOOCOMMERCE_ALERT', $QUALIFIED_MODULE)}<br>
		</div>
				...
				<thead>
					<tr class="blockHeader">
						<th colspan="2" class="mediumWidthType">
							<span class="fa-solid fa-cash-register mr-2"></span>
							{\App\Language::translate('LBL_WOOCOMMERCE_SETTINGS', $QUALIFIED_MODULE)}
						</th>
					</tr>
				</thead>
				<tbody>
	...
	<!-- /tpl-Settings-WooCommerce-Index -->
{/strip}
