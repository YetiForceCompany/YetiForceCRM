...
{strip} {assign var=SPAN_COUNT value=1}
	<div  class="row">
		{foreach item=SETTING_SHORTCUT from=$SETTINGS_SHORTCUT name=shortcuts}
			<div class="col-md-3 mr-3 mb-3 contentsBackground well cursorPointer moduleBlock" id="shortcut_{$SETTING_SHORTCUT->getId()}" data-actionurl="{$SETTING_SHORTCUT->getPinUnpinActionUrl()}" data-url="{$SETTING_SHORTCUT->getUrl()}">
