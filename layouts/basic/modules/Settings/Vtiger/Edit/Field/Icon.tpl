...
{strip}
	...
	<div class="js-icon-container">
		<input name="{$FIELD_MODEL->getFieldName()}" type="hidden" value="{$VALUE}" class="js-source-field" data-fieldinfo='{$FIELD_INFO}' />
		<div class="input-group {$WIDTHTYPE_GROUP} ">
			<div class="input-group-prepend">
				<label class="input-group-text js-icon-show p-1 pl-2 pr-2 u-fs-xlg" style=""><span class="{$FIELD_VALUE}"></span></label>
			</div>
