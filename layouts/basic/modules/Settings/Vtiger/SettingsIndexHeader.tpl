{strip}
	...
	<div class="row no-margin">
		<ul class="nav nav-tabs massEditTabs">
			...
			<li class="nav-item" data-mode="index" data-params="{\App\Purifier::encodeHtml(\App\Json::encode(['count'=>$WARNINGS_COUNT]))}"><a class="active nav-link" data-toggle="tab"><strong>{\App\Language::translate('LBL_START', $QUALIFIED_MODULE)}</strong></a></li>
