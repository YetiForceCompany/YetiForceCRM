...
{strip}
	<div class="tpl-Settings-Base-DashBoard-SettingsShortCutsContainer px-3 pb-4 pt-0 u-columns-width-200px-rem u-columns-count-5"  id="settingsShortCutsContainer">
