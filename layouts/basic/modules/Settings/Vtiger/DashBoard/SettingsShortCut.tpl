...
-->*}
{strip}
	<a class="tpl-Settings-Base-DashBoard-SettingsShortCut dashboardWidget text-white bg-navy u-hover-opacity u-cursor-pointer moduleBlock px-1 py-2 mb-n1 mt-3 mr-3 flex-grow-1 u-w-max-320px"
