...
-->*}
{strip}
	<div class="col-md-3 mr-3 mb-3 contentsBackground well u-cursor-pointer moduleBlock" id="shortcut_{$SETTINGS_SHORTCUT->getId()}" data-actionurl="{$SETTINGS_SHORTCUT->getPinUnpinActionUrl()}" data-url="{$SETTINGS_SHORTCUT->getUrl()}">
