...
-->*}
{strip}
	<input type="hidden" value="{$PAGING_MODEL->getRecordStartRange()}" id="pageStartRange"/>
	<input type="hidden" value="{$PAGING_MODEL->getRecordEndRange()}" id="pageEndRange"/>
	<input type="hidden" value="{$PAGING_MODEL->isPrevPageExists()}" id="previousPageExist"/>
	<input type="hidden" value="{$PAGING_MODEL->isNextPageExists()}" id="nextPageExist"/>
	<input type="hidden" value="{if (isset($LISTVIEW_COUNT))}{$LISTVIEW_COUNT}{/if}" id="totalCount"/>
			...
			{foreach item=LISTVIEW_ENTRY from=$LISTVIEW_ENTRIES}
				...
				>
					...
					{foreach item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS}
						...
						{assign var=VALUE value=$LISTVIEW_ENTRY->getDisplayValue($LISTVIEW_HEADERNAME)}
