			...
			<form name="addItemForm" class="form-horizontal" method="post" action="index.php">
				...
				<div class="modal-body tabbable">
					...
					{if $SELECTED_PICKLIST_FIELDMODEL->isRoleBased()}
						<div class="form-group">	
							<div class="col-md-3 control-label">{\App\Language::translate('LBL_ASSIGN_TO_ROLE',$QUALIFIED_MODULE)}</div>
				...
				{include file='ModalFooter.tpl'|@\App\Layout::getTemplatePath:$qualifiedName}
			</form>
		</div>
	</div>
</div>
