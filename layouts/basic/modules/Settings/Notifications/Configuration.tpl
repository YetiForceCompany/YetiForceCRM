						...
						<thead>
							<tr>
								<th>
									...
									<button class="btn btn-xs btn-success float-right addUser" type="button" data-editurl=""><span class="fas fa-plus"></span> {\App\Language::translate('LBL_ADD',$QUALIFIED_MODULE)}</button>
								</th>
							</tr>
						</thead>
