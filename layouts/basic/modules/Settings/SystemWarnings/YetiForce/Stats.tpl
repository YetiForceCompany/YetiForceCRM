{strip}
	...
	<form class="tpl-Settings-SystemWarnings-YetiForce-Stats form-horizontal row validateForm" method="post" action="index.php">
		...
		<div class="input-group">
			...
			<input type="text" name="company_name" class="form-control" data-validation-engine="validate[required,funcCall[Vtiger_YetiForceCompanyName_Validator_Js.invokeValidation]]" placeholder="{App\Language::translate('LBL_NAME','Settings:Companies')}" value="{$COMPANY->get('name')}">
		</div><br />
