			...
			<tr>
				<td colspan="5">
					<div class="">
						...
						<div class="col-md-9">
							<select id="fieldsList" multiple="multiple" name="fieldsList" data-placeholder="{vtranslate('LBL_SELECT_FIELDS_OF_TARGET_MODULE', $QUALIFIED_MODULE)}" class="row form-control selectizeElement">
