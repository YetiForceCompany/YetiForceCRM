			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row mb-3">
						...
						<div class="col-12 form-group row">
							<label class="col-6">{\App\Language::translate('LBL_WORKING_HOURS_FROM', $QUALIFIED_MODULE)}</label>
						...
						<div class="col-12 form-group row">
							<label class="col-6">{\App\Language::translate('LBL_WORKING_HOURS_TO', $QUALIFIED_MODULE)}</label>
							<div class="input-group time col-6">
								<input id="hours_from" type="text" data-format="{$USER_MODEL->get('hour_format')}"
