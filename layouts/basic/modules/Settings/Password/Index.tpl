					...
					<tbody>
						...
						<tr>
							...
							<td style="border-left: none;">
								...
								<div class="col-xs-7">
									<p class="form-control-static"><span class="fas fa-info-circle popoverTooltip" data-content="{\App\Language::translate('LBL_PASSWORD_CHANGE_TIME_DESC', $QUALIFIED_MODULE)}" data-placement="auto top"></span></p>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td style="border-left: none;">
								...
								<div class="col-xs-7">
									<p class="form-control-static"><span class="fas fa-info-circle popoverTooltip" data-content="{\App\Language::translate('LBL_TIME_TO_CHANGE_PASSWORD_DESC', $QUALIFIED_MODULE)}" data-placement="auto top"></span></p>
								</div>
							</td>
						</tr>
					</tbody>
