...
{strip}
	<!-- tpl-Settings-ConfigEditor-Performance -->
	<div class="verticalScroll">
		<form class="js-form-ajax-submit js-validate-form">
			...
			<input name="type" type="hidden" value="Performance" />
			{assign var="CONFIG_MODEL" value=Settings_ConfigEditor_Module_Model::getInstance()->init('Performance')}
			<div class="p-2">
				{foreach from=$CONFIG_MODEL->performanceFields item=FIELD_LABEL key=FIELD_NAME}
