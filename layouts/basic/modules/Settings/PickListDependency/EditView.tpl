		...
		<div class="contents">
			<form id="pickListDependencyForm" class="form-horizontal" method="POST">
				...
				<div class="form-row mb-3">
					<div class="col-md-12 form-row">
						<div class="col-md-6 form-row">
							<label class="col-md-4 muted u-text-small-bold col-form-label d-flex justify-content-sm-end">{\App\Language::translate('LBL_SELECT_MODULE', $QUALIFIED_MODULE)}</label>
				...
				<div class="form-row">
					<div class="col-md-12 form-row">
						<div class="col-md-6 form-row">
							<label class="col-md-4 muted u-text-small-bold col-form-label d-flex justify-content-sm-end">{\App\Language::translate('LBL_SOURCE_FIELD', $QUALIFIED_MODULE)}</label>
							<div class="col-md-8 controls">
						...
						<div class="col-md-6 form-row">
							<label class="col-md-4 muted u-text-small-bold col-form-label d-flex justify-content-sm-end">{\App\Language::translate('LBL_TARGET_FIELD', $QUALIFIED_MODULE)}</label>
							<div class="col-md-8 controls">
