			...
			<div class="form-row align-items-center my-2">
				<div class="col-md-4 btn-toolbar">
					{foreach item=LISTVIEW_BASICACTION from=$LISTVIEW_LINKS['LISTVIEWBASIC']}
						<button class="btn addButton btn-success" {if stripos($LISTVIEW_BASICACTION->getUrl(), 'javascript:')===0} onclick='{substr($LISTVIEW_BASICACTION->getUrl(), strlen("javascript:"))};'
