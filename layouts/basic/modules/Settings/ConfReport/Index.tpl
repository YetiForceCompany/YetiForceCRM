							...
							{foreach from=Settings_ConfReport_Module_Model::getLibrary() key=key item=item}
								<tr {if $item.status == 'LBL_NO'}class="danger"{/if}>
									<td>
										...
										{if isset($item.help) && $item.status}<a href="#" class="popoverTooltip float-right" data-trigger="focus" data-placement="rigth" data-content="{App\Language::translate($item.help, $MODULE)}"><i class="fa fa-info-circle"></i></a>{/if}
									</td>
						...
						<tbody>
							{foreach from=Settings_ConfReport_Module_Model::getSecurityConf() key=key item=item}
								<tr {if $item.status}class="danger"{/if}>
									<td>
										<label>{$key}</label>
										{if isset($item.help) && $item.status}<a href="#" class="popoverTooltip float-right" data-trigger="focus" data-placement="rigth" data-content="{\App\Language::translateEncodeHtml($item.help, $MODULE)}"><i class="fa fa-info-circle"></i></a>{/if}
									</td>
						...
						<tbody>
							{foreach from=Settings_ConfReport_Module_Model::getStabilityConf(false,false,true) key=key item=item}
								<tr {if $item['incorrect']}class="danger"{/if}>
									<td>
										<label>{$key}</label>
										{if isset($item['help']) && $item['incorrect']}<a href="#" class="popoverTooltip float-right" data-trigger="focus" data-placement="rigth" data-content="{\App\Language::translateEncodeHtml($item['help'], $MODULE)}"><i class="fa fa-info-circle"></i></a>{/if}
									</td>
