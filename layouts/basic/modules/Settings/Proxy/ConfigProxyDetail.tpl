...
{strip}
	...
	<div class="tpl-Settings-Vtiger-ConfigEditorDetail" id="ConfigProxyDetails">
			...
			<table class="table tableRWD table-bordered table-sm themeTableColor">
				...
				<tr class="blockHeader">
					<th colspan="2" class="{$WIDTHTYPE}">
						<span class="alignMiddle">{\App\Language::translate('LBL_PROXY_CONFIG', $QUALIFIED_MODULE)}</span>
					</th>
				</tr>
				</thead>
				<tbody>
