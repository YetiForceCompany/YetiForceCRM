			...
			<div class="col-sm-18 col-md-12">
				<div class="row">
					<div class="col-sm-4 col-md-3">
						{if $IMAGE}
							<img src="{$IMAGE|escape}" class="grow thumbnail-image card-img-top intrinsic-item" alt="{App\Purifier::encodeHtml($PRODUCT->getLabel())}" title="{App\Purifier::encodeHtml($PRODUCT->getLabel())}" />
						{else}
						...
						{if $PRICE !== false }
							<div class="text-danger h1 mb-3 mt-2 text-center">
								{$PRICE} {$CURRENCY} / {$PRODUCT->getPaymentFrequencyShort()}
							</div>
						{/if}
					</div>
