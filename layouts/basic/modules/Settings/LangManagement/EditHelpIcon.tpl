					...
					<tr data-langkey="{$lang_key}">
						{foreach from=$langs item=item key=key}
							...
							{else}
								...
								<a href="#" class="HelpInfoPopover pull-left padding10" title="" data-placement="left" data-content="{htmlspecialchars(App\Purifier::decodeHtml($item))}" data-original-title='{$langs.label}'><i class="fas fa-info-circle"></i></a>
								</div>
