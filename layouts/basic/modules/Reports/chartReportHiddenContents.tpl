			...
			<optgroup label='{\App\Language::translate($PRIMARY_MODULE_NAME,$MODULE)}-{\App\Language::translate($BLOCK_LABEL,$PRIMARY_MODULE_NAME)}'>
				{foreach key=FIELD_KEY item=FIELD_LABEL from=$BLOCK}
					...
					{if $FIELD_INFO[4] eq 'D' or $FIELD_INFO[4] eq 'DT'}
						<option value="{$FIELD_KEY}:Y">{\App\Language::translate($FIELD_LABEL, $PRIMARY_MODULE_NAME)} ({\App\Language::translate('LBL_YEAR', $PRIMARY_MODULE_NAME)})</option>
						<option value="{$FIELD_KEY}:MY">{\App\Language::translate($FIELD_LABEL, $PRIMARY_MODULE_NAME)} ({\App\Language::translate('LBL_MONTH', $PRIMARY_MODULE_NAME)})</option>
						<option value="{$FIELD_KEY}">{\App\Language::translate($FIELD_LABEL, $PRIMARY_MODULE_NAME)}</option>
		...
		{foreach key=BLOCK_LABEL item=BLOCK from=$SECONDARY_MODULE}
			<optgroup label='{\App\Language::translate($SECONDARY_MODULE_NAME,$MODULE)}-{\App\Language::translate($BLOCK_LABEL,$SECONDARY_MODULE_NAME)}'>
				{foreach key=FIELD_KEY item=FIELD_LABEL from=$BLOCK}
					{assign var=FIELD_INFO value=explode(':', $FIELD_KEY)}
					{if $FIELD_INFO[4] eq 'D' or $FIELD_INFO[4] eq 'DT'}
						<option value="{$FIELD_KEY}:Y">{\App\Language::translate($SECONDARY_MODULE_NAME, $SECONDARY_MODULE_NAME)} {\App\Language::translate($FIELD_LABEL, $SECONDARY_MODULE_NAME)} ({\App\Language::translate('LBL_YEAR', $SECONDARY_MODULE_NAME)})</option>
						<option value="{$FIELD_KEY}:MY">{\App\Language::translate($SECONDARY_MODULE_NAME, $SECONDARY_MODULE_NAME)} {\App\Language::translate($FIELD_LABEL, $SECONDARY_MODULE_NAME)} ({\App\Language::translate('LBL_MONTH', $SECONDARY_MODULE_NAME)})</option>
						<option value="{$FIELD_KEY}">{\App\Language::translate($SECONDARY_MODULE_NAME, $SECONDARY_MODULE_NAME)} {\App\Language::translate($FIELD_LABEL, $SECONDARY_MODULE_NAME)}</option>
					{else if $FIELD_INFO[4] neq 'I' and $FIELD_INFO[4] neq 'N' and $FIELD_INFO[4] neq 'NN'}
						<option value="{$FIELD_KEY}">{\App\Language::translate($SECONDARY_MODULE_NAME, $SECONDARY_MODULE_NAME)} {\App\Language::translate($FIELD_LABEL, $SECONDARY_MODULE_NAME)}</option>
					{/if}
				{/foreach}
