	...
	<div class="js-toggle-panel c-panel__content row mx-1" data-js="click" data-label="{$BLOCK_LABEL}">
		<div class="blockHeader card-header bg-light">
			<div class="col-md-8 form-row">
				<span class="u-cursor-pointer blockToggle fas fa-angle-right {if !($IS_HIDDEN)}d-none{/if}" data-mode="hide"></span>
				<span class="u-cursor-pointer blockToggle fas fa-angle-down {if ($IS_HIDDEN)}d-none{/if}" data-mode="show"></span>
