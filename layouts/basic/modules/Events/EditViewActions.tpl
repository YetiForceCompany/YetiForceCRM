...
{strip}
	<div class="formActionsPanel">
		<button class="btn btn-primary saveAndComplete" type="button">
			<span class="fas fa-check mr-0 mr-sm-2"></span>
			<strong class="d-none d-sm-inline-block">{\App\Language::translate('LBL_SAVE_AND_CLOSE', $MODULE)}</strong>
		</button> 
		...
		<button class="btn btn-danger" type="reset" onclick="javascript:window.history.back();">
			<span class="fas fa-times mr-0 mr-sm-2"></span>
			<strong class="d-none d-sm-inline-block">{\App\Language::translate('LBL_CANCEL', $MODULE)}</strong></button>
