			...
			{if $OPENSINGLEORDERS || ($EDITVIEW_PERMITTED && !$LOCKEDIT)}
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						{foreach  item=ITEM from=Vtiger_Util_Helper::getPickListValues('ssingleorders_status')}
							{if in_array($ITEM, $RESTRICTS_ITEM) || $ITEM eq $RECORD->get('ssingleorders_status')} {continue} {/if}
