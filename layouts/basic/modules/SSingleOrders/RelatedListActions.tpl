...
{strip}
	...
	{assign var=OPENSINGLEORDERS value=Users_Privileges_Model::isPermitted($RELATED_MODULE_NAME, 'OpenSingleOrders', $RELATED_RECORD->getId())}
	<div class="pull-right actions">
		<span class="actionImages">
			{if ($IS_EDITABLE && $LOCKEDIT eq false) || $OPENSINGLEORDERS}
