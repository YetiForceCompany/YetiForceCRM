{if $DATA['show_chart']}
	{literal}
		<script type="text/javascript">
			$(document).ready(()=> {
				//YetiForce_Bar_Widget_Js('YetiForce_ProjectTimeControl_Widget_Js', {}, {});
				/*const widget = new YetiForce_ProjectTimeControl_Widget_Js($('.widgetChartContainer').get(0));
				widget.generateData();
				widget.postLoadWidget();*/
			...
			var instance = new YetiForce_ProjectTimeControl_Widget_Js();
	...
	<div class="container">
		...
		<div class="widgetChartContainer chartcontent c-time-employees"><canvas></canvas></div>
	</div>
{else}
