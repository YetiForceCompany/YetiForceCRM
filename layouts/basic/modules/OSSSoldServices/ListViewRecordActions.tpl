...
{strip}
	<div class="actions pull-right">
		<span class="actionImages">
			...
			{/if}
			{if ($LISTVIEW_ENTRY->rawData['ssservicesstatus'] eq 'PLL_ACCEPTED') && (($IS_MODULE_EDITABLE && $LISTVIEW_ENTRY->isEditable() && $LISTVIEW_ENTRY->editFieldByModalPermission()) || $LISTVIEW_ENTRY->editFieldByModalPermission(true))}
				<a class="showModal" data-url="{$LISTVIEW_ENTRY->getEditFieldByModalUrl()|cat:'&changeEditFieldByModal=osssoldservices_renew'}">
