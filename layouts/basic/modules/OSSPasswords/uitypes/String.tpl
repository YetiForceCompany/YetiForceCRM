...
<button class="btn btn-success btn-xs hide" data-clipboard-target="{$MODULE}_editView_fieldName_{$FIELD_NAME}" id="copy-button" title="{vtranslate('LBL_CopyToClipboardTitle', $MODULE)}"><span class="glyphicon glyphicon-download-alt"></span></button>
{/if}
<p>
