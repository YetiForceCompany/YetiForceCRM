						...
						<div class="detailViewButtoncontainer">
							<div class="btn-toolbar btn-group">
								{if isset($DETAILVIEW_LINKS['DETAIL_VIEW_ADDITIONAL'])}
									{include file=\App\Layout::getTemplatePath('ButtonLinks.tpl', $MODULE) LINKS=$DETAILVIEW_LINKS['DETAIL_VIEW_ADDITIONAL'] BUTTON_VIEW='detailViewBasic' CLASS='c-btn-link--responsive'}
								{/if}
