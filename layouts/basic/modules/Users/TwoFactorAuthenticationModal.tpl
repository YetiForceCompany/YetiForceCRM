...
{strip}
	<div class="modal-header tpl-TwoFactorAuthenticationModal">
		<h5 class="modal-title">
			<span class="fas fa-key mr-1"></span>
			{\App\Language::translate('LBL_TWO_FACTOR_AUTHENTICATION', $MODULE_NAME)}
		</h5>
		{if !$LOCK_EXIT}
	...
	<form name="PasswordUsersForm" class="form-horizontal validateForm" action="index.php" method="post" autocomplete="off">
		...
		<div class="modal-body">
			<div class="alert alert-info alert-dismissible hide js-wrong-code" role="alert" data-js="class: .js-wrong-code">
