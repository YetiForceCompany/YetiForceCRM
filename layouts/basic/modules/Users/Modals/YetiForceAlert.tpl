...
{strip}
	...
	<div class="modal-body pb-3">
		...
		{if \App\Security\AdminAccess::isPermitted('YetiForce')}
			<a href="index.php?module=YetiForce&parent=Settings&view=Shop" target="_blank"
		...
		<div class="mt-3">
			<div class="progress">
				<div class="progress-bar progress-bar-striped progress-bar-animated js-progress-bar" role="progressbar"
					aria-valuemin="0" aria-valuemax="100" style="width: 100%;" data-js="container">
