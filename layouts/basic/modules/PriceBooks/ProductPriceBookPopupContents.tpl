...
{strip}
	...
	<div class="clearfix form-actions pushDown">
		...
		<button class="btn btn-success addButton select pull-right"><i class="fa fa-plus"></i>&nbsp;<strong>{\App\Language::translate('LBL_ADD_TO',$MODULE_NAME)}&nbsp;{\App\Language::translate($SOURCE_MODULE, $SOURCE_MODULE)}</strong></button>
	</div>
{/strip}
