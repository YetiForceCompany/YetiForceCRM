		...
		<div class="col-md-4">
			<div class="box float-right">
				...
				<a class="btn btn-sm btn-light" role="button" href="javascript:void(0);" name="drefresh" data-url="{$WIDGET->getUrl()}&linkid={$WIDGET->get('linkid')}&content=data">
					<span class="fas fa-sync-alt border-0" hspace="2" border="0" align="absmiddle=" title="{\App\Language::translate('LBL_REFRESH')}"></span>
				...
				{if !$WIDGET->isDefault()}
					<a class="btn btn-sm btn-light" role="button" name="dclose" class="widget" data-url="{$WIDGET->getDeleteUrl()}">
						<span class="fas fa-times border-0" hspace="2" align="absmiddle" title="{\App\Language::translate('LBL_CLOSE')}"></span>
