...
-->*}
{strip}
	{assign var=OPENRECURRINGORDERS value=Users_Privileges_Model::isPermitted($MODULE_NAME, 'OpenRecord', $RECORD_ID)}
	<div class="actions pull-right">
		<span class="actionImages">
			{if ($IS_MODULE_EDITABLE && $LISTVIEW_ENTRY->isEditable()) || $OPENRECURRINGORDERS}
				<a class="showModal" data-url="{$LISTVIEW_ENTRY->getModalUrl()}">
