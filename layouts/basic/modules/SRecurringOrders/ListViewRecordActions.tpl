...
-->*}
{strip}
	{assign var=OPENRECURRINGORDERS value=Users_Privileges_Model::isPermitted($MODULE_NAME, 'OpenRecurringOrders', $RECORD_ID)}
	<div class="actions pull-right">
		<span class="actionImages">
			{if ($IS_MODULE_EDITABLE && $LISTVIEW_ENTRY->lockEditView eq false) || $OPENRECURRINGORDERS}
