 ...
 */
jQuery.Class("SRequirementsCards_Modal_Js", {}, {
	registerChangeStatus: function () {
		var thisInstance = this;
		jQuery('#sRequirementsCardsModal .changeStatus').on('click', function (e) {
		...
		AppConnector.request(params).then(
				function (data) {
					if (data.success) {
						...
						if (viewName === 'Detail') {
							if (app.getModuleName() == 'SRequirementsCards') {
	...
	registerHelpInfo: function () {
		var form = jQuery('#sRequirementsCardsModal');
	...
	registerEvents: function () {
		...
		jQuery('#sRequirementsCardsModal .convert').each(function () {
...
jQuery(document).ready(function (e) {
	var instance = new SRequirementsCards_Modal_Js();
