...
{strip}
	<div class="tpl-Calendar-Extended-CalendarViewPostProcess js-calendar-right-panel {if $USER_MODEL->get('leftpanelhide')}leftPanelOpen {/if}siteBarRight calendarRightPanel col-xs-12 hideSiteBar"
		...
		<div class="o-calendar__panel__tabs">
			...
			<ul class="nav nav-pills js-show-sitebar d-none" id="rightPanelTab" role="tablist" data-js="click">
				<li class="nav-item">
					<a class="nav-link active show border-0" id="rightPanelFilter-tab" data-toggle="tab" href="#rightPanelFilter" role="tab"
					   aria-controls="filter" aria-selected="false">
					   </a>
				</li>
			</ul>
		</div>
		<div class="tab-content" id="rightPanelTabContent">
			<div class="tab-pane fade active show " id="rightPanelFilter" role="tabpanel" aria-labelledby="rightPanelFilter-tab">
