	...
	{if count($DATA) gt 0 }
		<div style="padding:5px;">
			...
			{foreach item=ROW from=$DATA}
				<div class="row">
					<div class="col-md-4"><a class="modCT_{$RELATED_MODULE}" href="index.php?module={$RELATED_MODULE}&view=Detail&record={$ROW['id']}">{\App\Purifier::encodeHtml($ROW['assetname'])}</a></div>
