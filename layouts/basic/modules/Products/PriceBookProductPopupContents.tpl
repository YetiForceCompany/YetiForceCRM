...
{strip}
	...
	{if $LISTVIEW_ENTRIES_COUNT neq '0'}
		<div class="clearfix form-actions">
			...
			<button class="btn btn-success addButton select pull-right"><i class="fas fa-plus"></i>&nbsp;<strong>{\App\Language::translate('LBL_ADD_TO_PRICEBOOKS',$MODULE)}</strong></button>
		</div>
	{/if}
