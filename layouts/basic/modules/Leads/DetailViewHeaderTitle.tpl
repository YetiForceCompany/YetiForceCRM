	...
	<div class="d-flex flex-wrap flex-md-nowrap px-3 w-100">
		...
		<div class="u-min-w-md-70 w-100">
			...
			<div class="pl-1">
				...
				<div class="js-popover-tooltip--ellipsis d-flex flex-nowrap align-items-center" data-content="{$RECORD->getDisplayValue('company')}" data-toggle="popover" data-js="popover | mouseenter">
