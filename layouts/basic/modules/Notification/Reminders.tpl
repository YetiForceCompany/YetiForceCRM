...
{strip}
	...
	<div class="remindersContent pb-5">
						...
						<div>
							...
							<div class="moreContent font-weight-light font-italic">
								...
								{if $SHOW_BUTTON}
									...
									<div class="text-right mb-1"><button type="button" class="btn btn-info btn-sm moreBtn" data-on="{\App\Language::translate('LBL_MORE_BTN')}" data-off="{\App\Language::translate('LBL_HIDE_BTN')}">{\App\Language::translate('LBL_MORE_BTN')}</button>
								</div>
								{/if}
							</div>
						</div>
		...
		<div class="tpl-remiders-bottom-buttons btn-group btn-toolbar mr-md-2 flex-md-nowrap">
			...
			<button type="button" class="btn btn-light js-popover-tooltip showModal" data-js="popover" data-placement="top" data-content="{\App\Language::translate('LBL_NOTIFICATION_SETTINGS',$MODULE_NAME)}" data-target="focus hover" data-url="index.php?module=Notification&amp;view=NotificationConfig">
