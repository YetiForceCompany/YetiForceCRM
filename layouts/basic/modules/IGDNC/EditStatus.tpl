	...
	<div class="pull-left">
		<div class="btn-toolbar">
			{if $OPEN_RECORD || $RECORD->isViewable()}
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						{foreach  item=ITEM from=Vtiger_Util_Helper::getPickListValues('igdnc_status')}
							{if in_array($ITEM, $RESTRICTS_ITEM) || $ITEM eq $RECORD->get('igdnc_status')} {continue} {/if}
			...
			{foreach from=$RESTRICTS_ITEM item=ITEM}
				{if $RECORD->get('igdnc_status') neq $ITEM}
					<div class="btn-group">
