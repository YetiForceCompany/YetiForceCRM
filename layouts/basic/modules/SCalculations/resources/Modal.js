 ...
 */
jQuery.Class("SCalculations_Modal_Js", {}, {
	registerChangeStatus: function () {
		var thisInstance = this;
		jQuery('#sCalculationsModal .changeStatus').on('click', function (e) {
		...
		AppConnector.request(params).then(
				function (data) {
					if (data.success) {
						...
						if (viewName === 'Detail') {
							if (app.getModuleName() == 'SCalculations') {
	...
	registerHelpInfo: function () {
		var form = jQuery('#sCalculationsModal');
	...
	registerEvents: function () {
		...
		jQuery('#sCalculationsModal .convert').each(function () {
...
jQuery(document).ready(function (e) {
	var instance = new SCalculations_Modal_Js();
