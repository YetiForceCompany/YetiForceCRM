...
class Fields extends \Api\RestApi\BaseModule\Fields
{
	 ...
	 *				),
	 *			),
	 *			@OA\Property(property="blocks", type="object", title="List of all available blocks in the module",
	 ...
	 *				),
	 *			),
	 *			@OA\Property(property="inventory", type="object", title="Inventory field group, available depending on the type of module",
