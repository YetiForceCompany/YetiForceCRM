...
class RelatedModules extends \Api\Core\BaseAction
{
	 ...
	 *				@OA\AdditionalProperties(type="object",
	 * 					@OA\Property(property="relationId", type="integer", title="Relation ID", example=3),
	 * 					@OA\Property(property="relatedModuleName", type="string", title="Related module name", example="Documents"),
	 * 					@OA\Property(property="icon", type="string", title="Icon class", example="far fa-address-card"),
	 * 					@OA\Property(property="label", type="string", title="Translated label", example="Documents"),
	 * 				),
	 *			),
	 * 		),
	 *	),
