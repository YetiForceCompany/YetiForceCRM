<?php
/**
 * RestApi container for custom view - file.
 *
 * @package API
 *
...
/**
 * RestApi container for custom view - class.
 */
class CustomView extends \Api\Core\BaseAction
{
	 ...
	 *
	 *	@OA\Get(
	 *		path="/webservice/RestApi/{moduleName}/CustomView",
	 ...
	 *	),
	 *	@OA\Get(
	 *		path="/webservice/RestApi/{moduleName}/CustomView/{cvId}",
