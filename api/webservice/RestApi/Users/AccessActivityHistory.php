...
class AccessActivityHistory extends \Api\Core\BaseAction
{
	 ...
	 *				type="object",
	 *				@OA\Property(property="time", type="string", title="Date time in user format", example="2021-06-01 11:57"),
	 *				@OA\Property(property="status", type="string", title="Operation name", example="Signed in"),
	 *				@OA\Property(property="agent", type="string", title="User agent", example="PostmanRuntime/7.28.0"),
	 *				@OA\Property(property="ip", type="string", title="IP address", example="127.0.0.1"),
	 *			),
	 *		),
	 *	),
	 */
