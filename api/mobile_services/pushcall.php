...
class PushCall{
	...
	public function post($type = '', $authorization = ''){
		...
		\App\log::trace('Start PushCall metod');
		...
		\App\log::trace('End PushCall metod | return: '.print_r( $resultData,true));
		return $resultData;
	}
	...
	public function getPushCallDetails(){
		...
		\App\log::trace('Start PushCall::getPushCallDetails | user id: '.$this->userID);
		...
		\App\log::trace('End PushCall::getPushCallDetails | return: '.print_r( $resultData,true));
		return $resultData;
	}
	...
	public function checkPermissions($authorization){
		...
		\App\log::trace('Start PushCall::checkPermissions | '.print_r( $authorization,true));
		$return = false;	
		...
		\App\log::trace('End PushCall::checkPermissions | return: '.$return);
		return $return;
	}
}
