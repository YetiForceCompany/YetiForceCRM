 ...
 */
class LibraryRoundcube extends \includes\SystemWarnings\Template
{
	...
	public function process()
	{
		...
		if ($this->status == 0) {
			$this->link = 'index.php?module=ModuleManager&parent=Settings&action=Basic&mode=downloadLibrary&name=roundcube';
