...
abstract class Vtiger_View_Controller extends Vtiger_Action_Controller
{
	...
	public function getFooterScripts(\App\Request $request)
	{
		$jsFileNames = [
			...
			'~libraries/ansicolors/ansicolors.js',
			'~libraries/async/dist/async.js',
			'~libraries/csv-parse/cardinal.js',
			'~libraries/esprima/dist/esprima.js',
			'~libraries/lodash/lodash.js',
			'~libraries/humanize/humanize.js',
			'~libraries/minimist/index.js',
			'~libraries/wordwrap/index.js',
			'~libraries/redeyed/redeyed.js',
