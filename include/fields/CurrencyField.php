...
class CurrencyField
{
	...
	public function initialize($user = null)
	{
		...
		$this->numberOfDecimal = (empty($user->getDetail('no_of_currency_decimals')) && $user->getDetail('no_of_currency_decimals') !== '0') ? 2 : (int)$user->getDetail('no_of_currency_decimals');
	}
