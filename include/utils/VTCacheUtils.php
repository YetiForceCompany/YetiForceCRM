...
class VTCacheUtils
{
	...
	static function lookupReportListOfModuleInfos()
	{
		return self::$_report_listofmodules_cache;
	}

	static function updateReportListOfModuleInfos($module_list, $related_modules)
	{
	...
	static function lookupReportInfo($userid, $reportid)
	{
	...
	static function updateReportInfo($userid, $reportid, $primarymodule, $secondarymodules, $reporttype, $reportname, $description, $folderid, $owner)
	{
		if (!isset(self::$_reportmodule_infoperuser_cache[$userid])) {
	...
	static function lookupReportSubordinateUsers($reportid)
	{
	...
	static function updateReportSubordinateUsers($reportid, $userids)
	{
	...
	static function lookupReportScheduledInfo($userid, $reportid)
	{
	...
	static function updateReportScheduledInfo($userid, $reportid, $isScheduled, $scheduledFormat, $scheduledInterval, $scheduledRecipients, $scheduledTime)
	{
		if (!isset(self::$_reportmodule_scheduledinfoperuser_cache[$userid])) {
