...
$languageStrings = [
    ...
    'LBL_CAN_ASSIGN_MULTIOWNER_TO' => 'Compartilhar com os Usuários',
    ...
    'LBL_BROWSING_OTHER_USERS_GRAPHICAL_CALENDAR' => 'É possível que outros usuários naveguem ou não pelos calendários gráficos de outros usuários',
    ...
    'LBL_PERMISSIONS_TO_LIST_RELATED_RECORDS' => 'Devemos listar os registros relacionados com os registros que podemos acessar e ser compartilhados',
    'LBL_PERMISSIONS_TO_VIEW_RELATED_RECORDS' => 'Devemos visualizar os registros relacionados com os registros que podemos acessar e ser compartilhado',
    'LBL_PERMISSIONS_TO_EDIT_RELATED_RECORDS' => 'Caso a edição dos registros (do qual não somos proprietaŕios) relacionados com nossos registros for habilitada',
    'LBL_PERMISSIONS_FIELD_RELATED_RECORDS' => 'As permissões para os registros relacionados são baseadas em campos',
    'LBL_PERMITTED_BY_READ_ACCESS' => 'Access to record',
    'LBL_PERMITTED_BY_SHARING' => 'Excessões de permissões de acesso',
    'LBL_INACTIVE' => 'Inativo',
    'LBL_ONLY_PARENT' => 'Registro pai',
    'LBL_ACCORDING_TO_HIERARCHY' => 'De acordo com a hierarquia',
    'LBL_SHOW_GLOBAL_SEARCH_ADVANCED' => 'Habilitar busca avançada',
    'LBL_BLOCK_COPY' => 'Copiando bloco',
    'LBL_BLOCK_CUT' => 'Cortando bloco',
    'LBL_BLOCK_PASTE' => 'Copiando bloco',
    'LBL_AUTO_ASSIGN_RECORDS' => 'Atribuir Registros automaticamente',
];
$jsLanguageStrings = [
