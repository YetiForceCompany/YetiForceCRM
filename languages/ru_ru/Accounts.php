...
$languageStrings = array(
	...
	'Analyst'                      => 'Аналитик'            , 
	'Approval for email'	=>	'Разрешить отправлять электронную почту',
	'Approval for phone calls'	=>	'Разрешить звонить',
	'Average profit sales order'	=>	'Средняя прибыль от продаж (%)',
	'Balance'	=>	'Баланс',
	'Calculations accepted'	=>	'Производить рассчет',
	...
	'LBL_FINANSIAL_SUMMARY'	=>	'Финансовое резюме',
