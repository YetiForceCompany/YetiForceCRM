...
$jsLanguageStrings = array(
    ...
    'Transfer records to user' => 'Прикрепить все записи к пользователю',
    'User to be deleted' => 'Удаляемый пользователь',		'JS_MOBILE_PERFORM_CALL_OK' => 'Номер телефона отправлн на Ваш телефон',	'JS_MOBILE_PERFORM_CALL_ERROR' => 'Ошибка, при попытке отправить номер телефона',
);