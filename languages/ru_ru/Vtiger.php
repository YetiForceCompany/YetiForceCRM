...
$jsLanguageStrings = [
	...
	'JS_PLEASE_SELECT_AN_LEAD_TO_COPY_ADDRESS' => 'Копировать из Обращения',
	'JS_PLEASE_SELECT_AN_VENDOR_TO_COPY_ADDRESS' => 'Копировать из Поставщика',
	...
	'JS_AN_INCORRECT_RANGE_OF_DATES_WAS_ENTERED' => 'Указан не верный диапазон дат',
	'JS_STARTED_GENERATING_FILE' => 'Создание файла',
	'JS_CAN_NOT_REMOVE_COMMENT' => 'Вы не можете удалять комментарии с ответами. Удалите все ответы для того, чтобы удалить комментарий.',
	'LBL_DELETE_COMMENT_CONFIRMATION' => 'Вы уверены, что хотите удалить комментарий?',
];
