...
$languageStrings = array(
	...
	'LBL_CONFREPORT_DESCRIPTION'	=>	'Здысь вы можете посмотреть конфигурацию сервера и получить информацию о том, что основные настройки сервера совместимы с рекомендованными параметрами.',
