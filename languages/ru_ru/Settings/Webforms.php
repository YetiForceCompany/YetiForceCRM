...
$languageStrings = [
	...
	'LBL_WEBFORM_REFERENCE_FIELD'	=>	'Ссылающееся поле Веб-Формы',
	'LBL_SELECT_FIELDS_OF_TARGET_MODULE' => 'Выберите поля целевого модуля...',
	'LBL_ALLOWS_YOU_TO_MANAGE_WEBFORMS'	=>	'Позволяет вам управлять Веб-Формами',
	'LBL_ADD_FIELDS' => 'Добавить поля',
	'LBL_EMBED_THE_FOLLOWING_FORM_IN_YOUR_WEBSITE' => 'Вставьте следующую форму на сайт',
	'LBL_SELECT_VALUE' => 'Выберите значение',
	'LBL_LABEL' => 'Метка: ',
	'LBL_SAVE_FIELDS_ORDER' => 'Сохранить последовательность', 
	'LBL_HIDDEN' => 'Скрытое',
	'LBL_ENABLE_TARGET_MODULES_FOR_WEBFORM' => 'Включить целевые модуля в Веб-Форму',
