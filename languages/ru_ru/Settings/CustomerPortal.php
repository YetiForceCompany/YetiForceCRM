...
$languageStrings = array(
	...
	'LBL_PORTAL_URL' => 'Ссылка на портал',
	...
	//Messages
	'LBL_PRIVILEGES_MESSAGE' => 'ПРИМЕЧАНИЕ: Профиль пользователя будет выбран для управления полями, которые появляются в Клиентском портале.',
	...
	'LBL_PORTAL_URL_MESSAGE' => 'ПРИМЕЧАНИЕ: Ссылка на портал, где ваши клиенты могут создавать/отслеживать заявки, иметь доступ к базе знаний и т.д. Контакту отправятся логин и пароль для доступа к порталу, если у него в карточке есть подписка на услуги Клиентского портала.',
