...
$languageStrings = array(
	...
	'LBL_DISPLAY_NAME' => 'Пользователь',
	'LBL_EMAIL' => 'Почта',
	'LBL_LOGIN' => 'Логин',
	'LBL_KEY' => 'Ключ',
	'LBL_SELECT_USER' => 'Выберите имя пользователя:',
	'LBL_ALERT_DAV_NO_ACTIVE_TITLE' => 'Приложение Синхронизация контактов не активно',
	'LBL_ALERT_DAV_NO_ACTIVE_DESC' => 'Для активации приложения Синхронизация контактов, расскомметируйте строку DAV в файле api/config.php',
