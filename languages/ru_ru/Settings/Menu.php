...
$languageStrings = [
    ...
    'LBL_CREATING_MENU' => 'Создать пункт меню',
    'LBL_SELECT_TYPE_OF_MENU' => 'Выбрать пункт меню',
    'LBL_TYPE_OF_MENU' => 'Тип меню',
    'LBL_NEW_WINDOW' => 'Открывать в новом окне',
    'LBL_NEXT' => 'Далее',
    'LBL_ADD_NEW_MENU' => 'Добавить',
    'LBL_URL' => 'Ссылка',
    'LBL_LABEL_NAME' => 'Название метки',
    'LBL_JAVASCRIPT' => 'Скрипт',
    'LBL_EDITION_MENU' => 'Редактировать меню',
    'LBL_SAVE_MENU' => 'Сохранить',
    'LBL_SAVED_MENU' => 'Изменения успешно сохранены',
...
$jsLanguageStrings = [
    ...
    'JS_REMOVE' => 'Удалить',
    'JS_NO_DATA' => 'Нет меню',
    'JS_TEST_HOTKEY_OK' => 'Горячая клавиша работает правильно',
];
