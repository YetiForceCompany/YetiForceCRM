...
$languageStrings = [
	...
	'LBL_CONFIGURE_DEPENDENCY_HELP_2' => "Если вы желаете посмотреть или изменить связи для других значений Исходного поля, <br/>вы можете выбрать соответствующие значения, нажав на кнопку <b>\'Выбор исходных значений\'</b>",
	...
	'LBL_ERR_CYCLIC_DEPENDENCY' => 'Эта зависимость не допускается, так как она попадает в бесконечные циклические зависимости',
	'LBL_PICKLIST_DEPENDENCY' => 'Редактор зависимостей списков',
