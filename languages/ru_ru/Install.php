...
$jsLanguageStrings = array(
	...
	'LBL_PHP_WARNING'	=>	'Некоторые из настроек PHP не соответствуют рекомендуемым значениям. Это может повлиять на некоторые из особенностей Vtiger CRM. Вы уверены, что вы хотите продолжить?',
