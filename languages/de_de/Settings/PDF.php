...
$languageStrings = [
	...
	'LBL_HEADER_IN_MILIMETERS' => 'Header Margin from the top of the page in Millimeter',
	'LBL_FOOTER_IN_MILIMETERS' => 'Footer margin from the bottom of the page in Millimeter',
