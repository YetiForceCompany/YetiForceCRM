...
$languageStrings = [
	...
	'LBL_HTTPS_HELP_TEXT' => 'SSL ist die Standard Sicherheitstechnologie für die verschlüsselte Verbindung zwischen dem Webserver und dem Browser.',
	...
	'LBL_PUBLIC_HTML_HELP_TEXT' => 'Wir empfehlen das System so zu installieren, dass nur das öffentliche HTML Verzeichnis benutzt wird. Es erhöht die Datensicherheit, wenn auf nichtöffentliche Verzeichnisse und Dateien nicht direkt über die Adresse(URL) zugegriffen werden kann.',
	'LBL_SESSION_REGENERATE_HELP_TEXT' => 'Wir empfehlen die Erneuerung von Session IDs zu aktivieren, da diese Option es schwerer macht die Benutzersitzung zu übernehmen. Änderungen sollten in der Hauptkonfigurationsdatei durchgeführt werden..',
	...
	'LBL_MAX_EXECUTION_TIME_HELP_TEXT' => 'Maximale Ausführungszeit für PHP Skripte (Ein Request).',
	'LBL_MAX_INPUT_TIME_HELP_TEXT' => 'Maximale Eingabezeit für POST oder GET in Sekunden.',
	'LBL_DEFAULT_SOCKET_TIMEOUT_HELP_TEXT' => 'Maximale Zeit für externe Serververbindungen in Sekunden.',
	'LBL_MEMORY_LIMIT_HELP_TEXT' => 'Maximal verfügbares RAM für ein PHP Skript.',
	...
	'LBL_ZLIB_OUTPUT_COMPRESSION_HELP_TEXT' => 'Soll der Server komprimierte Daten an den Browser senden.',
	'LBL_SESSION_AUTO_START_HELP_TEXT' => 'Soll die Session automatisch gestartet werden when das PHP Scipt ausgeführt wird.',
	'LBL_SESSION_GC_MAXLIFETIME_HELP_TEXT' => 'Zeit (in Sekunden) bis die Session gelöscht wird.',
	...
	'LBL_MAX_ALLOWED_PACKET_HELP_TEXT' => 'Maximale Datengröße die verschickt werden darf.',
	'LBL_INNODB_FILE_PER_TABLE_HELP_TEXT' => 'Daten werden in der Datenbank in vielen Dateien gespeichert, wobei jede Tabelle ihre eigene Datei hat, entgegen dem alten Ansatz wo alle Daten in einer datei gespeichert werden. Diese Option ist ab MySQL 5.6.6 standardmäßig aktiviert.',
	'LBL_INNODB_STATS_ON_METADATA_HELP_TEXT' => 'Aktualisierung von Statistiken von InnoDB Tabellen für manche Abfragen, zum Beispiel SHOW TABLE STATUS. Deaktiverung dieser Option erhöht die Effektivität für große InnoDB Tabellen. Wir empfehlen die Deaktivierung dieser Option.',
	'LBL_TMP_DIR' => 'Temporäres Verzeichnis',
	'LBL_INVALID_TIME_ZONE' => 'Ungültige Zeitzone:',
	'LBL_DATABASE_INFORMATION' => 'Datenbank Information',
	'LBL_DB_DRIVER' => 'Engine',
	'LBL_DB_CLIENT_VERSION' => 'Client Version',
	'LBL_DB_SERVER_VERSION' => 'Engine Version',
	'LBL_DB_CONNECTION_STATUS' => 'Verbindungsstatus',
	'LBL_DB_SERVER_INFO' => 'Serverinformation',
	'LBL_DENY_PUBLIC_DIR_TITLE' => 'Berechtigunsüberprüfung für Verzeichnisse',
	'LBL_PUBLIC_DIR' => 'Verzeichnispfad',
	'LBL_DENY_PUBLIC_DIR_STATUS' => 'Zugriff verboten?',
	'LBL_DENY_PUBLIC_DIR_HELP_TEXT' => 'Es ist erforderlich den Zugriff auf dieses Verzeichnis zu unterbinden. Das Verzeichnis ist öffentlich zugänglich und sein Inhalt ist sonst nicht geschützt.',
	'LBL_AUTO_DETECT_LINE_ENDINGS_HELP_TEXT' => 'Es wird empfohlen die Codeprüfung zu aktivieren falls Dateien importiert werden.',
];
$jsLanguageStrings = [
