...
$languageStrings = [
	...
	'LBL_TOO_MANY_FAILED_LOGIN_ATTEMPTS' => 'Ihre IP aufgrund mehrerer fehlgeschlagener Anmeldeversuche gesperrt',
	...
	'BTN_MASS_RESET_PASSWORD' => 'Massenrücksetzen Passwort',
	'LBL_RESET_PASSWORD_HEAD' => 'Benutzer Passwort zurücksetzen',
	'LBL_MASS_RESET_PASSWORD_HEAD' => 'Massenrücksetzen Benutzer Passwörter',
	'LBL_RESET_PASSWORD_DESC' => 'Das System generiert ein neues Benutzerpasswort und sendet dies per E-Mail an den Benutzer.',
	'LBL_RESET_PASSWORD_ERROR' => 'Das System kann das Passwort nicht zurücksetzen, da kein aktiver SMTP Zugang für Systemmeldungen eingerichtet ist.',
	'LBL_PASSWORD_WAS_RESET_AND_SENT_TO_USER' => 'Passwort wurde zurückgesetzt und an die E-Mailadresse des Benutzers versendet.',
	'LBL_PASSWORD_WAS_RESET_AND_SENT_TO_USERS' => 'Passwörter wurden zurückgesetzt und an die E-Mailadressen der Benutzer versendet.',
	'LBL_PASSWORD_SHOULD_BE_SAME' => 'Beide Passwörter müssen übereinstimmen.',
	'LBL_INCORRECT_OLD_PASSWORD' => 'Fehlerhaftes Altes Passwort. Bitte erneut probieren.',
	'LBL_SEND_EMAIL_RESET_PASSWORD' => 'System generiert ein neues Passwort und sendet dies an die E-Mailadresse.',
	'LBL_NO_USER_FOUND' => 'Keine Benutzer gefunden.',
	'LBL_TOO_MANY_FAILED_LOGIN_ATTEMPTS' => 'Zu viele Fehlversuche beim Anmelden. IP wurde geblockt.',
	'LBL_IP_IS_BLOCKED' => 'Die IP steht auf der Liste der geblockten IPs, bitte kontaktieren Sie Ihren Administrator.',
	'FL_DATE_PASSWORD_CHANGE' => 'Kürzliiche Passwortänderung',
	'LBL_PASSWORD_SUCCESSFULLY_CHANGED' => 'Das Passwort wurde erfolgreich geändert.',
	'LBL_YOUR_PASSWORD_HAS_EXPIRED' => 'Das Passwort ist abgelaufen, bitte konaktieren Sie Ihren Administrator.',
	'LBL_YOUR_PASSWORD_WILL_EXPIRE' => 'Ihr Passwort wird in %s Tagen ablaufen und das System Ihren Zugang sperren. Es ist erforderlich, Ihr Passwort so schnell wie möglich zu ändern.',
	'FL_FORCE_PASSWORD_CHANGE' => 'Passwortänderung erzwingen',
	'LBL_CHANGING_PASSWORD_OF_ANOTHER_USER' => 'Das Ändern des Passwortes eines anderen Benutzers, zwingt Ihn dieses bei der ersten Anmeldung zu ändern.',
	'LBL_FORCE_PASSWORD_CHANGE_ALERT' => 'Ihr Passwort wurde geändert. Um fortzufahren, geben Sie bitte ein neues Passwort ein.',
