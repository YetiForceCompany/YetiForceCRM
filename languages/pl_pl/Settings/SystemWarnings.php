...
$languageStrings = [
	...
	'LBL_CONFIG_REPORT_DESC' => 'Konfiguracja serwera nie została poprawnie ustawiona. Mogą wystąpić problemy z działaniem systemu, lub wprowadzane dane mogą zostać uszkodzone, lub usunięte. Więcej informacji znajduje się w artykule <a target="_blank" href="https://www.yetiforce.com/en/knowledge-base/documentation/implementer-documentation/item/web-server-requirements"><u>Wymagania dla serwera WWW na stronie yetiforce.com</u></a>',
	...
	'LBL_STATS_DESC' => 'Pomóż nam ulepszać YetiForce i oferowane przez nas usługi poprzez przesyłanie nam anonimowych informacji dotyczących używanej przez Ciebie wersji systemu.<br />Zbierane przez nas dane obejmują poniższe informacje: <ul><li>unikalny klucz twojej instancji generowany tylko na potrzeby newslettera</li><li>wersja systemu</li><li>język</li><li>strefa czasowa</li></ul>Kwestie bezpieczeństwa traktujemy niezwykle poważnie i zapewniamy, że dane zbierane są wyłącznie w celach statystycznych.<br />Przyłącz się do budowania społeczności YetiForce.',
	// Alerts
	'LBL_SAVE_TO_NEWSLETTER' => 'Zapisz się do newslettera',
	'LBL_REMIND_LATER' => 'Przypomnij później',
	'LBL_DATA_SAVE_OK' => 'Dane zostały zapisane poprawnie',
	'LBL_DATA_SAVE_FAIL' => 'Wystąpił błąd w trakcie zapisu, sprawdź logi',
	// Others
	'BTN_SET_IGNORE' => 'Ignoruj',
