...
$languageStrings = [
	...
	'SQL_MODE_HELP_TEXT' => 'Określa różne tryby pracy z bazą danych. Tryby wpływają na składnię SQL, a także na sprawdzanie poprawności danych.',
	'MAX_ALLOWED_PACKET_HELP_TEXT' => 'Określa maksymalną wielkość danych przesłanych za jednym razem.',
	'DATETIME_FORMAT_HELP_TEXT' => 'Ta zmienna nie jest używana i jest przestarzała. Będzie usunięta w wersji 8.0 MySQL.',
	'INNODB_FILE_PER_TABLE_HELP_TEXT' => 'Określa czy dane będą przechowywane w bazie danych w wielu plikach, gdzie każda tabela ma swój plik. W odróżnieniu od starego podejścia gdzie wszystkie dane były w jednym pliku. Ta opcja jest włączona domyślnie od wersji 5.6.6 MySQL.',
	'INNODB_STATS_ON_METADATA_HELP_TEXT' => 'Ta opcja aktualizuje statystyki dla tabel InnoDB dla niektórych zapytań jak np. SHOW TABLE STATUS. Wyłączenie tej opcji korzystnie wpływa na wydajność dla dużych tabel InnoDB. Zaleca się wyłączenie tej opcji.',
