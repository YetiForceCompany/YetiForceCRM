...
$languageStrings = array(
    ...
    'Alert_no_module_desc' => 'Scanner module requires that You install and activate OSSMail module. Check is this module is installed, if not You need to install it.',
    ...
    'Alert_info_tab_accounts' => 'Choose what actions should be called for individual email accounts.',
    ...
    'Delete_panel' => 'Below configuration pane is used to delete the module. Module name: ',
    'Uninstall' => 'Uninstall',
    'Cancel' => 'Cancel',
    ...
    'DELETE' => 'Uninstallation of module',
    ...
    'Uninstall OSSMailScanner module' => 'Uninstall OSSMailScanner module',
    'StopCron' => 'Manually stop scanning',
    'Manually stopped' => 'Manually stoped',
	...
	'ERROR_ACTIVE_CRON' => 'Unable to turn on scanning because cron is are currently active.',
	'Change ticket status' => 'Ticket status change',
        'Change_ticket_status' => 'Update ticket status',
    'Alert_info_conftab_change_ticket_status' => 'This option allows for changing ticket status to "Replied" when Mail Scanner finds an email from a customer who sent this ticket.',
