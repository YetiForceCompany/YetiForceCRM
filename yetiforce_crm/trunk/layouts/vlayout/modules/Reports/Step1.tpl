				...
				<div id="scheduleBox" class='well contentsBackground {if $SCHEDULEDREPORTS->get('scheduleid') eq ''} hide {/if}'>
                    ...
                    <div class='row-fluid' id='recipientsList' style='padding:5px 0px 10px 0px;'>
                        ...
                        <div class='span4'>
                            ...
                            <select multiple data-placeholder="{vtranslate('LBL_SELECT_OPTION')}" class="chosen-select span6" id='recipients' name='recipients' data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" style="width: 281px !important;">
