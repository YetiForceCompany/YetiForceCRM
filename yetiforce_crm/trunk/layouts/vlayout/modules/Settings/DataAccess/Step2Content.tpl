...
{*                        <pre>*}
                        {foreach from=$REQUIRED_CONDITIONS key=cnd_key item=cnd_item name=field_select}
                            <div class="row-fluid conditionRow marginBottom10px" id="cnd_num_{$smarty.foreach.field_select.index}">
                                <span class="span4">
                                    <select data-num="{$smarty.foreach.field_select.index}" class="chzn-select row-fluid comparator-select field-name-select" data-placeholder="{vtranslate('LBL_SELECT_FIELD',$QUALIFIED_MODULE)}">
                ...
                <div class="addCondition"><button class="add_condition btn" data-type="condition_all" type="button"><strong>{vtranslate('ADD_CONDITIONS', $QUALIFIED_MODULE)}</strong></button></div>
            </div>
            <div class="allConditionContainer conditionGroup contentsBackground well">
...
{*                                    {var_dump($cnd_item)}*}
                ...
                <div class="addCondition"><button class="add_condition btn" data-type="condition_option" type="button"><strong>{vtranslate('ADD_CONDITIONS', $QUALIFIED_MODULE)}</strong></button></div>
            </div>
			<br>
