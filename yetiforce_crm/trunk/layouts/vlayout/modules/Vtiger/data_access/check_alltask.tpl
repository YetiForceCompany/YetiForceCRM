...
<div class="row-fluid">
	<div class="span12 padding-bottom1per">
		...
		<select multiple name="status" class="marginLeftZero span6 select2">
	...
	<div class="marginLeftZero span12 padding-bottom1per">
		<h5 class="padding-bottom1per"><strong>{vtranslate('Message if the task exist', 'DataAccess')}:</strong></h5>
		<input type="text" name="message" class="marginLeftZero span6 " value="{$message}">
	</div>
</div>
