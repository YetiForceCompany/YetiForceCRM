...
class Vtiger_DetailView_Model extends Vtiger_Base_Model {
	...
	public function getWidgets() {
		...
		if(Vtiger_Functions::getModuleId('OSSMailView')){
			$OSSMailViewRecord_Model = Vtiger_Record_Model::getCleanInstance('OSSMailView');
			$widgets[] = array(
				'linktype' => 'DETAILVIEWWIDGET',
				'linklabel' => 'Email_list',
				'linkurl' => 'module=OSSMailView&view=widget&smodule='.$this->getModuleName().'&srecord='.$this->getRecord()->getId().'&mode=showEmailsList&type=all'
			);
		}
		if($this->getModuleName() == 'Potentials' || $this->getModuleName() == 'HelpDesk' || $this->getModuleName() == 'Project'){
			if(Vtiger_Functions::getModuleId('OSSCosts')){
				$OSSCostsRecord_Model = Vtiger_Record_Model::getCleanInstance('OSSCosts');
				$widgets[] = array(
					'linktype' => 'DETAILVIEWWIDGET',
					'linklabel' => 'Summary of costs',
					'linkurl' => 'module=OSSCosts&view=widget&smodule='.$this->getModuleName().'&srecord='.$this->getRecord()->getId()
				);
			}
		}
		//////////////// opensaas
