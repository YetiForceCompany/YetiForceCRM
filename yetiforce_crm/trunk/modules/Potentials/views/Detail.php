...
class Potentials_Detail_View extends Vtiger_Detail_View {
	...
	function showCharts(Vtiger_Request $request) {
		...
		$response = $moduleModel->getTimePotentials($recordId);
		$viewer->assign('MODULE_NAME', $moduleName);
		$viewer->assign('DATA', $data);
		$viewer->assign('DATA2', $response);
		$viewer->view('charts/ShowTimePotentialsEmployees.tpl', $moduleName);
		$viewer->view('charts/ShowTimePotentials.tpl', $moduleName);
	}
}
