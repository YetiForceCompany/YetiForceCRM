...
function rcube_mail_ui()
{
  ...
  function layout_messageview()
  {
	...
	$('#messagecontent').css('top', ($('.oss-header').outerHeight() + $('#messageheader').outerHeight() + 1) + 'px'); ///////////////////   OpenSaaS
...
//    var abooks = $('#directorylist'); ///////////////////   OpenSaaS
//    $('#compose-contacts .scroller').css('top', abooks.position().top + abooks.outerHeight()); ///////////////////   OpenSaaS
  }
