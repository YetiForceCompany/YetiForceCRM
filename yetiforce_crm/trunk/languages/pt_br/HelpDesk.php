...
$languageStrings = array(
	...
	'LBL_NOTICE_FOOTER'=>'Se você não deseja receber notificações do nosso Sistema de Gestão de Projeto, por favor, nos informe enviando um e-mail para <a href="mailto:help@yetiforce.com" target="_blank">help@yetiforce.com</a>. Caso não seja o destinatário desta mensagem, por favor, nos informe e apague-a.',
);
