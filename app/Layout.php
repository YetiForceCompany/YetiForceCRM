...
class Layout
{
	...
	public static function truncateHtml(string $html, ?string $size = 'medium', ?int $length = 200): string
	{
		...
		return "<div class=\"js-iframe-content\" >$teaser <iframe sandbox=\"allow-same-origin allow-popups\" class=\"w-100 {$iframeClass}\" frameborder=\"0\" style=\"{$css}\" srcdoc=\"$html\"></iframe>{$btn}</div>";
	}
}
