      ...
      >
        ...
        >
          <q-btn
            ...
            color="primary"
            :class="['glossy animation-duration', config.draggableButton ? 'btn-absolute' : 'q-px-sm']"
            style="z-index: 99999999999;"
            @mouseup="showDialog"
            @touchend="showDialog"
            :round="config.draggableButton"
            :size="config.draggableButton ? '' : '13px'"
          >
            <q-badge
            ...
            <q-badge
              ...
              :class="['shadow-3 text-primary btn-badge', config.draggableButton ? 'btn-badge--left-top' : 'q-mr-xs']"
              color="white"
...
export default {
  ...
  computed: {
    ...
    badgeClass() {
      return this.config.draggableButton ? '' : 'q-ml-sm'
    },
    dialog: {
      get() {
  ...
  methods: {
    ...
    ...mapActions(['startUpdatesListener', 'fetchRoom']),
    initDialogModel() {
