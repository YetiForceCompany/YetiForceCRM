...
var __vue_script__ = {
  ...
  computed: {
    fullName: function fullName() {
      return "".concat(this.$parent.$options.name, ".").concat(this.name !== 'default' ? this.name + '.' : '');
    },
...
function __vue_normalize__(template, style, script, scope, functional, moduleIdentifier, createInjector, createInjectorSSR) {
  ...
  component.__file = "C:\\www\\YetiForceCRM\\public_html\\src\\modules\\Core\\modules\\Hooks\\components\\HookWrapper.vue";
