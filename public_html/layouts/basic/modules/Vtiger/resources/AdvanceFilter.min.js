...
jQuery.Class('Vtiger_AdvanceFilter_Js', {
	getInstance: function getInstance(container) {
  ...
  */
	initializeOperationMappingDetails: function initializeOperationMappingDetails() {
  ...
  */
	getFilterContainer: function getFilterContainer() {
  ...
  */
	setFilterContainer: function setFilterContainer(element) {
		this.filterContainer = element;
		return this;
	},
	getDateSpecificConditionInfo: function getDateSpecificConditionInfo() {
  ...
  */
	getConditionListFromType: function getConditionListFromType(fieldType) {
	...
	getDateConditions: function getDateConditions(fieldType) {
		if (fieldType != 'D' && fieldType != 'DT') {
			return [];
		}
  ...
  */
	getConditionLabel: function getConditionLabel(key) {
  ...
  */
	getAddConditionElement: function getAddConditionElement() {
		var filterContainer = this.getFilterContainer();
  ...
  * @return : current instance
  */
	addNewCondition: function addNewCondition(conditionGroupElement) {
		var basicElement = $('.basic', conditionGroupElement);
		var newRowElement = basicElement.find('.js-conditions-row').clone(true, true);
		var selectElement = newRowElement.find('select').addClass('select2');
		var conditionList = $('.conditionList', conditionGroupElement);
  ...
  */
	addConditionHandler: function addConditionHandler(e) {
		var element = jQuery(e.currentTarget);
		var conditionGroup = element.closest('div.conditionGroup');
		this.addNewCondition(conditionGroup);
	},
	getFieldSpecificType: function getFieldSpecificType(fieldSelected) {
  ...
  */
	loadConditions: function loadConditions(fieldSelect) {
  ...
  */
	getFieldSpecificUi: function getFieldSpecificUi(fieldSelectElement) {
		...
		if (fieldModel.get('comparatorElementVal') === 'd') {
			...
			return $(html);
		} else if (fieldModel.getType().toLowerCase() === 'boolean' || fieldSelectElement.find('option:selected').data('fieldtype') === 'C') {
			var selectedValue = fieldSelectElement.closest('.js-conditions-row').find('[data-value="value"]').val();
  ...
  */
	loadFieldSpecificUi: function loadFieldSpecificUi(fieldSelect) {
		...
		var valueType = fieldUiHolder.find('[name="' + fieldInfo.name + '"]').data('valuetype');
		...
		if ($.inArray(fieldModel.getType(), ['multipicklist', 'sharedOwner', 'multiReferenceValue', 'taxes', 'categoryMultipicklist']) > -1) {
			fieldName = fieldName + '[]';
		} else if ($.inArray(fieldModel.getType(), ['userCreator', 'picklist', 'owner', 'languages', 'modules', 'inventoryLimit', 'currencyList', 'fileLocationType']) > -1 && fieldSpecificUi.is('select') && (comparatorElementVal == 'e' || comparatorElementVal == 'n')) {
			fieldName = fieldName + '[]';
		}
  ...
  */
	loadFieldSpecificUiForAll: function loadFieldSpecificUiForAll() {
  ...
  */
	addValidationToFieldIfNeeded: function addValidationToFieldIfNeeded(selectFieldElement) {
  ...
  */
	isFieldSupportsValidation: function isFieldSupportsValidation(fieldSelect) {
		var fieldModel = this.fieldModelInstance;
  ...
  */
	getValues: function getValues() {
		...
		var fieldList = ['columnname', 'comparator', 'value', 'column_condition'],
						...
						if (field === 'value' && valueSelectElement.attr('type') === 'checkbox') {
							...
							for (i = 0; i < valuesArr.length; i++) {
								if (typeof pickListValues[valuesArr[i]] !== 'undefined') {
									_newValuesArr.push(pickListValues[valuesArr[i]]);
								} else {
									_newValuesArr.push(valuesArr[i]);
								}
							}
							rowValues[field] = _newValuesArr.join(',');
  ...
  */
	deleteConditionHandler: function deleteConditionHandler(e) {
		var element = jQuery(e.currentTarget);
  ...
  */
	registerAddCondition: function registerAddCondition() {
		var thisInstance = this;
  ...
  */
	registerConditionChange: function registerConditionChange() {
		var filterContainer = this.getFilterContainer();
		var thisInstance = this;
  ...
  */
	registerDeleteCondition: function registerDeleteCondition() {
		var thisInstance = this;
		var filterContainer = this.getFilterContainer();
...
Vtiger_Field_Js('AdvanceFilter_Field_Js', {}, {
	getUiTypeSpecificHtml: function getUiTypeSpecificHtml() {
