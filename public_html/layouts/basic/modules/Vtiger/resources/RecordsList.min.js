...
$.Class('Base_RecordsList_JS',{},{/**
		 ...
		 */registerEvents:function registerEvents(modalContainer){this.container=modalContainer,this.moduleName=this.container.data('module'),this.registerBasicEvents(),this.registerListEvents(),this.registerHeadersClickEvent();}});
