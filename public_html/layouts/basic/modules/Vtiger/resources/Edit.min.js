...
document.progressLoader.progressIndicator({mode:"hide"}),editViewForm.removeData("submit"),app.formAlignmentAfterValidation(editViewForm);});},/**
		 ...
		 * Set field value
		 * @param {object} params
		 */setFieldValue:function setFieldValue(params){var fieldElement=this.getForm().find("[name=\"".concat(params.fieldName,"\"]:last")),fieldInfo=fieldElement.data("fieldinfo");fieldElement.is("select")?fieldElement.find("option[value=\"".concat(params.value,"\"]")).length?fieldElement.val(params.value).trigger("change"):fieldInfo.picklistvalues.hasOwnProperty(params.value)&&fieldElement.append(new Option(params.value,params.value,!0,!0)).trigger("change"):"checkbox"==fieldElement.attr("type")?fieldElement.prop("checked","1"==params.value).trigger("change"):fieldElement.val(params.value);},/**
		 * Set field options
