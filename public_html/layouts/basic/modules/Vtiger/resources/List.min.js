...
jQuery.Class('Vtiger_List_Js',{listInstance:!1,getRelatedModulesContainer:!1,massEditPreSave:'Vtiger.MassEdit.PreSave',getInstance:function getInstance(){if(!1===Vtiger_List_Js.listInstance){var moduleClassName,fallbackClassName,instance,module=app.getModuleName(),parentModule=app.getParentModuleName();return 'Settings'==parentModule?(moduleClassName=parentModule+'_'+module+'_List_Js','undefined'==typeof window[moduleClassName]&&(moduleClassName=module+'_List_Js'),fallbackClassName=parentModule+'_Vtiger_List_Js','undefined'==typeof window[fallbackClassName]&&(fallbackClassName='Vtiger_List_Js')):(moduleClassName=module+'_List_Js',fallbackClassName='Vtiger_List_Js'),instance='undefined'==typeof window[moduleClassName]?new window[fallbackClassName]:new window[moduleClassName],Vtiger_List_Js.listInstance=instance,instance}return Vtiger_List_Js.listInstance},/*
		 ...
		 */triggerSendEmail:function triggerSendEmail(params){var listInstance=Vtiger_List_Js.getInstance(),validationResult=listInstance.checkListRecordSelected();if(!0!==validationResult){var postData=listInstance.getSearchParams();delete postData.parent,delete postData.mode,postData.view='SendMailModal',postData.cvid=listInstance.getCurrentCvId(),params&&jQuery.extend(postData,params),AppConnector.request(postData).done(function(response){app.showModalWindow(response,function(data){data.find('[name="saveButton"]').on('click',function(){data.find('form').validationEngine('validate')&&(jQuery.extend(postData,{field:data.find('#field').val(),template:data.find('#template').val(),mailNotes:data.find('#mail_notes').val(),action:'Mail',mode:'sendMails'}),delete postData.view,AppConnector.request(postData).done(function(response){!0==response.result&&app.hideModalWindow();}).fail(function(){app.hideModalWindow();}));});});});}else listInstance.noRecordSelectedAlert();},/*
