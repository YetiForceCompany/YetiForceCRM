...
jQuery.Class('Vtiger_List_Js',{listInstance:!1,getRelatedModulesContainer:!1,massEditPreSave:'Vtiger.MassEdit.PreSave',getInstance:function getInstance(){if(!1===Vtiger_List_Js.listInstance){var moduleClassName,fallbackClassName,instance,module=app.getModuleName(),parentModule=app.getParentModuleName();return 'Settings'==parentModule?(moduleClassName=parentModule+'_'+module+'_List_Js','undefined'==typeof window[moduleClassName]&&(moduleClassName=module+'_List_Js'),fallbackClassName=parentModule+'_Vtiger_List_Js','undefined'==typeof window[fallbackClassName]&&(fallbackClassName='Vtiger_List_Js')):(moduleClassName=module+'_List_Js',fallbackClassName='Vtiger_List_Js'),instance='undefined'==typeof window[moduleClassName]?new window[fallbackClassName]:new window[moduleClassName],Vtiger_List_Js.listInstance=instance,instance}return Vtiger_List_Js.listInstance},/*
		 ...
		 */triggerSendEmail:function triggerSendEmail(params){var listInstance=Vtiger_List_Js.getInstance(),validationResult=listInstance.checkListRecordSelected();if(!0!==validationResult){var postData=listInstance.getSearchParams();delete postData.parent,postData.view='SendMailModal',postData.cvid=listInstance.getCurrentCvId(),params&&jQuery.extend(postData,params),AppConnector.request(postData).done(function(response){app.showModalWindow(response,function(data){data.find('[name="saveButton"]').on('click',function(){data.find('form').validationEngine('validate')&&(jQuery.extend(postData,{field:data.find('#field').val(),template:data.find('#template').val(),action:'Mail',mode:'sendMails'}),delete postData.view,AppConnector.request(postData).done(function(response){!0==response.result&&app.hideModalWindow();}).fail(function(){app.hideModalWindow();}));});});});}else listInstance.noRecordSelectedAlert();},/*
...
listFloatThead:!1,getListSearchInstance:function getListSearchInstance(events){return null!=events&&(this.noEventsListSearch=events),!1==this.listSearchInstance&&(this.getListViewContainer().find('.searchField').length||this.getListViewContainer().find('.picklistSearchField').length)&&(this.listSearchInstance=YetiForce_ListSearch_Js.getInstance(this.getListViewContainer(),this.noEventsListSearch)),this.listSearchInstance},getListViewContainer:function getListViewContainer(){return !1==this.listViewContainer&&(this.listViewContainer=jQuery('div.listViewPageDiv')),this.listViewContainer},getListViewTopMenuContainer:function getListViewTopMenuContainer(){return !1==this.listViewTopMenuContainer&&(this.listViewTopMenuContainer=jQuery('.listViewTopMenuDiv')),this.listViewTopMenuContainer},getListViewContentContainer:function getListViewContentContainer(){return !1==this.listViewContentContainer&&(this.listViewContentContainer=jQuery('.listViewContentDiv')),this.listViewContentContainer},getFilterBlock:function getFilterBlock(){if(!1==this.filterBlock){var filterSelectElement=this.getFilterSelectElement();0>=filterSelectElement.length?this.filterBlock=jQuery():filterSelectElement.is('select')&&(this.filterBlock=filterSelectElement.data('select2').$dropdown);}return this.filterBlock},getFilterSelectElement:function getFilterSelectElement(){return !1==this.filterSelectElement&&(this.filterSelectElement=jQuery('#customFilter')),this.filterSelectElement},getSearchParams:function getSearchParams(){var params=this.getDefaultParams();return !0!==this.checkListRecordSelected()&&(params.selected_ids=this.readSelectedIds(!0),params.excluded_ids=this.readExcludedIds(!0)),params},getDefaultParams:function getDefaultParams(){var params={module:app.getModuleName(),page:$('#pageNumber').val(),view:app.getViewName(),viewname:this.getCurrentCvId(),orderby:$('#orderBy').val(),entityState:$('#entityState').val()};app.getUrlVar('mid')&&(params.mid=app.getUrlVar('mid')),app.getParentModuleName()&&(params.parent=app.getParentModuleName()),$('#sortOrder').length&&(params.sortorder=$('#sortOrder').val());var listSearchInstance=this.getListSearchInstance();if(!1!==listSearchInstance){var _searchValue=listSearchInstance.getAlphabetSearchValue();params.search_params=JSON.stringify(listSearchInstance.getListSearchParams(!0)),'undefined'!=typeof _searchValue&&0<_searchValue.length&&(params.search_key=listSearchInstance.getAlphabetSearchField(),params.search_value=_searchValue,params.operator='s');}return params},/*
		 ...
		 */getPageCount:function getPageCount(){var aDeferred=jQuery.Deferred(),pageCountParams=this.getPageJumpParams();return AppConnector.request(pageCountParams).done(function(data){var response;response='object'==('undefined'==typeof data?'undefined':_typeof(data))?data:JSON.parse(data),aDeferred.resolve(response);}).fail(function(){}),aDeferred.promise()},/**
...
jQuery('#recordsCount').val(''),jQuery('#totalPageCount').text(''),$('.pagination').data('totalCount',0),this.getListViewRecords(urlParams).done(function(){_this3.breadCrumbsFilter(selectOption.text()),_this3.ListViewPostOperation(),_this3.updatePagination(1);}),event.stopPropagation();},/*
...
return $(':focus').length?void _this4.registerChangeCustomFilterEvent(event):(event.preventDefault(),filterSelect.select2('close'),!1)}),filterSelect.on('click','option',this.registerChangeCustomFilterEvent.bind(this)),this.getFilterBlock().on('mouseup','.select2-results__option',this.registerChangeCustomFilterEvent.bind(this)),this.getListViewTopMenuContainer().find('.js-filter-tab').on('click',function(e){var cvId=$(e.currentTarget).data('cvid'),selectOption=filterSelect.find('[value='+cvId+']');selectOption.trigger('click'),$('#select2-customFilter-container span').contents().last().replaceWith(selectOption.text()),filterSelect.val(cvId).trigger('change');});},breadCrumbsFilter:function breadCrumbsFilter(text){var breadCrumbs=jQuery('.breadcrumbsContainer'),breadCrumbsLastSpan=breadCrumbs.last('span'),filterExist=breadCrumbsLastSpan.find('.breadCrumbsFilter');filterExist.length&&text!=null?filterExist.text(' ['+app.vtranslate('JS_FILTER')+': '+text+']'):1>filterExist.length&&(text=text==null?this.getFilterSelectElement().find(':selected').text():text,breadCrumbsLastSpan.hasClass('breadCrumbsFilter')?breadCrumbsLastSpan.text(': '+text):breadCrumbs.append('<small class="breadCrumbsFilter hideToHistory p-1 js-text-content u-text-ellipsis--no-hover" data-js="text"> ['+app.vtranslate('JS_FILTER')+': '+text+']</small>'));},ListViewPostOperation:function ListViewPostOperation(){return !0},/*
		 ...
		 */registerDeselectAllClickEvent:function registerDeselectAllClickEvent(){var listViewPageDiv=this.getListViewContainer(),thisInstance=this;listViewPageDiv.on('click','#deSelectAllMsg',function(){jQuery('#deSelectAllMsgDiv').hide(),jQuery('#listViewEntriesMainCheckBox').prop('checked',!1),jQuery('.listViewEntriesCheckBox').each(function(){jQuery(this).prop('checked',!1).closest('tr').removeClass('highlightBackgroundColor');});thisInstance.writeSelectedIds([]),thisInstance.writeExcludedIds([]);});},/*
...
this.getFilterSelectElement().data('select2').close(),new CustomView($(event.currentTarget).find('#createFilter').data('createurl'));},registerFeaturedFilterClickEvent:function registerFeaturedFilterClickEvent(){var thisInstance=this,listViewFilterBlock=this.getFilterBlock();!1!=listViewFilterBlock&&listViewFilterBlock.on('mouseup','.js-filter-favorites',function(event){var liElement=$(this).closest('.select2-results__option'),currentOptionElement=thisInstance.getSelectOptionFromChosenOption(liElement),params={cvid:currentOptionElement.attr('value'),module:'CustomView',action:'Featured',sorceModuleName:app.getModuleName()};params.actions=1===currentOptionElement.data('featured')?'remove':'add',AppConnector.request(params).done(function(){window.location.reload();}),event.stopPropagation();});},/*
		 ...
		 */inactiveFieldsValidation:function inactiveFieldsValidation(form){var massEditFieldList=jQuery('#massEditFieldsNameList').data('value');for(var fieldName in massEditFieldList){var fieldInfo=massEditFieldList[fieldName],fieldElement=form.find('[name="'+fieldInfo.name+'"]');//Not all the fields will be enabled for mass edit
...
var listViewContainer=this.getListViewContentContainer();listViewContainer.find('#listViewEntriesMainCheckBox,.listViewEntriesCheckBox').prop('checked',!1),this.getListSearchInstance(!1),this.registerDesktopEvents(listViewContainer),this.registerUnreviewedCountEvent(),this.registerLastRelationsEvent(),Vtiger_Index_Js.registerMailButtons(listViewContainer);},/**
		 ...
		 */postMassDeleteRecords:function postMassDeleteRecords(){var aDeferred=jQuery.Deferred(),listInstance=Vtiger_List_Js.getInstance();return app.hideModalWindow(),listInstance.getListViewRecords().done(function(){jQuery('#recordsCount').val(''),jQuery('#totalPageCount').text(''),jQuery('#deSelectAllMsg').trigger('click'),listInstance.calculatePages().done(function(){listInstance.updatePagination();}),aDeferred.resolve();}),jQuery('#recordsCount').val(''),aDeferred.promise()}});
