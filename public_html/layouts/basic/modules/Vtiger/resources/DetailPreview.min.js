...
$.Class('Vtiger_DetailPreview_Js', {}, {
  ...
  */
	registerLinkEvent: function registerLinkEvent() {
  ...
  */
	updateParentFrame: function updateParentFrame() {
  ...
  */
	registerSizeEvent: function registerSizeEvent() {
		var thisInstance = this;
  ...
  */
	registerDetailEvent: function registerDetailEvent() {
		var moduleClassName = app.getModuleName() + '_Detail_Js',
		    parent = false;
	...
	updateChatConfig: function updateChatConfig() {
