...
/* {[The file is published on the basis of YetiForce Public License 4.0 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */'use strict';Vtiger_List_Js("Vtiger_ListPreview_Js",{},{frameProgress:!1,/**
...
var listOffsetTop=this.list.offset().top-this.headerH,initialH=this.sideBlocks.height(),mainViewPortHeightCss={height:mainBody.height()},mainViewPortWidthCss={width:mainBody.height()};this.gutter.addClass("js-fixed-scroll");var fixedElements=this.container.find(".js-fixed-scroll"),fixedThead=this.list.siblings(".floatThead-container");scrollContainer.on("scroll",function onScroll(){scrollContainer.scrollTop()>=listOffsetTop?(fixedThead.add(fixedElements).css({top:scrollContainer.scrollTop()-listOffsetTop}),fixedElements.css(mainViewPortHeightCss),_this2.rotatedText.css(mainViewPortHeightCss),_this2.rotatedText.css(mainViewPortWidthCss)):(fixedThead.add(fixedElements).css({top:"initial"}),fixedElements.css({height:initialH+scrollContainer.scrollTop()}),_this2.rotatedText.css({width:initialH+scrollContainer.scrollTop(),height:initialH+scrollContainer.scrollTop()}));});},registerResizeEvent:function registerResizeEvent(){var _this3=this;$(window).on("resize",function(){App.Components.Scrollbar.page.element.scrollTop()>=_this3.list.offset().top+$(".commonActionsContainer").height()&&_this3.container.find(".gutter").css("left",_this3.preview.offset().left-8);});},registerFixedThead:function registerFixedThead(){var list=this.list;this.listFloatThead=list.find(".js-fixed-thead"),this.listFloatThead.floatThead("destroy"),this.listFloatThead.floatThead({scrollContainer:function scrollContainer(){return list}}),this.listFloatThead.floatThead("reflow");},getSecondColMinWidth:function getSecondColMinWidth(container){var thisWidth,maxWidth=0;return container.find(".listViewEntries").each(function(i){thisWidth=$(this).find(".listViewEntryValue a").first().width(),0===i?maxWidth=thisWidth:thisWidth>maxWidth?maxWidth=thisWidth:maxWidth;}),maxWidth},setDomParams:function setDomParams(container){this.container=container,this.listColumnFirstWidth=container.find(".listViewEntriesDiv .listViewHeaders th").first().width(),this.listColumnSecondWidth=this.getSecondColMinWidth(container),this.windowMinWidth=100*(15/$(window).width()),this.windowMaxWidth=100-this.minWidth,this.sideBlocks=container.find(".js-side-block"),this.sideBlockLeft=this.sideBlocks.first(),this.sideBlockRight=this.sideBlocks.last(),this.list=container.find(".js-list-preview"),this.preview=container.find(".js-detail-preview"),this.rotatedText=container.find(".u-rotate-90"),this.footerH=$(".js-footer").outerHeight(),this.headerH=$(".js-header").outerHeight();},getDefaultSplitSizes:function getDefaultSplitSizes(){var thWidth=100*((this.listColumnFirstWidth+this.listColumnSecondWidth+82)/$(window).width());return [thWidth,100-thWidth]},/**
		 ...
		 */registerPreviewEvent:function registerPreviewEvent(){var _this7=this,iframe=$(".listPreviewframe"),container=this.getListViewContentContainer();this.setDomParams(container),this.toggleSplit(container),993<$(window).width()&&this.registerListEvents(container),iframe.on("load",function(){_this7.frameProgress.progressIndicator({mode:"hide"}),iframe.height(iframe.contents().find(".bodyContents").height()-20);}),$(".listViewEntriesTable .listViewEntries").first().trigger("click");},/**
