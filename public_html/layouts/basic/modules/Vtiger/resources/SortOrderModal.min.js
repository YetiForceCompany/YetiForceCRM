...
/* {[The file is published on the basis of YetiForce Public License 4.0 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */'use strict';$.Class("Base_SortOrderModal_JS",{},{/**
		 * Modal container
		 */container:!1,/**
		 * Source container
		 */sourceContainer:!1,/**
		 ...
		 */getSourceContainer:function getSourceContainer(){return $("[data-modalid="+this.source+"]").closest(".listViewContentDiv,.relatedContainer,.js-kanban-header")},/**
