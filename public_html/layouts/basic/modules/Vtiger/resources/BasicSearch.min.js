...
jQuery.Class('Vtiger_BasicSearch_Js', {}, {
  ...
  */
	getSearchModule: function getSearchModule() {
  ...
  */
	setSearchModule: function setSearchModule(moduleName) {
  ...
  */
	getCurrentSearchModule: function getCurrentSearchModule() {
  ...
  */
	_search: function _search(params) {
		...
		if (this.mainContainer) {
			var operatorElement = this.mainContainer.find('.js-global-search-operator .active[data-operator]');
