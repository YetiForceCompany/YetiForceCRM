...
if(Vtiger_DashBoard_Js.grid=GridStack.init({verticalMargin:"0.5rem",alwaysShowResizeHandle:/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)},".grid-stack"),Vtiger_DashBoard_Js.grid.on("change",function(){thisInstance.savePositions($(".grid-stack-item"));}),this.loadWidgets(),this.getContainer().width()!==this.getContainer().parent().width()){var parentWidth=thisInstance.getContainer().parent().width();this.getContainer().css("width",parentWidth+"px");}},savePositions:function savePositions(widgets){for(var widget,widgetRowColPositions={},widgetSizes={},index=0,len=widgets.length;index<len;++index)widget=$(widgets[index]),widgetRowColPositions[widget.find(".grid-stack-item-content").attr("id")]=JSON.stringify({row:widget.attr("data-gs-y"),col:widget.attr("data-gs-x")}),widgetSizes[widget.find(".grid-stack-item-content").attr("id")]=JSON.stringify({width:widget.attr("data-gs-width"),height:widget.attr("data-gs-height")});this.updateLazyWidget(),AppConnector.request({module:app.getModuleName(),action:"SaveWidgetPositions",position:widgetRowColPositions,size:widgetSizes});},updateLazyWidget:function updateLazyWidget(){var scrollTop=this.scrollContainer.scrollTop();this.scrollContainer.scrollTop(scrollTop+1).scrollTop(scrollTop);},loadWidgets:function loadWidgets(){var thisInstance=this;this.scrollContainer=App.Components.Scrollbar.page.element,Quasar.plugins.Platform.is.desktop||(this.scrollContainer=$(".bodyContent"),app.showNewScrollbar(this.scrollContainer)),thisInstance.getContainer().find(".dashboardWidget").Lazy({threshold:0,appendScroll:this.scrollContainer,widgetLoader:function widgetLoader(element){thisInstance.loadWidget(element);}}),this.updateLazyWidget(this.scrollContainer);},loadWidget:function loadWidget(widgetContainer){var self=this,urlParams=widgetContainer.data("url"),mode=widgetContainer.data("mode"),moduleName=app.getModuleName(),sourceModule=$("a.active","ul.selectDashboradView").parent().data("module");if(widgetContainer.progressIndicator(),"open"===mode){var name=widgetContainer.attr("id"),userId=CONFIG.userId;if(1===widgetContainer.data("cache")){var cacheUrl=app.cacheGet(name+"_"+userId,!1);urlParams=cacheUrl?cacheUrl:urlParams;}AppConnector.request(urlParams).done(function(data){widgetContainer.html(data),widgetContainer.closest(".grid-stack").on("gsresizestop",function(){self.adjustHeightWidget(widgetContainer);}),App.Fields.Picklist.showSelect2ElementView(widgetContainer.find(".select2")),App.Fields.Tree.register(widgetContainer),self.getWidgetInstance(widgetContainer),widgetContainer.trigger(Vtiger_Widget_Js.widgetPostLoadEvent),self.adjustHeightWidget(widgetContainer),sourceModule&&moduleName!=sourceModule&&$("a.js-widget-remove",widgetContainer).remove();});}},/**
		 ...
		 */showAndHideAlert:function showAndHideAlert(widgetAction){var container=this.getContainer(),alertContainer=container.find(".js-dashboards-alert");"addWidget"===widgetAction?alertContainer.addClass("d-none"):0==container.find(".js-css-element-queries").length&&alertContainer.removeClass("d-none");},registerEvents:function registerEvents(){this.registerGrid(),this.registerRefreshWidget(),this.removeWidget(),this.registerDatePickerHideInitiater(),this.registerShowMailBody(),this.registerChangeMailUser(),this.registerMiniListWidget(),this.registerTabModules(),this.removeWidgetFromList(),this.registerSelectDashboard(),this.registerTabletScrollEvent(),this.registerUpdatePredefinedWidgets(),ElementQueries.listen();}});
