...
var Vtiger_Index_Js = {
	showLocation: function showLocation(element) {
	...
	massAddDocuments: function massAddDocuments(url) {
	...
	getEmailFromRecord: function getEmailFromRecord(record, module, maxEmails) {
	...
	registerMailButtons: function registerMailButtons(container) {
	...
	sendMailWindow: function sendMailWindow(url, popup, postData) {
		if (popup) {
  ...
  */
	loadWidgets: function loadWidgets(widgetContainer, open) {
	...
	loadWidgetsOnLoad: function loadWidgetsOnLoad() {
		var widgets = $('div.widgetContainer');
  ...
  */
	...
	markNotifications: function markNotifications(id) {
		var aDeferred = $.Deferred();
		var thisInstance = this;
		var params = {
			module: 'Notification',
	...
	markAllNotifications: function markAllNotifications(element) {
		var ids = [];
  ...
  */
	registerReminders: function registerReminders() {
	...
	getNotificationsForReminder: function getNotificationsForReminder() {
		var thisInstance = this;
  ...
  */
	requestReminder: function requestReminder() {
		var thisInstance = this;
	...
	refreshReminderCount: function refreshReminderCount(content, element, tag) {
	...
	changeWatching: function changeWatching(instance) {
		var value, module, state, user, record;
	...
	updateWatching: function updateWatching(module, value, user, record) {
		var aDeferred = $.Deferred();
		var params = {
			module: module,
			action: 'Watchdog',
	...
	assignToOwner: function assignToOwner(element, userId) {
		element = $(element);
		if (userId == undefined) {
	...
	performPhoneCall: function performPhoneCall(phoneNumber, record) {
		AppConnector.request({
			module: app.getModuleName(),
			view: 'BasicAjax',
	...
	registerAterloginEvents: function registerAterloginEvents() {
