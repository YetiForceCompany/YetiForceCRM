...
jQuery.Class('Vtiger_TreeRecords_Js', {}, {
	...
	getTreeListValues: function getTreeListValues(container) {
	...
	getRecordsParams: function getRecordsParams(container) {
		var selected = [];
	...
	getRecordsList: function getRecordsList() {
		var thisInstance = this;
	...
	registerFilterChangeEvent: function registerFilterChangeEvent(container) {
		var thisInstance = this;
		container.on('change', '#moduleFilter', function (e) {
			thisInstance.getRecordsList();
		});
	},
	registerSelectBrancheEvent: function registerSelectBrancheEvent(container) {
		var thisInstance = this;
