	...
	getValues: function getValues() {
		...
		conditionGroups.each(function (index, domElement) {
			...
			conditions.each(function (i, conditionDomElement) {
				...
				var fieldType = fieldSelectElement.find('option:selected').data('fieldinfo').type,
				    rowValues = {},
				    key = void 0,
				    field = void 0;
	...
	getPopUp: function getPopUp(container) {
		...
		container.on('click', '.getPopupUi', function (e) {
			...
			var callBackFunction = function callBackFunction(data) {
				...
				var moduleNameElement = fieldValueElement.closest('.js-conditions-row').find('[name="modulename"]');
	...
	getUi: function getUi() {
		...
		if (comparatorSelectedOptionVal.length > 0) {
			if (comparatorSelectedOptionVal === 'between' || comparatorSelectedOptionVal === 'custom') {
				...
				html = '<input name="' + this.getName() + '" type="text" value="' + this.getValue() + '" data-validation-engine="' + 'validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]]"' + ' data-validator="[{"name":"PositiveNumber"}]">' + '<input type="hidden" name="valuetype" value="' + this.get('workflow_valuetype') + '" />';
				return jQuery(html);
				...
				return $(html);
			} else if (comparatorSelectedOptionVal === 'is today') ; else {
				return this._super();
			}
		} else {
			html = '<input type="text" class="getPopupUi date form-control" name="' + this.getName() + '"  data-date-format="' + this.getDateFormat() + '"  value="' + this.getValue() + '" />' + '<input type="hidden" name="valuetype" value="' + this.get('workflow_valuetype') + '" />';
			element = $(html);
			return this.addValidationToElement(element);
		}
	},
	_specialDateComparator: function _specialDateComparator(comp) {
...
Vtiger_Date_Field_Js('AdvanceFilterEx_Datetime_Field_Js', {}, {
  ...
  */
	...
	_specialDateTimeComparator: function _specialDateTimeComparator(comp) {
...
Vtiger_Currency_Field_Js('AdvanceFilterEx_Currency_Field_Js', {}, {
	getUi: function getUi() {
		var html = '<input type="text" class="getPopupUi marginLeftZero form-control" name="' + this.getName() + '" value="' + this.getValue() + '"  />' + '<input type="hidden" name="valuetype" value="' + this.get('workflow_valuetype') + '" />';
...
Vtiger_Time_Field_Js('AdvanceFilterEx_Time_Field_Js', {}, {
  ...
  */
	getUi: function getUi() {
		var html = '<input type="text" class="getPopupUi time form-control" name="' + this.getName() + '"  value="' + this.getValue() + '" />' + '<input type="hidden" name="valuetype" value="' + this.get('workflow_valuetype') + '" />';
		var element = jQuery(html);
		return this.addValidationToElement(element);
	}
});
...
Vtiger_Field_Js('Vtiger_Percentage_Field_Js', {}, {
  ...
  */
	getUi: function getUi() {
		var html = '<input type="text" class="getPopupUi form-control" name="' + this.getName() + '" value="' + this.getValue() + '" />' + '<input type="hidden" name="valuetype" value="' + this.get('workflow_valuetype') + '" />';
		var element = jQuery(html);
		return this.addValidationToElement(element);
	}
});
...
Vtiger_Field_Js('Vtiger_Boolean_Field_Js', {}, {
  ...
  */
	getUi: function getUi() {
		var html = '<input type="text" class="getPopupUi form-control boolean" name="' + this.getName() + '" value="' + this.getValue() + '" />' + '<input type="hidden" name="valuetype" value="' + this.get('workflow_valuetype') + '" />';
		var element = jQuery(html);
		return this.addValidationToElement(element);
	}
});
