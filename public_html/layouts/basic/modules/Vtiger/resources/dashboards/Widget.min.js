...
return data.datasets=data.datasets.map(function(dataset,index){return dataset.datasetIndex=index,_this4.parseOptions(dataset,dataset,!0)}),chart},/**
		 ...
		 * Register calendar
		 */registerCalendar:function registerCalendar(){var _this9=this,self=this,container=this.getContainer(),userTimeFormat=CONFIG.hourFormat;//Default time format
