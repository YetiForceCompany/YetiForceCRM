...
Vtiger_BasicSearch_Js('Vtiger_AdvanceSearch_Js', {
  ...
  */
	...
	getFilterForm: function getFilterForm() {
  ...
  */
	getAdvanceSearch: function getAdvanceSearch() {
  ...
  */
	initiateSearch: function initiateSearch() {
		...
		var postLoad = function postLoad(uiData) {
  ...
  */
	showSearchResults: function showSearchResults(data) {
		var aDeferred = $.Deferred();
		var postLoad = function postLoad(data) {
			//app.showScrollBar($(data).find('.contents'));
			aDeferred.resolve(data);
		};
		var html = '<div class="row">' + '<span class="col-md-4 searchHolder"></span>' + '<span class="col-md-8 filterHolder marginLeftZero d-none"></span>' + '</div>';
		var jQhtml = $(html);
  ...
  */
	saveAndViewFilter: function saveAndViewFilter(params) {
		this.saveFilter(params).done(function (response) {
  ...
  */
	isSearchAndFilterComponentsShown: function isSearchAndFilterComponentsShown() {
  ...
  */
	performValidation: function performValidation() {
		...
		var validationDone = function validationDone(form, status) {
			if (status) {
  ...
  */
	registerShowFiler: function registerShowFiler() {
		var thisInstance = this;
	...
	registerEvents: function registerEvents() {
		...
		$('#advanceSearchButton').on('click', function (e) {
			...
			if (searchModule.length <= 0) {
				app.getChosenElementFromSelect($('#searchModuleList')).validationEngine('showPrompt', app.vtranslate('JS_SELECT_MODULE'), 'error', 'topRight', true);
				return;
			}
