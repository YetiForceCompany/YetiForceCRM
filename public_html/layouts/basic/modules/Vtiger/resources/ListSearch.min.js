...
jQuery.Class('YetiForce_ListSearch_Js',{getInstance:function getInstance(container,noEvents,reletedInstance,moduleName){'undefined'==typeof moduleName&&(moduleName=app.getModuleName());var instance,moduleClassName=module+'_ListSearch_Js';return instance='undefined'==typeof window[moduleClassName]?new window.YetiForce_ListSearch_Js(container,noEvents,reletedInstance):new window[moduleClassName](container,noEvents,reletedInstance),instance.moduleName=moduleName,instance},registerSearch:function registerSearch(container,callBack){container.on('click','.js-change-order',function(e){var element=$(e.currentTarget);callBack({orderby:defineProperty({},element.data('columnname'),element.data('nextsortorderval'))});}),container.on('click','.js-listview_header',function(e){var element=$(e.currentTarget);callBack({orderby:element.data('columnname'),sortorder:element.data('nextsortorderval')});}),container.on('click','.js-list-reload',function(e,data){callBack(data);});}},{moduleName:!1,container:!1,reletedInstance:!1,viewName:!1,/**
