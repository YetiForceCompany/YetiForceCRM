...
Vtiger_Detail_Js(
	...
	{},
	{
		 ...
		 */ registerEmailEnabledActions: function registerEmailEnabledActions() {
			var moduleName = app.getModuleName(),
				listInstance = new window[moduleName + '_List_Js']();
			listInstance.registerEvents(), listInstance.markSelectedRecords();
		},
		registerEventForRelatedTabClick: function registerEventForRelatedTabClick() {
			var thisInstance = this,
				detailContentsHolder = thisInstance.getContentHolder(),
				detailContainer = detailContentsHolder.closest('div.detailViewInfo');
			jQuery('.related', detailContainer).on('click', 'li:not(.spaceRelatedList)', function (
				...
				if (!tabElement.hasClass('dropdown')) {
					...
					element.progressIndicator({
						position: 'html',
						blockInfo: { enabled: !0, elementToBlock: detailContainer }
					});
					var url = tabElement.data('url');
					if ('undefined' != typeof urlAttributes) {
					...
					thisInstance
						...
						.done(function (data) {
							...
							'function' == typeof callBack && callBack(data),
								tabElement.data('linkKey') == thisInstance.detailViewSummaryTabLabel &&
		...
		registerEvents: function registerEvents() {
			this._super(); //Calling registerevents of campaigns list to handle checkboxs click of related records
			...
			app.event.on('RelatedList.AfterLoad', function (event, instance) {
				...
				emailEnabledModule && thisInstance.registerEmailEnabledActions();
			});
		}
	}
);
