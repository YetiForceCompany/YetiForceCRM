...
Vtiger_Edit_Js('Documents_Edit_Js', {}, {
	...
	getMaxiumFileUploadingSize: function getMaxiumFileUploadingSize(container) {
		return container.find('.maxUploadSize').data('value');
	},

	isFileLocationInternalType: function isFileLocationInternalType(fileLocationElement) {
	...
	isFileLocationExternalType: function isFileLocationExternalType(fileLocationElement) {
	...
	convertFileSizeInToDisplayFormat: function convertFileSizeInToDisplayFormat(fileSizeInBytes) {
		var i = -1;
	...
	registerFileLocationTypeChangeEvent: function registerFileLocationTypeChangeEvent(container) {
	...
	registerFileChangeEvent: function registerFileChangeEvent(container) {
		var thisInstance = this;
