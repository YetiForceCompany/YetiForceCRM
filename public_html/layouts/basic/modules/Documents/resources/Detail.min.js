...
Vtiger_Detail_Js("Documents_Detail_Js", {
  ...
  */
	checkFileIntegrity: function checkFileIntegrity(checkFileIntegrityUrl) {
  ...
  */
	getFileIntegrityResponse: function getFileIntegrityResponse(params) {
  ...
  */
	displayCheckFileIntegrityResponse: function displayCheckFileIntegrityResponse(data) {
	...
	showNotify: function showNotify(customParams) {
		var params = {
