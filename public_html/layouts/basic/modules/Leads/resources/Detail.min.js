...
Vtiger_Detail_Js("Leads_Detail_Js", {
  ...
  */
	convertLead: function convertLead(convertLeadUrl, buttonElement) {
		...
		if (jQuery.isEmptyObject(Leads_Detail_Js.cache)) {
			AppConnector.request(convertLeadUrl).done(function (data) {
				if (data) {
  ...
  */
	disableConvertLeadButton: function disableConvertLeadButton(button) {
		jQuery(button).attr('disabled', 'disabled');
	},
	/*
  * function to enable the Convert Lead button
  */
	enableConvertLeadButton: function enableConvertLeadButton(button) {
		jQuery(button).removeAttr('disabled');
	},
	/*
  * function to enable all the input and textarea elements
  */
	removeDisableAttr: function removeDisableAttr(moduleBlock) {
		moduleBlock.find('input,textarea,select').removeAttr('disabled');
	},
	/*
  * function to disable all the input and textarea elements
  */
	addDisableAttr: function addDisableAttr(moduleBlock) {
  ...
  */
	displayConvertLeadModel: function displayConvertLeadModel(data, buttonElement) {
		var instance = this;
		...
		if (errorElement.length != '0') {
			...
			var params = {
				...
				width: '35%',
				pnotify_after_open: function pnotify_after_open() {
					instance.disableConvertLeadButton(buttonElement);
				},
				pnotify_after_close: function pnotify_after_close() {
  ...
  */
	checkingModuleSelection: function checkingModuleSelection(element) {
		var instance = this;
	...
	registerForReferenceField: function registerForReferenceField() {
  ...
  */
	registerConvertLeadEvents: function registerConvertLeadEvents() {
		var container = this.getConvertLeadContainer();
		var instance = this;
		//Trigger Event to change the icon while shown and hidden the accordion body
		container.on('hide.bs.collapse', '.js-collapse ', function (e) {
			$(e.currentTarget).closest('.convertLeadModules').find('.fas').removeClass('fa-chevron-up').addClass('fa-chevron-down');
		}).on('show.bs.collapse', '.js-collapse ', function (e) {
			$(e.currentTarget).closest('.convertLeadModules').find('.fas').removeClass('fa-chevron-down').addClass('fa-chevron-up');
		});
  ...
  */
	registerConvertLeadSubmit: function registerConvertLeadSubmit() {
  ...
  */
	getConvertLeadModules: function getConvertLeadModules() {
		var container = this.getConvertLeadContainer();
  ...
  */
	getConvertLeadForm: function getConvertLeadForm() {
  ...
  */
	...
	updateConvertLeadvalue: function updateConvertLeadvalue() {
