...
Vtiger_List_Js("Portal_List_Js", {
	...
	editBookmark: function editBookmark(params) {
	...
	massDeleteRecords: function massDeleteRecords() {
	...
	loadListViewContent: function loadListViewContent(url) {
	...
	registerAddBookmark: function registerAddBookmark() {
	...
	registerEditBookmark: function registerEditBookmark() {
	...
	registerDeleteBookmark: function registerDeleteBookmark() {
	...
	registerAlphabetSearch: function registerAlphabetSearch() {
	...
	registerSortingEvent: function registerSortingEvent() {
	...
	registerPreviousPageEvent: function registerPreviousPageEvent() {
	...
	registerNextPageEvent: function registerNextPageEvent() {
