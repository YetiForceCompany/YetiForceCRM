...
$.Class('Settings_WebserviceApps_Index_Js', {}, {
  ...
  */
	registerTableEvents: function registerTableEvents() {
		var thisInstance = this;
		var container = this.container = $('.configContainer');
  ...
  * @param {int} id
  */
	showFormToEditKey: function showFormToEditKey(id) {
		var thisInstance = this;
		var params = {
			module: app.getModuleName(),
			parent: app.getParentModuleName(),
		...
		AppConnector.request(params).done(function (data) {
			...
			app.showModalWindow(data, function (container) {
				var prevButton = container.find('.previewPassword');
				var password = container.find('[name="pass"]');
				...
				var clipboard = App.Fields.Text.registerCopyClipboard(container, '.copyPassword');
  ...
  */
	registerAddButton: function registerAddButton() {
		var thisInstance = this;
