...
jQuery.Class('Settings_PublicHoliday_Js', {}, {
  ...
  */
	registerDeleteHoliday: function registerDeleteHoliday(element) {
  ...
  */
	deleteHoliday: function deleteHoliday(holidayId) {
		var thisInstance = this,
  ...
  */
	registerAddDate: function registerAddDate() {
		var thisInstance = this,
  ...
  * Function to register click event for add custom block button
  */
	registerEditDate: function registerEditDate() {
		var thisInstance = this,
		    contents = jQuery('#layoutDashBoards');
  ...
  */
	saveNewDate: function saveNewDate(form) {
		var thisInstance = this,
	...
	registerChangeDate: function registerChangeDate() {
		var thisInstance = this,
