...
Settings_Vtiger_Index_Js('Settings_Logs_Index_Js', {
	getWarningsList: function getWarningsList() {
		var thisInstance = this;
		var container = $('.js-warnings-content');
	...
	registerWarningsList: function registerWarningsList(container) {
		var _this = this;
		...
		container.find('.setIgnore').on('click', function (e) {
			...
			AppConnector.request({
				...
				_this.getWarningsList(container);
			});
		});
	},
	registerWarningsFolders: function registerWarningsFolders(container) {
		var thisInstance = this;
		var data = [];
		var treeValues = container.find('.js-tree-values').val();
		if (treeValues) {
		...
		container.find('.js-switch--warnings').on('change', function () {
			thisInstance.getWarningsList();
		});
	},
