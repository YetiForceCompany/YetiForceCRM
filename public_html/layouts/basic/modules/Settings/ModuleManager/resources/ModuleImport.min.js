...
jQuery.Class('Settings_Module_Import_Js', {}, {
  ...
  */
	getImportModuleStep1Params: function getImportModuleStep1Params() {
		var params = {
  ...
  */
	getImportModuleStepView: function getImportModuleStepView(params) {
  ...
  */
	validationFileZipPath: function validationFileZipPath(form) {
		form.on('submit', function (e) {
			if (typeof form.data('submit') !== "undefined") {
				return false;
			} else {
				var filePath = form.find('.js-validation-zip').val();
				...
				if (fileType != 'zip') {
					var _errorMessage = app.vtranslate('JS_SELECT_FILE_EXTENSION') + '\n' + '.zip';
					var _params = {
						text: _errorMessage,
						type: 'error'
					};
					Vtiger_Helper_Js.showMessage(_params);
					return false;
				}
			}
		});
  ...
  */
	registerEventsForImportModuleStep1: function registerEventsForImportModuleStep1(container) {
  ...
  */
	registerEventsForImportModuleStep2: function registerEventsForImportModuleStep2(container) {
