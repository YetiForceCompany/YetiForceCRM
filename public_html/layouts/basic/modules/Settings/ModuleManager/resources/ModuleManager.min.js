...
jQuery.Class('Settings_Module_Manager_Js', {
	validateField: function validateField(field, rules, i, options) {
		var specialChars = /[&\<\>\:\'\"\,]/;
	...
	validateModuleName: function validateModuleName(field, rules, i, options) {
		var returnVal = false;
	...
	sendForm: function sendForm(form) {
	...
	registerModalCreateModule: function registerModalCreateModule(data) {
		var _this = this;
  ...
  */
	updateModuleStatus: function updateModuleStatus(currentTarget) {
	...
	createModule: function createModule(currentTarget) {
		var progressIndicatorElement = jQuery.progressIndicator();
	...
	frameProgress: false,
	deleteModule: function deleteModule(container) {
		var self = this;
		container.on('click', '.deleteModule', function () {
			var forModule = $(this).attr("name");
