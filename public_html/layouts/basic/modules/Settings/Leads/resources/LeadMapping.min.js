...
jQuery.Class("Settings_LeadMapping_Js", {
  ...
  */
	triggerEdit: function triggerEdit(editUrl) {
  ...
  */
	triggerDelete: function triggerDelete(event, url) {
  ...
  */
	registerEventsForEditView: function registerEventsForEditView() {
  ...
  */
	registerEventForAddingNewMapping: function registerEventForAddingNewMapping() {
  ...
  */
	registerOnChangeEventForSourceModule: function registerOnChangeEventForSourceModule() {
		var form = jQuery('#leadsMapping');
  ...
  */
	registerEventForFormSubmit: function registerEventForFormSubmit() {
  ...
  */
	registerOnChangeEventOfTargetModule: function registerOnChangeEventOfTargetModule() {
		var form = jQuery('#leadsMapping');
