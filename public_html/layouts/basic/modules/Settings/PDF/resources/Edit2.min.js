...
/* {[The file is published on the basis of YetiForce Public License 4.0 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */'use strict';Settings_PDF_Edit_Js("Settings_PDF_Edit2_Js",{},{step2Container:!1,advanceFilterInstance:!1,init:function init(){this.initialize();},/**
...
return valid},opts.promptPosition="topLeft",container.validationEngine(opts),App.Fields.Picklist.showSelect2ElementView(container.find(".select2")),this.registerCancelStepClickEvent(container),App.Fields.Text.registerCopyClipboard(container);}});
