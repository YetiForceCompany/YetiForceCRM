...
/* {[The file is published on the basis of YetiForce Public License 6.5 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */"use strict";jQuery.Class("Settings_MailRbl_Index_Js",{},{dataTable:!1,dataTableMap:{forVerification:{order:[[0,"desc"]],columns:[{data:"datetime"},{orderable:!1,data:"sender"},{orderable:!1,data:"recipient"},{orderable:!1,data:"ip"},{data:"type"},{data:"user"},{orderable:!1,data:function data(row){var action="";return action+="<div class=\"o-tab__container--action\">",1!==row.statusId&&(action+="<button type=\"button\" class=\"btn btn-success btn-xs js-update\" data-id=\"".concat(row.id,"\" data-status=\"1\" title=\"").concat(app.vtranslate("BTN_STATUS_ACTION_ACCEPT"),"\" data-js=\"click\"><span class=\"fas fa-check\"></span></button>")),2!==row.statusId&&(action+="<button type=\"button\" class=\"btn btn-warning btn-xs ml-2 js-update\" data-id=\"".concat(row.id,"\" data-status=\"2\" title=\"").concat(app.vtranslate("BTN_STATUS_ACTION_REJECT"),"\" data-js=\"click\"><span class=\"fas fa-times\"></span></button>")),action+="<button type=\"button\" class=\"btn btn-secondary btn-xs ml-2 js-details\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_SHOW_DETAILS"),"\" data-js=\"click\"><span class=\"fas fa-search-plus\"></span></button>"),action+="<button type=\"button\" class=\"btn btn-danger btn-xs ml-2 js-trash\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_DELETE"),"\" data-js=\"click\"><span class=\"fas fa-trash\"></span></button>"),action+="</dv>",action},defaultContent:""}]},toSend:{order:[[0,"desc"]],columns:[{data:"datetime"},{orderable:!1,data:"sender"},{orderable:!1,data:"recipient"},{orderable:!1,data:"ip"},{data:"type"},{data:"user"},{orderable:!1,data:function data(row){var action="";return action+="<div class=\"o-tab__container--action\">",action+="<button type=\"button\" class=\"btn btn-primary btn-xs js-send-request-id\" data-type=\"quick\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_STATUS_ACTION_QUICK_SEND_REQUEST"),"\" data-js=\"click\"><span class=\"fas fa-fighter-jet\"></span></button>"),action+="<button type=\"button\" class=\"btn btn-info btn-xs ml-2 js-send-request-id\" data-type=\"manual\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_STATUS_ACTION_SEND_REQUEST"),"\" data-js=\"click\"><span class=\"fas fa-paper-plane\"></span></button>"),action+="<button type=\"button\" class=\"btn btn-secondary btn-xs ml-2 js-details\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_SHOW_DETAILS"),"\" data-js=\"click\"><span class=\"fas fa-search-plus\"></span></button>"),action+="<button type=\"button\" class=\"btn btn-danger btn-xs ml-2 js-trash\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_DELETE"),"\" data-js=\"click\"><span class=\"fas fa-trash\"></span></button>"),action+="</dv>",action},defaultContent:""}]},request:{order:[[0,"desc"]],columns:[{data:"datetime"},{orderable:!1,data:"sender"},{orderable:!1,data:"recipient"},{orderable:!1,data:"ip"},{data:"type"},{data:"status"},{data:"user"},{orderable:!1,data:function data(row){var action="";return action+="<div class=\"o-tab__container--action\">",action+="<button type=\"button\" class=\"btn btn-secondary btn-xs js-details\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_SHOW_DETAILS"),"\" data-js=\"click\"><span class=\"fas fa-search-plus\"></span></button>"),1==row.statusId?(action+="<button type=\"button\" class=\"btn btn-primary btn-xs ml-2 js-send-request-id\" data-type=\"quick\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_STATUS_ACTION_QUICK_SEND_REQUEST"),"\" data-js=\"click\"><span class=\"fas fa-fighter-jet\"></span></button>"),action+="<button type=\"button\" class=\"btn btn-info btn-xs ml-2 js-send-request-id\" data-type=\"manual\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_STATUS_ACTION_SEND_REQUEST"),"\" data-js=\"click\"><span class=\"fas fa-paper-plane\"></span></button>")):action+="<button type=\"button\" class=\"btn btn-success btn-xs ml-2 js-update\" data-id=\"".concat(row.id,"\" data-status=\"1\" title=\"").concat(app.vtranslate("BTN_STATUS_ACTION_ACCEPT"),"\" data-js=\"click\"><span class=\"fas fa-check\"></span></button>"),2!==row.statusId&&(action+="<button type=\"button\" class=\"btn btn-warning btn-xs ml-2 js-update\" data-id=\"".concat(row.id,"\" data-status=\"2\" title=\"").concat(app.vtranslate("BTN_STATUS_ACTION_REJECT"),"\" data-js=\"click\"><span class=\"fas fa-times\"></span></button>")),action+="<button type=\"button\" class=\"btn btn-danger btn-xs ml-2 js-trash\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_DELETE"),"\" data-js=\"click\"><span class=\"fas fa-trash\"></span></button>"),action+="</dv>",action},defaultContent:""}]},blackList:{columns:[{data:"ip"},{data:"status"},{orderable:!1,data:function data(row){var action="";return 0!=row.request&&(action+="<button type=\"button\" class=\"btn btn-secondary btn-sm js-details\" data-id=\"".concat(row.request,"\" title=\"").concat(app.vtranslate("BTN_SHOW_DETAILS"),"\" data-js=\"click\"><span class=\"fas fa-search-plus\"></span></button>")),action},defaultContent:""},{orderable:!1,data:function data(row){var action="";return 0!==row.statusId&&(action+="<button type=\"button\" class=\"btn btn-success btn-sm js-update\" data-id=\"".concat(row.id,"\" data-status=\"0\" title=\"").concat(app.vtranslate("BTN_STATUS_ACTION_ACCEPT"),"\" data-js=\"click\"><span class=\"fas fa-check\"></span></button>")),1!==row.statusId&&(action+="<button type=\"button\" class=\"btn btn-warning btn-sm ml-2 js-update\" data-id=\"".concat(row.id,"\" data-status=\"1\" title=\"").concat(app.vtranslate("BTN_UNLOCK_STATUS_ACTION_REJECT"),"\" data-js=\"click\"><span class=\"fas fa-times\"></span></button>")),action+="<button type=\"button\" class=\"btn btn-danger btn-sm ml-2 js-trash\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_DELETE"),"\" data-js=\"click\"><span class=\"fas fa-trash\"></span></button>"),action},defaultContent:""}]},whiteList:{columns:[{data:"ip"},{data:"status"},{orderable:!1,data:function data(row){var action="";return 0!=row.request&&(action+="<button type=\"button\" class=\"btn btn-secondary btn-sm js-details\" data-id=\"".concat(row.request,"\" title=\"").concat(app.vtranslate("BTN_SHOW_DETAILS"),"\" data-js=\"click\"><span class=\"fas fa-search-plus\"></span></button>")),action},defaultContent:""},{orderable:!1,data:function data(row){var action="";return 0!==row.statusId&&(action+="<button type=\"button\" class=\"btn btn-success btn-sm js-update\" data-id=\"".concat(row.id,"\" data-status=\"0\" title=\"").concat(app.vtranslate("BTN_STATUS_ACTION_ACCEPT"),"\" data-js=\"click\"><span class=\"fas fa-check\"></span></button>")),1!==row.statusId&&(action+="<button type=\"button\" class=\"btn btn-warning btn-sm ml-2 js-update\" data-id=\"".concat(row.id,"\" data-status=\"1\" title=\"").concat(app.vtranslate("BTN_UNLOCK_STATUS_ACTION_REJECT"),"\" data-js=\"click\"><span class=\"fas fa-times\"></span></button>")),action+="<button type=\"button\" class=\"btn btn-danger btn-sm ml-2 js-trash\" data-id=\"".concat(row.id,"\" title=\"").concat(app.vtranslate("BTN_DELETE"),"\" data-js=\"click\"><span class=\"fas fa-trash\"></span></button>"),action},defaultContent:""}]},publicRbl:{columns:[{data:"ip"},{data:"type"},{data:"status"},{data:"comment"}]}},/**
		 * Register DataTable
		 ...
		 */refreshCounters:function refreshCounters(){var tabs=$("#tabs li a");AppConnector.request({module:app.getModuleName(),parent:app.getParentModuleName(),action:"GetData",mode:"counters"}).done(function(response){tabs.each(function(){response.result[this.dataset.name]!==void 0&&$(this).find(".js-badge").text(response.result[this.dataset.name]);});});},/**
		 * Register events
		 */registerEvents:function registerEvents(){var _this=this;this.registerTabEvents(),this.refreshCounters(),$("#tabs a[data-toggle=\"tab\"]").on("shown.bs.tab",function(){_this.registerTabEvents();});}});
