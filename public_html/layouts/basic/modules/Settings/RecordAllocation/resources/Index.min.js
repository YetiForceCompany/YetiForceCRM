...
jQuery.Class('Settings_RecordAllocation_Index_Js', {}, {
  ...
  */
	registerDataTables: function registerDataTables(contentData) {
  ...
  * @param {jQuery} contentData
  */
	registerDragDropEvent: function registerDragDropEvent(contentData) {
		if (contentData == undefined) {
			return;
		}
		var thisInstance = this;
  ...
  */
	addPanel: function addPanel(module) {
		var thisInstance = this;
  ...
  */
	registerLoadData: function registerLoadData() {
		var thisInstance = this;
		this.getContainer().on('change', '.js-base-user', function (e) {
			...
			var bodyContainerTable = panel.find('.js-clear-tables').clone(true, true);
			if (userData != undefined) {
				var activeData = bodyContainerTable.find('.js-data-table .dropContainer:first'),
  ...
  */
	registerHeaderElements: function registerHeaderElements() {
