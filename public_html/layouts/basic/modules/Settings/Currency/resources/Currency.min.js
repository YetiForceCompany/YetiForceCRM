...
jQuery.Class('Settings_Currency_Js', {
  ...
  */
	triggerAdd: function triggerAdd(event) {
  ...
  */
	triggerEdit: function triggerEdit(event, id) {
		event.stopPropagation();
		var instance = Settings_Currency_Js.currencyInstance;
  ...
  * @param {int} id
  */
	triggerDefault: function triggerDefault(event, id) {
		event.stopPropagation();
  ...
  */
	triggerDelete: function triggerDelete(event, id) {
		event.stopPropagation();
  ...
  */
	showEditView: function showEditView(id) {
  ...
  */
	registerCurrencyStatusChangeEvent: function registerCurrencyStatusChangeEvent(form) {
  ...
  */
	registerCurrencyNameChangeEvent: function registerCurrencyNameChangeEvent(form) {
  ...
  */
	saveCurrencyDetails: function saveCurrencyDetails(form) {
		var thisInstance = this;
		var progressIndicatorElement = jQuery.progressIndicator({
			'position': 'html',
			'blockInfo': {
  ...
  */
	loadListViewContents: function loadListViewContents() {
		var progressIndicatorElement = jQuery.progressIndicator({
			'position': 'html',
			'blockInfo': {
				'enabled': true
  ...
  */
	transformEdit: function transformEdit(id) {
		var aDeferred = jQuery.Deferred();
  ...
  */
	deleteCurrency: function deleteCurrency(id, transferCurrencyEle, currentTrEle) {
	...
	triggerDisplayTypeEvent: function triggerDisplayTypeEvent() {
	...
	registerRowClick: function registerRowClick() {
		var thisInstance = this;
