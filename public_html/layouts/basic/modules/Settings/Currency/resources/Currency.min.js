...
progressIndicatorElement.progressIndicator({mode:'hide'}),jQuery('#listViewContents').html(data);}//thisInstance.triggerDisplayTypeEvent();
).fail(function(){progressIndicatorElement.progressIndicator({mode:'hide'});});},/**
