...
var Settings_Profiles_Js = {
	...
	initEditView: function initEditView() {
		...
		function handleActionSelectionState(e) {
			...
			var action = target.data('action-state');
	...
	registerSelectAllModulesEvent: function registerSelectAllModulesEvent() {
	...
	registerSelectAllViewActionsEvent: function registerSelectAllViewActionsEvent() {
	...
	registerSelectAllEditActionsEvent: function registerSelectAllEditActionsEvent() {
	...
	registerSelectAllDeleteActionsEvent: function registerSelectAllDeleteActionsEvent() {
	...
	registerSelectAllCreateActionsEvent: function registerSelectAllCreateActionsEvent() {
	...
	checkSelectAll: function checkSelectAll(checkBoxElement, mainCheckBoxElement) {
		var state = true;
	...
	performSelectAllActionsOnLoad: function performSelectAllActionsOnLoad() {
  ...
  */
	...
	registerGlobalPermissionActionsEvent: function registerGlobalPermissionActionsEvent() {
