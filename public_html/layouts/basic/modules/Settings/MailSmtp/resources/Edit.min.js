...
Settings_Vtiger_Edit_Js('Settings_MailSmtp_Edit_Js', {}, {
	registerSubmitForm: function registerSubmitForm() {
  ...
  */
	registerPreviewPassword: function registerPreviewPassword() {
	...
	registerSaveSendMail: function registerSaveSendMail() {
		var form = this.getForm();
		form.find(".js-save-send-mail").on('click', function () {
