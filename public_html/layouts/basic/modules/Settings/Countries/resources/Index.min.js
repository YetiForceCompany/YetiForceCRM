...
$.Class("Settings_Countries_Index_Js", {}, {
	registerSortableEvent: function registerSortableEvent() {
	...
	registerStatus: function registerStatus(content) {
	...
	registerPhone: function registerPhone(content) {
	...
	registerUitype: function registerUitype(content) {
	...
	allStatuses: 1,
	registerAllStatuses: function registerAllStatuses(content) {
		var thisInstance = this;
	...
	registerRowToTop: function registerRowToTop(content) {
		var thisInstance = this;
	...
	registerRowToBottom: function registerRowToBottom(content) {
		var thisInstance = this;
	...
	registerSequenceListOnServer: function registerSequenceListOnServer() {
		var sequenceList = {};
