...
jQuery.Class('Settings_CustomView_Index_Js',{},{container:!1,contents:!1,/**
	 ...
	 * Update sequences
	 */updateSequence:function updateSequence(){var sequences=[];this.getContents().find('.js-filter-row').each(function(n,row){var cvId=$(row).data('cvid');sequences.push(cvId);}),app.saveAjax('upadteSequences',sequences).done(function(data){data.success&&Vtiger_Helper_Js.showPnotify({text:data.result.message,type:'success'});});},/**
