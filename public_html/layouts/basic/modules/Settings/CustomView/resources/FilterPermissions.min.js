...
jQuery.Class("Settings_CustomView_FilterPermissions_Js", {}, {
	...
	registerDisabledButtons: function registerDisabledButtons() {
		var container = this.getForm();
	...
	move: function move(currentTarget) {
		var container = this.getForm();
		var sourceClass = currentTarget.data('source');
  ...
  */
	setDefaultPreferences: function setDefaultPreferences(e) {
		var thisInstance = this;
		var container = this.getForm();
	...
	setForm: function setForm(element) {
