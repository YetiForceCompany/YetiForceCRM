...
var Settings_Picklist_Js = {
	registerModuleChangeEvent: function registerModuleChangeEvent() {
	...
	registerModulePickListChangeEvent: function registerModulePickListChangeEvent() {
	...
	registerAddItemEvent: function registerAddItemEvent() {
	...
	registerAssingValueToRuleEvent: function registerAssingValueToRuleEvent() {
	...
	registerAssignValueToRoleSaveEvent: function registerAssignValueToRoleSaveEvent(data) {
	...
	registerEnablePickListValueClickEvent: function registerEnablePickListValueClickEvent() {
	...
	registerenableOrDisableListSaveEvent: function registerenableOrDisableListSaveEvent() {
	...
	regiserSelectRolesEvent: function regiserSelectRolesEvent(data) {
  ...
  */
	registerRenameItemEvent: function registerRenameItemEvent() {
		var _this = this;

		$('#renameItem').on('click', function (e) {
			var selectedListItems = _this.getSelectedItems();
			if (selectedListItems.length < 1) {
				...
				AppConnector.request({
					...
					app.showModalWindow(data);
					var form = $('#renameItemForm');
					_this.registerScrollForNonEditablePicklistValues(form);
  ...
  */
	registerScrollForNonEditablePicklistValues: function registerScrollForNonEditablePicklistValues(container) {
  ...
  */
	getSelectedItems: function getSelectedItems() {
		var pickListValuesTable = $('#pickListValuesTable');
  ...
  */
	registerDeleteItemEvent: function registerDeleteItemEvent() {
		var _this2 = this;

		$('#deleteItem').on('click', function (e) {
			var selectedListItems = _this2.getSelectedItems();
			var pickListValues = $('.pickListValue', pickListValuesTable);
			...
			_this2.showDeleteItemForm({
				...
				mode: 'showDeleteView',
				pickListFieldId: $('#modulePickList').val(),
				fieldValue: JSON.stringify(selectedListItems.map(function (item) {
					return item.key;
				}))
			});
		});
	...
	registerDeleteOptionEvent: function registerDeleteOptionEvent() {
	...
	registerChangeRoleEvent: function registerChangeRoleEvent() {
  ...
  * @param   {jQuery}  form
  */
	registerProcessStatusItemSaveEvent: function registerProcessStatusItemSaveEvent(form) {
  ...
  */
	registerProcessStatusItemEvent: function registerProcessStatusItemEvent() {
		var _this3 = this;

		$('#processStatusItem').on('click', function (e) {
			var selectedListItems = _this3.getSelectedItems();
			if (selectedListItems.length === 0) {
				...
				AppConnector.request({
					...
					app.showModalWindow(data);
					var form = $('#processStatusItemForm');
					_this3.registerScrollForNonEditablePicklistValues(form);
					form.validationEngine();
	...
	registerAddItemSaveEvent: function registerAddItemSaveEvent(container) {
  ...
  */
					...
					if (typeof data.result !== 'undefined') {
						...
						if (newValue !== '') {
							var encodedOldValue = oldValue.replace(/"/g, '\\"'),
							    ...
							    renamedElement = '<tr class="pickListValue u-cursor-pointer">' + '<td class="u-text-ellipsis"><img class="alignMiddle" src="' + dragImagePath + '" />&nbsp;&nbsp;' + data.result.newValue + '</td></tr>';
	...
	showDeleteItemForm: function showDeleteItemForm(params) {
	...
	registerSelectPickListValueEvent: function registerSelectPickListValueEvent() {
	...
	registerPickListValuesSortableEvent: function registerPickListValuesSortableEvent() {
	...
	registerSaveSequenceClickEvent: function registerSaveSequenceClickEvent() {
	...
	registerAssingValueToRoleTabClickEvent: function registerAssingValueToRoleTabClickEvent() {
		jQuery('#assignedToRoleTab').on('click', function (e) {
			jQuery('#rolesList').trigger('change');
		});
	},

	registerItemActions: function registerItemActions() {
