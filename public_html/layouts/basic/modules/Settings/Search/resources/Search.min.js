...
var Settings_Index_Js = {
	...
	initEvants: function initEvants() {
	...
	updateLabels: function updateLabels(e) {
		var target = $(e.currentTarget);
	...
	editLabels: function editLabels(e) {
		...
		App.Fields.Picklist.showSelect2ElementView(select, {
			sortableCb: function sortableCb(currentSelect) {
  ...
  */
	showSaveModuleSequenceButton: function showSaveModuleSequenceButton() {
		var thisInstance = this;
  ...
  */
	hideSaveModuleSequenceButton: function hideSaveModuleSequenceButton() {
		var layout = jQuery('.SearchFieldsEdit');
		var saveButton = layout.find('.saveModuleSequence');
  ...
  */
	updateModulesSequence: function updateModulesSequence() {
		var thisInstance = this;
