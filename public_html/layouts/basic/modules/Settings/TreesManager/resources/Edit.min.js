...
jQuery.Class('Settings_TreesManager_Edit_Js', {}, {
	...
	registerEvents: function registerEvents() {
		...
		$('.addNewElementBtn').on('click', function () {
						...
						remove: {
							...
							action: function action(data) {
								...
								$.each(id, function (index, value) {
									var menu = treeInstance.get_node(value);
	...
	deleteItemEvent: function deleteItemEvent(id, inst) {
		var self = this,
		...
		app.showModalWindow(null, 'index.php?module=TreesManager&parent=Settings&view=ReplaceTreeItem', function (wizardContainer) {
			var jstreeInstanceReplace = wizardContainer.find('#treePopupContents');
			...
			wizardContainer.find('.js-modal__save').on('click', function () {
				...
				if (!selected.length || selected.length > 1) {
					var message = 'JS_ONLY_ONE_ITEM_SELECTED';
					if (!selected.length) {
	...
	checkChildren: function checkChildren(id, data) {
		var self = this,
		    dataNew = [];
		for (var key in data) {
			if (data[key].id != id) {
