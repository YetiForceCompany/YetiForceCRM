...
Vtiger_List_Js('Settings_Vtiger_List_Js', {
  ...
  */
	makeDeleteRequest: function makeDeleteRequest(params, aDeferred, instance) {
  ...
  */
	deleteById: function deleteById(id) {
		...
		if (showConfirmation) {
			Vtiger_Helper_Js.showConfirmationBox({
				...
				_this.makeDeleteRequest(params, aDeferred, instance);
			});
		} else {
	...
	getDeleteParams: function getDeleteParams() {
		return {
  ...
  */
	getListViewContainer: function getListViewContainer() {
  ...
  */
	postDeleteAction: function postDeleteAction(container) {
		var thisInstance = this;
