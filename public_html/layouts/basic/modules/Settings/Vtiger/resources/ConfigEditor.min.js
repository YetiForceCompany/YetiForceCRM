...
jQuery.Class("Settings_Vtiger_ConfigEditor_Js", {}, {
  ...
  */
	saveConfigEditor: function saveConfigEditor(form) {
  ...
  */
	loadContents: function loadContents(url) {
		var aDeferred = jQuery.Deferred();
  ...
  */
	registerEditViewEvents: function registerEditViewEvents() {
  ...
  */
	registerDetailViewEvents: function registerDetailViewEvents() {
		var thisInstance = this;
