...
$.Class('Settings_CustomRecordNumbering_Js', {}, {
  ...
  */
	registerOnChangeEventOfSourceModule: function registerOnChangeEventOfSourceModule() {
		var editViewForm = this.getForm();
		var sequenceBtn = editViewForm.find('.js-adavanced-sequence');
  ...
  */
	saveModuleCustomNumbering: function saveModuleCustomNumbering() {
		...
		var leadingZeros = editViewForm.find('[name="leading_zeros"]').val();
		var currentPrefix = $.trim(prefix.val());
  ...
  */
	registerEventToUpdateRecordsWithSequenceNumber: function registerEventToUpdateRecordsWithSequenceNumber() {
		var editViewForm = this.getForm();
  ...
  */
	registerChangeEvent: function registerChangeEvent() {
	...
	registerCopyClipboard: function registerCopyClipboard(editViewForm) {
  ...
  */
	checkPrefix: function checkPrefix() {
		...
		var editViewForm = this.getForm();
		var value = editViewForm.find('[name="reset_sequence"]').val();
		var prefix = editViewForm.find('[name="prefix"]').val();
		var postfix = editViewForm.find('[name="postfix"]').val();
		var saveBtn = editViewForm.find('.saveButton');
		switch (value) {
			case 'Y':
		...
		if (sequenceExists) {
			var regex = new RegExp("{{picklist:([a-z0-9_]+)}}", 'g');
			var regexResult = (postfix + prefix).match(regex);
  ...
  */
	checkAdavancedSequenceBtn: function checkAdavancedSequenceBtn() {
		var editViewForm = this.getForm();
		var sequenceBtn = editViewForm.find('.js-adavanced-sequence');
		var prefix = editViewForm.find('[name="prefix"]').val();
		var postfix = editViewForm.find('[name="postfix"]').val();
  ...
  */
	registerAdavancedSequenceEvent: function registerAdavancedSequenceEvent() {
		var editViewForm = this.getForm();
		var sequenceBtn = editViewForm.find('.js-adavanced-sequence');
