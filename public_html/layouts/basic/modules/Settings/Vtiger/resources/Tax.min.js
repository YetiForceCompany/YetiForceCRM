...
jQuery.Class("Settings_Vtiger_Tax_Js", {}, {
  ...
  */
	editTax: function editTax(url, currentTrElement) {
  ...
  */
	saveTaxDetails: function saveTaxDetails(form, currentTrElement) {
		var thisInstance = this;
  ...
  */
	addTaxDetails: function addTaxDetails(details) {
		...
		var trElementForTax = jQuery('<tr class="opacity" data-taxid="' + details.taxid + '" data-taxtype="' + details.type + '"><td style="border-left: none;" class="textAlignCenter ' + details.row_type + '"><label class="taxLabel">' + details.taxlabel + '</label></td><td style="border-left: none;" class="textAlignCenter ' + details.row_type + '"><span class="taxPercentage">' + details.percentage + '%</span></td><td style="border-left: none;" class="textAlignCenter ' + details.row_type + '"><input class="editTaxStatus" type="checkbox" checked>' + '<div class="pull-right actions"><a class="editTax u-cursor-pointer" data-url="' + details._editurl + '"><i class="fas fa-edit alignBottom" title="' + app.vtranslate('JS_EDIT') + '"></i></a></div></td></tr>');
  ...
  */
	updateTaxDetails: function updateTaxDetails(data, currentTrElement) {
  ...
  */
	validateTaxName: function validateTaxName(data) {
		var thisInstance = this;
		var aDeferred = jQuery.Deferred();
