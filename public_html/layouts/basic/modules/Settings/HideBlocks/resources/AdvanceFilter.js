...
Vtiger_Field_Js(
	...
	{},
	{
		...
		getUi: function () {
			var html =
				'<input type="text" class="getPopupUi" name="' +
				this.getName() +
		...
		getUi: function () {
			...
			if (comparatorSelectedOptionVal.length > 0) {
				if (comparatorSelectedOptionVal == 'between' || comparatorSelectedOptionVal == 'custom') {
					html =
						'<div class="date"><input class="dateRangeField form-control"' +
						'data-calendar-type="range" name="' +
						this.getName() +
						'" data-date-format="' +
						this.getDateFormat() +
				...
				html =
					'<input type="text" class="getPopupUi form-control date" name="' +
					this.getName() +
					'"  data-date-format="' +
					this.getDateFormat() +
					'"  value="' +
	...
	{},
	{
		...
		getUi: function () {
			...
			if (this._specialDateTimeComparator(this.get('comparatorElementVal'))) {
				...
				html =
					'<input type="text" class="getPopupUi date" name="' +
					this.getName() +
					'"  data-date-format="' +
					this.getDateFormat() +
					'"  value="' +
...
Vtiger_Currency_Field_Js(
	...
	{},
	{
		getUi: function () {
			var html =
				'<input type="text" class="getPopupUi marginLeftZero" name="' +
				this.getName() +
				'" value="' +
				this.getValue() +
				'"  />' +
...
Vtiger_Time_Field_Js(
	...
	{},
	{
		...
		getUi: function () {
			var html =
				'<input type="text" class="getPopupUi time" name="' +
				this.getName() +
				'"  value="' +
				this.getValue() +
				'" />' +
...
Vtiger_Field_Js(
	...
	{},
	{
		...
		getUi: function () {
			var html =
				'<input type="text" class="getPopupUi boolean" name="' +
				this.getName() +
				'" value="' +
				this.getValue() +
				'" />' +
