...
jQuery.Class("Settings_CurrencyUpdate_Index_Js", {}, {
  ...
  */
	registerInfoButton: function registerInfoButton(container) {
  ...
  */
	registerAlertButton: function registerAlertButton(container) {
  ...
  */
	registerBankChange: function registerBankChange(container) {
		container.find('#bank').on('change', function () {
			var bankName = container.find('#bank option:selected').data('name');
