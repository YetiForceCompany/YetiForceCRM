...
Settings_Workflows_Edit_Js("Settings_Workflows_Edit3_Js", {}, {
  ...
  */
	...
	registerEditTaskEvent: function registerEditTaskEvent() {
		...
		container.on('click', '[data-url]', function (e) {
			...
			app.showModalWindow(null, params, function (data) {
				...
				if (data) {
					var clipboard = App.Fields.Text.registerCopyClipboard(data);
	...
	registerCheckSelectDateEvent: function registerCheckSelectDateEvent() {
  ...
  */
	registerSaveTaskSubmitEvent: function registerSaveTaskSubmitEvent(taskType) {
		var _this = this;
		...
		$('#saveTask').on('submit', function (e) {
			...
			if (form.validationEngine('validate') === true) {
				...
				if (typeof _this[customValidationFunctionName] !== "undefined") {
					var result = _this[customValidationFunctionName].apply(_this);
					if (result !== true) {
				...
				if (typeof _this[preSaveActionFunctionName] !== "undefined") {
					_this[preSaveActionFunctionName].apply(_this, [taskType]);
				}
	...
	VTUpdateFieldsTaskCustomValidation: function VTUpdateFieldsTaskCustomValidation() {
		return this.checkDuplicateFieldsSelected();
	},
	VTCreateEntityTaskCustomValidation: function VTCreateEntityTaskCustomValidation() {
		return this.checkDuplicateFieldsSelected();
	},
	checkDuplicateFieldsSelected: function checkDuplicateFieldsSelected() {
	...
	preSaveVTUpdateFieldsTask: function preSaveVTUpdateFieldsTask(tasktype) {
		var values = this.getValues(tasktype);
		$('[name="field_value_mapping"]').val(JSON.stringify(values));
	},
	preSaveVTCreateEntityTask: function preSaveVTCreateEntityTask(tasktype) {
		var values = this.getValues(tasktype);
		$('[name="field_value_mapping"]').val(JSON.stringify(values));
	},
	preSaveVTEmailTask: function preSaveVTEmailTask(tasktype) {
	...
	preSaveVTUpdateRelatedFieldTask: function preSaveVTUpdateRelatedFieldTask(tasktype) {
		var values = this.getValues(tasktype);
		$('[name="field_value_mapping"]').val(JSON.stringify(values));
	},
	preSaveSumFieldFromDependent: function preSaveSumFieldFromDependent(tasktype) {
  ...
  */
	isEmptyFieldSelected: function isEmptyFieldSelected(fieldSelect) {
	...
	getVTCreateEntityTaskFieldList: function getVTCreateEntityTaskFieldList() {
		return new Array('fieldname', 'value', 'valuetype', 'modulename');
	},
	getVTUpdateFieldsTaskFieldList: function getVTUpdateFieldsTaskFieldList() {
		return new Array('fieldname', 'value', 'valuetype');
	},
	getVTUpdateRelatedFieldTaskFieldList: function getVTUpdateRelatedFieldTaskFieldList() {
		return new Array('fieldname', 'value', 'valuetype');
	},
	/**
  * Get values
  ...
  * @returns {Array}
  */
	getValues: function getValues(tasktype) {
		var _this2 = this;
		...
		$('.js-conditions-row', $('#save_fieldvaluemapping')).each(function (i, conditionDomElement) {
			...
			if (_this2.isEmptyFieldSelected(fieldSelectElement)) {
				return true;
			}
  ...
  */
	getckEditorInstance: function getckEditorInstance() {
		if (this.ckEditorInstance === false) {
			this.ckEditorInstance = new App.Fields.Text.Editor();
		}
		return this.ckEditorInstance;
	},
	registerTaskStatusChangeEvent: function registerTaskStatusChangeEvent() {
		var container = this.getContainer();
	...
	registerTaskDeleteEvent: function registerTaskDeleteEvent() {
		var thisInstance = this;
		var container = this.getContainer();
	...
	registerFillTaskFromEmailFieldEvent: function registerFillTaskFromEmailFieldEvent() {
	...
	registerFillTaskFieldsEvent: function registerFillTaskFieldsEvent() {
	...
	registerFillMailContentEvent: function registerFillMailContentEvent() {
	...
	registerVTEmailTaskEvents: function registerVTEmailTaskEvents() {
		var textAreaElement = $('#content');
	...
	registerVTCreateTodoTaskEvents: function registerVTCreateTodoTaskEvents() {
		app.registerEventForClockPicker();
	},
	registerVTUpdateFieldsTaskEvents: function registerVTUpdateFieldsTaskEvents() {
		var thisInstance = this;
	...
	registerVTUpdateRelatedFieldTaskEvents: function registerVTUpdateRelatedFieldTaskEvents() {
		var thisInstance = this;
		this.registerAddFieldEvent();
		this.registerDeleteConditionEvent();
		this.registerFieldChange();
  ...
  */
	addField: function addField() {
		var replaceElement = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  ...
  */
	registerAddFieldEvent: function registerAddFieldEvent() {
		var _this3 = this;
	...
	registerDeleteConditionEvent: function registerDeleteConditionEvent() {
		$('#saveTask').on('click', '.js-condition-delete', function (e) {
  ...
  */
	registerFieldChange: function registerFieldChange() {
		...
		$('#saveTask').on('change', 'select[name="fieldname"]', function (e) {
			...
			if (selectedElement.val() !== 'none' && selectedElement.val()) {
				...
				_this4.loadFieldSpecificUi(selectedElement);
			} else {
				_this4.addField(conditionRow);
			}
		});
	},
	...
	getFieldValueMapping: function getFieldValueMapping() {
	...
	fieldValueReMapping: function fieldValueReMapping() {
  ...
  * @returns this
  */
	loadFieldSpecificUi: function loadFieldSpecificUi(fieldSelect) {
		var selectedOption = fieldSelect.find('option:selected');
  ...
  */
	getFieldSpecificUi: function getFieldSpecificUi(fieldSelectElement) {
		var fieldModel = this.fieldModelInstance;
		return $(fieldModel.getUiTypeSpecificHtml());
	},
	registerVTCreateEventTaskEvents: function registerVTCreateEventTaskEvents() {
		app.registerEventForClockPicker();
	},
	registerVTCreateEntityTaskEvents: function registerVTCreateEntityTaskEvents() {
		this.registerChangeCreateEntityEvent();
		this.registerVTUpdateFieldsTaskEvents();
	},
	registerChangeCreateEntityEvent: function registerChangeCreateEntityEvent() {
		var thisInstance = this;
  ...
  */
	...
	checkHiddenStatusofCcandBcc: function checkHiddenStatusofCcandBcc() {
		var ccLink = $('#ccLink');
		var bccLink = $('#bccLink');
  ...
  */
	registerCcAndBccEvents: function registerCcAndBccEvents() {
		var thisInstance = this;
