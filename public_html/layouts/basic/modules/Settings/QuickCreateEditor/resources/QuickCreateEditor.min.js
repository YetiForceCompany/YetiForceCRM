...
jQuery.Class("Settings_QuickCreateEditor_Js",{},{updatedBlockSequence:{},updatedBlockFieldsList:[],/**
		 ...
		 */makeFieldsListSortable:function makeFieldsListSortable(){var thisInstance=this;jQuery("#quickCreateEditorContainer").find(".contents");jQuery("#quickCreateEditorContainer .contents .editFieldsTable").each(function(){jQuery(this).find("ul[name=sortable1], ul[name=sortable2]").sortable({containment:"#moduleBlocks",revert:!0,tolerance:"pointer",cursor:"move",connectWith:jQuery(this).find(".connectedSortable"),update:function update(e,ui){// rearrange the older block fields
