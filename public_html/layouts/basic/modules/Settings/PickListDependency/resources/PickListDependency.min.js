...
jQuery.Class('Settings_PickListDependency_Js', {
  ...
  */
	triggerDelete: function triggerDelete(event, module, sourceField, targetField) {
		event.stopPropagation();
  ...
  */
	getModuleDependencyGraph: function getModuleDependencyGraph(form) {
  ...
  */
	registerPicklistFieldsChangeEvent: function registerPicklistFieldsChangeEvent(form) {
		var thisInstance = this;
  ...
  */
	checkValuesForDependencyGraph: function checkValuesForDependencyGraph(form) {
		var thisInstance = this;
  ...
  */
	checkCyclicDependency: function checkCyclicDependency(sourceModule, sourceFieldValue, targetFieldValue) {
		var aDeferred = jQuery.Deferred();
		var params = {};
  ...
  *            targetFieldValue - target picklist value
  */
	addNewDependencyPickList: function addNewDependencyPickList(sourceModule, sourceFieldValue, targetFieldValue) {
		var thisInstance = this;
  ...
  */
	registerCancelAddView: function registerCancelAddView(form) {
		var thisInstance = this;
  ...
  */
	registerAddViewEvents: function registerAddViewEvents() {
		var thisInstance = this;
		var form = jQuery('#pickListDependencyForm');
  ...
  */
	registerDependencyGraphEvents: function registerDependencyGraphEvents() {
		var thisInstance = this;
		var form = jQuery('#pickListDependencyForm');
		var dependencyGraph = jQuery('#dependencyGraph');
  ...
  */
	registerListViewEvents: function registerListViewEvents() {
		var thisInstance = this;
  ...
  */
	registerCancelDependency: function registerCancelDependency(form) {
		var thisInstance = this;
  ...
  */
	registerTargetFieldsClickEvent: function registerTargetFieldsClickEvent(dependencyGraph) {
		var thisInstance = this;
		thisInstance.updatedSourceValues = [];
	...
	registerTargetFieldsUnmarkAll: function registerTargetFieldsUnmarkAll(dependencyGraph) {
		var thisInstance = this;
		thisInstance.updatedSourceValues = [];
  ...
  */
	registerSelectSourceValuesClick: function registerSelectSourceValuesClick(dependencyGraph) {
		var _this = this;
		...
		dependencyGraph.find('button.sourceValues').on('click', function () {
			...
			app.showModalWindow(clonedContainer, function (data) {
				...
				data.find('[name="saveButton"]').on('click', function (e) {
					_this.selectedSourceValues = [];
					var sourceValues = data.find('.sourceValue');
					$.each(sourceValues, function (index, ele) {
						var element = $(ele);
						var elementId = element.attr('id');
						var hiddenElement = selectSourceValues.find('#' + elementId);
						if (element.is(':checked')) {
							_this.selectedSourceValues.push(element.val());
					...
					app.hideModalWindow();
					_this.loadMappingForSelectedValues(dependencyGraph);
				});
			}, { 'width': '1000px' });
		});
	},
  ...
  */
	loadMappingForSelectedValues: function loadMappingForSelectedValues(dependencyGraph) {
		var thisInstance = this;
  ...
  */
	savePickListDependency: function savePickListDependency(form) {
		var self = this;
  ...
  */
	loadListViewContents: function loadListViewContents(forModule) {
		var thisInstance = this;
		var progressIndicatorElement = jQuery.progressIndicator({
			'position': 'html',
			'blockInfo': {
  ...
  */
	registerSourceModuleChangeEvent: function registerSourceModuleChangeEvent() {
		var thisInstance = this;
		var container = jQuery('.contentsDiv');
