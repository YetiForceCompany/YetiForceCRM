 ...
 * All Rights Reserved.
 *************************************************************************************/"use strict";jQuery.Class("Settings_PickListDependency_Js",{//holds the picklist dependency instance
...
selectedSourceValues:[],/*
		 ...
		 */registerListViewEvents:function registerListViewEvents(){var thisInstance=this,forModule=jQuery(".contentsDiv").find(".pickListSupportedModules").val();thisInstance.listViewForModule=forModule,thisInstance.registerSourceModuleChangeEvent();},/**
...
cancelDependencyLink.on("click",function(){thisInstance.loadListViewContents(thisInstance.listViewForModule);});},/**
		 ...
		 */updateValueMapping:function updateValueMapping(dependencyGraph){var self=this;self.valueMapping=[];var sourceValuesArray=self.updatedSourceValues,dependencyTable=dependencyGraph.find(".pickListDependencyTable"),_loop=function(){var encodedSourceValue="string"==typeof sourceValuesArray[key]?sourceValuesArray[key].replace(/"/g,"\\\""):sourceValuesArray[key];var selectedTargetValues=dependencyTable.find("td[data-source-value=\""+encodedSourceValue+"\"]").filter(".selectedCell"),targetValues=[];0<selectedTargetValues.length?jQuery.each(selectedTargetValues,function(index,element){targetValues.push(jQuery(element).data("targetValue"));}):targetValues.push(""),self.valueMapping.push({sourcevalue:sourceValuesArray[key],targetvalues:targetValues});};for(var key in sourceValuesArray)_loop();},/**
