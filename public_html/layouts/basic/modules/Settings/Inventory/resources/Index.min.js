...
jQuery.Class("Settings_Inventory_Index_Js", {}, {
  ...
  */
	edit: function edit(url, currentTrElement) {
  ...
  */
	saveDetails: function saveDetails(form, currentTrElement) {
		var thisInstance = this;
  ...
  */
	validateName: function validateName(data) {
		var thisInstance = this;
		var aDeferred = jQuery.Deferred();
  ...
  */
	updateCheckbox: function updateCheckbox(currentTarget) {
		var aDeferred = jQuery.Deferred();
	...
	removeInventory: function removeInventory(inventoryElement) {
