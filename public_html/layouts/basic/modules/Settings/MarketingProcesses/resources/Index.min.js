...
jQuery.Class("Settings_MarketingProcesses_Index_Js", {}, {
	registerChangeVal: function registerChangeVal(content) {
	...
	registerSaveMapping: function registerSaveMapping(content) {
	...
	uniqueReduce: function uniqueReduce(mapping, relations) {
	...
	registerEventToDeleteMapping: function registerEventToDeleteMapping(content) {
	...
	registerMapping: function registerMapping(content) {
