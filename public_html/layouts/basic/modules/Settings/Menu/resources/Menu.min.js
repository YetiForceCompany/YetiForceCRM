...
jQuery.Class('Settings_Menu_Index_Js', {}, {
	...
	registerMenuChanges: function registerMenuChanges() {
		var thisInstance = this;
	...
	getChildrenMenu: function getChildrenMenu(childrens, parent) {
		var menus = [];
		var thisInstance = this;
	...
	registerChangeRoleMenu: function registerChangeRoleMenu() {
		var thisInstance = this;
		$('.menuConfigContainer').on('change', '[name="roleMenu"]', function (e) {
			thisInstance.loadContent();
		});
	},
	getMenuData: function getMenuData(selectedRole) {
	...
	registerAddMenu: function registerAddMenu() {
		var thisInstance = this;
	...
	registerEditMenu: function registerEditMenu(container) {
		var thisInstance = this;
	...
	registerStep1: function registerStep1(container) {
		var thisInstance = this;
	...
	registerSelectIcons: function registerSelectIcons(container) {
	...
	registerStep2: function registerStep2(container) {
		var thisInstance = this;
		container.find('form').validationEngine(app.validationEngineOptions);
		thisInstance.registerHotkeys(container);
		thisInstance.registerHiddenInput(container);
	...
	removeMenu: function removeMenu(id, inst) {
		var thisInstance = this;
	...
	registerHotkeys: function registerHotkeys(container) {
	...
	registerHiddenInput: function registerHiddenInput(container) {
	...
	cacheFilters: false,
	registerFilters: function registerFilters(container) {
		var thisInstance = this;
	...
	loadFilters: function loadFilters(container, module) {
		var thisInstance = this;
	...
	registerModalButton: function registerModalButton() {
		var thisInstance = this;
	...
	copyMenu: function copyMenu(fromRole) {
		var thisInstance = this;
		var aDeferred = jQuery.Deferred();
