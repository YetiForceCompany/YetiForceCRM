...
jQuery('#recordsCount').val(''),jQuery('#totalPageCount').text(''),thisInstance.getListViewRecords(params).done(function(){thisInstance.updatePagination(),thisInstance.registerBasic();});});},/*
