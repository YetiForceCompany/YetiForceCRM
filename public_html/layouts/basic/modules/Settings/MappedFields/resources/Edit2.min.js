...
/* {[The file is published on the basis of YetiForce Public License 6.5 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */"use strict";Settings_MappedFields_Edit_Js("Settings_MappedFields_Edit2_Js",{},{step2Container:!1,advanceFilterInstance:!1,restictName:["_csrf","mode","module","parent","record","view"],init:function init(){this.initialize();},/**
