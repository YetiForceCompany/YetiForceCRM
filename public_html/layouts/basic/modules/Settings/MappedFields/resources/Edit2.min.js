...
Settings_MappedFields_Edit_Js('Settings_MappedFields_Edit2_Js', {}, {
  ...
  */
	...
	getData: function getData(data) {
		...
		for (var i in data) {
			var name = i.split('][');
			if (name.length == 2) {
				if (name[1] != 'default]' && data[i] != 0) mappingData[i] = data[i];else if (name[1] == 'default]') mappingData[i] = jQuery.isArray(data[i]) ? data[i].join(',') : data[i].trim();
  ...
  */
	...
	getSequenceNumber: function getSequenceNumber(element) {
  ...
  */
	...
	loadDefaultValueWidget: function loadDefaultValueWidget(element) {
		var thisInstance = this;
	...
	loadDefaultValueWidgetForMappedFields: function loadDefaultValueWidgetForMappedFields(fieldsList) {
		var thisInstance = this;
  ...
  */
	validationMappingFields: function validationMappingFields() {
		var aDeferred = jQuery.Deferred(),
