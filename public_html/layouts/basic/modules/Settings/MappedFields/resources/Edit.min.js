...
/* {[The file is published on the basis of YetiForce Public License 6.5 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */"use strict";Settings_Vtiger_Edit_Js("Settings_MappedFields_Edit_Js",{instance:{}},{currentInstance:!1,editContainer:!1,init:function init(){this.initiate();},/**
		 ...
		 */getInstance:function getInstance(step){if(step in Settings_MappedFields_Edit_Js.instance)return Settings_MappedFields_Edit_Js.instance[step];return Settings_MappedFields_Edit_Js.instance[step]=new window["Settings_MappedFields_Edit"+step+"_Js"],Settings_MappedFields_Edit_Js.instance[step]},/*
		 ...
		 */initiate:function initiate(container){"undefined"==typeof container&&(container=jQuery(".mfTemplateContents")),container.is(".mfTemplateContents")?this.setContainer(container):this.setContainer(jQuery(".mfTemplateContents",container)),this.initiateStep("1"),this.currentInstance.registerEvents();},/*
