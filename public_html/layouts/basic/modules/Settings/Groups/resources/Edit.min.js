...
Settings_Vtiger_Edit_Js('Settings_Groups_Edit_Js', {}, {
	...
	getMemberSelectElement: function getMemberSelectElement() {
  ...
  */
	registerFormForValidation: function registerFormForValidation() {
  ...
  */
	registerButtonsModule: function registerButtonsModule() {
		var editViewForm = this.getForm();
