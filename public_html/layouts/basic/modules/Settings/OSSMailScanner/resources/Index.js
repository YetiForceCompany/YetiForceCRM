		...
		AppConnector.request({
			...
			if (data.success) {
				...
				for (let i = 0; i < data.result.length; i++) {
					let html = '<tr>'
						+ '<td class="p-1">' + self.isEmpty(data.result[i]['id']) + '</td>'
						+ '<td class="p-1">' + self.isEmpty(data.result[i]['start_time']) + '</td>'
						+ '<td class="p-1">' + self.isEmpty(data.result[i]['end_time']) + '</td>'
						+ '<td class="p-1">' + self.isEmpty(app.vtranslate(data.result[i]['status'])) + '</td>'
						+ '<td class="p-1">' + self.isEmpty(data.result[i]['user']) + '</td>'
						+ '<td class="p-1">' + self.isEmpty(data.result[i]['count']) + '</td>'
						+ '<td class="p-1">' + self.isEmpty(data.result[i]['stop_user']) + '</td>'
