...
1>customRuleEntries.length&&(customRuleTable.find('.js-custom-rule-headers').fadeOut('slow').remove(),customRuleTable.parent().find('.js-record-details').removeClass('d-none'),customRuleTable.addClass('d-none'));}else Vtiger_Helper_Js.showPnotify({type:'error',text:'JS_ERROR'});});});},/*
