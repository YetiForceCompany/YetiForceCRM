...
var Settings_Roles_Js = {
	...
	initDeleteView: function initDeleteView() {
	...
	initPopupView: function initPopupView() {
  ...
  */
	registerModalUploadButton: function registerModalUploadButton() {
		var thisInstance = this;
  ...
  * @param {jQuery} form
  */
	registerUploadButton: function registerUploadButton(form) {
		form.on('submit', function (e) {
			e.preventDefault();
