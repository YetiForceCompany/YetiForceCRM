...
jQuery.Class('Settings_Notifications_Configuration_Js', {}, {
  ...
  */
	registerModulesChangeEvent: function registerModulesChangeEvent(container) {
	...
	registerButtonEvents: function registerButtonEvents(container) {
		var thisInstance = this;
		...
		container.find('.addUser, .wrapperExceptions').on('click', function (e) {
			...
			var reload = true;
			var element = jQuery(e.currentTarget);
			var url = 'index.php?module=' + app.getModuleName() + '&parent=' + app.getParentModuleName() + '&srcModule=' + container.find('#supportedModule').val() + '&view=Members';
