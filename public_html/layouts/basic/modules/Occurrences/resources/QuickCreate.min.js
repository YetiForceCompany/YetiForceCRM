 ...
 */function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function(){var result,Super=babelHelpers.getPrototypeOf(Derived);if(hasNativeReflectConstruct){var NewTarget=babelHelpers.getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget);}else result=Super.apply(this,arguments);return babelHelpers.possibleConstructorReturn(this,result)}}function _isNativeReflectConstruct(){if("undefined"==typeof Reflect||!Reflect.construct)return !1;if(Reflect.construct.sham)return !1;if("function"==typeof Proxy)return !0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch(e){return !1}}window.Occurrences_CalendarModal_Js=/*#__PURE__*/function(_Vtiger_Calendar_Js){function Occurrences_CalendarModal_Js(container,readonly){var _this;return babelHelpers.classCallCheck(this,Occurrences_CalendarModal_Js),_this=_super.call(this,container,readonly),_this.isSwitchAllDays=!1,_this.sidebarName="add",_this.eventCreate=!1,_this.module=container.find("[name=\"module\"]").val(),_this.renderCalendar(),_this.registerEvents(),_this}babelHelpers.inherits(Occurrences_CalendarModal_Js,_Vtiger_Calendar_Js);var _super=_createSuper(Occurrences_CalendarModal_Js);return babelHelpers.createClass(Occurrences_CalendarModal_Js,[{key:"addCommonMethodsToYearView",value:function addCommonMethodsToYearView(){}/**
	 * Function sets calendar module's options
	 */},{key:"setCalendarModuleOptions",value:function setCalendarModuleOptions(){var options=babelHelpers.get(babelHelpers.getPrototypeOf(Occurrences_CalendarModal_Js.prototype),"setCalendarModuleOptions",this).call(this);return options.selectable=!0,options.hiddenDays=app.getMainParams("hiddenDays",!0),options.header={left:"month,"+app.getMainParams("weekView")+","+app.getMainParams("dayView"),center:"prevYear,prev,title,next,nextYear",right:"today"},options.eventClick=function(calEvent,jsEvent){jsEvent.preventDefault();},options}/**
	 ...
	 * @param startDate
	 * @param endDate
	 */},{key:"selectDays",value:function selectDays(startDate,endDate){var _this4=this;if("status"===this.sidebarName)return this.sidebarName="add",void this.getCalendarCreateView().done(function(){_this4.selectDays(startDate,endDate);});var startHour=app.getMainParams("startHour"),endHour=app.getMainParams("endHour"),view=this.getCalendarView().fullCalendar("getView");!1==endDate.hasTime()&&endDate.add(-1,"days"),startDate=startDate.format(),endDate=endDate.format(),""==startHour&&(startHour="00"),""==endHour&&(endHour="00"),"agendaDay"!=view.name&&"agendaWeek"!=view.name&&(startDate=startDate+"T"+startHour+":00",endDate=endDate+"T"+endHour+":00");var dateFormat=CONFIG.dateFormat.toUpperCase(),timeFormat=CONFIG.hourFormat.toUpperCase(),defaultTimeFormat="";timeFormat=24==timeFormat?"HH:mm":"hh:mm A",defaultTimeFormat=dateFormat+" "+timeFormat,this.container.find("[name=\"date_start\"]").val(moment(startDate).format(defaultTimeFormat)),this.container.find("[name=\"date_end\"]").val(moment(endDate).format(defaultTimeFormat));}}]),Occurrences_CalendarModal_Js}(Vtiger_Calendar_Js),$.Class("Occurrences_QuickCreate_Js",{},{container:!1,module:!1,calendar:!1,getContainer:function getContainer(){return this.container},setContainer:function setContainer(container){this.container=container;},setModule:function setModule(){this.module=this.getContainer().find("[name=\"module\"]").val();},initCalendar:function initCalendar(){var className=this.module+"_CalendarModal_Js";this.calendar=new window[className](this.getContainer().closest(".js-modal-container"),!0);},registerEvents:function registerEvents(container){this.setContainer(container),this.setModule(),this.initCalendar();}});
