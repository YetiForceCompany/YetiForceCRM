 ...
 */window.Occurrences_CalendarModal_Js=function(_Vtiger_Calendar_Js){function Occurrences_CalendarModal_Js(container,readonly){classCallCheck(this,Occurrences_CalendarModal_Js);var _this=possibleConstructorReturn(this,(Occurrences_CalendarModal_Js.__proto__||Object.getPrototypeOf(Occurrences_CalendarModal_Js)).call(this,container,readonly));return _this.isSwitchAllDays=!1,_this.sidebarName='add',_this.eventCreate=!1,_this.module=container.find('[name="module"]').val(),_this.renderCalendar(),_this.registerEvents(),_this}return inherits(Occurrences_CalendarModal_Js,_Vtiger_Calendar_Js),createClass(Occurrences_CalendarModal_Js,[{key:'addCommonMethodsToYearView',value:function addCommonMethodsToYearView(){}/**
	 * Function sets calendar module's options
	 */},{key:'setCalendarModuleOptions',value:function setCalendarModuleOptions(){var options=get(Occurrences_CalendarModal_Js.prototype.__proto__||Object.getPrototypeOf(Occurrences_CalendarModal_Js.prototype),'setCalendarModuleOptions',this).call(this);return options.selectable=!0,options.hiddenDays=app.getMainParams('hiddenDays',!0),options.header={left:'month,'+app.getMainParams('weekView')+','+app.getMainParams('dayView'),center:'prevYear,prev,title,next,nextYear',right:'today'},options.eventClick=function(calEvent,jsEvent){jsEvent.preventDefault();},options}/**
