...
/* {[The file is published on the basis of YetiForce Public License 4.0 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */'use strict';Vtiger_Detail_Js("Partners_Detail_Js",{},{hierarchyResponseCache:{},/**
		 * Get response data
		 * @param {Object} params
		 * @returns {Object}
