...
Vtiger_List_Js("RecycleBin_List_Js", {
  ...
  */
	registerModuleFilter: function registerModuleFilter() {
		var self = this,
		    container = this.getListViewContainer();
		var filterSelectElement = container.find('.js-source-module');
  ...
  * @param {boolean} force
  */
	updatePaginationAjax: function updatePaginationAjax() {
  ...
  */
	registerEmptyRecycle: function registerEmptyRecycle() {
		var self = this,
		    container = this.getListViewContainer();
