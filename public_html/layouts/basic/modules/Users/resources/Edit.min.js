...
Vtiger_Edit_Js("Users_Edit_Js", {
  ...
  */
	registerChangeEventForCurrencySeparator: function registerChangeEventForCurrencySeparator() {
	...
	registerHourFormatChangeEvent: function registerHourFormatChangeEvent() {},
	getHourValues: function getHourValues(list, currentValue) {
		var options = '';
		for (var key in list) {
	...
	changeStartHourValuesEvent: function changeStartHourValuesEvent(form) {
	...
	triggerHourFormatChangeEvent: function triggerHourFormatChangeEvent(form) {
  ...
  */
	registerRecordPreSaveEvent: function registerRecordPreSaveEvent(form) {
		var thisInstance = this;
		form.on(Vtiger_Edit_Js.recordPreSave, function (e, data) {
			...
			thisInstance.verifyFormData().done(function (data) {
	...
	verifyFormData: function verifyFormData() {
