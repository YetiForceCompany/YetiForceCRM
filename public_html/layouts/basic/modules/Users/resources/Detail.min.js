...
Vtiger_Detail_Js("Users_Detail_Js", {
  ...
  */
	triggerDeleteUser: function triggerDeleteUser(deleteUserUrl) {
	...
	triggerChangeAccessKey: function triggerChangeAccessKey(url) {
	...
	startHourUpdateEvent: function startHourUpdateEvent(form) {
		var thisInstance = this;
	...
	saveFieldValues: function saveFieldValues(fieldDetailList) {
		...
		if (typeof fieldDetailList !== "undefined") {
			...
			if (data['field'] == 'email1') {
				thisInstance.usersEditInstance.checkEmail(data['value']).done(function (data) {}, function (data, error) {
					lock = true;
					aDeferred.reject();
				});
			}
