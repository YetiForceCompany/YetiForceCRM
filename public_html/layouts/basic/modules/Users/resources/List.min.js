...
Vtiger_List_Js("Settings_Users_List_Js", {
  ...
  */
	deleteRecord: function deleteRecord(deleteRecordActionUrl) {
	...
	deleteUser: function deleteUser(form) {
  ...
  *@param userId, event
  */
	deleteUserPermanently: function deleteUserPermanently(userId, e) {
		e.stopPropagation();
  ...
  *@param userId, event
  */
	restoreUser: function restoreUser(userId, e) {
		e.stopPropagation();
  ...
  */
	triggerMassOff2FA: function triggerMassOff2FA() {
  ...
  */
	getPageJumpParams: function getPageJumpParams() {
  ...
  */
	usersFilter: function usersFilter() {
		...
		$('#usersFilter').on('change', function () {
			...
			AppConnector.request({
				...
				_this.updatePaginationFilter();
				var listSearchInstance = _this.getListSearchInstance();
	...
	updatePaginationFilter: function updatePaginationFilter() {
		var self = this,
	...
	updatePagination: function updatePagination(pageNumber) {
