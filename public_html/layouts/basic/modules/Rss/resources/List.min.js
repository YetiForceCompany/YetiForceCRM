...
Vtiger_List_Js("Rss_List_Js", {}, {
  ...
  */
	...
	registerRssButtonClickEvent: function registerRssButtonClickEvent(container) {
	...
	breadCrumbsFilter: function breadCrumbsFilter(text) {
		return;
	},
  ...
  */
	showRssModal: function showRssModal(mode) {
  ...
  * @parm form
  */
	rssFeedSave: function rssFeedSave(form) {
		var thisInstance = this;
  ...
  * @param <integer> id
  */
	getRssFeeds: function getRssFeeds(id) {
		var thisInstance = this;
		var aDeferred = jQuery.Deferred();
  ...
  * @param container
  */
	setFeedContainerHeight: function setFeedContainerHeight(container) {
  ...
  * @param container
  */
	registerFeedClickEvent: function registerFeedClickEvent(container) {
		var thisInstance = this;
  ...
  */
	getFrameElement: function getFrameElement(url) {
		var progressIndicatorElement = jQuery.progressIndicator({
			'position': 'html',
			'blockInfo': {
				'enabled': true
  ...
  */
	registerDeleteRecordClickEvent: function registerDeleteRecordClickEvent() {
  ...
  */
	deleteRecord: function deleteRecord(container) {
		var thisInstance = this;
  ...
  */
	registerMakeDefaultClickEvent: function registerMakeDefaultClickEvent(container) {
		var thisInstance = this;
  ...
  */
	makeDefault: function makeDefault(container) {
		var recordId = container.find('#recordId').val();
		var module = app.getModuleName();
		var postData = {
			"module": module,
