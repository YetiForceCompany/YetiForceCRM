			...
			eventRender: function (event, element) {
				...
				app.showPopoverElementView(element.find('.fc-content'), {
					...
					content: '<div><span class="glyphicon glyphicon-time" aria-hidden="true"></span> <label>' + app.vtranslate('JS_START_DATE') + '</label>: ' + event.start.format('YYYY-MM-DD ' + popoverTimeFormat) + '</div>' +
							...
							(event.status ? '<div><span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span> <label>' + app.vtranslate('JS_STATE') + '</label>: ' + app.vtranslate(event.status) + '</div>' : '') +
							'<div><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> <label>' + app.vtranslate('JS_IS_PRIVATE') + '</label>: ' + (event.isPrivate ? app.vtranslate('JS_YES') : app.vtranslate('JS_NO')) + '</div>' +
