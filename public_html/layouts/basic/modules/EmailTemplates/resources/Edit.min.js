...
Vtiger_Edit_Js("EmailTemplates_Edit_Js", {}, {
	...
	loadVariablePanel: function loadVariablePanel(form) {
	...
	afterLoadVariablePanel: function afterLoadVariablePanel(html) {
		App.Fields.Picklist.showSelect2ElementView(html.find('select.select2'));
	},
	registerVariablePanelEvent: function registerVariablePanelEvent(form) {
		var thisInstance = this;
		if (typeof form === "undefined") {
			form = this.getForm();
		}
