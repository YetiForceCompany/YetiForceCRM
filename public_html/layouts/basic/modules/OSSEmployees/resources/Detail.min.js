...
Vtiger_Detail_Js("OSSEmployees_Detail_Js", {
	...
	triggerEmployeeHierarchy: function triggerEmployeeHierarchy(HierarchyUrl) {
		OSSEmployees_Detail_Js.getEmployeeHierarchyResponseData(HierarchyUrl).done(function (data) {
			app.showModalWindow(data);
		});
	},
	getEmployeeHierarchyResponseData: function getEmployeeHierarchyResponseData(params) {
