...
/* {[The file is published on the basis of YetiForce Public License 4.0 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */'use strict';Vtiger_ListPreview_Js("Accounts_ListPreview_Js",{},{/**
		 ...
		 */postLoadListViewRecordsEvents:function postLoadListViewRecordsEvents(container){this._super(container),this.registerHierarchyRecordCount();},/**
		 * Registers ListPreview's events.
		 */registerEvents:function registerEvents(){this._super(),this.registerHierarchyRecordCount();}});
