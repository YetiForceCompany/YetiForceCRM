...
jQuery.Class("OpenStreetMap_Map_Js", {}, {
	...
	cacheLayerMarkers: {},
	indirectPointLayer: {},
	setSelectedParams: function setSelectedParams(params) {
		delete params['view'];
		this.selectedParams = params;
	},
	registerMap: function registerMap(startCoordinate, startZoom) {
	...
	setMarkersByResponse: function setMarkersByResponse(response) {
	...
	registerCacheEvents: function registerCacheEvents(container) {
		var thisInstance = this;
	...
	getCacheParamsToRequest: function getCacheParamsToRequest() {
		var container = this.container;
		var params = [];
	...
	registerSearchCompany: function registerSearchCompany() {
		var container = this.container;
	...
	registerBasicModal: function registerBasicModal() {
		var thisInstance = this;
		var container = this.container;
	...
	registerModalView: function registerModalView(container) {
		var thisInstance = this;
		var progressIndicatorElement = jQuery.progressIndicator({
			'position': container,
			'blockInfo': {
	...
	registerDetailView: function registerDetailView(container) {
		this.container = container;
