...
jQuery.Class("Notification_NotificationConfig_Js", {}, {
	registerEventForModal: function registerEventForModal(container) {
		...
		container.find('.sentNoticeAll').on('click', function (e) {
			e.stopPropagation();
			var element = $(e.currentTarget).find('.fas');
	...
	changeSendNoticeState: function changeSendNoticeState(element, val) {
		if (val !== undefined) {
			if (val === true) {
