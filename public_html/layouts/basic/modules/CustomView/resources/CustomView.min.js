 ...
 *************************************************************************************/'use strict';function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}function _defineProperties(target,props){for(var descriptor,i=0;i<props.length;i++)descriptor=props[i],descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor);}function _createClass(Constructor,protoProps,staticProps){return protoProps&&_defineProperties(Constructor.prototype,protoProps),staticProps&&_defineProperties(Constructor,staticProps),Constructor}var CustomView=/*#__PURE__*/function(){function CustomView(url){var _this=this;_classCallCheck(this,CustomView);var progressIndicatorElement=$.progressIndicator({position:"html",blockInfo:{enabled:!0}});app.showModalWindow(null,url,function(){_this.contentsCotainer=$(".js-filter-modal__container"),_this.advanceFilterInstance=new Vtiger_ConditionBuilder_Js(_this.contentsCotainer.find(".js-condition-builder"),_this.contentsCotainer.find("#sourceModule").val()),_this.advanceFilterInstance.registerEvents(),_this.columnSelectElement=!1,_this.registerEvents(),progressIndicatorElement.progressIndicator({mode:"hide"});});}return _createClass(CustomView,[{key:"loadDateFilterValues",value:function loadDateFilterValues(){var selectedDateFilter=$("#standardDateFilter option:selected"),currentDate=selectedDateFilter.data("currentdate"),endDate=selectedDateFilter.data("enddate");$("#standardFilterCurrentDate").val(currentDate),$("#standardFilterEndDate").val(endDate);}/**
...
var advfilterlist=_this2.advanceFilterInstance.getConditions();return $("#advfilterlist").val(JSON.stringify(advfilterlist)),$("[name=\"duplicatefields\"]").val(JSON.stringify(_this2.getDuplicateFields())),$("input[name=\"columnslist\"]",_this2.getContentsContainer()).val(JSON.stringify(_this2.getSelectedColumns())),_this2.saveAndViewFilter(),!1}app.formAlignmentAfterValidation($(e.currentTarget));});}/**
	 ...
	 */},{key:"registerDisableSubmitOnEnter",value:function registerDisableSubmitOnEnter(){this.getContentsContainer().find("#viewname, [name=\"color\"]").keydown(function(e){13===e.keyCode&&e.preventDefault();});}},{key:"registerEvents",value:function registerEvents(){var _this3=this;this.registerIconEvents(),App.Fields.Tree.register(this.getContentsContainer()),this.registerBlockToggleEvent(),this.registerColorEvent(),this.registerDuplicatesEvents();var select2Element=App.Fields.Picklist.showSelect2ElementView(this.getColumnSelectElement());this.registerSubmitEvent(select2Element),$(".stndrdFilterDateSelect").datepicker(),$("#standardDateFilter").on("change",function(){_this3.loadDateFilterValues();}),$("#CustomView").validationEngine(app.validationEngineOptions),this.registerDisableSubmitOnEnter();}}]),CustomView}();
