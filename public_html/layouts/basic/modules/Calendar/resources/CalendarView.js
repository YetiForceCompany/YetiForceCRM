...
jQuery.Class("Calendar_CalendarView_Js", {
			...
			eventRender: function (event, element) {
				app.showPopoverElementView(element.find('.fc-content'), {
					...
					content: '<div><span class="glyphicon glyphicon-time" aria-hidden="true"></span> <label>' + app.vtranslate('JS_START_DATE') + '</label>: ' + event.start_display + '</div>' +
							...
							(event.accname ? '<div><span class="userIcon_Accounts" aria-hidden="true"></span> <label>' + app.vtranslate('JS_ACCOUNTS') + '</label>: ' + event.accname + '</div>' : '') +
	...
	addCalendarEvent: function (calendarDetails) {
		...
		eventObject.className = 'ownerCBg_' + calendarDetails.assigned_user_id.value + ' picklistCBr_Calendar_activitytype_' + calendarDetails.activitytype.value;
