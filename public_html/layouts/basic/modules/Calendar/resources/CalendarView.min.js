...
window.calendarLoaded=!1,window.Calendar_Calendar_Js=/*#__PURE__*/function(_Vtiger_Calendar_Js){function Calendar_Calendar_Js(){return _classCallCheck(this,Calendar_Calendar_Js),_super.apply(this,arguments)}_inherits(Calendar_Calendar_Js,_Vtiger_Calendar_Js);var _super=_createSuper(Calendar_Calendar_Js);return _createClass(Calendar_Calendar_Js,[{key:"setCalendarModuleOptions",value:/**
	 * Set calendar module options.
	 * @returns {{allDaySlot: boolean, dayClick: object, selectable: boolean}}
	 */function setCalendarModuleOptions(){var _this=this,self=this;return {allDaySlot:!1,dateClick:function dateClick(args){_this.eventCreate&&_this.showCalendarCreateView().done(function(form){_this.dayCallbackCreateModal(form,args);});},selectable:!1,eventClick:function eventClick(info){info.jsEvent.preventDefault();var element=$(info.el),link=element.attr("href");link||(link=element.find("a").attr("href")),!self.readonly&&self.eventEdit?self.showSidebarEvent(link):window.location.assign(link.replace("view=","xview=")+"&view=Detail");}}}/**
	 * Show sidebar event
	 * @param {*} params
	 * @returns {Promise}
	 ...
	 * Register events
	 */},{key:"registerEvents",value:function registerEvents(){_get(_getPrototypeOf(Calendar_Calendar_Js.prototype),"registerEvents",this).call(this),this.registerSiteBarEvents(),this.registerPopoverButtonsClickEvent(),ElementQueries.listen(),this.showCalendarCreateView();}}]),Calendar_Calendar_Js}(Vtiger_Calendar_Js);
