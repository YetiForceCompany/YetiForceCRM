...
window.calendarLoaded=!1,window.Calendar_CalendarExtended_Js=/*#__PURE__*/function(_Calendar_Calendar_Js){function Calendar_CalendarExtended_Js(container,readonly){var _this;return _classCallCheck(this,Calendar_CalendarExtended_Js),_this=_super.call(this,container,readonly),_this.sidebarView={length:0},_this.calendarContainer=!1,_this.addCommonMethodsToYearView(),_this.calendar=_this.getCalendarView(),_this}/**
	 * Function extends FC.views.year with current class methods
	 */_inherits(Calendar_CalendarExtended_Js,_Calendar_Calendar_Js);var _super=_createSuper(Calendar_CalendarExtended_Js);return _createClass(Calendar_CalendarExtended_Js,[{key:"addCommonMethodsToYearView",value:function addCommonMethodsToYearView(){var self=this;FC.views.year=FC.views.year.extend({baseInstance:self,selectDays:self.selectDays,getCalendarCreateView:self.getCalendarCreateView,getSidebarView:self.getSidebarView,getCurrentCvId:self.getCurrentCvId,getCalendarView:self.getCalendarView,showRightPanelForm:self.showRightPanelForm,getSelectedUsersCalendar:self.getSelectedUsersCalendar,registerClearFilterButton:self.registerClearFilterButton,clearFilterButton:self.clearFilterButton,registerFilterTabChange:self.registerFilterTabChange,sidebarView:self.sidebarView,registerAfterSubmitForm:self.registerAfterSubmitForm,registerViewRenderEvents:self.registerViewRenderEvents,appendSubDateRow:self.appendSubDateRow,refreshDatesRowView:self.refreshDatesRowView,generateYearList:self.generateYearList,updateCountTaskCalendar:self.updateCountTaskCalendar,registerDatesChange:self.registerDatesChange,addHeaderButtons:self.addHeaderButtons,browserHistoryConfig:self.browserHistoryConfig,readonly:self.readonly,container:self.container,module:self.module,showChangeDateButtons:self.showChangeDateButtons,showTodayButtonCheckbox:self.showTodayButtonCheckbox,getDefaultParams:self.getDefaultParams});}/**
	 * Render calendar
	 ...
	 * Register events
	 */},{key:"registerEvents",value:function registerEvents(){_get(_getPrototypeOf(Calendar_CalendarExtended_Js.prototype),"registerEvents",this).call(this),this.registerAddForm(),this.registerSiteBarEvents(),this.registerPopoverButtonsClickEvent(),ElementQueries.listen();}}]),Calendar_CalendarExtended_Js}(Calendar_Calendar_Js);
