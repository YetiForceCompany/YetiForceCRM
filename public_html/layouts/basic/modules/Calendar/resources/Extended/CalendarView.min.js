...
window.calendarLoaded=!1,window.Calendar_CalendarExtended_Js=function(_Calendar_Calendar_Js){function Calendar_CalendarExtended_Js(container,readonly){classCallCheck(this,Calendar_CalendarExtended_Js);var _this=possibleConstructorReturn(this,(Calendar_CalendarExtended_Js.__proto__||Object.getPrototypeOf(Calendar_CalendarExtended_Js)).call(this,container,readonly));return _this.sidebarView={length:0},_this.calendarContainer=!1,_this.addCommonMethodsToYearView(),_this.calendar=_this.getCalendarView(),_this}/**
	 ...
	 */},{key:'registerAutofillTime',value:function registerAutofillTime(){app.getMainParams('autofillTime')&&this.container.find('.js-autofill').prop('checked','checked').trigger('change');}},{key:'registerPinUser',value:function registerPinUser(){$('.js-pin-user').off('click').on('click',function(){var thisInstance=$(this);AppConnector.request({module:this.module,action:'Calendar',mode:'pinOrUnpinUser',element_id:thisInstance.data('elementid')}).done(function(data){var response=data.result;'unpin'===response?thisInstance.find('.js-pin-icon').removeClass('fas').addClass('far'):'pin'===response?thisInstance.find('.js-pin-icon').removeClass('far').addClass('fas'):app.showNotify({text:app.vtranslate('JS_ERROR'),type:'error'});});});}},{key:'registerAddForm',value:function registerAddForm(){var thisInstance=this,sideBar=thisInstance.getSidebarView();thisInstance.getCalendarCreateView();var user=app.getMainParams('usersId');void 0===user&&(user=[app.getMainParams('userId')]),AppConnector.request('index.php?module='+this.module+'&view=RightPanelExtended&mode=getUsersList&user='+user).done(function(data){if(data){var formContainer=sideBar.find('.js-users-form');formContainer.html(data),thisInstance.registerUsersChange(formContainer),App.Fields.Picklist.showSelect2ElementView(formContainer.find('select')),app.showNewScrollbar(formContainer,{suppressScrollX:!0}),thisInstance.registerFilterForm(formContainer);}}),AppConnector.request('index.php?module='+this.module+'&view=RightPanelExtended&mode=getGroupsList&user='+user).done(function(data){if(data){var formContainer=sideBar.find('.js-group-form');formContainer.html(data),thisInstance.registerUsersChange(formContainer),App.Fields.Picklist.showSelect2ElementView(formContainer.find('select')),formContainer.addClass('u-min-h-30per'),app.showNewScrollbar(formContainer,{suppressScrollX:!0}),thisInstance.registerFilterForm(formContainer);}});}/**
	 ...
	 * Register events
	 */},{key:'registerEvents',value:function registerEvents(){get(Calendar_CalendarExtended_Js.prototype.__proto__||Object.getPrototypeOf(Calendar_CalendarExtended_Js.prototype),'registerEvents',this).call(this),this.registerAddForm(),this.registerSiteBarEvents(),this.registerPopoverButtonsClickEvent(),ElementQueries.listen();}}]),Calendar_CalendarExtended_Js}(Calendar_Calendar_Js);
