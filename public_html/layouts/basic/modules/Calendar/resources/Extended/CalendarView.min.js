...
window.calendarLoaded=!1,window.Calendar_CalendarExtended_Js=function(_Calendar_Calendar_Js){function _class(container,readonly){classCallCheck(this,_class);var _this=possibleConstructorReturn(this,(_class.__proto__||Object.getPrototypeOf(_class)).call(this,container,readonly));return _this.sidebarView={length:0},_this.calendarContainer=!1,_this.addCommonMethodsToYearView(),_this.calendar=_this.getCalendarView(),_this}/**
	 ...
	 */},{key:'registerFilterForm',value:function registerFilterForm(){var self=this;this.getSidebarView().find('a[data-toggle="tab"]').one('shown.bs.tab',function(){$('.js-filter__search').on('keyup',self.findElementOnList.bind(self));});}/**
