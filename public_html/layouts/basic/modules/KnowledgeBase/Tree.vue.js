...
__vue_render__._withStripped = true;
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-4fc3a794_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Icon.vue"}, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-4fc3a794";
  /* module identifier */
...
//
const { offset: offset$1, ready: ready$1, height: height$1 } = dom;
var script$1 = {
  name: 'Carousel',
  data() {
    return {
  ...
  methods: {
    setHeight() {},
    onResize(size) {
      this.height = `${this.$q.screen.height - offset$1(this.$refs.carousel.$el).top}px`;
    }
  }
};
    ...
    [
      ...
      _vm.record.knowledgebase_view === "PLL_PRESENTATION"
        ? _c(
            ...
            {
              ref: "carousel",
              staticClass: "bg-white text-black shadow-1 rounded-borders",
            ...
            _vm._l(_vm.record.content, function(slide, index) {
              return _c(
                ...
                [_c("div", { domProps: { innerHTML: _vm._s(slide) } })]
              )
            }),
            1
          )
...
__vue_render__$1._withStripped = true;
  ...
  const __vue_inject_styles__$1 = function (inject) {
    if (!inject) return
    inject("data-v-896878e0_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Carousel.vue"}, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$1 = "data-v-896878e0";
  /* module identifier */
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("q-breadcrumbs-el", {
                        class: [
                          _vm.activeCategory === "" ? "" : "cursor-pointer"
                        ],
                        attrs: {
                        ...
                        on: {
                          click: function($event) {
                            _vm.activeCategory === "" ? "" : _vm.getData();
                          }
                        }
                      }),
                      _vm._v(" "),
                      _vm.activeCategory !== ""
                        ? _vm._l(
                            _vm.tree.categories[_vm.activeCategory].parentTree,
                        ...
                        [
                          ...
                          _c("q-tooltip", [
                            _vm._v(
                              "\n              " +
                                _vm._s(
                                  _vm.translate("JS_SEARCH_CURRENT_CATEGORY")
                                ) +
                                "\n            "
                            )
                          ])
                        ...
                        [
                          ...
                          _c("q-item-section", [
                            _vm._v(
                              "\n              " +
                                _vm._s(
                                  _vm.translate(_vm.tree.topCategory.label)
                                ) +
                                "\n            "
                            )
                          ])
                        ...
                        [
                          _c(
                            "div",
                            {
                              ...
                              staticClass: "q-pa-sm row items-start q-gutter-md"
                            },
                            [
                              _vm._l(_vm.tree.data.categories, function(
                                categoryValue,
                                    ...
                                    ? _c(
                                        ...
                                        [
                                          _c(
                                            ...
                                            {
                                              staticClass:
                                                "text-black flex cursor-pointer",
                                              attrs: { header: "" },
                                              on: {
                                                click: function($event) {
                                                  return _vm.getData(
              ...
              _c(
                ...
                [
                  _vm.record.related
                    ? _c("q-table", {
                        attrs: {
                          data: _vm.getTableArray(_vm.record.related),
                          columns: _vm.columns,
                          "row-key": "subject",
                          grid: "",
                          "hide-header": "",
                          title: _vm.translate("JS_RELATED_ARTICLES")
                        },
                        scopedSlots: _vm._u(
                          [
                            {
