...
Vtiger_Edit_Js("OSSTimeControl_Edit_Js", {}, {
	...
	registerGenerateTCFieldTimeAndCost: function registerGenerateTCFieldTimeAndCost() {
	...
	differenceDays: function differenceDays(container) {
  ...
  */
	registerRecordPreSaveEvent: function registerRecordPreSaveEvent(container) {
		var thisInstance = this;
	...
	registerGenerateTCFromHelpDesk: function registerGenerateTCFromHelpDesk() {
		var thisInstance = this;
