...
window.MailIntegration_Compose={/**
	 ...
	 */registerAutocomplete:function registerAutocomplete(){return this.container.find('.js-search-input').autocomplete({delay:'600',minLength:'3',classes:{"ui-autocomplete":'mobile'},source:function source(request,response){window.MailIntegration_Compose.findEmail(request,response);},select:function select(e,ui){window.MailIntegration_Compose.onSelectRecipient(this,ui.item);}})},/**
