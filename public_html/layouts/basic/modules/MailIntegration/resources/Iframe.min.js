...
var MailIntegration_Iframe={mailId:0,container:{},iframe:{},iframeWindow:{},moduleSelect:{},addRecordBtn:{},loaderParams:{blockInfo:{enabled:!0},message:!1},/**
	 ...
	 * Register events
	 */registerEvents:function registerEvents(){this.container=$('#page'),this.iframe=$('#js-iframe'),this.iframeWindow=this.iframe[0].contentWindow,this.addRecordBtn=this.container.find('.js-add-record'),this.mailId=this.container.find('.js-iframe-container').data('mailId'),this.mailItem=Office.context.mailbox.item,this.iframe.length&&(this.registerListItemEvents(),this.registerIframeEvents(),this.setIframeHeight(),this.mailId?(this.registerModulesSelect(),this.registerAddRecord()):this.registerImportClick());}};window.App.Components.Scrollbar.active=!1,function(){MailIntegration_Iframe.registerEvents();}($);
