...
PasswordHelper = {
	...
	passwordStrength: function passwordStrength(password, translations) {
	...
	showPassword: function showPassword(record) {
	...
	showDetailsPassword: function showDetailsPassword(record) {
		var showPassText = app.vtranslate('LBL_ShowPassword');
		var hidePassText = app.vtranslate('LBL_HidePassword');
	...
	showPasswordQuickEdit: function showPasswordQuickEdit(record) {
		var hidePassText = app.vtranslate('LBL_HidePassword');
