...
/* {[The file is published on the basis of YetiForce Public License 6.5 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */"use strict";Vtiger_Detail_Js("SSalesProcesses_Detail_Js",{},{//It stores the IStorages Hierarchy response data
...
return jQuery.isEmptyObject(thisInstance.hierarchyResponseCache)?AppConnector.request(params).done(function(data){thisInstance.hierarchyResponseCache=data,aDeferred.resolve(thisInstance.hierarchyResponseCache);}).fail(function(textStatus,errorThrown){aDeferred.reject(textStatus,errorThrown);}):aDeferred.resolve(thisInstance.hierarchyResponseCache),aDeferred.promise()},/*
