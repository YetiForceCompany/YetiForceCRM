...
'undefined'==typeof timeComponent&&(timeComponent='00:00:00');var timeSections=timeComponent.split(':');return 'undefined'!=typeof timeSections[2]&&(seconds=timeSections[2]),'undefined'!=typeof dateTimeComponents[2]&&('pm'===dateTimeComponents[2].toLowerCase()&&'12'!==timeSections[0]&&(timeSections[0]=parseInt(timeSections[0],10)+12),'am'===dateTimeComponents[2].toLowerCase()&&'12'===timeSections[0]&&(timeSections[0]='00')),--month,dateInstance=new Date(year,month,date,timeSections[0],timeSections[1],seconds),dateInstance},/*
		 ...
		 */showPnotify:function showPnotify(customParams){var userParams=customParams;'string'==typeof customParams&&(userParams={},userParams.text=customParams);var params={target:document.body,data:{type:'error',hide:!1,delay:'2000',modules:{Buttons:{closerHover:!1,labels:{close:app.vtranslate('JS_CLOSE')}},Animate:{animate:!0,inClass:'animate__zoomInLeft',outClass:'animate__zoomOutRight'}}}};return 'undefined'!=typeof customParams.type&&'error'!=customParams.type&&(params.data.hide=!0),params.data=$.extend(params.data,userParams),new PNotify(params)},/*
		 * Function to remove pnotify message
		 */hidePnotify:function hidePnotify(notice){'undefined'==typeof notice&&(notice=$('.ui-pnotify')),notice.remove();},/*
