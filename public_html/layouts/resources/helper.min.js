...
$.Class('Vtiger_Helper_Js', {
  ...
  */
	setLangCode: function setLangCode() {
  ...
  */
	...
	getLabelDayFromDate: function getLabelDayFromDate(day) {
		var dayOfWeek = day;
		var dayOfWeekLabel = '';
		switch (dayOfWeek) {
			case 0:
  ...
  */
	...
	getDateInstance: function getDateInstance(dateTime, dateFormat) {
  ...
  */
	showConfirmationBox: function showConfirmationBox(params) {
	...
	showMessage: function showMessage(params) {
  ...
  */
	showPnotify: function showPnotify(customParams) {
  ...
  */
	hidePnotify: function hidePnotify(notice) {
  ...
  */
	addClickOutSideEvent: function addClickOutSideEvent(element, callbackFunction) {
		element.one('clickoutside', callbackFunction);
	},
	/*
  * Function to show horizontal top scroll bar
  */
	showHorizontalTopScrollBar: function showHorizontalTopScrollBar() {
	...
	hideOptions: function hideOptions(element, attr, value) {
		var opval = '';
