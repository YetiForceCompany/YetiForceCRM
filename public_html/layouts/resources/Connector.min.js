...
if("undefined"==typeof params.data||rawData){if("string"!=typeof params)callerParams=$.extend({},params);else if(callerParams=params,index=callerParams.indexOf("?"),-1!==index){var subStr=callerParams.substr(0,index+1);//need to replace only "index.php?" or "?"
