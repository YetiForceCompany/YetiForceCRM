...
function _createForOfIteratorHelper(o,allowArrayLike){var it="undefined"!=typeof Symbol&&o[Symbol.iterator]||o["@@iterator"];if(!it){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&"number"==typeof o.length){it&&(o=it);var i=0,F=function(){};return {s:F,n:function n(){return i>=o.length?{done:!0}:{done:!1,value:o[i++]}},e:function e(_e){throw _e},f:F}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var err,normalCompletion=!0,didErr=!1;return {s:function s(){it=it.call(o);},n:function n(){var step=it.next();return normalCompletion=step.done,step},e:function e(_e2){didErr=!0,err=_e2;},f:function f(){try{normalCompletion||null==it.return||it.return();}finally{if(didErr)throw err}}}}function _unsupportedIterableToArray(o,minLen){if(o){if("string"==typeof o)return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);return "Object"===n&&o.constructor&&(n=o.constructor.name),"Map"===n||"Set"===n?Array.from(o):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(o,minLen):void 0}}function _arrayLikeToArray(arr,len){(null==len||len>arr.length)&&(len=arr.length);for(var i=0,arr2=new Array(len);i<len;i++)arr2[i]=arr[i];return arr2}function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable})),keys.push.apply(keys,symbols);}return keys}function _objectSpread(target){for(var source,i=1;i<arguments.length;i++)source=null==arguments[i]?{}:arguments[i],i%2?ownKeys(Object(source),!0).forEach(function(key){babelHelpers.defineProperty(target,key,source[key]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});return target}window.App.Fields={Date:{months:["JS_JAN","JS_FEB","JS_MAR","JS_APR","JS_MAY_SHORT","JS_JUN","JS_JUL","JS_AUG","JS_SEP","JS_OCT","JS_NOV","JS_DEC"],monthsTranslated:["JS_JAN","JS_FEB","JS_MAR","JS_APR","JS_MAY_SHORT","JS_JUN","JS_JUL","JS_AUG","JS_SEP","JS_OCT","JS_NOV","JS_DEC"].map(function(monthName){return app.vtranslate(monthName)}),fullMonths:["JS_JANUARY","JS_FEBRUARY","JS_MARCH","JS_APRIL","JS_MAY","JS_JUNE","JS_JULY","JS_AUGUST","JS_SEPTEMBER","JS_OCTOBER","JS_NOVEMBER","JS_DECEMBER"],fullMonthsTranslated:["JS_JANUARY","JS_FEBRUARY","JS_MARCH","JS_APRIL","JS_MAY","JS_JUNE","JS_JULY","JS_AUGUST","JS_SEPTEMBER","JS_OCTOBER","JS_NOVEMBER","JS_DECEMBER"].map(function(monthName){return app.vtranslate(monthName)}),days:["JS_SUN","JS_MON","JS_TUE","JS_WED","JS_THU","JS_FRI","JS_SAT"],daysTranslated:["JS_SUN","JS_MON","JS_TUE","JS_WED","JS_THU","JS_FRI","JS_SAT"].map(function(monthName){return app.vtranslate(monthName)}),fullDays:["JS_SUNDAY","JS_MONDAY","JS_TUESDAY","JS_WEDNESDAY","JS_THURSDAY","JS_FRIDAY","JS_SATURDAY"],fullDaysTranslated:["JS_SUNDAY","JS_MONDAY","JS_TUESDAY","JS_WEDNESDAY","JS_THURSDAY","JS_FRIDAY","JS_SATURDAY"].map(function(monthName){return app.vtranslate(monthName)}),/**
		 ...
		 */Completions:/*#__PURE__*/function(){/**
			 ...
			 */},{key:"registerEmojiPanel",value:function registerEmojiPanel(inputDiv,emojisContainer){new EmojiPanel({container:".js-completions__emojis",json_url:CONFIG.siteUrl+"libraries/emojipanel/dist/emojis.json"}),emojisContainer.on("click",function(e){var element=$(e.target);element.toggleClass("active");}),emojisContainer.on("click",".emoji",function(e){e.preventDefault(),e.stopPropagation(),void 0!==$(e.currentTarget).data("char")&&inputDiv.append("".concat($(e.currentTarget).data("char")));}),emojisContainer.on("mouseenter",".emoji",function(e){void 0!==$(e.currentTarget).data("name")&&(emojisContainer.find(".emoji-hovered").remove(),emojisContainer.find("footer").prepend("<div class=\"emoji-hovered\">".concat($(e.currentTarget).data("char")+" "+$(e.currentTarget).data("name"),"</div>")));}),emojisContainer.on("clickoutside",function(){emojisContainer.removeClass("active");});}}]),Completions}(),/**
		 * Get mention data (invoked by ck editor mentions plugin and tribute.js)
		 * @param {object} opts
		 * @param {function} callback
		 * @param {string} searchModule
		 */getMentionData:function getMentionData(text,callback){var searchModule=2<arguments.length&&arguments[2]!==void 0?arguments[2]:"-",basicSearch=new Vtiger_BasicSearch_Js;basicSearch.reduceNumberResults=app.getMainParams("gsAmountResponse"),basicSearch.returnHtml=!1,basicSearch.searchModule=searchModule,"object"===babelHelpers.typeof(text)&&(text=text.query.toLowerCase()),"owners"===searchModule?AppConnector.request({action:"Search",mode:"owners",value:text}).done(function(data){callback(data.result);}):basicSearch.search(text).done(function(data){data=JSON.parse(data);var serverDataFormat=data.result,reponseDataList=[];for(var id in serverDataFormat){var responseData=serverDataFormat[id];reponseDataList.push(responseData);}callback(reponseDataList);});},/**
		 * Destroy ckEditor
		 * @param {jQuery} element
...
page:params.page}},processResults:function processResults(data){var items=new Array;return !0==data.success&&(selectElement.find("option").each(function(){var currentTarget=$(this);items.push({label:currentTarget.html(),value:currentTarget.val()});}),items=items.concat(data.result.items)),{results:items,pagination:{more:!1}}},cache:!1},params.escapeMarkup=function(markup){if("undefined"!==markup)return markup};var minimumInputLength=3;return "undefined"!==selectElement.data("minimumInput")&&(minimumInputLength=selectElement.data("minimumInput")),params.minimumInputLength=minimumInputLength,params.templateResult=function(data){return "undefined"==typeof data.name?data.text:"optgroup"==data.type?"<strong>"+data.name+"</strong>":"<span>"+data.name+"</span>"},params.templateSelection=function(data){return ""===data.text?data.name:data.text},params},/**
	 ...
	 * Tree
	 */Tree:/*#__PURE__*/function(){function Tree(container){babelHelpers.classCallCheck(this,Tree),this.container=container,this.init();}/**
		 * Register function
		 * @param {jQuery} container
		 */return babelHelpers.createClass(Tree,[{key:"init",value:/**
		 * Initiation
	 ...
	 */TimePeriod:/*#__PURE__*/function(){function TimePeriod(container){if(babelHelpers.classCallCheck(this,TimePeriod),this.container=container,this.value=container.val(),this.value){var split=this.value.split(":");this.time=Number(split[0]),this.period=split[1];}else this.time=0,this.period="H",this.value="0:H",container.val(this.value);this.injectContent();}/**
		 ...
		 */return babelHelpers.createClass(TimePeriod,[{key:"injectContent",value:/**
	 ...
	 * Multi currency
	 */MultiCurrency:/*#__PURE__*/function(){function MultiCurrency(container){babelHelpers.classCallCheck(this,MultiCurrency),this.container=container,this.init();}/**
		 * Register function
		 * @param {jQuery} container
		 */return babelHelpers.createClass(MultiCurrency,[{key:"init",value:/**
		 * Initiation
	 ...
	 * Meeting URL
	 */MeetingUrl:/*#__PURE__*/function(){function MeetingUrl(container){babelHelpers.classCallCheck(this,MeetingUrl),this.container=container,this.init();}/**
		 * Register function
		 * @param {jQuery} container
		 */return babelHelpers.createClass(MeetingUrl,[{key:"init",value:/**
		 * Initiation
	 ...
	 * Changes Json
	 */ChangesJson:/*#__PURE__*/function(){function ChangesJson(container){babelHelpers.classCallCheck(this,ChangesJson),this.container=container,this.init();}/**
		 * Register function
		 * @param {jQuery} container
		 */return babelHelpers.createClass(ChangesJson,[{key:"init",value:/**
		 * Initiation
	 ...
	 * MultiReference
	 */MultiReference:/*#__PURE__*/function(){function MultiReference(container){babelHelpers.classCallCheck(this,MultiReference),this.container=container,this.init();}/**
		 * Register function
		 * @param {jQuery} container
		 */return babelHelpers.createClass(MultiReference,[{key:"init",value:/**
		 * Initiation
	 ...
	 * Password
	 */Password:/*#__PURE__*/function(){function Password(container){babelHelpers.classCallCheck(this,Password),this.container=container,this.init();}/**
		 * Register function
		 * @param {jQuery} container
		 */return babelHelpers.createClass(Password,[{key:"init",value:/**
		 * Initiation
