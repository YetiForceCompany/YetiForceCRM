...
page:item.page}},processResults:params.ajax&&params.ajax.processResults?params.ajax.processResults:function(data){var items=new Array;return !0==data.success&&(selectElement.find("option").each(function(){var currentTarget=$(this);items.push({label:currentTarget.html(),value:currentTarget.val()});}),items=items.concat(data.result.items)),{results:items,pagination:{more:!1}}},cache:!1},params.escapeMarkup=function(markup){if("undefined"!==markup)return markup},params.minimumInputLength=3,"undefined"!==selectElement.data("minimumInput")&&(params.minimumInputLength=selectElement.data("minimumInput")),params.templateResult=function(data){return "undefined"==typeof data.name?data.text:"optgroup"==data.type?"<strong>"+data.name+"</strong>":"<span>"+data.name+"</span>"},params.templateSelection=function(data){return ""===data.text?data.name:data.text},params},/**
	 ...
	 */Tree:/*#__PURE__*/function(){function Tree(container){_classCallCheck(this,Tree),this.container=container,this.init();}/**
		 ...
		 */},{key:"modalEvent",value:function modalEvent(){var _this7=this;$(".js-tree-modal",this.container).off("click").on("click",function(){var sourceFieldElement=_this7.container.find("input.sourceField"),fieldDisplayElement=_this7.container.find("input[name=\""+sourceFieldElement.attr("name")+"_display\"]");AppConnector.request({module:sourceFieldElement.data("module-name"),view:"TreeModal",template:sourceFieldElement.data("treetemplate"),fieldName:sourceFieldElement.attr("name"),multiple:sourceFieldElement.data("multiple"),value:sourceFieldElement.val()}).done(function(requestData){app.modalEvents.treeModal=function(modal,instance){instance.setSelectEvent(function(responseData){sourceFieldElement.val(responseData.id),fieldDisplayElement.val(responseData.name).attr("readonly",!0),sourceFieldElement.trigger("change");});},app.showModalWindow(requestData,{modalId:"treeModal"});});});}/**
	 ...
	 */MeetingUrl:/*#__PURE__*/function(){function MeetingUrl(container){_classCallCheck(this,MeetingUrl),this.container=container,this.init();}/**
		 ...
		 * Initiation
		 */function init(){var _this12=this,addButton=$(".js-meeting-add",this.container);if(!addButton.length)return !1;var valElement=$(".js-meeting-val",this.container);addButton.off("click").on("click",function(e){var progressIndicatorElement=$.progressIndicator({blockInfo:{enabled:!0}});AppConnector.request(_this12.getUrl(e)).done(function(data){var result=data.result;result&&result.success&&result.url?valElement.attr("readonly",!0).val(result.url):app.showNotify({text:app.vtranslate("JS_ERROR"),type:"error"}),progressIndicatorElement.progressIndicator({mode:"hide"});}).fail(function(){app.showNotify({text:app.vtranslate("JS_ERROR"),type:"error"}),progressIndicatorElement.progressIndicator({mode:"hide"});});}),$(".js-meeting-clear",this.container).off("click").on("click",function(){valElement.attr("readonly",!1).val("");}),this.addEventsForDependentFields();}/**
		 * Gets URL
	 ...
	 */MultiAttachment:/*#__PURE__*/function(){/**
		 ...
		 * @param {Event} e
		 * @param {Object} data
		 */},{key:"submit",value:function submit(){this.filesActive++,this.progressInstance=$.progressIndicator({position:"replace",blockInfo:{enabled:!0,elementToBlock:this.container}});}/**
		 ...
		 *
		 * @param {Event} e
		 */},{key:"dragOver",value:function dragOver(){this.container.addClass("c-multi-image__drop-effect");}/**
		 * Dragleave event handler
		 * @param {Event} e
		 */},{key:"dragLeave",value:function dragLeave(){this.container.removeClass("c-multi-image__drop-effect");}/**
		 ...
		 * @param {Event} e
		 * @param {Object} ui
		 */},{key:"sortStop",value:function sortStop(){var _this26=this,actualElements=this.result.find("fieldset").toArray();this.files=actualElements.map(function(element){for(var elementHash,i=0,len=_this26.files.length;i<len;i++)if(elementHash=$(element).data("key"),_this26.files[i].key===elementHash)return _this26.files[i]}),this.updateFormValues();}/**
