...
/* {[The file is published on the basis of YetiForce Public License 5.0 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */"use strict";/** Class representing a calendar. */var _class;function _typeof(obj){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(obj){return typeof obj}:function(obj){return obj&&"function"==typeof Symbol&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj},_typeof(obj)}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}function _defineProperties(target,props){for(var descriptor,i=0;i<props.length;i++)descriptor=props[i],descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,_toPropertyKey(descriptor.key),descriptor);}function _createClass(Constructor,protoProps,staticProps){return protoProps&&_defineProperties(Constructor.prototype,protoProps),staticProps&&_defineProperties(Constructor,staticProps),Object.defineProperty(Constructor,"prototype",{writable:!1}),Constructor}function _defineProperty(obj,key,value){return key=_toPropertyKey(key),key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value,obj}function _toPropertyKey(arg){var key=_toPrimitive(arg,"string");return "symbol"===_typeof(key)?key:String(key)}function _toPrimitive(input,hint){if("object"!==_typeof(input)||null===input)return input;var prim=input[Symbol.toPrimitive];if(prim!==void 0){var res=prim.call(input,hint||"default");if("object"!==_typeof(res))return res;throw new TypeError("@@toPrimitive must return a primitive value.")}return ("string"===hint?String:Number)(input)}window.Calendar_Js=(_class=/*#__PURE__*/function(){/**
	 ...
	 */},{key:"registerUsersChange",value:function registerUsersChange(formContainer){var _this8=this;formContainer.find(".js-input-user-owner-id-ajax, .js-input-user-owner-id").on("change",function(){_this8.reloadCalendarData();});}/**
	 * Register change on select all checkbox
	 * @param {jQuery} formContainer
	 */},{key:"registerSelectAll",value:function registerSelectAll(formContainer){var _this9=this;formContainer.find(".js-select-all").on("change",function(e){var checkboxSelectAll=$(e.currentTarget),checkboxes=formContainer.find(".js-input-user-owner-id-ajax, .js-input-user-owner-id");checkboxSelectAll.is(":checked")?checkboxes.prop("checked",!0):(checkboxes.prop("checked",!1),formContainer.find("#ownerId"+CONFIG.userId).prop("checked",!0)),_this9.reloadCalendarData();});}/**
	 * Register sidebar events.
	 */},{key:"registerSidebarEvents",value:function registerSidebarEvents(){var _this10=this;$(".bodyContents").on("Vtiger.Widget.Load.undefined",function(){_this10.registerSelect2Event();});}/**
	 ...
	 * Register add button.
	 */},{key:"registerAddButton",value:function registerAddButton(){var _this11=this;$(".js-add").on("click",function(){_this11.getCalendarCreateView().done(function(data){App.Components.QuickCreate.showModal(data,{callbackFunction:function callbackFunction(){_this11.reloadCalendarData();}});});});}/**
	 ...
	 * @param info
	 */},{key:"selectDays",value:function selectDays(info){var _this12=this;this.getCalendarCreateView().done(function(data){App.Components.QuickCreate.showModal(data,{callbackFunction:function callbackFunction(){self.reloadCalendarData();},callbackPostShown:function callbackPostShown(modal){_this12.selectCallbackCreateModal(modal,info);}});});}/**
