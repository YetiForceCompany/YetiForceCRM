...
/* {[The file is published on the basis of YetiForce Public License 5.0 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */"use strict";/** Class representing a calendar. */var _class;function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}function _defineProperties(target,props){for(var descriptor,i=0;i<props.length;i++)descriptor=props[i],descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor);}function _createClass(Constructor,protoProps,staticProps){return protoProps&&_defineProperties(Constructor.prototype,protoProps),staticProps&&_defineProperties(Constructor,staticProps),Object.defineProperty(Constructor,"prototype",{writable:!1}),Constructor}function _defineProperty(obj,key,value){return key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value,obj}window.Calendar_Js=(_class=/*#__PURE__*/function(){/**
	 ...
	 */function _class(){var _this=this,container=0<arguments.length&&void 0!==arguments[0]?arguments[0]:$(".js-base-container"),readonly=!!(1<arguments.length&&void 0!==arguments[1])&&arguments[1],browserHistory=!(2<arguments.length&&void 0!==arguments[2])||arguments[2];_classCallCheck(this,_class),this.fullCalendar,this.calendarCreateView=!1,this.container=container,this.calendarView=container.find(".js-calendar__container"),this.readonly=readonly,this.eventCreate=app.getMainParams("eventCreate"),this.eventEdit=app.getMainParams("eventEdit"),this.browserHistory=!readonly&&browserHistory,this.sidebarView={length:0},this.startHour=app.getMainParams("startHour"),this.endHour=app.getMainParams("endHour"),""==this.startHour&&(this.startHour="00"),""==this.endHour&&(this.endHour="00"),this.browserHistoryConfig=this.browserHistory?this.setBrowserHistoryOptions():{},this.calendarOptions=this.setCalendarOptions(),this.eventTypeKeyName=!1,this.module=app.getModuleName(),app.event.on("QuickEdit.AfterSaveFinal",function(){_this.reloadCalendarData();});}/**
	 ...
	 */},{key:"getCalendarView",value:function getCalendarView(){return !1==this.calendarView&&(this.calendarView=this.container.find(".js-calendar__container")),this.calendarView}/**
	 * Load calendar data
	 ...
	 */},{key:"registerUsersChange",value:function registerUsersChange(formContainer){var _this6=this;formContainer.find(".js-input-user-owner-id-ajax, .js-input-user-owner-id").on("change",function(){_this6.reloadCalendarData();});}/**
	 * Register change on select all checkbox
	 * @param {jQuery} formContainer
	 */},{key:"registerSelectAll",value:function registerSelectAll(formContainer){formContainer.find(".js-select-all").on("change",function(e){var checkboxSelectAll=$(e.currentTarget),checkboxes=formContainer.find(".js-input-user-owner-id-ajax, .js-input-user-owner-id");checkboxSelectAll.is(":checked")?checkboxes.prop("checked",!0):(checkboxes.prop("checked",!1),formContainer.find("#ownerId"+CONFIG.userId).prop("checked",!0)),self.reloadCalendarData();});}/**
	 * Register sidebar events.
	 */},{key:"registerSidebarEvents",value:function registerSidebarEvents(){var _this7=this;$(".bodyContents").on("Vtiger.Widget.Load.undefined",function(){_this7.registerSelect2Event();});}/**
	 ...
	 * Get current cv id
	 * @returns {int}
	 */},{key:"getCurrentCvId",value:function getCurrentCvId(){return $(".js-calendar__extended-filter-tab .active").parent(".js-filter-tab").data("cvid")}/**
	 ...
	 * Register add button.
	 */},{key:"registerAddButton",value:function registerAddButton(){var _this8=this;$(".js-add").on("click",function(){_this8.getCalendarCreateView().done(function(data){App.Components.QuickCreate.showModal(data,{callbackFunction:function callbackFunction(){_this8.reloadCalendarData();}});});});}/**
	 ...
	 * @param info
	 */},{key:"selectDays",value:function selectDays(info){var _this9=this;this.getCalendarCreateView().done(function(data){App.Components.QuickCreate.showModal(data,{callbackFunction:function callbackFunction(){self.reloadCalendarData();},callbackPostShown:function callbackPostShown(modal){_this9.selectCallbackCreateModal(modal,info);}});});}/**
