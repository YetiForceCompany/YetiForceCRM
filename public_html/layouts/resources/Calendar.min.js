 ...
 */window.Calendar_Js=/*#__PURE__*/function(){/**
	 ...
	 */},{key:"registerSitebarEvents",value:function registerSitebarEvents(){var _this4=this;$(".bodyContents").on("Vtiger.Widget.Load.undefined",function(){_this4.registerSelect2Event();});}/**
	 * Load calendar data
	 */},{key:"loadCalendarData",value:function loadCalendarData(){var _this5=this,defaultParams=this.getDefaultParams();if(this.getCalendarView().fullCalendar("removeEvents"),!defaultParams.emptyFilters){var progressInstance=$.progressIndicator();AppConnector.request(defaultParams).done(function(events){_this5.getCalendarView().fullCalendar("addEventSource",events.result),progressInstance.hide();});}}},{key:"getSidebarView",value:function getSidebarView(){return this.sidebarView.length||(this.sidebarView=this.container.find(".js-calendar-right-panel")),this.sidebarView}},{key:"getCurrentCvId",value:function getCurrentCvId(){return $(".js-calendar__extended-filter-tab .active").parent(".js-filter-tab").data("cvid")}/**
	 * Default params
