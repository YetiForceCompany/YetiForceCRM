 ...
 */window.Calendar_Js=function(){/**
	 ...
	 * @param {bool} readonly
	 */function _class(){var container=0<arguments.length&&void 0!==arguments[0]?arguments[0]:$('.js-base-container'),readonly=!!(1<arguments.length&&void 0!==arguments[1])&&arguments[1],browserHistory=!(2<arguments.length&&void 0!==arguments[2])||arguments[2];classCallCheck(this,_class),this.calendarView=!1,this.calendarCreateView=!1,this.container=container,this.readonly=readonly,this.eventCreate=app.getMainParams('eventCreate'),this.eventEdit=app.getMainParams('eventEdit'),this.browserHistory=!readonly&&browserHistory,this.sidebarView={length:0},this.browserHistoryConfig=this.browserHistory?{}:this.setBrowserHistoryOptions(),this.calendarOptions=this.setCalendarOptions(),this.eventTypeKeyName=!1,this.module=app.getModuleName();}/**
	 * Set calendar's options.
	 * @returns {object}
	 */return createClass(_class,[{key:'setCalendarOptions',value:function setCalendarOptions(){return Object.assign(this.setCalendarBasicOptions(),this.setCalendarAdvancedOptions(),this.setCalendarModuleOptions(),this.browserHistoryConfig)}/**
	 ...
	 * Register add button.
	 */},{key:'registerAddButton',value:function registerAddButton(){var self=this;$('.js-add').on('click',function(){self.getCalendarCreateView().done(function(data){var headerInstance=new Vtiger_Header_Js;headerInstance.handleQuickCreateData(data,{callbackFunction:function callbackFunction(data){self.addCalendarEvent(data.result);}});});});}/**
	 ...
	 */},{key:'getCalendarView',value:function getCalendarView(){return !1==this.calendarView&&(this.calendarView=this.container.find('.js-calendar__container')),this.calendarView}}]),_class}(),window.Calendar_Unselectable_Js=function(_Calendar_Js){function _class2(){return classCallCheck(this,_class2),possibleConstructorReturn(this,(_class2.__proto__||Object.getPrototypeOf(_class2)).apply(this,arguments))}return inherits(_class2,_Calendar_Js),createClass(_class2,[{key:'setCalendarModuleOptions',/**
	 * Set calendar module options.
	 * @returns {{allDaySlot: boolean, dayClick: object, selectable: boolean}}
	 */value:function setCalendarModuleOptions(){var self=this;return {allDaySlot:!1,dayClick:!!this.eventCreate&&function(date){self.registerDayClickEvent(date.format()),self.getCalendarView().fullCalendar('unselect');},selectable:!1}}/**
