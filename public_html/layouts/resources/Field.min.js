...
jQuery.Class('Vtiger_Field_Js',{/**
		 ...
		 * Function to get the ui
		 * @return - input text field
		 */getUi:function getUi(){var html='<div class="input-group time"><input class="clockPicker form-control" type="text" data-format="'+this.getTimeFormat()+'" name="'+this.getName()+'"  value="'+this.getValue()+'" /><span class="input-group-addon"><i class="far fa-clock"></i></span></div>',element=jQuery(html);return this.addValidationToElement(element)}}),Vtiger_Field_Js('Vtiger_Text_Field_Js',{},{/**
		 * Function to get the ui
		 * @return - input text field
		 ...
		 */getUi:function getUi(){var html='<div class="input-group"><input type="number" class="form-control" min="0" max="100" name="'+this.getName()+'" value="'+this.getValue()+'" step="any"/><span class="input-group-addon">%</span></div>',element=jQuery(html);return this.addValidationToElement(element)}}),Vtiger_Field_Js('Vtiger_Recurrence_Field_Js',{},{/**
		 * Function to get the pick list values
		 * @return <object> key value pair of options
		 */getPickListValues:function getPickListValues(){return this.get('picklistvalues')},/**
		 * Function to get the ui
