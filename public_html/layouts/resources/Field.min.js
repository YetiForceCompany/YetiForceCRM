...
jQuery.Class('Vtiger_Field_Js', {
  ...
  */
	getInstance: function getInstance(data, moduleName) {
  ...
  */
	setData: function setData(fieldInfo) {
		this.data = fieldInfo;
		return this;
	},
  ...
  */
	getUiTypeModel: function getUiTypeModel() {
  ...
  */
	addValidationToElement: function addValidationToElement(element) {
...
Vtiger_Field_Js('Vtiger_Picklist_Field_Js', {}, {
  ...
  */
	getPickListValues: function getPickListValues() {
...
Vtiger_Field_Js('Vtiger_Date_Field_Js', {}, {
  ...
  */
	getUi: function getUi() {
		var html = '<div class="date input-group">' + '<input class="dateField form-control datepicker" type="text" name="' + this.getName() + '"  data-date-format="' + this.getDateFormat() + '"  value="' + this.getValue() + '" autocomplete="off"/>' + '<div class="input-group-append"><span class="input-group-text u-cursor-pointer js-date__btn" data-js="click"><span class="fas fa-calendar-alt"></span></span></div>' + '</div>';
...
Vtiger_Field_Js('Vtiger_Currency_Field_Js', {}, {
  ...
  */
	...
	getUi: function getUi() {
		var html = '<div class="input-group">' + '<span class="input-group-addon">' + this.getCurrencySymbol() + '</span>' + '<input type="text" class="form-control" name="' + this.getName() + '" value="' + this.getValue() + '"  />' + '</div>';
		var element = jQuery(html);
		return this.addValidationToElement(element);
	}
});
...
Vtiger_Field_Js('Vtiger_Time_Field_Js', {}, {
  ...
  */
	getUi: function getUi() {
		var html = '<div class="input-group time">' + '<input class="clockPicker form-control" type="text" data-format="' + this.getTimeFormat() + '" name="' + this.getName() + '"  value="' + this.getValue() + '" />' + '<span class="input-group-addon"><i class="far fa-clock"></i></span>' + '</div>';
		var element = jQuery(html);
		return this.addValidationToElement(element);
	}
});
...
Vtiger_Field_Js('Vtiger_Percentage_Field_Js', {}, {
  ...
  */
	getUi: function getUi() {
		var html = '<div class="input-group">' + '<input type="number" class="form-control" min="0" max="100" name="' + this.getName() + '" value="' + this.getValue() + '" step="any"/>' + '<span class="input-group-addon">%</span>' + '</div>';
		var element = jQuery(html);
		return this.addValidationToElement(element);
	}
});
