...
var formError=form.find(".formError:not('.greenPopup'):first");if(0<formError.length){var destination=formError.offset().top;$("html").animate({scrollTop:destination-105},"slow");}},convertToDatePickerFormat:function convertToDatePickerFormat(dateFormat){return "yyyy-mm-dd"===dateFormat?"Y-m-d":"mm-dd-yyyy"===dateFormat?"m-d-Y":"dd-mm-yyyy"===dateFormat?"d-m-Y":"yyyy.mm.dd"===dateFormat?"Y.m.d":"mm.dd.yyyy"===dateFormat?"m.d.Y":"dd.mm.yyyy"===dateFormat?"d.m.Y":"yyyy/mm/dd"===dateFormat?"Y/m/d":"mm/dd/yyyy"===dateFormat?"m/d/Y":"dd/mm/yyyy"===dateFormat?"d/m/Y":void 0},convertTojQueryDatePickerFormat:function convertTojQueryDatePickerFormat(dateFormat){var i,dotMode="-";-1!==dateFormat.indexOf("-")&&(dotMode="-"),-1!==dateFormat.indexOf(".")&&(dotMode="."),-1!==dateFormat.indexOf("/")&&(dotMode="/");var splitDateFormat=dateFormat.split(dotMode);for(i in splitDateFormat){var sectionDate=splitDateFormat[i];4===sectionDate.length&&(splitDateFormat[i]=sectionDate.substring(0,2));}return splitDateFormat.join(dotMode)},/*
