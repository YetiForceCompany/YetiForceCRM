...
/* {[The file is published on the basis of YetiForce Public License 5.0 that can be found in the following directory: licenses/LicenseEN.txt or yetiforce.com]} */"use strict";function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}function _defineProperties(target,props){for(var descriptor,i=0;i<props.length;i++)descriptor=props[i],descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor);}function _createClass(Constructor,protoProps,staticProps){return protoProps&&_defineProperties(Constructor.prototype,protoProps),staticProps&&_defineProperties(Constructor,staticProps),Object.defineProperty(Constructor,"prototype",{writable:!1}),Constructor}var MultiImage=/*#__PURE__*/function(){/**
	 ...
	 * @param {Event} e
	 * @param {Object} data
	 */},{key:"submit",value:function submit(e,data){data.formData={hash:data.files[0].hash},App.Fields.MultiImage.currentFileUploads++,this.progressInstance=$.progressIndicator({position:"replace",blockInfo:{enabled:!0,elementToBlock:this.elements.component}});}/**
...
files.forEach(function(file){App.Fields.MultiImage.currentFileUploads--,_this.deleteFile(file.hash,!1),app.showNotify({textTrusted:!1,title:app.vtranslate("JS_FILE_UPLOAD_ERROR"),text:file.name,type:"error"});}),this.updateFormValues())}/**
	 ...
	 */},{key:"deleteFile",value:function deleteFile(hash){var _this6=this,showConfirmation=!(1<arguments.length&&void 0!==arguments[1])||arguments[1];if(showConfirmation){var fileInfo=this.getFileInfo(hash);app.showConfirmModal({title:fileInfo.name,text:app.vtranslate("JS_DELETE_FILE_CONFIRMATION"),titleTrusted:!1,icon:"fa fa-trash-alt",confirmedCallback:function confirmedCallback(){_this6.deleteFileCallback(hash);}});}else this.deleteFileCallback(hash);}/**
	 ...
	 */},{key:"generatePreviewElements",value:function generatePreviewElements(files,callback){var _this9=this;files.forEach(function(file){file instanceof File?_this9.generatePreviewFromFile(file,function(template,imageSrc){file.preview=_this9.addPreviewPopover(file,template,imageSrc),_this9.addFileInfoProperty(file.hash,"previewElement",file.preview),callback(file.preview);}):_this9.generatePreviewFromValue(file,function(template,imageSrc){file.preview=_this9.addPreviewPopover(file,template,imageSrc),_this9.addFileInfoProperty(file.hash,"previewElement",file.preview),callback(file.preview);});});}/**
	 * Generate preview of image as html string
	 *
	 * @param {File} file
	 * @param {function} callback
	 */},{key:"generatePreviewFromFile",value:function generatePreviewFromFile(file,callback){var _this10=this,fr=new FileReader;fr.onload=function(){file.imageSrc=fr.result,_this10.addFileInfoProperty(file.hash,"imageSrc",file.imageSrc),callback(_this10.createPreview(file),fr.result);},fr.readAsDataURL(file);}/**
	 ...
	 */},{key:"loadExistingFiles",value:function loadExistingFiles(){var _this11=this;this.files=this.files.map(function(file){return file.hash=App.Fields.Text.generateRandomHash(CONFIG.userId),file}).slice(0,this.options.limit),this.generatePreviewElements(this.files,function(element){_this11.elements.result.append(element);}),this.updateFormValues();}/**
