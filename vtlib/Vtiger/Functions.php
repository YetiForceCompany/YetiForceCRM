...
class Functions
{
	...
	public static function getCRMRecordMetadata($mixedid)
	{
		...
		if ($missing) {
			$sql = sprintf("SELECT vtiger_crmentity.crmid, setype, deleted, smcreatorid, smownerid, vtiger_crmentity_label.label, vtiger_crmentity_search.searchlabel 
				FROM vtiger_crmentity 
				LEFT JOIN vtiger_crmentity_search ON vtiger_crmentity_search.crmid = vtiger_crmentity.crmid 
				LEFT JOIN vtiger_crmentity_label ON vtiger_crmentity_label.crmid = vtiger_crmentity.crmid 
