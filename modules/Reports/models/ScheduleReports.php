...
class Reports_ScheduleReports_Model extends \App\Base
{
	...
	public function saveScheduleReport()
	{
		...
		if ($isReportScheduled == '0' || $isReportScheduled == '' || $isReportScheduled === false) {
			...
			if ($adb->numRows($checkScheduledResult) > 0) {
							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0" style="font-size: 12px; font-weight: normal; color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);">
									<tr>
										...
										<table width="100%" cellspacing="0" cellpadding="5" border="0">
												...
												<tr>
													<td style="font-size: 12px; color: rgb(0, 0, 0); font-weight: normal; text-align: justify; line-height: 20px;"> ' . \App\Language::translate('LBL_AUTO_GENERATED_REPORT_EMAIL', $currentModule) . '</td>
												</tr>
												<tr>
													<td align="center">
