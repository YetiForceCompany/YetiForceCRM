...
class Reports extends Vtiger_CRMEntity
{
	/**
	...
	var $table_name = 'vtiger_report';
	var $table_index = 'reportid';
...
//	var $customFieldTable = Array('u_yf_ssingleorderscf', 'ssingleordersid');
	...
	var $list_fields = Array(
		...
		'reportname' => Array('report', 'reportname'),
	...
	var $list_link_field = 'reportname';
	...
	var $popup_fields = Array('reportname');
	// For Alphabetical search
	var $def_basicsearch_col = 'reportname';
	// Column value to use on detail view record text display
	var $def_detailview_recname = 'reportname';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('reportname', 'assigned_user_id');
