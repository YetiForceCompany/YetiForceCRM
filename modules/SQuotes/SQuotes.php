...
class SQuotes extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_squotes';
	public var $table_index = 'squotesid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_squotescf', 'squotesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_squotes', 'u_yf_squotescf', 'u_yf_squotes_address', 'vtiger_entity_stats');
