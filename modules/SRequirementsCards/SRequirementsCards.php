...
class SRequirementsCards extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_srequirementscards';
	public var $table_index = 'srequirementscardsid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_srequirementscardscf', 'srequirementscardsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_srequirementscards', 'u_yf_srequirementscardscf', 'vtiger_entity_stats');
