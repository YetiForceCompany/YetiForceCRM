...
class HolidaysEntitlement extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'vtiger_holidaysentitlement';
	public var $table_index = 'holidaysentitlementid';
	public var $column_fields = Array();

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('vtiger_holidaysentitlementcf', 'holidaysentitlementid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'vtiger_holidaysentitlement', 'vtiger_holidaysentitlementcf');
	...
	public var $popup_fields = Array('ossemployeesid');
	// For Alphabetical search
	public var $def_basicsearch_col = 'ossemployeesid';
	// Column value to use on detail view record text display
	public var $def_detailview_recname = 'ossemployeesid';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	public var $mandatory_fields = Array('ossemployeesid', 'assigned_user_id', 'holidaysentitlement_year', 'days');
