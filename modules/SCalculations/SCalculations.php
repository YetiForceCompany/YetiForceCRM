...
class SCalculations extends Vtiger_CRMEntity
{
	 ...
	 */
	public $customFieldTable = Array('u_yf_scalculationscf', 'scalculationsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public $tab_name = Array('vtiger_crmentity', 'u_yf_scalculations', 'u_yf_scalculationscf', 'vtiger_entity_stats');
