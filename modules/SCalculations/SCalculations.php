...
class SCalculations extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_scalculations';
	public var $table_index = 'scalculationsid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_scalculationscf', 'scalculationsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_scalculations', 'u_yf_scalculationscf', 'vtiger_entity_stats');
