...
class IGIN extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_igin';
	public var $table_index = 'iginid';
	protected $lockFields = ['igin_status' => ['PLL_ACCEPTED']];

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_igincf', 'iginid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_igin', 'u_yf_igincf');
