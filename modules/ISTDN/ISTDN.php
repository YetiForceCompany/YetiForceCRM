...
class ISTDN extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_istdn';
	public var $table_index = 'istdnid';
	protected $lockFields = ['istdn_status' => ['PLL_ACCEPTED']];

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_istdncf', 'istdnid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_istdn', 'u_yf_istdncf');
