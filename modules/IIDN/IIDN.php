...
class IIDN extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_iidn';
	public var $table_index = 'iidnid';
	protected $lockFields = ['iidn_status' => ['PLL_ACCEPTED']];

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_iidncf', 'iidnid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_iidn', 'u_yf_iidncf');
