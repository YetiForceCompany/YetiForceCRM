...
class FBookkeeping extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_fbookkeeping';
	public var $table_index = 'fbookkeepingid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_fbookkeepingcf', 'fbookkeepingid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_fbookkeeping', 'u_yf_fbookkeepingcf');
