...
class IPreOrder extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_ipreorder';
	public var $table_index = 'ipreorderid';
	protected $lockFields = ['ipreorder_status' => ['PLL_ACCEPTED']];

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_ipreordercf', 'ipreorderid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_ipreorder', 'u_yf_ipreordercf');
