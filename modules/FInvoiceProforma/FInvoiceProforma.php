...
class FInvoiceProforma extends Vtiger_CRMEntity
{
	 ...
	 */
	public $customFieldTable = Array('u_yf_finvoiceproformacf', 'finvoiceproformaid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public $tab_name = Array('vtiger_crmentity', 'u_yf_finvoiceproforma', 'u_yf_finvoiceproformacf', 'u_yf_finvoiceproforma_address');
