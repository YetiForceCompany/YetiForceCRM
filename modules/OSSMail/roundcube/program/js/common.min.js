...
var Base64=function(){var a=function(a){for(var c=0,d="",e=c2=c3=0;c<a.length;)e=a.charCodeAt(c),128>e?(d+=String.fromCharCode(e),c++):191<e&&224>e?(c2=a.charCodeAt(c+1),d+=String.fromCharCode((e&31)<<6|c2&63),c+=2):(c2=a.charCodeAt(c+1),c3=a.charCodeAt(c+2),d+=String.fromCharCode((e&15)<<12|(c2&63)<<6|c3&63),c+=3);return d};return{encode:function(a){if("function"===typeof window.btoa)try{return btoa(a)}catch(c){}a=a.replace(/\r\n/g,"\n");for(var d="",e=0;e<a.length;e++){var f=a.charCodeAt(e);128>
f?d+=String.fromCharCode(f):(127<f&&2048>f?d+=String.fromCharCode(f>>6|192):(d+=String.fromCharCode(f>>12|224),d+=String.fromCharCode(f>>6&63|128)),d+=String.fromCharCode(f&63|128))}a=d;for(var g,l,m,k=0,h="",n=a.length;k<n;)g=a.charCodeAt(k++),d=a.charCodeAt(k++),e=a.charCodeAt(k++),f=g>>2,g=(g&3)<<4|d>>4,l=(d&15)<<2|e>>6,m=e&63,isNaN(d)?l=m=64:isNaN(e)&&(m=64),h=h+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g)+
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(l)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(m);return h},decode:function(b){if("function"===typeof window.atob)try{return a(atob(b))}catch(c){}var d,e,f,g,l,m,k=0,h="";b=b.replace(/[^A-Za-z0-9\+\/\=]/g,"");for(m=b.length;k<m;)d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(k++)),e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(k++)),
g="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(k++)),l="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(k++)),d=d<<2|e>>4,e=(e&15)<<4|g>>2,f=(g&3)<<6|l,h+=String.fromCharCode(d),64!=g&&(h+=String.fromCharCode(e)),64!=l&&(h+=String.fromCharCode(f));return a(h)}}}();
