...
width:420,minHeight:90}).show();l.messagedialog.closest("div[role=dialog]").attr("role","alertdialog");0<a.timeout&&(l.message_timer=window.setTimeout(c,a.timeout))}}function v(){$('#messagecontent').css('top', ($('.oss-header').outerHeight() + $('#messageheader').outerHeight() + 1) + 'px');$("#message-objects div a").addClass("button");$("#attachment-list li").length||($("div.rightcol").hide().attr("aria-hidden","true"),$("div.leftcol").css("margin-right","0"))}function b(a){}function e(a){}function E(a){if("TEXTAREA"==a.nodeName){var d=
