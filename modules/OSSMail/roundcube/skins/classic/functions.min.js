...
$("<li>"),b=$('<a href="#"></a>').text(rcmail.env.spell_langs[i]).addClass("active").data("lang",i).click(function(){rcmail.spellcheck_lang_set($(this).data("lang"))}),b.appendTo(c),c.appendTo(f);f.appendTo(e)}$("li",f).each(function(){var a=$("a",this);a.data("lang")==d?a.addClass("selected"):a.hasClass("selected")&&a.removeClass("selected")});this.show_popupmenu("spellmenu",a)},show_attachmentmenu:function(a,b){var c=a.parentNode.id.replace(/^attach/,"");$("#attachmenuopen").unbind("click").attr("onclick",
...
next_sibling:function(a){for(a=a.nextSibling;a&&3==a.nodeType;)a=a.nextSibling;return a},prev_sibling:function(a){for(a=a.previousSibling;a&&3==a.nodeType;)a=a.previousSibling;return a},enable_command:function(a){"reply-list"==a.command&&1==rcmail.env.reply_all_mode&&(a=rcmail.gettext(a.status?"replylist":"replyall"),$("a.button.replyAll").attr("title",a))},folder_search_init:function(a){$(".boxtitle a.search",a).click(function(b){var c=$(".boxtitle",a),d=$(".listsearchbox",a),e=d.is(":visible")?
-1:1,f=24+($("select",d).length?24:0);d.slideToggle({duration:160,progress:function(b,d){0>e&&(d=1-d);$(".boxlistcontent",a).css("top",c.outerHeight()+f*d+"px")},complete:function(){d.toggleClass("expanded");d.is(":visible")?d.find("input[type=text]").focus():$("a.reset",d).click()}});return!1})}};
