...
function rcmail_zipdownload(a){if("eml"==a)a=rcmail.get_single_uid(),rcmail.goto_url("viewsource",{_uid:a,_mbox:rcmail.get_message_mailbox(a),_save:1});else if(rcmail.message_list&&1<rcmail.message_list.get_selection().length){var b=[],c=$("#zipdownload-form"),e=rcmail.selection_post_data();e._mode=a;e._token=rcmail.env.request_token;$.each(e,function(a,d){if("object"==typeof d&&1<d.length)for(var c=0;c<d.length;c++)b.push($("<input>").attr({type:"hidden",name:a+"[]",value:d[c]}));else b.push($("<input>").attr({type:"hidden",
