...
(this.checked=!0)}),!this.env.acl_specials.length||0>$.inArray(a,this.env.acl_specials)?d=$("td.user",c).text():f=a):b.filter(function(){return this.id.match(/^acl([lrs]|read)$/)}).prop("checked",!0);g.val(d);$("input[value="+f+"]").prop("checked",!0);this.acl_id=a;var d={},l=this,h=document.body;d[this.gettext("save")]=function(a){l.command("acl-save")};d[this.gettext("cancel")]=function(a){l.command("acl-cancel")};this.acl_popup=this.show_popup_dialog('<div style="width:480px;height:280px">&nbsp;</div>',
a?this.gettext("acl.editperms"):this.gettext("acl.newuser"),d,{button_classes:["mainaction"],modal:!0,closeOnEscape:!0,close:function(a,b){(l.is_framed()?parent.rcmail:l).ksearch_hide();l.acl_form.appendTo(h).hide();$(this).remove();window.focus()}});this.acl_form.appendTo(this.acl_popup).show();"user"==f?g.focus():$("input:checked",n).focus()};
rcube_webmail.prototype.acl_class=function(a,b){var c,e,d=0;a=String(a);b=String(b);c=0;for(e=b.length;c<e;c++)-1<a.indexOf(b[c])&&d++;return d==e?"enabled":d?"partial":"disabled"};
