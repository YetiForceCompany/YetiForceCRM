...
(this.checked=!0)}),!this.env.acl_specials.length||0>$.inArray(a,this.env.acl_specials)?d=$("td.user",c).text():f=a):b.filter(function(){return this.id.match(/^acl([lrs]|read)$/)}).prop("checked",!0);g.val(d);$("input[value="+f+"]").prop("checked",!0);this.acl_id=a;var d={},l=this,h=document.body;d[this.gettext("save")]=function(a){l.command("acl-save")};d[this.gettext("cancel")]=function(a){l.command("acl-cancel")};b=$('<div style="width:480px; min-height:280px"></div>');this.acl_form.appendTo(b).show();
this.acl_popup=this.show_popup_dialog(b,a?this.gettext("acl.editperms"):this.gettext("acl.newuser"),d,{button_classes:["mainaction"],modal:!0,closeOnEscape:!0,close:function(a,b){(l.is_framed()?parent.rcmail:l).ksearch_hide();l.acl_form.appendTo(h).hide();$(this).remove();window.focus()}});"user"==f?g.focus():$("input:checked",n).focus()};
