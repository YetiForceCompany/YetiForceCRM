...
class IGRN extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_igrn';
	public var $table_index = 'igrnid';
	protected $lockFields = ['igrn_status' => ['PLL_ACCEPTED']];

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_igrncf', 'igrnid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_igrn', 'u_yf_igrncf');
