...
Class Settings_OSSProjectTemplates_Steps_View extends Settings_OSSProjectTemplates_Base_View
{
	...
	public function process(Vtiger_Request $request)
	{
		...
		$viewer->assign('PROJECT_MILESTONE_TPL_LIST', $settingsModuleModel->getListTpl($baseModule));
		echo $viewer->view($step . '.tpl', $moduleSettingsName, true);
	}
}
