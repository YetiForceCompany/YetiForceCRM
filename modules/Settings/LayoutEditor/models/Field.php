...
class Settings_LayoutEditor_Field_Model extends Vtiger_Field_Model
{
	...
	public function delete()
	{
		...
		if (305 === $this->getUIType()) {
			...
			$rr = $db->createCommand()->delete('s_#__multireference', ['source_module' => $fldModule, 'dest_module' => $fieldParams['module']])->execute();
			var_dump('MultiReferenceValue 2', $rr, $fldModule, $fieldParams['module']);
		}
	}
