...
class Settings_ConfReport_Module_Model extends Settings_Vtiger_Module_Model {
	...
	public static $writableFilesAndFolders = array(
		...
		'User privileges directory' => 'data/userPrivileges/',
		'Tabdata file' => 'data/userPrivileges/tabdata.php',
		'Menu file' => 'data/userPrivileges/menu_0.php',
		'User privileges file' => 'data/userPrivileges/user_privileges_1.php',
		'Parent tabdata file' => 'config/parent_tabdata.php',
		'Cache directory' => 'data/cache/',
		'Address book directory' => 'data/addressBook/',
		'Cache backup directory' => 'data/cache/backup/',
		'Image cache directory' => 'data/cache/images/',
		'Import cache directory' => 'data/cache/import/',
		'Logs directory' => 'data/logs/',
		'Session directory' => 'data/cache/session/',
		'Cache templates directory' => 'data/cache/templates_c/',
		'Cache upload directory' => 'data/cache/upload/',
		'Cron modules directory' => 'cron/modules/',
		'Vtlib test directory' => 'data/cache/vtlib/',
		'Vtlib test HTML directory' => 'data/cache/vtlib/HTML',
		'Modules directory' => 'modules/',
		'Storage directory' => 'data/storage/',
		'Product image directory' => 'data/storage/Products/',
		'User image directory' => 'data/storage/Users/',
		'Contact image directory' => 'data/storage/Contacts/',
		'Logo directory' => 'data/storage/Logo/',
		'MailView attachments directory' => 'data/storage/OSSMailView/',
	);
	...
	public static function getConfigurationValue() {
		...
		$directiveValues = array(
			...
			'post_max_size' => array('prefer' => '10 MB'),
			'upload_max_filesize' => array('prefer' => '10 MB'),
