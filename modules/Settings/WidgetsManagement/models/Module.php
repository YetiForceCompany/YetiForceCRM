...
class Settings_WidgetsManagement_Module_Model extends Settings_Vtiger_Module_Model {
	...
	public function getWidgetsWithLimit(){
		...
		$widgetWithLimit = ['History', 'Upcoming Activities', 'Overdue Activities', 'Mini List', 'Delegated project tasks', 'Delegated (overdue) project tasks', 'Delagated Events/To Do', 'Delegated (overdue) Events/ToDos', 'Calculations'];
