...
class Settings_Groups_Module_Model extends Settings_Vtiger_Module_Model
{
	...
	public var $baseTable = 'vtiger_groups';
	public var $baseIndex = 'groupid';
	public var $listFields = array('groupname' => 'Name', 'description' => 'Description');
	public var $name = 'Groups';
