...
class OSSPaymentsIn extends Vtiger_CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_osspaymentsin';
	var $table_index= 'osspaymentsinid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_osspaymentsincf', 'osspaymentsinid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_osspaymentsin', 'vtiger_osspaymentsincf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_osspaymentsin'   => 'osspaymentsinid',
		'vtiger_osspaymentsincf' => 'osspaymentsinid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = array (
		'LBL_PAYMENTSNO' => array('osspaymentsin', 'paymentsno'),
		'LBL_PAYMENTSNAME' => array('osspaymentsin', 'paymentsname'),
		'LBL_PAYMENTSVALUE' => array('osspaymentsin', 'paymentsvalue'),
		'LBL_PAYMENTSCURRENCY' => array('osspaymentsin', 'paymentscurrency'),
		'LBL_PAYMENTSSTATUS' => array('osspaymentsin', 'osspaymentsin_status'),
	...
	var $list_fields_name = array (
		...
		'LBL_PAYMENTSSTATUS' => 'osspaymentsin_status',
	...
	var $default_order_by = 'paymentsname';
	...
	private function addWorkflow($moduleName) {
		...
		$emm->addEntityMethod($moduleName, $functionName, "modules/OSSPaymentsIn/workflow/UpdateBalance.php", $functionName);
