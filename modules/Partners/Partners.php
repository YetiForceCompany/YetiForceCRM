...
class Partners extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_partners';
	public var $table_index = 'partnersid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_partnerscf', 'partnersid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_partners', 'u_yf_partnerscf', 'u_yf_partners_address', 'vtiger_entity_stats');
