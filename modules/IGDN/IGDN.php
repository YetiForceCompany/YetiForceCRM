...
class IGDN extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_igdn';
	public var $table_index = 'igdnid';
	protected $lockFields = ['igdn_status' => ['PLL_ACCEPTED']];

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_igdncf', 'igdnid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_igdn', 'u_yf_igdncf');
