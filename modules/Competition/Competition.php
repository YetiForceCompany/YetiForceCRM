...
class Competition extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_competition';
	public var $table_index = 'competitionid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_competitioncf', 'competitionid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_competition', 'u_yf_competitioncf', 'u_yf_competition_address', 'vtiger_entity_stats');
