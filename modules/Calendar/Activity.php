...
class Activity extends CRMEntity
{
	...
	public var $log;
	public var $db;
	public var $table_name = "vtiger_activity";
	public var $table_index = 'activityid';
	public var $reminder_table = 'vtiger_activity_reminder';
	public var $tab_name = Array('vtiger_crmentity', 'vtiger_activity', 'vtiger_activitycf');
	public var $tab_name_index = Array('vtiger_crmentity' => 'crmid', 'vtiger_activity' => 'activityid', 'vtiger_activity_reminder' => 'activity_id', 'vtiger_recurringevents' => 'activityid', 'vtiger_activitycf' => 'activityid');
	public var $column_fields = [];
	public var $sortby_fields = Array('subject', 'due_date', 'date_start', 'smownerid', 'activitytype', 'lastname'); //Sorting is added for due date and start date
	// This is used to retrieve related vtiger_fields from form posts.
	public var $additional_column_fields = Array('assigned_user_name', 'assigned_user_id', 'contactname', 'contact_phone', 'contact_email', 'parent_name');

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('vtiger_activitycf', 'activityid');
