...
class OSSPaymentsOut extends Vtiger_CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_osspaymentsout';
	var $table_index= 'osspaymentsoutid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_osspaymentsoutcf', 'osspaymentsoutid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_osspaymentsout', 'vtiger_osspaymentsoutcf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_osspaymentsout'   => 'osspaymentsoutid',
		'vtiger_osspaymentsoutcf' => 'osspaymentsoutid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = array (
		'LBL_PAYMENTSNO' => array('vtiger_osspaymentsout', 'paymentsno'),
		'LBL_PAYMENTSNAME' => array('vtiger_osspaymentsout', 'paymentsname'),
		'LBL_PAYMENTSVALUE' => array('vtiger_osspaymentsout', 'paymentsvalue'),
		'LBL_PAYMENTSCURRENCY' => array('vtiger_osspaymentsout', 'paymentscurrency'),
		'LBL_PAYMENTSSTATUS' => array('vtiger_osspaymentsout', 'osspaymentsout_status'),
	...
	var $list_fields_name = array (
		...
		'LBL_PAYMENTSSTATUS' => 'osspaymentsout_status',
	...
	var $search_fields = array (
		'LBL_PAYMENTSVALUE' => array('osspaymentsout', 'paymentsvalue'),
		'LBL_PAYMENTSNO' => array('osspaymentsout', 'paymentsno'),
		'LBL_PAYMENTSNAME' => array('osspaymentsout', 'paymentsname'),
