...
class FCorectingInvoice extends Vtiger_CRMEntity
{
	 ...
	 */
	public $customFieldTable = Array('u_yf_fcorectinginvoicecf', 'fcorectinginvoiceid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public $tab_name = Array('vtiger_crmentity', 'u_yf_fcorectinginvoice', 'u_yf_fcorectinginvoicecf', 'u_yf_fcorectinginvoice_address');
