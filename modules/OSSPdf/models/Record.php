...
class OSSPdf_Record_Model extends Vtiger_Record_Model {
	...
	function slownie($liczba, $kod_waluty) {
		...
		if ($kwotazl>999999999) $txt .= $this->policz(substr($kwotazl, 0,3), vtranslate('LBL_miliard_1','OSSPdf'), vtranslate('LBL_miliard_2','OSSPdf'), vtranslate('LBL_miliard_3','OSSPdf'));
		if ($kwotazl>999999) $txt .= $this->policz(substr($kwotazl, 3,3), vtranslate('LBL_milion_1','OSSPdf'), vtranslate('LBL_milion_2', 'OSSPdf'), vtranslate('LBL_milion_3', 'OSSPdf'));
		if ($kwotazl>999) $txt .= $this->policz(substr($kwotazl, 6,3), vtranslate('LBL_tysiac_1', 'OSSPdf'), vtranslate('LBL_tysiac_2', 'OSSPdf'), vtranslate('LBL_tysiac_3', 'OSSPdf'));
