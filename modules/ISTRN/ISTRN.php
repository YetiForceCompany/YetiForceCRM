...
class ISTRN extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_istrn';
	public var $table_index = 'istrnid';
	protected $lockFields = ['istrn_status' => ['PLL_ACCEPTED']];

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_istrncf', 'istrnid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_istrn', 'u_yf_istrncf');
