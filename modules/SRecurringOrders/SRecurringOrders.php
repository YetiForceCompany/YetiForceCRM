...
class SRecurringOrders extends Vtiger_CRMEntity
{
	 ...
	 */
	var $tab_name = Array('vtiger_crmentity', 'u_yf_srecurringorders', 'u_yf_srecurringorderscf', 'u_yf_recurring_info');
	...
	function vtlib_handler($moduleName, $eventType)
	{
		...
		if ($eventType == 'module.postinstall') {
			...
			$moduleInstance->setModuleSeqNumber("configure", 'SRecurringOrders', 'S-SO', '1');
