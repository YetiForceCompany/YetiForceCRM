...
/**
 * DetailView Class for SRecurringOrders
 * @package YetiForce.Model
 * @license licenses/License.html
 * @author Radosław Skrzypczak <r.skrzypczak@yetiforce.com>
 */
class SRecurringOrders_DetailView_Model extends Vtiger_DetailView_Model
{
	...
	public function getDetailViewLinks($linkParams)
	{
		...
		$openRecord = Users_Privileges_Model::isPermitted($moduleName, 'OpenRecurringOrders', $recordId);
