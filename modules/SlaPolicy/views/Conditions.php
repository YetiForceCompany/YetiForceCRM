<?php
/**
 * SlaPolicy Conditions View class.
 *
 * @package   View
 *
 ...
 */
class SlaPolicy_Conditions_View extends Vtiger_Index_View
{
	/**
	 * Process.
	 *
	...
	public function process(App\Request $request)
	{
		...
		$recordModel = SlaPolicy_Record_Model::getCleanInstance();
		if (!empty($record)) {
			$recordModel = SlaPolicy_Record_Model::getInstanceById($record);
		}
