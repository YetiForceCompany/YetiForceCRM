...
class SSingleOrders extends Vtiger_CRMEntity
{
	...
	var $table_name = 'u_yf_ssingleorders';
	var $table_index = 'ssingleordersid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('u_yf_ssingleorderscf', 'ssingleordersid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'u_yf_ssingleorders', 'u_yf_ssingleorderscf');
	...
	function vtlib_handler($moduleName, $eventType)
	{
		...
		if ($eventType == 'module.postinstall') {
			...
			if ($modcommentsModuleInstance && file_exists('modules/ModTracker/ModTracker.php')) {
				...
				$tabid = Vtiger_Functions::getModuleId('SSingleOrders');
	...
	{
		$adb = PearDatabase::getInstance();
		$actions = ['OpenSingleOrders', 'CloseSingleOrders'];
