...
class SSingleOrders extends Vtiger_CRMEntity
{
	 ...
	 */
	public $customFieldTable = Array('u_yf_ssingleorderscf', 'ssingleordersid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public $tab_name = Array('vtiger_crmentity', 'u_yf_ssingleorders', 'u_yf_ssingleorderscf', 'u_yf_ssingleorders_address', 'vtiger_entity_stats');
