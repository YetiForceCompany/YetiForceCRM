...
class SSingleOrders extends Vtiger_CRMEntity
{
	...
	public var $table_name = 'u_yf_ssingleorders';
	public var $table_index = 'ssingleordersid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public var $customFieldTable = Array('u_yf_ssingleorderscf', 'ssingleordersid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public var $tab_name = Array('vtiger_crmentity', 'u_yf_ssingleorders', 'u_yf_ssingleorderscf', 'u_yf_ssingleorders_address', 'vtiger_entity_stats');
	...
	public var $list_fields = Array(
		...
		'LBL_SUBJECT' => Array('ssingleorders', 'subject'),
	...
	public function vtlib_handler($moduleName, $eventType)
	{
		...
		if ($eventType == 'module.postinstall') {
			...
			if ($modcommentsModuleInstance && file_exists('modules/ModTracker/ModTracker.php')) {
				...
				$tabid = vtlib\Functions::getModuleId('SSingleOrders');
