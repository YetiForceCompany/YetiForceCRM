	...
	public function getMenuHeaderLinks(\App\Request $request)
	{
		...
		if (Users_Module_Model::getSwitchUsers()) {
			$headerLinks[] = [
				...
				'linkurl' => '',
				'fontawesomeicon' => 'fas fa-exchange-alt fa-fw',
				'nocaret' => true,
		...
		if (AppConfig::security('SHOW_MY_PREFERENCES')) {
			$headerLinks[] = [
				...
				'fontawesomeicon' => 'fas fa-tasks fa-fw',
			];
		}
		if ($userModel->isAdminUser()) {
			if ($request->getByType('parent', 2) !== 'Settings') {
				$headerLinks[] = [
					...
					'fontawesomeicon' => 'fas fa-cog fa-fw',
				];
			} else {
				$headerLinks[] = [
					'linktype' => 'HEADERLINK',
					...
					'linkurl' => 'index.php',
					'fontawesomeicon' => 'fas fa-user fa-fw',
				];
			}
		}
		$headerLinks[] = [
			...
			'fontawesomeicon' => 'fas fa-power-off fa-fw',
