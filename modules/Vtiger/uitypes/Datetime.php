...
class Vtiger_Datetime_UIType extends Vtiger_Date_UIType
{
	...
	public function getListViewDisplayValue($value, $record = false, $recordModel = false, $rawText = false)
	{
		...
		switch ($this->getFieldModel()->getUIType()) {
			case 80:
				return $rawText ? \App\Fields\DateTime::formatToViewDate($value) : '<span title="' . self::getDisplayDateTimeValue($value) . '">' . \App\Fields\DateTime::formatToViewDate($value) . '</span>';
		}
