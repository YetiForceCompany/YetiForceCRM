...
class Vtiger_Reference_UIType extends Vtiger_Base_UIType
{
	...
	public function getDisplayValue($value, $record = false, $recordModel = false, $rawText = false, $length = false)
	{
		...
		return "<a class='modCT_$referenceModuleName showReferenceTooltip js-popover-tooltip js-popover-tooltip--link' href='index.php?module=$referenceModuleName&view=" . $referenceModule->getDetailViewName() . "&record=$value' title='" . App\Language::translateSingularModuleName($referenceModuleName) . "'>$name</a>";
	}
