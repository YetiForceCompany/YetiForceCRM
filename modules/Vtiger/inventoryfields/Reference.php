...
class Vtiger_Reference_InventoryField extends Vtiger_Basic_InventoryField
{
	...
	public function getDisplayValue($value)
	{
		...
		$linkValue = '<a class="modColorText_' . $metaData['setype'] . '" href="index.php?module=' . $metaData['setype'] . '&view=Detail&record=' . $value . '" title="' . \App\Language::translate($metaData['setype'], $metaData['setype']) . '">' . \App\Record::getLabel($value) . '</a>';
		return $linkValue;
	}
