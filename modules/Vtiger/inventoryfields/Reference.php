...
class Vtiger_Reference_InventoryField extends Vtiger_Basic_InventoryField
{
	...
	public function getDisplayValue($value, $rawText = false)
	{
		...
		return "<a class='modCT_$moduleName showReferenceTooltip js-popover-tooltip js-popover-tooltip--link' href='index.php?module=$moduleName&view=Detail&record=$value' title='" . App\Language::translateSingularModuleName($moduleName) . "'>$label</a>";
	}
