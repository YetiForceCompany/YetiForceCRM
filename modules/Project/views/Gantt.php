...
class Project_Gantt_View extends Vtiger_Index_View
{
	...
	public function getFooterScripts(\App\Request $request)
	{
		...
		return array_merge(parent::getFooterScripts($request), $this->checkAndConvertJsScripts([
			...
			'~libraries/jquery-gantt-editor/node_modules/jquery/jquery.timers.js',
			...
			'~libraries/jquery-gantt-editor/node_modules/svg/jquery.svg.js',
			'~libraries/jquery-gantt-editor/node_modules/svg/jquery.svgdom.js',
